...
#define POLLIN (0x01) /* ROUX does not make priority distinctions */
#define POLLRDNORM (0x01)
#define POLLRDBAND (0x01)

#define POLLPRI (0x02)

#define POLLOUT (0x04) /* ROUX does not make priority distinctions */
#define POLLWRNORM (0x04)
#define POLLWRBAND (0x04)

#define POLLERR (0x08)
#define POLLHUP (0x10)
#define POLLRDHUP (0x10) /* ROUX does not support shutdown(fd, SHUT_RD) */
...
/* This is the ROUX variant of the standard pollfd structure.  The poll()
...
struct pollfd {
	...
	/* Non-standard fields used internally by ROUX. */
...
int ppoll(FAR struct pollfd *fds, nfds_t nfds, FAR const struct timespec *timeout_ts,
...
fortify_function(poll) int poll(FAR struct pollfd *fds, nfds_t nfds, int timeout)
{
