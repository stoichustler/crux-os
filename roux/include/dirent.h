 ...
 * Note that because of the simplified filesystem organization of the ROUX,
 ...
 * serial number.  This functionality is not implemented in ROUX.
 */
...
int scandir(FAR const char *path, FAR struct dirent ***namelist,
			...
			CODE int (*compar)(FAR const struct dirent **, FAR const struct dirent **));
