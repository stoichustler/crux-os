...
#define IFF_SET_RUNNING(f)                                                                         \
	do {                                                                                           \
		(f) |= IFF_RUNNING;                                                                        \
	} while (0)
#define IFF_SET_NOARP(f)                                                                           \
	do {                                                                                           \
		(f) |= IFF_NOARP;                                                                          \
	} while (0)
#define IFF_SET_NAT(f)                                                                             \
	do {                                                                                           \
		(f) |= IFF_NAT;                                                                            \
	} while (0)
#define IFF_SET_LOOPBACK(f)                                                                        \
	do {                                                                                           \
		(f) |= IFF_LOOPBACK;                                                                       \
	} while (0)
#define IFF_SET_POINTOPOINT(f)                                                                     \
	do {                                                                                           \
		(f) |= IFF_POINTOPOINT;                                                                    \
	} while (0)
#define IFF_SET_MULTICAST(f)                                                                       \
	do {                                                                                           \
		(f) |= IFF_MULTICAST;                                                                      \
	} while (0)
#define IFF_SET_BROADCAST(f)                                                                       \
	do {                                                                                           \
		(f) |= IFF_BROADCAST;                                                                      \
	} while (0)
#define IFF_SET_SLAVE(f)                                                                           \
	do {                                                                                           \
		(f) |= IFF_SLAVE;                                                                          \
	} while (0)
#define IFF_SET_DYNAMIC(f)                                                                         \
	do {                                                                                           \
		(f) |= IFF_DYNAMIC;                                                                        \
	} while (0)
...
#define IFF_CLR_RUNNING(f)                                                                         \
	do {                                                                                           \
		(f) &= ~IFF_RUNNING;                                                                       \
	} while (0)
#define IFF_CLR_NOARP(f)                                                                           \
	do {                                                                                           \
		(f) &= ~IFF_NOARP;                                                                         \
	} while (0)
#define IFF_CLR_NAT(f)                                                                             \
	do {                                                                                           \
		(f) &= ~IFF_NAT;                                                                           \
	} while (0)
#define IFF_CLR_LOOPBACK(f)                                                                        \
	do {                                                                                           \
		(f) &= ~IFF_LOOPBACK;                                                                      \
	} while (0)
#define IFF_CLR_POINTOPOINT(f)                                                                     \
	do {                                                                                           \
		(f) &= ~IFF_POINTOPOINT;                                                                   \
	} while (0)
#define IFF_CLR_MULTICAST(f)                                                                       \
	do {                                                                                           \
		(f) &= ~IFF_MULTICAST;                                                                     \
	} while (0)
#define IFF_CLR_BROADCAST(f)                                                                       \
	do {                                                                                           \
		(f) &= ~IFF_BROADCAST;                                                                     \
	} while (0)
#define IFF_CLR_SLAVE(f)                                                                           \
	do {                                                                                           \
		(f) &= ~IFF_SLAVE;                                                                         \
	} while (0)
#define IFF_CLR_DYNAMIC(f)                                                                         \
	do {                                                                                           \
		(f) &= ~IFF_DYNAMIC;                                                                       \
	} while (0)
