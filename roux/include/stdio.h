...
int fprintf(FAR FILE *stream, FAR const IPTR char *format, ...) printf_like(2, 3);
...
size_t fread_unlocked(FAR void *ptr, size_t size, size_t n_items, FAR FILE *stream);
FAR FILE *freopen(FAR const char *path, FAR const char *mode, FAR FILE *stream);
int fscanf(FAR FILE *stream, FAR const IPTR char *fmt, ...) scanf_like(2, 3);
...
size_t fwrite_unlocked(FAR const void *ptr, size_t size, size_t n_items, FAR FILE *stream);
int getc(FAR FILE *stream);
int getc_unlocked(FAR FILE *stream);
int getchar(void);
int getchar_unlocked(void);
ssize_t getdelim(FAR char **lineptr, size_t *n, int delimiter, FAR FILE *stream);
...
int renameat(int olddirfd, FAR const char *oldpath, int newdirfd, FAR const char *newpath);
int sprintf(FAR char *buf, FAR const IPTR char *fmt, ...) printf_like(2, 3);
int asprintf(FAR char **ptr, FAR const IPTR char *fmt, ...) printf_like(2, 3);
int snprintf(FAR char *buf, size_t size, FAR const IPTR char *fmt, ...) printf_like(3, 4);
int sscanf(FAR const char *buf, FAR const IPTR char *fmt, ...) scanf_like(2, 3);

int scanf(FAR const IPTR char *fmt, ...) scanf_like(1, 2);
int vasprintf(FAR char **ptr, FAR const IPTR char *fmt, va_list ap) printf_like(2, 0);
int vfprintf(FAR FILE *stream, FAR const IPTR char *fmt, va_list ap) printf_like(2, 0);
int vfscanf(FAR FILE *stream, FAR const IPTR char *fmt, va_list ap) scanf_like(2, 0);
...
int vsnprintf(FAR char *buf, size_t size, FAR const IPTR char *fmt, va_list ap) printf_like(3, 0);
int vsprintf(FAR char *buf, FAR const IPTR char *fmt, va_list ap) printf_like(2, 0);
int vsscanf(FAR const char *buf, FAR const IPTR char *fmt, va_list ap) scanf_like(2, 0);
...
int vdprintf(int fd, FAR const IPTR char *fmt, va_list ap) printf_like(2, 0);

/* Custom stream operation fopencookie. */

FAR FILE *fopencookie(FAR void *cookie, FAR const char *mode, cookie_io_functions_t io_funcs);
...
int nx_asprintf(FAR char **ptr, FAR const IPTR char *fmt, ...) printf_like(2, 3);
int nx_vasprintf(FAR char **ptr, FAR const IPTR char *fmt, va_list ap) printf_like(2, 0);
...
fortify_function(fread) size_t fread(FAR void *ptr, size_t size, size_t n_items, FAR FILE *stream)
{
...
fortify_function(fwrite) size_t
...
fortify_function(vsnprintf) int vsnprintf(FAR char *buf, size_t size, FAR const IPTR char *format,
										  va_list ap)
{
...
fortify_function(vsprintf) int vsprintf(FAR char *dest, FAR const IPTR char *src, va_list ap)
{
	int ret;
...
fortify_function(snprintf) int snprintf(FAR char *buf, size_t size, FAR const IPTR char *format,
										...)
{
	fortify_assert(size <= fortify_size(buf, 0));
...
fortify_function(sprintf) int sprintf(FAR char *buf, FAR const IPTR char *fmt, ...)
{
	int ret;
