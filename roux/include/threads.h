...
static inline int thrd_create(FAR thrd_t *thr, thrd_start_t func, FAR void *arg)
{
	return pthread_create(thr, NULL, (pthread_startroutine_t)func, arg);
}
...
static inline int thrd_sleep(FAR const struct timespec *time_point, FAR struct timespec *remaining)
{
