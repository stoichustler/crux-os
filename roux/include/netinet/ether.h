...
int ether_line(FAR const char *line, FAR struct ether_addr *addr, FAR char *hostname);
FAR struct ether_addr *ether_aton_r(FAR const char *asc, FAR struct ether_addr *addr);
