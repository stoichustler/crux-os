...
#include <roux/config.h>   /* Default settings */
#include <roux/compiler.h> /* Compiler settings, noreturn_function */
 ...
 * default value (ROUX permits you to override that default behavior
...
#define PTHREAD_COND_INITIALIZER                                                                   \
	{                                                                                              \
		SEM_INITIALIZER(0), CLOCK_REALTIME                                                         \
	}
...
#define PTHREAD_MUTEX_DEFAULT_PRIO_FLAGS                                                           \
	(PTHREAD_MUTEX_DEFAULT_PRIO_INHERIT | PTHREAD_MUTEX_DEFAULT_PRIO_PROTECT)

#define PTHREAD_NXMUTEX_INITIALIZER                                                                \
	{                                                                                              \
		NXSEM_INITIALIZER(NXSEM_NO_MHOLDER, SEM_TYPE_MUTEX | PTHREAD_MUTEX_DEFAULT_PRIO_FLAGS)     \
	}
#define PTHREAD_NXRMUTEX_INITIALIZER                                                               \
	{                                                                                              \
		PTHREAD_NXMUTEX_INITIALIZER, 0                                                             \
	}

#if defined(CONFIG_PTHREAD_MUTEX_TYPES) && !defined(CONFIG_PTHREAD_MUTEX_UNSAFE)
#define PTHREAD_MUTEX_INITIALIZER                                                                  \
	{                                                                                              \
		NULL, __PTHREAD_MUTEX_DEFAULT_FLAGS, PTHREAD_MUTEX_DEFAULT, PTHREAD_NXRMUTEX_INITIALIZER   \
	}

#define PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP                                                     \
	{                                                                                              \
		NULL, __PTHREAD_MUTEX_DEFAULT_FLAGS, PTHREAD_MUTEX_RECURSIVE,                              \
			PTHREAD_NXRMUTEX_INITIALIZER,                                                          \
	}
#elif defined(CONFIG_PTHREAD_MUTEX_TYPES)
#define PTHREAD_MUTEX_INITIALIZER                                                                  \
	{                                                                                              \
		PTHREAD_MUTEX_DEFAULT, PTHREAD_NXRMUTEX_INITIALIZER,                                       \
	}
#define PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP                                                     \
	{                                                                                              \
		PTHREAD_MUTEX_RECURSIVE, PTHREAD_NXRMUTEX_INITIALIZER                                      \
	}
#elif !defined(CONFIG_PTHREAD_MUTEX_UNSAFE)
#define PTHREAD_MUTEX_INITIALIZER                                                                  \
	{                                                                                              \
		NULL, __PTHREAD_MUTEX_DEFAULT_FLAGS, PTHREAD_NXMUTEX_INITIALIZER                           \
	}
#else
#define PTHREAD_MUTEX_INITIALIZER                                                                  \
	{                                                                                              \
...
#define PTHREAD_RWLOCK_INITIALIZER                                                                 \
	{                                                                                              \
		PTHREAD_MUTEX_INITIALIZER, PTHREAD_COND_INITIALIZER, 0, 0, false                           \
	}
...
int pthread_attr_getdetachstate(FAR const pthread_attr_t *attr, FAR int *detachstate);
int pthread_attr_setdetachstate(FAR pthread_attr_t *attr, int detachstate);

#ifdef CONFIG_SMP
/* Set or obtain thread affinity attributes */

int pthread_attr_setaffinity_np(FAR pthread_attr_t *attr, size_t cpusetsize,
								FAR const cpu_set_t *cpuset);
int pthread_attr_getaffinity_np(FAR const pthread_attr_t *attr, size_t cpusetsize,
								cpu_set_t *cpuset);
#endif
...
int pthread_attr_getstackaddr(FAR const pthread_attr_t *attr, FAR void **stackaddr);
...
int pthread_attr_setstack(FAR pthread_attr_t *attr, FAR void *stackaddr, size_t stacksize);
int pthread_attr_getstack(FAR const pthread_attr_t *attr, FAR void **stackaddr,
...
int pthread_mutexattr_getprioceiling(FAR const pthread_mutexattr_t *attr, FAR int *prioceiling);
int pthread_mutexattr_setprioceiling(FAR pthread_mutexattr_t *attr, int prioceiling);
int pthread_mutex_getprioceiling(FAR const pthread_mutex_t *mutex, FAR int *prioceiling);
int pthread_mutex_setprioceiling(FAR pthread_mutex_t *mutex, int prioceiling, FAR int *old_ceiling);
...
int pthread_mutex_timedlock(FAR pthread_mutex_t *mutex, FAR const struct timespec *abs_timeout);
...
int pthread_condattr_getpshared(FAR const pthread_condattr_t *attr, FAR int *pshared);
int pthread_condattr_setpshared(FAR pthread_condattr_t *attr, int pshared);
int pthread_condattr_getclock(FAR const pthread_condattr_t *attr, clockid_t *clock_id);
...
int pthread_cond_clockwait(FAR pthread_cond_t *cond, FAR pthread_mutex_t *mutex, clockid_t clockid,
						   FAR const struct timespec *abstime);
...
int pthread_barrier_init(FAR pthread_barrier_t *barrier, FAR const pthread_barrierattr_t *attr,
						 unsigned int count);
...
int pthread_rwlockattr_getpshared(FAR const pthread_rwlockattr_t *attr, FAR int *pshared);
...
int pthread_rwlock_clockrdlock(FAR pthread_rwlock_t *lock, clockid_t clockid,
							   FAR const struct timespec *abstime);
...
int pthread_rwlock_clockwrlock(FAR pthread_rwlock_t *lock, clockid_t clockid,
							   FAR const struct timespec *abstime);
...
int pthread_atfork(CODE void (*prepare)(void), CODE void (*parent)(void), CODE void (*child)(void));
