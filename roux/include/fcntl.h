...
#define O_DSYNC O_SYNC			 /* Equivalent to OSYNC in ROUX */
 ...
 * this bit number may be used within ROUX for other, internal purposes.
 */
...
#define FASYNC 0			 /* No counterpart in ROUX */
...
#define F_SETPIPE_SZ                                                                               \
	19					/* Modify the capacity of the pipe to arg bytes, but not larger than       \
...
#define AT_FDCWD                                                                                   \
	-100						   /* Special value used to indicate openat should use the current \
									* working directory.                                           \
									*/
