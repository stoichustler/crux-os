...
#define BT_PSM_SDP                                                                                 \
	0x0001 /* Bluetooth Service Discovery                                                          \
			* Protocol (SDP), Bluetooth SIG */
#define BT_PSM_RFCOMM                                                                              \
	0x0003 /* RFCOMM with TS 07.10, Bluetooth                                                      \
			* SIG */
#define BT_PSM_TCS_BIN                                                                             \
	0x0005 /* Bluetooth Telephony Control                                                          \
			* Specification / TCS Binary,                                                          \
			* Bluetooth SIG */
#define BT_PSM_TCS_BIN_CORDLESS                                                                    \
	0x0007 /* Bluetooth Telephony Control                                                          \
			* Specification / TCS Binary,                                                          \
			* Bluetooth SIG */
#define BT_PSM_BNEP                                                                                \
	0x000f /* Bluetooth Network Encapsulation                                                      \
			* Protocol, Bluetooth SIG */
#define BT_PSM_HID_CTRL                                                                            \
	0x0011 /* Human Interface Device, Bluetooth                                                    \
			* SIG */
#define BT_PSM_HID_INT                                                                             \
	0x0013				   /* Human Interface Device, Bluetooth                                    \
							* SIG */
#define BT_PSM_UPnP 0x0015 /* [ESDP] , Bluetooth SIG */
#define BT_PSM_AVCTP                                                                               \
	0x0017 /* Audio/Video Control Transport                                                        \
			* Protocol, Bluetooth SIG */
#define BT_PSM_AVDTP                                                                               \
	0x0019 /* Audio/Video Distribution Transport                                                   \
			* Protocol, Bluetooth SIG */
#define BT_PSM_AVCTP_BROWSING                                                                      \
	0x001b /* Audio/Video Remote Control                                                           \
			* Profile, Bluetooth SIG */
#define BT_PSM_UDI_CPLANE                                                                          \
	0x001d				  /* Unrestricted Digital Information                                      \
						   * Profile [UDI], Bluetooth SIG */
#define BT_PSM_ATT 0x001f /* Bluetooth Core Specification */
#define BT_PSM_3DSP                                                                                \
	0x0021 /* 3D Synchronization Profile,                                                          \
			* Bluetooth SIG. */
#define BT_PSM_LE_PSM_IPSP                                                                         \
	0x0023 /* Internet Protocol Support Profile                                                    \
			* (IPSP), Bluetooth SIG */
#define BT_PSM_OTS                                                                                 \
	0x0025 /* Object Transfer Service (OTS),                                                       \
			* Bluetooth SIG  */
...
/* See include/roux/wireless/bluetooth/bt_hci.h for address definitions.  In
