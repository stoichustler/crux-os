...
int posix_spawn_file_actions_adddup2(FAR posix_spawn_file_actions_t *file_actions, int fd1,
									 int fd2);
int posix_spawn_file_actions_addopen(FAR posix_spawn_file_actions_t *file_actions, int fd,
									 FAR const char *path, int oflags, mode_t mode);
...
#ifndef CONFIG_BUILD_KERNEL
int posix_spawnattr_getstackaddr(FAR const posix_spawnattr_t *attr, FAR void **stackaddr);
int posix_spawnattr_setstackaddr(FAR posix_spawnattr_t *attr, FAR void *stackaddr);
#else
