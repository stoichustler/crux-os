...
FAR void *obstack_copy(FAR struct obstack *h, FAR const void *address, size_t size);
...
FAR void *obstack_copy0(FAR struct obstack *h, FAR const void *address, size_t size);
 ...
 *
 * Description:
 *   This is non-standard function that is probably available only on ROUX!
...
void obstack_grow(FAR struct obstack *h, FAR const void *address, size_t size);
...
void obstack_grow0(FAR struct obstack *h, FAR const void *address, size_t size);
...
int obstack_printf(FAR struct obstack *h, FAR const char *fmt, ...) printf_like(2, 3);
...
int obstack_vprintf(FAR struct obstack *h, FAR const char *fmt, va_list ap) printf_like(2, 0);
