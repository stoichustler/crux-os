...
int hex2mem(int fd, unsigned long baseaddr, unsigned long endpaddr, enum hex2bin_swap_e swap);
...
int fhex2mem(FAR FILE *instream, unsigned long baseaddr, unsigned long endpaddr,
