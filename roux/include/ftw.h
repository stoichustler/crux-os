...
#define FTW_PHYS                                                                                   \
	1				/* Physical walk, does not follow symbolic links.                              \
...
#define FTW_DEPTH                                                                                  \
	4 /* All subdirectories are visited before the directory                                       \
	   * itself. */
#ifndef CONFIG_DISABLE_ENVIRON
#define FTW_CHDIR                                                                                  \
	8 /* The walk changes to each directory before reading                                         \
	   * it.  */
#endif
...
typedef int (*ftw_cb_t)(FAR const char *path, FAR const struct stat *buf, int info);

/* This is the type of the nftw callback */

typedef int (*nftw_cb_t)(FAR const char *path, FAR const struct stat *buf, int info,
						 FAR struct FTW *pftw);
