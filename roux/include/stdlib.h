...
/* System() command is not implemented in the ROUX libc because it is so
...
FAR void *bsearch(FAR const void *key, FAR const void *base, size_t nel, size_t width,
				  CODE int (*compar)(FAR const void *, FAR const void *));
...
int __cxa_atexit(CODE void (*func)(FAR void *), FAR void *arg, FAR void *dso_handle);

#if CONFIG_FORTIFY_SOURCE > 0
fortify_function(realpath) FAR char *realpath(FAR const char *path, FAR char *resolved)
{
