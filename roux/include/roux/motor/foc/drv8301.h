...
#ifndef __INCLUDE_ROUX_MOTOR_FOC_DRV8301_H
#define __INCLUDE_ROUX_MOTOR_FOC_DRV8301_H
...
struct drv8301_ops_s {
	CODE int (*fault_attach)(FAR struct focpwr_dev_s *dev, xcpt_t isr, FAR void *arg);
...
#endif /* __INCLUDE_ROUX_MOTOR_FOC_DRV8301_H */
