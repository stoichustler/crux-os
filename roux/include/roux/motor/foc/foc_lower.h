...
#ifndef __INCLUDE_ROUX_MOTOR_FOC_FOC_LOWER_H
#define __INCLUDE_ROUX_MOTOR_FOC_FOC_LOWER_H
...
struct foc_callbacks_s {
	...
	CODE int (*notifier)(FAR struct foc_dev_s *dev, FAR foc_current_t *current,
...
struct foc_lower_ops_s {
	...
	CODE int (*info_get)(FAR struct foc_dev_s *dev, FAR struct foc_info_s *info);
...
#endif /* __INCLUDE_ROUX_MOTOR_FOC_FOC_LOWER_H */
