...
#ifndef __INCLUDE_ROUX_SYSLOG_SYSLOG_H
#define __INCLUDE_ROUX_SYSLOG_SYSLOG_H
 ...
 *      described in the include/roux/syslog/ramlog.h header file.
 *
...
typedef CODE ssize_t (*syslog_write_t)(FAR syslog_channel_t *channel, FAR const char *buf,
									   size_t buflen);
typedef CODE int (*syslog_putc_t)(FAR syslog_channel_t *channel, int ch);
...
FAR syslog_channel_t *syslog_stream_channel(FAR struct lib_outstream_s *stream);
#endif
 ...
 *   some compilers and passing of structures in the ROUX sycalls does
 *   not work.
 *
 ****************************************************************************/
...
#endif /* __ASSEMBLY__ */
#endif /* __INCLUDE_ROUX_SYSLOG_SYSLOG_H */
