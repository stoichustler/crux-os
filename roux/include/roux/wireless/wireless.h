...
#ifndef __INCLUDE_ROUX_WIRELESS_WIRELESS_H
#define __INCLUDE_ROUX_WIRELESS_WIRELESS_H
...
#define WL_IS80211POINTERCMD(cmd)                                                                  \
	((cmd) == SIOCGIWSCAN || (cmd) == SIOCSIWSCAN || (cmd) == SIOCSIWCOUNTRY ||                    \
	 (cmd) == SIOCGIWCOUNTRY || (cmd) == SIOCGIWRANGE || (cmd) == SIOCSIWENCODEEXT ||              \
	 (cmd) == SIOCGIWENCODEEXT || (cmd) == SIOCGIWESSID || (cmd) == SIOCSIWESSID)
...
#define IW_EV_LEN(field) (offsetof(struct iw_event, u) + sizeof(((union iwreq_data *)0)->field))

#endif /* __INCLUDE_ROUX_WIRELESS_WIRELESS_H */
