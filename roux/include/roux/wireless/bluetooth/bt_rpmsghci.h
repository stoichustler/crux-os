...
#ifndef __INCLUDE_ROUX_WIRELESS_BLUETOOTH_BT_RPMSGHCI_H
#define __INCLUDE_ROUX_WIRELESS_BLUETOOTH_BT_RPMSGHCI_H
...
FAR struct bt_driver_s *rpmsghci_register(FAR const char *remotecpu, FAR const char *name);
#endif

#endif /* __INCLUDE_ROUX_WIRELESS_BLUETOOTH_BT_RPMSGHCI_H */
