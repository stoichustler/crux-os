...
#ifndef __INCLUDE_ROUX_WIRELESS_LTE_LTE_IOCTL_H
#define __INCLUDE_ROUX_WIRELESS_LTE_LTE_IOCTL_H
...
#define IS_LWM2M_EVENT(cid)                                                                        \
	(((cid) == LTE_CMDID_LWM2M_READ_EVT) || ((cid) == LTE_CMDID_LWM2M_WRITE_EVT) ||                \
	 ((cid) == LTE_CMDID_LWM2M_EXEC_EVT) || ((cid) == LTE_CMDID_LWM2M_OVSTART_EVT) ||              \
	 ((cid) == LTE_CMDID_LWM2M_OVSTOP_EVT) || ((cid) == LTE_CMDID_LWM2M_SERVEROP_EVT) ||           \
	 ((cid) == LTE_CMDID_LWM2M_FWUP_EVT))

#define IS_LTE_REPORT_EVENT(cid)                                                                   \
	(((cid) == LTE_CMDID_REPNETINFO) || ((cid) == LTE_CMDID_REPSIMSTAT) ||                         \
	 ((cid) == LTE_CMDID_REPLTIME) || ((cid) == LTE_CMDID_REPQUAL) ||                              \
...
#endif /* __INCLUDE_ROUX_WIRELESS_LTE_LTE_IOCTL_H */
