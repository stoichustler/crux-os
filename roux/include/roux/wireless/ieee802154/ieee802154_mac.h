...
#ifndef __INCLUDE_ROUX_WIRELESS_IEEE802154_IEEE802154_MAC_H
#define __INCLUDE_ROUX_WIRELESS_IEEE802154_IEEE802154_MAC_H
...
#define IEEE802154_ANYADDRCOPY(dest, src, len) memcpy(dest, src, len)

#define IEEE802154_PANIDCOPY(dest, src) IEEE802154_ANYADDRCOPY(dest, src, IEEE802154_PANIDSIZE)

#define IEEE802154_SADDRCOPY(dest, src) IEEE802154_ANYADDRCOPY(dest, src, IEEE802154_SADDRSIZE)

#define IEEE802154_EADDRCOPY(dest, src) IEEE802154_ANYADDRCOPY(dest, src, IEEE802154_EADDRSIZE)

/* Compare two IEEE 802.15.4 addresses */

#define IEEE802154_ANYADDRCMP(addr1, addr2, len) (memcmp(addr1, addr2, len) == 0)

#define IEEE802154_PANIDCMP(addr1, addr2) IEEE802154_ANYADDRCMP(addr1, addr2, IEEE802154_PANIDSIZE)

#define IEEE802154_SADDRCMP(addr1, addr2) IEEE802154_ANYADDRCMP(addr1, addr2, IEEE802154_SADDRSIZE)

#define IEEE802154_EADDRCMP(addr1, addr2) IEEE802154_ANYADDRCMP(addr1, addr2, IEEE802154_EADDRSIZE)
...
#endif /* __INCLUDE_ROUX_WIRELESS_IEEE802154_IEEE802154_MAC_H */
