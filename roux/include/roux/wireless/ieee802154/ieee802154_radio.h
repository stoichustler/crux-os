...
#ifndef __INCLUDE_ROUX_WIRELESS_IEEE802154_IEEE802154_RADIO_H
#define __INCLUDE_ROUX_WIRELESS_IEEE802154_IEEE802154_RADIO_H
...
struct ieee802154_radiocb_s {
	CODE int (*poll)(FAR const struct ieee802154_radiocb_s *radiocb, bool gts,
	...
	CODE void (*edresult)(FAR const struct ieee802154_radiocb_s *radiocb, uint8_t edval);
};
...
struct ieee802154_radio_s {
	...
	CODE int (*getattr)(FAR struct ieee802154_radio_s *radio, enum ieee802154_attr_e,
						FAR union ieee802154_attr_u *attrval);
	CODE int (*setattr)(FAR struct ieee802154_radio_s *radio, enum ieee802154_attr_e,
	...
	CODE int (*txdelayed)(FAR struct ieee802154_radio_s *radio,
						  FAR struct ieee802154_txdesc_s *txdesc, uint32_t symboldelay);
	CODE int (*rxenable)(FAR struct ieee802154_radio_s *radio, bool enable);
	CODE int (*energydetect)(FAR struct ieee802154_radio_s *radio, uint32_t symboldelay);
...
#endif /* __INCLUDE_ROUX_WIRELESS_IEEE802154_IEEE802154_RADIO_H */
