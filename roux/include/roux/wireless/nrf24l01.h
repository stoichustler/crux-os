...
#ifndef __INCLUDE_ROUX_WIRELESS_NRF24L01_H
#define __INCLUDE_ROUX_WIRELESS_NRF24L01_H
...
#define NRF24L01_MAX_XMIT_RETR                                                                     \
	15						  /* Maximum auto retransmit count (for AA                             \
							   * transmissions) */
...
#define NRF24L01_DYN_LENGTH                                                                        \
	33 /* Specific length value to use to enable dynamic                                           \
		* packet length */
#define NRF24L01_XMIT_MAXRT                                                                        \
	255 /* Specific value returned by Number of available                                          \
		 * pipes */
...
int nrf24l01_setuprf(FAR struct nrf24l01_dev_s *dev, nrf24l01_datarate_t datarate, int outpower);
...
ssize_t nrf24l01_recv(struct nrf24l01_dev_s *dev, FAR uint8_t *buffer, size_t buflen,
...
#endif /* __INCLUDE_ROUX_WIRELESS_NRF24L01_H */
