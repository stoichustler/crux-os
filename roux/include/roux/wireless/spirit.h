...
#ifndef __INCLUDE_ROUX_WIRELESS_SPIRIT_H
#define __INCLUDE_ROUX_WIRELESS_SPIRIT_H
...
struct spirit_lower_s {
	...
	int (*attach)(FAR const struct spirit_lower_s *lower, xcpt_t handler, FAR void *arg);
...
#endif /* __INCLUDE_ROUX_IEEE802154__AT86RF23X_H */
