...
#ifndef __INCLUDE_ROUX_WIRELESS_IOCTL_H
#define __INCLUDE_ROUX_WIRELESS_IOCTL_H
 ...
 * Non-compatible, ROUX only IOCTL definitions for use with low-level
...
#define WLIOC_SETADDR                                                                              \
	_WLIOC_COM(2) /* arg: Pointer to address value, format                                         \
				   * of the address is driver specific */
#define WLIOC_GETADDR                                                                              \
	_WLIOC_COM(3) /* arg: Pointer to address value, format                                         \
				   * of the address is driver specific */
...
#define WLIOC_SETFINEPOWER                                                                         \
	_WLIOC_COM(6) /* arg: Pointer to int32_t,                                                      \
				   * Set power in steps of 0.01 dBm */
#define WLIOC_GETFINEPOWER                                                                         \
	_WLIOC_COM(7) /* arg: Pointer to int32_t,                                                      \
				   * Get power in steps of 0.01 dBm */

#define WLIOC_SETMODU                                                                              \
	_WLIOC_COM(8) /* arg: Pointer to enum wlioc_modulation_e.                                      \
				   * This sets the modulation technology. */
#define WLIOC_GETMODU                                                                              \
	_WLIOC_COM(9) /* arg: Pointer to enum wlioc_modulation_e.                                      \
				   * Get current modulation technology. */

/* Number of commands */

#define _WLIOC_COM_COMMANDS                                                                        \
	10 /* ! Must be corrected after changes to commands.                                           \
...
#define _WLIOC_LORA_COMMANDS                                                                       \
	12 /* ! Must be corrected after changes to commands.                                           \
		* ! Equal to the amount of commands above. */
...
#define _WLIOC_FSK_COMMANDS                                                                        \
	4 /* ! Must be corrected after changes to commands.                                            \
	   * ! Equal to the amount of commands above. */
...
#define _WLIOC_OOK_COMMANDS                                                                        \
	2 /* ! Must be corrected after changes to commands.                                            \
	   * ! Equal to the amount of commands above. */
...
#define _WLIOC_RN2XX3_COMMANDS                                                                     \
	20 /* ! Must be corrected after changes to commands.                                           \
		* ! Equal to the amount of commands above. */
...
#endif /* __INCLUDE_ROUX_WIRELESS_IOCTL_H */
