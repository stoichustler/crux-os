...
#ifndef __INCLUDE_ROUX_MATH_MPI_H
#define __INCLUDE_ROUX_MATH_MPI_H
...
struct mpi_ops_s {
	...
	CODE int (*calc)(FAR struct mpi_lowerhalf_s *lower, FAR struct mpi_calc_s *calc);
};
...
#endif /* __INCLUDE_ROUX_MATH_MPI_H */
