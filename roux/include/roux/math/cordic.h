...
#ifndef __INCLUDE_ROUX_MATH_CORDIC_H
#define __INCLUDE_ROUX_MATH_CORDIC_H
...
struct cordic_ops_s {
	...
	CODE int (*calc)(FAR struct cordic_lowerhalf_s *lower, FAR struct cordic_calc_s *calc);
};
...
#endif /* __INCLUDE_ROUX_MATH_CORDIC_H */
