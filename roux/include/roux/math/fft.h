...
#ifndef __INCLUDE_ROUX_MATH_FFT_H
#define __INCLUDE_ROUX_MATH_FFT_H
...
struct fft_ops_s {
	...
	CODE int (*calc)(FAR struct fft_lowerhalf_s *lower, FAR struct fft_calc_s *calc);
};
...
#endif /* __INCLUDE_ROUX_MATH_FFT_H */
