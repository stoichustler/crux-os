...
#ifndef __INCLUDE_ROUX_CRYPTO_CRYPTO_H
#define __INCLUDE_ROUX_CRYPTO_CRYPTO_H
...
#if defined(CONFIG_CRYPTO_AES)
int aes_cypher(FAR void *out, FAR const void *in, size_t size, FAR const void *iv,
			   FAR const void *key, size_t keysize, int mode, int encrypt);
#endif
...
#endif /* __ASSEMBLY__ */
#endif /* __INCLUDE_ROUX_CRYPTO_CRYPTO_H */
