...
#ifndef __INCLUDE_ROUX_CRYPTO_BLAKE2S_H
#define __INCLUDE_ROUX_CRYPTO_BLAKE2S_H
...
int blake2s(FAR void *out, size_t outlen, FAR const void *in, size_t inlen, FAR const void *key,
			size_t keylen);
...
#endif /* __INCLUDE_ROUX_CRYPTO_BLAKE2S_H */
