...
#ifndef __INCLUDE_ROUX_BINFMT_BINFMT_H
#define __INCLUDE_ROUX_BINFMT_BINFMT_H
...
struct binfmt_s {
	...
	CODE int (*load)(FAR struct binary_s *bin, FAR const char *filename,
...
int exec_module(FAR struct binary_s *binp, FAR const char *filename, FAR char *const *argv,
				FAR char *const *envp, FAR const posix_spawn_file_actions_t *actions,
 ...
 *
 *   This non-standard, ROUX function is similar to execv() and
 ...
 *
 *   This non-standard interface is included as a official ROUX API only
...
int exec(FAR const char *filename, FAR char *const *argv, FAR char *const *envp,
		 FAR const struct symtab_s *exports, int nexports);
...
int exec_spawn(FAR const char *filename, FAR char *const *argv, FAR char *const *envp,
			   FAR const struct symtab_s *exports, int nexports,
			   FAR const posix_spawn_file_actions_t *actions, FAR const posix_spawnattr_t *attr);
...
#endif /* __INCLUDE_ROUX_BINFMT_BINFMT_H */
