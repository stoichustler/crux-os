...
#ifndef __INCLUDE_ROUX_BINFMT_IEEE695_H
#define __INCLUDE_ROUX_BINFMT_IEEE695_H
...
#define IEEE695_COMENT_TRANSLATOR                                                                  \
	0x00							  /* Translator (may name the source language or translator)   \
									   */
...
#define IEEE695_COMENT_NEWOMF                                                                      \
	0xa1 /* "New OMF" extension. Indicates symbolic debug information version. */
...
#define IEEE695_COMENT_USER                                                                        \
	0xdf /* For pragma comment(user). Sometimes used for copyright notices */
...
#define IEEE695_EXTCMD_ISDEF                                                                       \
	{                                                                                              \
		0x01, 0xb9                                                                                 \
	}
#define IEEE695_EXTCMD_TRANS                                                                       \
	{                                                                                              \
		0x02, 0xb9                                                                                 \
	}
#define IEEE695_EXTCMD_SPLIT                                                                       \
	{                                                                                              \
		0x03, 0xb9                                                                                 \
	}
#define IEEE695_EXTCMD_INBLOCK                                                                     \
	{                                                                                              \
		0x04, 0xb9                                                                                 \
	}
#define IEEE695_EXTCMD_CALLOPT                                                                     \
	{                                                                                              \
		0x05, 0xb9                                                                                 \
	}
...
#define IEEE695_ATTR_TOOLVERSION                                                                   \
	54 /* Tool and version number used to create the module, 3 bytes follows */
...
#define IEEE695_MEMORYMODEL_BIG                                                                    \
	5							   /* Code has multiple 64K segments with common "near" data area  \
									*/
...
#define IEEE695_GETUINT16(p)                                                                       \
	(((uint16_t)(*(FAR uint8_t *)(p)) << 8) | (uint16_t)(*((FAR uint8_t *)(p) + 1)))

#define IEEE695_GETUINT32(p)                                                                       \
	(((uint32_t)(*(FAR uint8_t *)(p)) << 24) | ((uint32_t)(*((FAR uint8_t *)(p) + 1)) << 16) |     \
	 ((uint32_t)(*((FAR uint8_t *)(p) + 2)) << 8) | (uint32_t)(*((FAR uint8_t *)(p) + 3)))

/* This macro extracts the 16-bit length from the IEEE 695 record header */

#define IEEE695_RECLEN(rec) IEEE695_GETUINT16(((FAR struct ieee695_record_s *)(rec))->len)
...
#endif /* __INCLUDE_ROUX_BINFMT_IEEE695_H */
