...
#ifndef __INCLUDE_ROUX_BOARD_H
#define __INCLUDE_ROUX_BOARD_H
 ...
 *         meaning to ROUX; the meaning of the argument is a contract
 ...
 *
 *     LED_STARTED       ROUX has been started
 ...
 *
 *   If CONFIG_ARCH_LEDS is defined, then ROUX will control the on-board
 ...
 *   used by the ROUX LED logic exclusively and may not be available for
...
struct tcb_s;
void board_crashdump(uintptr_t sp, FAR struct tcb_s *tcb, FAR const char *filename, int lineno,
