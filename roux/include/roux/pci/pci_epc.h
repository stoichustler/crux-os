...
#ifndef __INCLUDE_ROUX_PCI_PCI_EPC_H
#define __INCLUDE_ROUX_PCI_PCI_EPC_H
...
struct pci_epc_ops_s {
	...
	CODE void (*clear_bar)(FAR struct pci_epc_ctrl_s *epc, uint8_t funcno,
						   FAR struct pci_epf_bar_s *bar);
	CODE int (*map_addr)(FAR struct pci_epc_ctrl_s *epc, uint8_t funcno, uintptr_t addr,
						 uint64_t pci_addr, size_t size);
	CODE void (*unmap_addr)(FAR struct pci_epc_ctrl_s *epc, uint8_t funcno, uintptr_t addr);
	CODE int (*set_msi)(FAR struct pci_epc_ctrl_s *epc, uint8_t funcno, uint8_t interrupts);
	CODE int (*get_msi)(FAR struct pci_epc_ctrl_s *epc, uint8_t funcno);
	CODE int (*set_msix)(FAR struct pci_epc_ctrl_s *epc, uint8_t funcno, uint16_t interrupts,
	...
	CODE int (*map_msi_irq)(FAR struct pci_epc_ctrl_s *epc, uint8_t funcno, uintptr_t phys_addr,
	...
	CODE FAR const struct pci_epc_features_s *(*get_features)(FAR struct pci_epc_ctrl_s *epc,
															  uint8_t funcno);
...
int pci_epc_mem_init(FAR struct pci_epc_ctrl_s *epc, FAR void *virt, uintptr_t phys, size_t size,
					 size_t page_size);
...
FAR void *pci_epc_mem_alloc_addr(FAR struct pci_epc_ctrl_s *epc, FAR uintptr_t *phys, size_t size);
...
void pci_epc_mem_free_addr(FAR struct pci_epc_ctrl_s *epc, uintptr_t phys_addr, size_t size);

#endif /* __INCLUDE_ROUX_PCI_PCI_EPC_H */
