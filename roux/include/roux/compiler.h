...
#ifndef __INCLUDE_ROUX_COMPILER_H
#define __INCLUDE_ROUX_COMPILER_H
 ...
 *
 * NOTE: The ROUX coding standard forbids the use of unnamed structures and
...
#define fortify_assert(condition)                                                                  \
	do {                                                                                           \
		if (!(condition)) {                                                                        \
			__builtin_trap();                                                                      \
		}                                                                                          \
...
#define malloc_like1(a)                                                                            \
	__attribute__((__malloc__(__builtin_free, 1))) __attribute__((__alloc_size__(a)))
#define malloc_like2(a, b)                                                                         \
	__attribute__((__malloc__(__builtin_free, 1))) __attribute__((__alloc_size__(a, b)))
...
#endif /* __INCLUDE_ROUX_COMPILER_H */
