...
#ifndef __INCLUDE_ROUX_NX_NXMU_H
#define __INCLUDE_ROUX_NX_NXMU_H
...
int nxmu_sendserver(FAR struct nxmu_conn_s *conn, FAR const void *msg, size_t msglen);
...
int nxmu_sendwindow(FAR struct nxbe_window_s *wnd, FAR const void *msg, size_t msglen);
...
#endif /* __INCLUDE_ROUX_NX_NXMU_H */
