...
#ifndef __INCLUDE_ROUX_NX_NXGLIB_H
#define __INCLUDE_ROUX_NX_NXGLIB_H
...
void nxgl_area2rect(FAR struct nxgl_rect_s *dest, FAR const struct fb_area_s *src);
...
void nxgl_rect2area(FAR struct fb_area_s *dest, FAR const struct nxgl_rect_s *src);
...
void nxgl_rectcopy(FAR struct nxgl_rect_s *dest, FAR const struct nxgl_rect_s *src);
...
void nxgl_rectoffset(FAR struct nxgl_rect_s *dest, FAR const struct nxgl_rect_s *src,
...
void nxgl_vectoradd(FAR struct nxgl_point_s *dest, FAR const struct nxgl_point_s *v1,
...
void nxgl_vectsubtract(FAR struct nxgl_point_s *dest, FAR const struct nxgl_point_s *v1,
					   FAR const struct nxgl_point_s *v2);
...
void nxgl_rectintersect(FAR struct nxgl_rect_s *dest, FAR const struct nxgl_rect_s *src1,
...
bool nxgl_intersecting(FAR const struct nxgl_rect_s *rect1, FAR const struct nxgl_rect_s *rect2);
...
void nxgl_rectadd(FAR struct nxgl_rect_s *dest, FAR const struct nxgl_rect_s *src1,
				  FAR const struct nxgl_rect_s *src2);
...
void nxgl_rectunion(FAR struct nxgl_rect_s *dest, FAR const struct nxgl_rect_s *src1,
					FAR const struct nxgl_rect_s *src2);
...
void nxgl_nonintersecting(FAR struct nxgl_rect_s result[4], FAR const struct nxgl_rect_s *rect1,
...
bool nxgl_rectoverlap(FAR struct nxgl_rect_s *rect1, FAR struct nxgl_rect_s *rect2);
...
bool nxgl_rectinside(FAR const struct nxgl_rect_s *rect, FAR const struct nxgl_point_s *pt);
...
void nxgl_rectsize(FAR struct nxgl_size_s *size, FAR const struct nxgl_rect_s *rect);
...
void nxgl_runoffset(FAR struct nxgl_run_s *dest, FAR const struct nxgl_run_s *src, nxgl_coord_t dx,
					nxgl_coord_t dy);
...
void nxgl_trapoffset(FAR struct nxgl_trapezoid_s *dest, FAR const struct nxgl_trapezoid_s *src,
					 nxgl_coord_t dx, nxgl_coord_t dy);
...
void nxgl_trapcopy(FAR struct nxgl_trapezoid_s *dest, FAR const struct nxgl_trapezoid_s *src);
...
#endif /* __INCLUDE_ROUX_NX_NXGLIB_H */
