...
#ifndef __INCLUDE_ROUX_NX_NXBE_H
#define __INCLUDE_ROUX_NX_NXBE_H
...
#define NXBE_WINDOW_BLOCKED                                                                        \
	(1 << 0)						   /* Bit 0: The window is blocked and will                    \
...
#define NXBE_ISFRAMED(wnd) (((wnd)->flags & NXBE_WINDOW_FRAMED) != 0)
#define NXBE_SETFRAMED(wnd)                                                                        \
	do {                                                                                           \
		(wnd)->flags |= NXBE_WINDOW_FRAMED;                                                        \
	} while (0)
...
#define NXBE_ISRAMBACKED(wnd) (((wnd)->flags & NXBE_WINDOW_RAMBACKED) != 0)
#define NXBE_SETRAMBACKED(wnd)                                                                     \
	do {                                                                                           \
		(wnd)->flags |= NXBE_WINDOW_RAMBACKED;                                                     \
	} while (0)
...
#define NXBE_ISMODAL(wnd) (((wnd)->flags & NXBE_WINDOW_MODAL) != 0)
#define NXBE_SETMODAL(wnd)                                                                         \
	do {                                                                                           \
		(wnd)->flags |= NXBE_WINDOW_MODAL;                                                         \
	} while (0)
...
#define NXBE_ISHIDDEN(wnd) (((wnd)->flags & NXBE_WINDOW_HIDDEN) != 0)
#define NXBE_SETHIDDEN(wnd)                                                                        \
	do {                                                                                           \
		(wnd)->flags |= NXBE_WINDOW_HIDDEN;                                                        \
	} while (0)
...
#endif /* __INCLUDE_ROUX_NX_NXBE_H */
