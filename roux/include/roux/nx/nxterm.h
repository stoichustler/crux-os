...
#ifndef __INCLUDE_ROUX_NX_NXTERM_H
#define __INCLUDE_ROUX_NX_NXTERM_H
...
#if defined(CONFIG_NXTERM_BPP) && CONFIG_NXTERM_BPP != 1 && CONFIG_NXTERM_BPP != 2 &&              \
	CONFIG_NXTERM_BPP != 4 && CONFIG_NXTERM_BPP != 8 && CONFIG_NXTERM_BPP != 16 &&                 \
 ...
 *
 *   This is an internal ROUX interface and should not be called directly
...
#endif /* CONFIG_NXTERM */
#endif /* __INCLUDE_ROUX_NX_NXTERM_H */
