...
#ifndef __INCLUDE_ROUX_IRQ_H
#define __INCLUDE_ROUX_IRQ_H
 ...
 * defined in arch/irq.h but arch/irq.h includes roux/irq.h and we get
...
int irq_attach_thread(int irq, xcpt_t isr, xcpt_t isrthread, FAR void *arg, int priority,
					  int stack_size);
