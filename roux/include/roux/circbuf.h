...
#ifndef __INCLUDE_ROUX_CIRCBUF_H
#define __INCLUDE_ROUX_CIRCBUF_H
...
#define CIRCBUF_INITIALIZER(base, size)                                                            \
	{                                                                                              \
		base, size, 0, 0, true                                                                     \
	}
...
ssize_t circbuf_peekat(FAR struct circbuf_s *circ, size_t pos, FAR void *dst, size_t bytes);
...
ssize_t circbuf_peek(FAR struct circbuf_s *circ, FAR void *dst, size_t bytes);
...
ssize_t circbuf_read(FAR struct circbuf_s *circ, FAR void *dst, size_t bytes);
...
ssize_t circbuf_write(FAR struct circbuf_s *circ, FAR const void *src, size_t bytes);
...
ssize_t circbuf_overwrite(FAR struct circbuf_s *circ, FAR const void *src, size_t bytes);
