/****************************************************************************
 * include/roux/pinctrl/pinctrl.h
 *
...
#ifndef __INCLUDE_ROUX_PINCTRL_PINCTRL_H
#define __INCLUDE_ROUX_PINCTRL_PINCTRL_H
...
struct pinctrl_ops_s {
	int (*set_function)(FAR struct pinctrl_dev_s *dev, uint32_t pin, uint32_t function);
	int (*set_strength)(FAR struct pinctrl_dev_s *dev, uint32_t pin, uint32_t strength);
	int (*set_driver)(FAR struct pinctrl_dev_s *dev, uint32_t pin, enum pinctrl_drivertype_e type);
	int (*set_slewrate)(FAR struct pinctrl_dev_s *dev, uint32_t pin, uint32_t slewrate);
...
#endif /* __INCLUDE_ROUX_PINCTRL_PINCTRL_H */
