...
#ifndef __INCLUDE_ROUX_RWSEM_H
#define __INCLUDE_ROUX_RWSEM_H
...
#define RWSEM_INITIALIZER                                                                          \
	{                                                                                              \
		NXMUTEX_INITIALIZER, SEM_INITIALIZER(0), RWSEM_NO_HOLDER, 0, 0, 0                          \
	}
