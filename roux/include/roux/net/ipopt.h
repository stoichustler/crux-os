...
#ifndef __INCLUDE_ROUX_NET_IPOPT_H
#define __INCLUDE_ROUX_NET_IPOPT_H
...
#define IPOPT_TYPE_OPTION_LSRR                                                                     \
	(3 << IPOPT_TYPE_OPTION_SHIFT) /* Loose source and record route (RFC 791) */
...
#define IPOPT_TYPE_OPTION_SSRR                                                                     \
	(9 << IPOPT_TYPE_OPTION_SHIFT) /* Strict source and record route (RFC 791) */
...
#define IPOPT_TYPE_OPTION_ADDREXT                                                                  \
	(19 << IPOPT_TYPE_OPTION_SHIFT)							 /* Address extension (RFC 1475)       \
															  */
#define IPOPT_TYPE_OPTION_RA (20 << IPOPT_TYPE_OPTION_SHIFT) /* Router alert (RFC 2113) */
#define IPOPT_TYPE_OPTION_SDBM                                                                     \
	(21 << IPOPT_TYPE_OPTION_SHIFT) /* Selective direct broadcast mode (RFC 1770) */
...
#define IPOPT_TYPE_OPTION_EXP3692                                                                  \
	(30 << IPOPT_TYPE_OPTION_SHIFT) /* RFC 3692-style experiment (RFC 4782) */
...
#define IPOPT_MKOPTION8(copied, class, option) ((uint8_t)IPOPT_MKTYPE(copied, class, option))
#define IPOPT_MKOPTION32(type, len, ptr, data)                                                     \
	((uint32_t)(type) << 24 | (uint32_t)(len) << 16 | (uint32_t)(ptr) << 8 | (uint32_t)(data))
...
#define IPOPT_SEC_TYPE IPOPT_MKTYPE(IPOPT_TYPE_COPIED, IPOPT_TYPE_CLASS_CTRL, IPOPT_TYPE_OPTION_SEC)
...
#define IPOPT_RA_TYPE IPOPT_MKTYPE(IPOPT_TYPE_COPIED, IPOPT_TYPE_CLASS_CTRL, IPOPT_TYPE_OPTION_RA)
#define IPOPT_RA IPOPT_MKOPTION32(IPOPT_RA_TYPE, 4, 0, 0)

#define IPOPT_SDBM_TYPE                                                                            \
	IPOPT_MKTYPE(IPOPT_TYPE_COPIED, IPOPT_TYPE_CLASS_CTRL, IPOPT_TYPE_OPTION_SDBM)

#define IPOPT_DPS_TYPE IPOPT_MKTYPE(IPOPT_TYPE_COPIED, IPOPT_TYPE_CLASS_CTRL, IPOPT_TYPE_OPTION_DPS)

#define IPOPT_UMP_TYPE IPOPT_MKTYPE(IPOPT_TYPE_COPIED, IPOPT_TYPE_CLASS_CTRL, IPOPT_TYPE_OPTION_UMP)
...
#endif /* __INCLUDE_ROUX_NET_IPOPT_H */
