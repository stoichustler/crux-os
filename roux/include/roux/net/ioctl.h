...
#ifndef __INCLUDE_ROUX_NET_IOCTL_H
#define __INCLUDE_ROUX_NET_IOCTL_H

/****************************************************************************
 * Included Files
 ****************************************************************************/

#include <roux/fs/ioctl.h> /* _SIOCBASE, etc. */
...
#define SIOCMIINOTIFY                                                                              \
	_SIOC(0x0023)				  /* Receive notification via signal on                            \
								   * PHY state change */
...
#define SIOCINQ                                                                                    \
	_SIOC(0x0027) /* Returns the amount of queued unread                                           \
				   * data in the receive */
...
#define SIOCTELNET                                                                                 \
	_SIOC(0x0029) /* Create a Telnet sessions.                                                     \
				   * See include/roux/net/telnet.h */
...
#define SIOCATMARK                                                                                 \
	_SIOC(0x003E) /* Determine whether socket is at                                                \
				   * out-of-band mark */
...
#endif /* __INCLUDE_ROUX_NET_IOCTL_H */
