...
#ifndef __INCLUDE_ROUX_NET_RADIODEV_H
#define __INCLUDE_ROUX_NET_RADIODEV_H
...
struct radio_driver_s {
	...
	CODE int (*r_get_mhrlen)(FAR struct radio_driver_s *netdev, FAR const void *meta);
	...
	CODE int (*r_req_data)(FAR struct radio_driver_s *netdev, FAR const void *meta,
...
#endif /* __INCLUDE_ROUX_NET_RADIODEV_H */
