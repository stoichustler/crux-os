...
#ifndef __INCLUDE_ROUX_NET_LAN9250_H
#define __INCLUDE_ROUX_NET_LAN9250_H
...
struct lan9250_lower_s {
	CODE int (*attach)(FAR const struct lan9250_lower_s *lower, xcpt_t handler, FAR void *arg);
	...
	CODE int (*getmac)(FAR const struct lan9250_lower_s *lower, FAR uint8_t *mac);
};
...
struct spi_dev_s; /* see roux/spi/spi.h */
#else
struct qspi_dev_s; /* see roux/spi/qspi.h */
#endif
...
#endif /* __INCLUDE_ROUX_NET_LAN9250_H */
