...
#ifndef __INCLUDE_ROUX_NET_IPV6EXT_H
#define __INCLUDE_ROUX_NET_IPV6EXT_H
...
#define HOPBYHOP_TYPE_DISCARD1                                                                     \
	0x80 /* Discard and send problem message if                                                    \
		  * ucast or mcast */
#define HOPBYHOP_TYPE_DISCARD2                                                                     \
	0xc0 /* Discard and send problem message if                                                    \
		  * not mcast */
...
#endif /* __INCLUDE_ROUX_NET_IPV6EXT_H */
