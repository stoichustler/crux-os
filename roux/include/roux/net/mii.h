...
#ifndef __INCLUDE_ROUX_NET_MII_H
#define __INCLUDE_ROUX_NET_MII_H
...
#define MII_MMDCONTROL_FUNC_RWINCR                                                                 \
	(2 << MII_MMDCONTROL_FUNC_SHIFT) /* Data, post incr on reads & writes */
...
#define MII_LAN8720_MODES_PHYAD(n)                                                                 \
	((n << MII_LAN8720_MODES_PHYAD_SHIFT) & MII_LAN8720_MODES_PHYAD_MASK)
#define MII_LAN8720_MODES_MODE_SHIFT (5) /* Bits 5-7: Mode */
#define MII_LAN8720_MODES_MODE_MASK (7 << MII_LAN8720_MODES_MODE_SHIFT)
#define MII_LAN8720_MODES_MODE(n)                                                                  \
	((n << MII_LAN8720_MODES_MODE_SHIFT) & MII_LAN8720_MODES_MODE_MASK)
...
#define MII_CONFIG2_SNR_AV32                                                                       \
	(0 << MII_CONFIG2_SNR_SHIFT) /* signal to noise ratio averaging over  32 symbols */
#define MII_CONFIG2_SNR_AV64                                                                       \
	(1 << MII_CONFIG2_SNR_SHIFT) /* signal to noise ratio averaging over  64 symbols */
#define MII_CONFIG2_SNR_AV128                                                                      \
	(2 << MII_CONFIG2_SNR_SHIFT) /* signal to noise ratio averaging over 128 symbols */
#define MII_CONFIG2_SNR_AV256                                                                      \
	(3 << MII_CONFIG2_SNR_SHIFT) /* signal to noise ratio averaging over 256 symbols */
...
#define MII_DP83848C_ANC_INT_EN                                                                    \
	(1 << 2) /* Enable Interrupt on Auto-negotiation complete event.                               \
			  */
#define MII_DP83848C_FHF_INT_EN                                                                    \
	(1 << 1) /* Enable Interrupt on False Carrier Counter Register half-full event. */
#define MII_DP83848C_RHF_INT_EN                                                                    \
	(1 << 0) /* Enable Interrupt on Receive Error Counter Register half-full event. */
...
#endif /* __ASSEMBLY__ */
#endif /* __INCLUDE_ROUX_NET_MII_H */
