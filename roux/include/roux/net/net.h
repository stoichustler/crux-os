...
#ifndef __INCLUDE_ROUX_NET_NET_H
#define __INCLUDE_ROUX_NET_NET_H
...
struct sock_intf_s {
	...
	CODE int (*si_bind)(FAR struct socket *psock, FAR const struct sockaddr *addr,
						socklen_t addrlen);
	CODE int (*si_getsockname)(FAR struct socket *psock, FAR struct sockaddr *addr,
							   FAR socklen_t *addrlen);
	CODE int (*si_getpeername)(FAR struct socket *psock, FAR struct sockaddr *addr,
							   FAR socklen_t *addrlen);
	CODE int (*si_listen)(FAR struct socket *psock, int backlog);
	CODE int (*si_connect)(FAR struct socket *psock, FAR const struct sockaddr *addr,
						   socklen_t addrlen);
	...
	CODE int (*si_poll)(FAR struct socket *psock, FAR struct pollfd *fds, bool setup);
	CODE ssize_t (*si_sendmsg)(FAR struct socket *psock, FAR struct msghdr *msg, int flags);
	CODE ssize_t (*si_recvmsg)(FAR struct socket *psock, FAR struct msghdr *msg, int flags);
	CODE int (*si_close)(FAR struct socket *psock);
	CODE int (*si_ioctl)(FAR struct socket *psock, int cmd, unsigned long arg);
	CODE int (*si_socketpair)(FAR struct socket *psocks[2]);
	CODE int (*si_shutdown)(FAR struct socket *psock, int how);
#ifdef CONFIG_NET_SOCKOPTS
	CODE int (*si_getsockopt)(FAR struct socket *psock, int level, int option, FAR void *value,
							  FAR socklen_t *value_len);
	CODE int (*si_setsockopt)(FAR struct socket *psock, int level, int option,
							  FAR const void *value, socklen_t value_len);
#endif
#ifdef CONFIG_NET_SENDFILE
	CODE ssize_t (*si_sendfile)(FAR struct socket *psock, FAR struct file *infile,
...
int sockfd_socket(int sockfd, FAR struct file **filep, FAR struct socket **socketp);
...
struct sockaddr; /* Forward reference. See roux/include/sys/socket.h */

int psock_bind(FAR struct socket *psock, FAR const struct sockaddr *addr, socklen_t addrlen);
...
int psock_accept(FAR struct socket *psock, FAR struct sockaddr *addr, FAR socklen_t *addrlen,
...
int psock_connect(FAR struct socket *psock, FAR const struct sockaddr *addr, socklen_t addrlen);
...
ssize_t psock_sendmsg(FAR struct socket *psock, FAR struct msghdr *msg, int flags);
...
ssize_t psock_recvmsg(FAR struct socket *psock, FAR struct msghdr *msg, int flags);
...
ssize_t psock_sendto(FAR struct socket *psock, FAR const void *buf, size_t len, int flags,
...
ssize_t psock_recvfrom(FAR struct socket *psock, FAR void *buf, size_t len, int flags,
...
int psock_getsockopt(FAR struct socket *psock, int level, int option, FAR void *value,
					 FAR socklen_t *value_len);
...
int psock_setsockopt(FAR struct socket *psock, int level, int option, FAR const void *value,
					 socklen_t value_len);
...
#ifdef CONFIG_NET_SENDFILE
ssize_t psock_sendfile(FAR struct socket *psock, FAR struct file *infile, FAR off_t *offset,
					   size_t count);
#endif
...
int psock_socketpair(int domain, int type, int protocol, FAR struct socket *psocks[2]);
...
#endif /* CONFIG_NET */
#endif /* __INCLUDE_ROUX_NET_NET_H */
