...
#ifndef __INCLUDE_ROUX_NET_BLUETOOTH_H
#define __INCLUDE_ROUX_NET_BLUETOOTH_H
...
#define BLUETOOTH_MAX_HDRLEN (BLUETOOTH_L2CAP_HDRLEN + BLUETOOTH_ACL_HDRLEN + BLUETOOTH_H4_HDRLEN)
...
int bluetooth_input(FAR struct radio_driver_s *radio, FAR struct iob_s *framelist,
					FAR struct bluetooth_frame_meta_s *meta);

#endif /* CONFIG_NET_BLUETOOTH */
#endif /* __INCLUDE_ROUX_NET_BLUETOOTH_H */
