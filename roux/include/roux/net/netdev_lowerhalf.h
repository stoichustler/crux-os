...
#ifndef __INCLUDE_ROUX_NET_NETDEV_LOWERHALF_H
#define __INCLUDE_ROUX_NET_NETDEV_LOWERHALF_H
...
#ifdef CONFIG_NETDEV_WIRELESS_HANDLER
typedef CODE int (*iw_handler_rw)(FAR struct netdev_lowerhalf_s *dev, FAR struct iwreq *iwr,
								  bool set);
typedef CODE int (*iw_handler_ro)(FAR struct netdev_lowerhalf_s *dev, FAR struct iwreq *iwr);
...
#endif /* __INCLUDE_ROUX_NET_NETDEV_LOWERHALF_H */
