...
#ifndef __INCLUDE_ROUX_NET_NETFILTER_IP_TABLES_H
#define __INCLUDE_ROUX_NET_NETFILTER_IP_TABLES_H
...
#define ipt_entry_for_every(entry, head, size)                                                     \
	for ((entry) = (FAR struct ipt_entry *)(head);                                                 \
		 ...
		 (entry) = (FAR struct ipt_entry *)((FAR uint8_t *)(entry) + (entry)->next_offset))

/* Get pointer to match / target from an entry pointer. */

#define IPT_MATCH(e) ((FAR struct xt_entry_match *)((FAR struct ipt_entry *)(e) + 1))
#define IPT_TARGET(e) ((FAR struct xt_entry_target *)((FAR uint8_t *)(e) + (e)->target_offset))
...
static inline FAR struct xt_entry_target *ipt_get_target(FAR struct ipt_entry *e)
{
	return (FAR struct xt_entry_target *)((FAR char *)e + e->target_offset);
}

#endif /* __INCLUDE_ROUX_NET_NETFILTER_IP_TABLES_H */
