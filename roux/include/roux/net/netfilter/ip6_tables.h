...
#ifndef __INCLUDE_ROUX_NET_NETFILTER_IP6_TABLES_H
#define __INCLUDE_ROUX_NET_NETFILTER_IP6_TABLES_H
...
#define ip6t_entry_for_every(entry, head, size)                                                    \
	for ((entry) = (FAR struct ip6t_entry *)(head);                                                \
		 ...
		 (entry) = (FAR struct ip6t_entry *)((FAR uint8_t *)(entry) + (entry)->next_offset))

/* Get pointer to match from an entry pointer. */

#define IP6T_MATCH(e) ((FAR struct xt_entry_match *)((FAR struct ip6t_entry *)(e) + 1))
#define IP6T_TARGET(e) ((FAR struct xt_entry_target *)((FAR uint8_t *)(e) + (e)->target_offset))
...
#define IP6T_FILL_ENTRY(e, target_name)                                                            \
	do {                                                                                           \
		...
		(e)->target.target.u.target_size = sizeof(*(e)) - (e)->entry.target_offset;                \
...
static inline FAR struct xt_entry_target *ip6t_get_target(FAR struct ip6t_entry *e)
{
	return (FAR struct xt_entry_target *)((FAR char *)e + e->target_offset);
}

#endif /* __INCLUDE_ROUX_NET_NETFILTER_IP6_TABLES_H */
