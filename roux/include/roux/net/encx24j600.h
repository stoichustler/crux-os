...
#ifndef __INCLUDE_ROUX_NET_ENCX24J600_H
#define __INCLUDE_ROUX_NET_ENCX24J600_H
...
struct enc_lower_s {
	int (*attach)(FAR const struct enc_lower_s *lower, xcpt_t handler, FAR void *arg);
...
#endif /* __INCLUDE_ROUX_NET_ENCX24J600_H */
