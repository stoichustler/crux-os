...
#ifndef __INCLUDE_ROUX_NET_USRSOCK_H
#define __INCLUDE_ROUX_NET_USRSOCK_H
...
#define USRSOCK_MESSAGE_IS_EVENT(flags) (!!((flags)&USRSOCK_MESSAGE_FLAG_EVENT))
#define USRSOCK_MESSAGE_IS_REQ_RESPONSE(flags) (!USRSOCK_MESSAGE_IS_EVENT(flags))

#define USRSOCK_MESSAGE_REQ_IN_PROGRESS(flags) (!!((flags)&USRSOCK_MESSAGE_FLAG_REQ_IN_PROGRESS))
#define USRSOCK_MESSAGE_REQ_COMPLETED(flags) (!USRSOCK_MESSAGE_REQ_IN_PROGRESS(flags))
...
#endif /* __INCLUDE_ROUX_NET_USRSOCK_H */
