...
#ifndef __INCLUDE_ROUX_VIDEO_VNC_H
#define __INCLUDE_ROUX_VIDEO_VNC_H
...
typedef CODE int (*vnc_mouseout_t)(FAR void *arg, int16_t x, int16_t y, uint8_t buttons);
typedef CODE int (*vnc_kbdout_t)(FAR void *arg, uint8_t nch, FAR const uint8_t *ch);
 ...
 *
 *   See also nx_vnc_fbinitialize() in include/roux/nx/nx.h.
 *
 * Input Parameters:
...
#endif /* __INCLUDE_ROUX_VIDEO_VNC_H */
