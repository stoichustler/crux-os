...
#ifndef __INCLUDE_ROUX_VIDEO_RGBCOLOR_H
#define __INCLUDE_ROUX_VIDEO_RGBCOLOR_H
...
#define ARGBTO32(a, r, g, b)                                                                       \
	((uint32_t)((a)&0xff) << 24 | (uint32_t)((r)&0xff) << 16 | (uint32_t)((g)&0xff) << 8 |         \
	 (uint32_t)((b)&0xff))
...
#endif /* __ASSEMBLY__ */
#endif /* __INCLUDE_ROUX_VIDEO_RGBCOLOR_H */
