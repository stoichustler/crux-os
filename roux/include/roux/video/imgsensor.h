...
#ifndef __INCLUDE_ROUX_VIDEO_IMGSENSOR_H
#define __INCLUDE_ROUX_VIDEO_IMGSENSOR_H
...
#define IMGSENSOR_IS_AVAILABLE(s) ((s)->ops->is_available ? (s)->ops->is_available(s) : false)
#define IMGSENSOR_INIT(s) ((s)->ops->init ? (s)->ops->init(s) : -ENOTTY)
#define IMGSENSOR_UNINIT(s) ((s)->ops->uninit ? (s)->ops->uninit(s) : -ENOTTY)
...
#define IMGSENSOR_VALIDATE_FRAME_SETTING(s, t, n, f, i)                                            \
	((s)->ops->validate_frame_setting ? (s)->ops->validate_frame_setting(s, t, n, f, i) : -ENOTTY)
#define IMGSENSOR_START_CAPTURE(s, t, n, f, i)                                                     \
	((s)->ops->start_capture ? (s)->ops->start_capture(s, t, n, f, i) : -ENOTTY)
...
#define IMGSENSOR_GET_FRAME_INTERVAL(s, t, i)                                                      \
	((s)->ops->get_frame_interval ? (s)->ops->get_frame_interval(s, t, i) : -ENOTTY)
#define IMGSENSOR_GET_SUPPORTED_VALUE(s, i, v)                                                     \
	((s)->ops->get_supported_value ? (s)->ops->get_supported_value(s, i, v) : -ENOTTY)
...
struct imgsensor_ops_s {
	...
	CODE int (*validate_frame_setting)(FAR struct imgsensor_s *sensor, imgsensor_stream_type_t type,
									   uint8_t nr_datafmts, FAR imgsensor_format_t *datafmts,
									   FAR imgsensor_interval_t *interval);
	CODE int (*start_capture)(FAR struct imgsensor_s *sensor, imgsensor_stream_type_t type,
							  uint8_t nr_datafmts, FAR imgsensor_format_t *datafmts,
							  FAR imgsensor_interval_t *interval);
	CODE int (*stop_capture)(FAR struct imgsensor_s *sensor, imgsensor_stream_type_t type);
	CODE int (*get_frame_interval)(FAR struct imgsensor_s *sensor, imgsensor_stream_type_t type,
								   FAR imgsensor_interval_t *interval);
	CODE int (*get_supported_value)(FAR struct imgsensor_s *sensor, uint32_t id,
									FAR imgsensor_supported_value_t *value);
	CODE int (*get_value)(FAR struct imgsensor_s *sensor, uint32_t id, uint32_t size,
						  FAR imgsensor_value_t *value);
	CODE int (*set_value)(FAR struct imgsensor_s *sensor, uint32_t id, uint32_t size,
...
#endif /* __INCLUDE_ROUX_VIDEO_HALIF_H */
