...
#ifndef __INCLUDE_ROUX_ELF_H
#define __INCLUDE_ROUX_ELF_H
...
#ifdef CONFIG_LIBC_ARCH_ELF
int up_relocate(FAR const Elf_Rel *rel, FAR const Elf_Sym *sym, uintptr_t addr,
				FAR void *arch_data);
int up_relocateadd(FAR const Elf_Rela *rel, FAR const Elf_Sym *sym, uintptr_t addr,
				   FAR void *arch_data);
#endif
