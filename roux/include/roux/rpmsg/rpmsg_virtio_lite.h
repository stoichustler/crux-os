...
#ifndef __INCLUDE_ROUX_RPMSG_RPMSG_VIRTIO_LITE_H
#define __INCLUDE_ROUX_RPMSG_RPMSG_VIRTIO_LITE_H
...
#define RPMSG_VIRTIO_LITE_CMD(c, v)                                                                \
	(((c) << RPMSG_VIRTIO_LITE_CMD_SHIFT) | ((v)&RPMSG_VIRTIO_LITE_CMD_MASK))
#define RPMSG_VIRTIO_LITE_GET_CMD(c) ((c) >> RPMSG_VIRTIO_LITE_CMD_SHIFT)

#define RPMSG_VIRTIO_LITE_RSC2CMD(r)                                                               \
	((FAR struct rpmsg_virtio_lite_cmd_s *)&((FAR struct resource_table *)(r))->reserved[0])
...
#define RPMSG_VIRTIO_LITE_GET_CPUNAME(d) ((d)->ops->get_cpuname ? (d)->ops->get_cpuname(d) : "")
...
#define RPMSG_VIRTIO_LITE_IS_MASTER(d) ((d)->ops->is_master ? (d)->ops->is_master(d) : false)
...
#define RPMSG_VIRTIO_LITE_NOTIFY(d, v) ((d)->ops->notify ? (d)->ops->notify(d, v) : -ENOSYS)
...
struct rpmsg_virtio_lite_ops_s {
	CODE FAR const char *(*get_local_cpuname)(FAR struct rpmsg_virtio_lite_s *dev);
	CODE FAR const char *(*get_cpuname)(FAR struct rpmsg_virtio_lite_s *dev);
	CODE FAR struct rpmsg_virtio_lite_rsc_s *(*get_resource)(FAR struct rpmsg_virtio_lite_s *dev);
...
#endif /* __INCLUDE_ROUX_RPMSG_RPMSG_VIRTIO_LITE_H */
