...
#ifndef __INCLUDE_ROUX_RPMSG_RPMSG_H
#define __INCLUDE_ROUX_RPMSG_RPMSG_H
...
#include <roux/rpmsg/rpmsg_ping.h>
...
CODE typedef void (*rpmsg_dev_cb_t)(FAR struct rpmsg_device *rdev, FAR void *priv);
CODE typedef bool (*rpmsg_match_cb_t)(FAR struct rpmsg_device *rdev, FAR void *priv,
									  FAR const char *name, uint32_t dest);
CODE typedef void (*rpmsg_bind_cb_t)(FAR struct rpmsg_device *rdev, FAR void *priv,
									 FAR const char *name, uint32_t dest);
...
#endif /* CONFIG_RPMSG */
#endif /* __INCLUDE_ROUX_RPMSG_RPMSG_H */
