...
#ifndef __INCLUDE_ROUX_USB_MAX3421E_H
#define __INCLUDE_ROUX_USB_MAX3421E_H
...
struct max3421e_lowerhalf_s {
	...
	CODE int (*attach)(FAR const struct max3421e_lowerhalf_s *lower, xcpt_t isr, FAR void *arg);
	CODE void (*enable)(FAR const struct max3421e_lowerhalf_s *lower, bool enable);
	CODE void (*acknowledge)(FAR const struct max3421e_lowerhalf_s *lower);
	CODE void (*power)(FAR const struct max3421e_lowerhalf_s *lower, bool enable);
...
#endif /* __INCLUDE_ROUX_USB_MAX3421E_H */
