...
#ifndef __INCLUDE_ROUX_USB_CDC_H
#define __INCLUDE_ROUX_USB_CDC_H
...
#define CDC_PROTO_ATM                                                                              \
	0x01					  /* Common AT commands (also known as Hayes                           \
							   * compatible)                                                       \
							   */
...
#define CDC_DATA_PROTO_PUFD                                                                        \
	0xfe						   /* The protocol(s) are described using a Protocol Unit          \
...
#define DLC_SET_AUX_LINE_STATE                                                                     \
	0x10 /* Request to connect or disconnect secondary jack from                                   \
		  * POTS circuit or CODEC, depending on hook state.                                        \
		  * (Optional).                                                                            \
		  */
#define DLC_SET_HOOK_STATE                                                                         \
	0x11 /* Select relay setting for on-hook, off-hook, and caller                                 \
		  * ID. (Required)                                                                         \
		  */
#define DLC_PULSE_SETUP                                                                            \
	0x12 /* Initiate pulse dialing preparation. (Optional).                                        \
		  */
#define DLC_SEND_PULSE                                                                             \
	0x13 /* Request number of make/break cycles to generate.                                       \
		  * (Optional)                                                                             \
		  */
#define DLC_SET_PULSE_TIME                                                                         \
	0x14 /* Setup value for time of make and break periods when                                    \
		  * pulse dialing. (Optional)                                                              \
		  */
#define DLC_RING_AUX_JACK                                                                          \
	0x15 /* Request for a ring signal to be generated on secondary                                 \
		  * phone jack. (Optional)                                                                 \
		  */

/* Table 3: Notifications, Direct Line Control Model */

#define DLC_AUX_JACK_HOOK_STATE                                                                    \
	0x08 /* Indicates hook state of secondary device plugged                                       \
		  * into the auxiliary phone jack. (Optional)                                              \
		  */
#define DLC_RING_DETECT                                                                            \
	0x09 /* Message to notify host that ring voltage was                                           \
		  * detected on POTS interface. (Required)                                                 \
		  */

/* Table 4: Requests, Abstract Control Model */

#define ACM_SEND_COMMAND                                                                           \
	0x00 /* Issues a command in the format of the supported                                        \
		  * control protocol. (Required)                                                           \
		  */
#define ACM_GET_RESPONSE                                                                           \
	0x01 /* Requests a response in the format of the                                               \
		  * supported control protocol. (Required)                                                 \
		  */
#define ACM_SET_COMM_FEATURE                                                                       \
	0x02 /* Controls the settings for a particular                                                 \
		  * communication feature. (Optional)                                                      \
		  */
#define ACM_GET_COMM_FEATURE                                                                       \
	0x03 /* Returns the current settings for the                                                   \
		  * communication feature. (Optional)                                                      \
		  */
#define ACM_CLEAR_COMM_FEATURE                                                                     \
	0x04 /* Clears the settings for a particular                                                   \
		  * communication feature. (Optional)                                                      \
		  */
#define ACM_SET_LINE_CODING                                                                        \
	0x20 /* Configures DTE rate, stop-bits, parity, and                                            \
		  * number-of-character bits. (Optional)                                                   \
		  */
#define ACM_GET_LINE_CODING                                                                        \
	0x21 /* Requests current DTE rate, stop-bits, parity, and                                      \
		  * number-of-character bits. (Optional)                                                   \
		  */
#define ACM_SET_CTRL_LINE_STATE                                                                    \
	0x22 /* RS-232 signal used to tell the DCE device the                                          \
		  * DTE device is now present. (Optional)                                                  \
		  */
#define ACM_SEND_BREAK                                                                             \
	0x23 /* Sends special carrier                                                                  \
		  */

/* Table 5: Notifications, Abstract Control Model */

#define ACM_NETWORK_CONNECTION                                                                     \
	0x00 /* Notification to host of network connection status.                                     \
		  * (Optional)                                                                             \
		  */
#define ACM_RESPONSE_AVAILABLE                                                                     \
	0x01 /* Notification to host to issue a GET_ENCAPSULATED_RESPONSE                              \
		  * request. (Required)                                                                    \
		  */
#define ACM_SERIAL_STATE                                                                           \
	0x20 /* Returns the current state of the carrier detect, DSR,                                  \
		  * break, and ring signal. (Optional)                                                     \
		  */

/* Table 6: Requests, Telephone Control Model */

#define TCM_SET_COMM_FEATURE                                                                       \
	0x02 /* Used to set a unique communication feature, which is                                   \
		  * normally specific to a particular device.                                              \
		  * (Optional)                                                                             \
		  */
#define TCM_GET_COMM_FEATURE                                                                       \
	0x03 /* Returns the current settings for the communication                                     \
		  * feature. (Optional)                                                                    \
		  */
#define TCM_CLEAR_COMM_FEATURE                                                                     \
	0x04 /* Clears the settings for a particular communication                                     \
		  * feature. (Optional)                                                                    \
		  */
#define TCM_SET_RINGER_PARMS                                                                       \
	0x30 /* Configures the ringer for a telephone device.                                          \
		  * (Optional)                                                                             \
		  */
#define TCM_GET_RINGER_PARMS                                                                       \
	0x31 /* Gets the current ringer configuration for a telephone                                  \
		  * device. (Required)                                                                     \
		  */
#define TCM_SET_OPERATION_PARMS                                                                    \
	0x32 /* Configures the operational mode of the telephone.                                      \
		  * (Optional)                                                                             \
		  */
#define TCM_GET_OPERATION_PARMS                                                                    \
	0x33 /* Gets the current operational mode of the telephone.                                    \
		  * (Optional)                                                                             \
		  */
#define TCM_SET_LINE_PARMS                                                                         \
	0x34 /* Allows changing the current state of the line                                          \
		  * associated with the interface, providing basic call                                    \
		  * capabilities, such as dialing and answering calls.                                     \
		  * (Required)                                                                             \
		  */
#define TCM_GET_LINE_PARMS                                                                         \
	0x35 /* Gets current status of the line. (Required)                                            \
		  */
#define TCM_DIAL_DIGITS                                                                            \
	0x36 /* Dials digits on the network connection. (Required)                                     \
		  */

/* Table 7: Notifications, Telephone Control Model */

#define TCM_CALL_STATE_CHANGE                                                                      \
	0x28 /* DReports a state change on a call. (Required)                                          \
		  */
#define TCM_LINE_STATE_CHANGE                                                                      \
	0x29 /* DReports a state change on a line. (Optional)                                          \
		  */

/* Table 8: Requests, Multi-Channel Model */

#define MCM_SET_UNIT_PARAM                                                                         \
	0x37 /* Used to set a Unit specific parameter (Optional)                                       \
		  */
#define MCM_GET_UNIT_PARAM                                                                         \
	0x38 /* Used to retrieve a Unit specific parameter (Required)                                  \
		  */
#define MCM_CLEAR_UNIT_PARAM                                                                       \
	0x39 /* Used to set a Unit specific parameter to its default                                   \
		  * state. (Optional)                                                                      \
		  */
...
#define CAPI_GET_PROFILE                                                                           \
	0x3a /* Returns the implemented capabilities of the device                                     \
		  * (Required)                                                                             \
		  */

/* Table 10: Requests, Ethernet Networking Control Model */

#define ECM_SEND_COMMAND                                                                           \
	0x00 /* Issues a command in the format of the supported                                        \
		  ...
		  */
#define ECM_GET_RESPONSE                                                                           \
	0x01 /* Requests a response in the format of the supported                                     \
		  * control protocol.                                                                      \
		  * (Optional)                                                                             \
		  */
#define ECM_SET_MCAST_FILTERS                                                                      \
	0x40 /* As applications are loaded and unloaded on the host,                                   \
		  ...
		  */
#define ECM_SET_PM_PAT_FILTER                                                                      \
	0x41 /* Some hosts are able to conserve energy and stay quiet                                  \
		  ...
		  * (Optional)                                                                             \
		  */
#define ECM_GET_PM_PAT_FILTER                                                                      \
	0x42 /* Retrieves the status of the above power management                                     \
		  * pattern filter setting                                                                 \
		  * (Optional)                                                                             \
		  */
#define ECM_SET_PACKET_FILTER                                                                      \
	0x43 /* Sets device filter for running a network analyzer                                      \
		  * application on the host machine (Required)                                             \
		  */
#define ECM_GET_STATISTIC                                                                          \
	0x44 /* Retrieves Ethernet device statistics such as frames                                    \
...
#define ECM_NETWORK_CONNECTION                                                                     \
	0x00 /* Reports whether or not the physical layer (modem,                                      \
		  * Ethernet PHY, etc.) link is up. (Required)                                             \
		  */
#define ECM_RESPONSE_AVAILABLE                                                                     \
	0x01 /* Notification to host to issue a                                                        \
		  * GET_ENCAPSULATED_RESPONSE request. (Optional)                                          \
		  */
#define ECM_SPEED_CHANGE                                                                           \
	0x2a /* Reports a change in upstream or downstream (Required)                                  \
		  */

/* Table 12: Requests, ATM Networking Control Model */

#define ATM_SEND_COMMAND                                                                           \
	0x00 /* Issues a command in the format of the supported control                                \
		  ...
		  * management. (Optional)                                                                 \
		  */
#define ATM_GET_RESPONSE                                                                           \
	0x01 /* Requests a response in the format of the supported                                     \
		  * control protocol. (Optional)                                                           \
		  */
#define ATM_SET_DATA_FORMAT                                                                        \
	0x50 /* Chooses which ATM data format will be exchanged                                        \
		  * between the host and the ATM Networking device.                                        \
		  * (Required)                                                                             \
		  */
#define ATM_GET_DEV_STATISTICS                                                                     \
	0x51 /* Retrieves global statistics from the ATM Networking                                    \
		  * device. (Required)                                                                     \
		  */
#define ATM_SET_DEFAULT_VC                                                                         \
	0x52 /* Pre-selects the VPI/VCI value for subsequent                                           \
		  * GetATMVCStatistics requests (Optional)                                                 \
		  */
#define ATM_GET_VC_STATISTICS                                                                      \
	0x53 /* Retrieves statistics from the ATM Networking device for                                \
		  * a particular VPI/VCI. (Optional)                                                       \
		  */

/* Table 13: Requests, Ethernet and ATM Networking Control Model */

#define ATM_NETWORK_CONNECTION                                                                     \
	0x00 /* Reports whether or not the physical layer (modem,                                      \
		  * Ethernet PHY, etc.) link is up. (Required)                                             \
		  */
#define ECM_NETWORK_CONNECTION ATM_NETWORK_CONNECTION
#define ATM_RESPONSE_AVAILABLE                                                                     \
	0x01 /* Notification to host to issue a                                                        \
		  * GET_ENCAPSULATED_RESPONSE request. (Optional)                                          \
		  */
#define ECM_RESPONSE_AVAILABLE ATM_RESPONSE_AVAILABLE
#define ATM_SPEED_CHANGE                                                                           \
	0x2a /* Reports a change in upstream or downstream speed of the                                \
...
#define CDC_DSUBTYPE_HDR                                                                           \
	0x00							/* Header Functional Descriptor, which marks the               \
...
#define ECMCAP_RCV_ERROR                                                                           \
	(1 << 3)							   /* Frames received with errors that are not delivered   \
											* to the USB host                                      \
											*/
...
#define ECMCAP_RCV_CRC_ERROR                                                                       \
	(1 << 17)								 /* Frames received with circular redundancy check     \
...
#define ECMCAP_XMIT_TIMES_CRS_LOST                                                                 \
	(1 << 27)							 /* Times carrier sense signal lost during                 \
										  * transmission                                           \
										  */
...
#define FEATURE_ABSTRACT_STATE                                                                     \
	0x01 /* Two bytes of data describing multiplexed state                                         \
		  * and idle state for this Abstract Model                                                 \
		  * communications device                                                                  \
		  */
#define FEATURE_COUNTRY_SETTING                                                                    \
	0x02 /* Country code in hexadecimal format as defined in                                       \
		  * ISO 3166                                                                               \
		  */
...
#define CDC_DTE_PRESENT                                                                            \
	(1 << 0) /* Indicates to DCE if DTE is present or not.                                         \
			  * This signal corresponds to V.24 signal                                             \
			  * 108/2 and RS-232 signal DTR.                                                       \
			  */
#define CDC_ACTIVATE_CARRIER                                                                       \
	(1 << 1) /* Carrier control for half duplex modems.                                            \
			  * This signal corresponds to V.24 signal                                             \
...
#define ECM_RCV_ERROR                                                                              \
	0x04						   /* Frames received with errors that are not delivered           \
									* to the USB host                                              \
									*/
...
#define ECM_RCV_CRC_ERROR                                                                          \
	0x12							 /* Frames received with circular redundancy check             \
									  * (CRC) or frame check sequence (FCS) error                  \
									  */
...
#define ECM_XMIT_TIMES_CRS_LOST                                                                    \
	0x1c						 /* Times carrier sense signal lost during                         \
								  * transmission                                                   \
								  */
...
#define ATM_FMT_TYPE1                                                                              \
	2					/* Type 2 format: ATM header template + concatenated ATM                   \
						 * cell payloads                                                           \
						 */
...
#define US_CELLS_SENT                                                                              \
	0x01h /* The number of cells that have been sent                                               \
		   * upstream to the WAN link by the ATM layer.                                            \
		   */
#define DS_CELLS_RECEIVED                                                                          \
	0x02h /* The number of cells that have been received                                           \
		   * downstream from the WAN link by the ATM                                               \
		   * layer.                                                                                \
		   */
#define DS_CELLS_USB_CONGESTION                                                                    \
	0x03h /* The number of cells that have been received                                           \
		   * downstream from the WAN link by the ATM                                               \
		   * layer and discarded due to congestion on the                                          \
		   * USB link.                                                                             \
		   */
#define DS_CELLS_AAL5_CRC_ERROR                                                                    \
	0x04h /* The number of cells that have been received                                           \
		   * downstream from the WAN link by the ATM                                               \
		   * layer and discarded due to AAL5 CRC errors.                                           \
		   */
#define DS_CELLS_HEC_ERROR                                                                         \
	0x05h /* The number of cells that have been received                                           \
		   * downstream from the WAN link and discarded                                            \
		   * due to HEC errors in the cell header.                                                 \
		   */
#define DS_CELLS_HEC_ERROR_CORRECTED                                                               \
	0x06h /* The number of cells that have been received                                           \
...
#define VC_US_CELLS_SENT                                                                           \
	0x01 /* The number of cells that have been                                                     \
		  * sent upstream to the WAN link for the                                                  \
		  * specified VPI/VCI since the device                                                     \
		  * has been powered on or reset                                                           \
		  */
#define VC_DS_CELLS_RECEIVED                                                                       \
	0x02 /* The number of cells that have been                                                     \
...
#define CDC_UART_RXCARRIER                                                                         \
	(1 << 0) /* bRxCarrier State of receiver carrier detection                                     \
			  * mechanism of device. This signal corresponds to                                    \
			  * V.24 signal 109 and RS-232 signal DCD.                                             \
			  */
#define CDC_UART_TXCARRIER                                                                         \
	(1 << 1) /* bTxCarrier State of transmission carrier. This                                     \
			  * signal corresponds to V.24 signal 106 and RS-232                                   \
			  * signal DSR.                                                                        \
			  */
#define CDC_UART_BREAK                                                                             \
	(1 << 2) /* bBreak State of break detection mechanism of the                                   \
			  * device.                                                                            \
			  */
#define CDC_UART_RING                                                                              \
	(1 << 3)					  /* bRingSignal State of ring signal detection of the             \
								   * device.                                                       \
								   */
...
#define CDC_UART_OVERRUN                                                                           \
	(1 << 6) /* bOverRun Received data has been discarded due to                                   \
...
#define CDC_CALLST_RINGBACK                                                                        \
	0x03 /* Ringback, with an extra byte of data provided to                                       \
		  * describe the type of ringback signaling                                                \
		  */
#define CDC_CALLST_CONNECTED                                                                       \
	0x04						 /* Connected, with an extra byte of data provided to              \
...
#endif /* __INCLUDE_ROUX_USB_CDC_H */
