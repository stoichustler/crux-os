...
#ifndef __INCLUDE_ROUX_USB_COMPOSITE_H
#define __INCLUDE_ROUX_USB_COMPOSITE_H
...
#define COMPOSITE_NSTRIDS                                                                          \
	(5) /* The number of String-IDs to                                                             \
		 * reserve for the composite device */
#define COMPOSITE_NCONFIGS                                                                         \
...
#endif /* __INCLUDE_ROUX_USB_COMPOSITE_H */
