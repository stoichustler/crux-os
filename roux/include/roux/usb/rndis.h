...
#ifndef __INCLUDE_ROUX_USB_RNDIS_H
#define __INCLUDE_ROUX_USB_RNDIS_H
 ...
 *   Register the corresponding network driver to ROUX and bring up the
 *   network.
 *
 * Input Parameters:
...
#endif /* __INCLUDE_ROUX_USB_RNDIS_H */
