...
#ifndef __INCLUDE_ROUX_USB_FUSB302_H
#define __INCLUDE_ROUX_USB_FUSB302_H
...
struct fusb302_config_s {
	...
	CODE int (*irq_attach)(FAR struct fusb302_config_s *state, xcpt_t isr, FAR void *arg);
...
#endif /* __INCLUDE_ROUX_USB_FUSB302_H */
