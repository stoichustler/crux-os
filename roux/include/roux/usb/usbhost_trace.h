...
#ifndef __INCLUDE_ROUX_USB_USBHOST_TRACE_H
#define __INCLUDE_ROUX_USB_USBHOST_TRACE_H
...
#define TRACE_ENCODE1(id, u23) (((uint32_t)(id)&0x1ff) << 23 | ((uint32_t)(u23)&0x007fffff))
#define TRACE_ENCODE2(id, u7, u16)                                                                 \
	(((uint32_t)(id)&0x1ff) << 23 | ((uint32_t)(u7)&0x7f) << 16 | ((u16)&0x0000ffff))
...
#endif /* __INCLUDE_ROUX_USB_USBHOST_TRACE_H */
