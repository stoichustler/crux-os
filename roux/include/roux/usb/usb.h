...
#ifndef __INCLUDE_ROUX_USB_USB_H
#define __INCLUDE_ROUX_USB_USB_H
...
#define GETUINT32(p)                                                                               \
	((uint32_t)(((uint32_t)(p)[3] << 24) | ((uint32_t)(p)[2] << 16) | ((uint32_t)(p)[1] << 8) |    \
				(uint32_t)(p)[0]))

#define PUTUINT32(p, v)                                                                            \
	do {                                                                                           \
		uint8_t *__p;                                                                              \
		__p = (FAR uint8_t *)(p);                                                                  \
		*__p++ = ((uint32_t)(v)&0xff);                                                             \
...
#endif /* __INCLUDE_ROUX_USB_USB_H */
