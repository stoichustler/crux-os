...
#ifndef __INCLUDE_ROUX_USB_EHCI_H
#define __INCLUDE_ROUX_USB_EHCI_H
...
#define EHCI_USBCMD_ITHRE_8MF                                                                      \
	(0x08 << EHCI_USBCMD_ITHRE_SHIFT)							 /* 8 micro-frames (default, 1 ms) \
																  */
...
#define EHCI_PORTSC_LSTATUS_SE0                                                                    \
	(0 << EHCI_PORTSC_LSTATUS_SHIFT) /* SE0 Not Low-speed device, perform EHCI reset */
#define EHCI_PORTSC_LSTATUS_KSTATE                                                                 \
	(1 << EHCI_PORTSC_LSTATUS_SHIFT) /* K-state Low-speed device, release ownership of port */
#define EHCI_PORTSC_LSTATUS_JSTATE                                                                 \
	(2 << EHCI_PORTSC_LSTATUS_SHIFT) /* J-state Not Low-speed device, perform EHCI reset */
...
#define EHCI_PORTSC_ALLINTS                                                                        \
	(EHCI_PORTSC_CSC | EHCI_PORTSC_PEC | EHCI_PORTSC_OCC | EHCI_PORTSC_RESUME)
...
#define ITD_NLP_TYP_SITD                                                                           \
	(2 << ITD_NLP_TYP_SHIFT) /* Split Transaction Isochronous Transfer Descriptor */
...
#define ITD_BUFPTR2_MULTI_3                                                                        \
	(3 << ITD_BUFPTR2_MULTI_SHIFT) /* Three transactions per micro-frame                           \
									*/
...
#define SITD_NLP_TYP_SITD                                                                          \
	(2 << SITD_NLP_TYP_SHIFT) /* Split Transaction Isochronous Transfer Descriptor */
...
#define SITD_BUFPTR1_TP_ENTIRE                                                                     \
	(0 << SITD_BUFPTR1_TP_SHIFT) /* Entire full-speed transaction data payload. */
...
#define QH_HLP_TYP_SITD                                                                            \
	(2 << QH_HLP_TYP_SHIFT) /* Split Transaction Isochronous Transfer Descriptor */
...
#define FSTN_NPP_TYP_SITD                                                                          \
	(2 << FSTN_NPP_TYP_SHIFT) /* Split Transaction Isochronous Transfer Descriptor */
...
#endif /* __INCLUDE_ROUX_USB_EHCI_H */
