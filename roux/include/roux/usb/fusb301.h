...
#ifndef __INCLUDE_ROUX_USB_FUSB301_H
#define __INCLUDE_ROUX_USB_FUSB301_H
...
struct fusb301_config_s {
	...
	CODE int (*irq_attach)(FAR struct fusb301_config_s *state, xcpt_t isr, FAR void *arg);
...
#endif /* __INCLUDE_ROUX_USB_FUSB301_H */
