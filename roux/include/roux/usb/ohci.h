...
#ifndef __INCLUDE_ROUX_USB_OHCI_H
#define __INCLUDE_ROUX_USB_OHCI_H
...
#define OHCI_FMINT_OFFSET                                                                          \
	0x0034						 /* HcFmInterval: Bit time interval that would not cause overrun   \
								  */
...
#define OHCI_INT_MIE                                                                               \
	(1 << 31) /* Bit 31: Master interrupt enable                                                   \
			   *         (Enable/disable only) */
...
#endif /* __INCLUDE_ROUX_USB_OHCI_H */
