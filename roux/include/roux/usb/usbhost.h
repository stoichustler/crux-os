...
#ifndef __INCLUDE_ROUX_USB_USBHOST_H
#define __INCLUDE_ROUX_USB_USBHOST_H
...
struct usbhost_class_s {
	...
	CODE int (*connect)(FAR struct usbhost_class_s *devclass, FAR const uint8_t *configdesc,
						int desclen);
...
struct usbhost_connection_s {
	...
	CODE int (*wait)(FAR struct usbhost_connection_s *conn, FAR struct usbhost_hubport_s **hport);
...
struct usbhost_driver_s {
	...
	CODE int (*ep0configure)(FAR struct usbhost_driver_s *drvr, usbhost_ep_t ep0, uint8_t funcaddr,
	...
	CODE int (*epfree)(FAR struct usbhost_driver_s *drvr, usbhost_ep_t ep);
	...
	CODE int (*alloc)(FAR struct usbhost_driver_s *drvr, FAR uint8_t **buffer, FAR size_t *maxlen);
	...
	CODE int (*ioalloc)(FAR struct usbhost_driver_s *drvr, FAR uint8_t **buffer, size_t buflen);
	CODE int (*iofree)(FAR struct usbhost_driver_s *drvr, FAR uint8_t *buffer);
	...
	CODE ssize_t (*transfer)(FAR struct usbhost_driver_s *drvr, usbhost_ep_t ep,
...
#ifdef CONFIG_USBHOST_ASYNCH
	CODE int (*asynch)(FAR struct usbhost_driver_s *drvr, usbhost_ep_t ep, FAR uint8_t *buffer,
	...
	CODE int (*connect)(FAR struct usbhost_driver_s *drvr, FAR struct usbhost_hubport_s *hport,
						bool connected);
#endif
	...
	CODE void (*disconnect)(FAR struct usbhost_driver_s *drvr, FAR struct usbhost_hubport_s *hport);
};
...
FAR const struct usbhost_registry_s *usbhost_findclass(FAR const struct usbhost_id_s *id);
...
#endif /* __INCLUDE_ROUX_USB_USBHOST_H */
