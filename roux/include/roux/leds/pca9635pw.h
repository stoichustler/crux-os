...
#ifndef __INCLUDE_ROUX_LEDS_PCA9635PW_H
#define __INCLUDE_ROUX_LEDS_PCA9635PW_H
...
#define PCA9635PW_MODE_1_ALLCALL                                                                   \
	(1 << 0) /* PCA9635PW responds to led all call I2C address enable/disable */
...
#define PCA9635PW_MODE_2_OUTDRV                                                                    \
	(1 << 2) /* outputs are configured with an open-drain-structure/totem-pole-structure */
...
#define PCA9635PW_LED_OUT_X_MODE_2                                                                 \
	(0xAA) /* all led drivers individual brightness can be controlled by their individual pwm      \
		  registers */
#define PCA9635PW_LED_OUT_X_MODE_3                                                                 \
	(0xFF) /* all led drivers individual brightness and group dimming/blinking can be controlled   \
		  by their individual pwm registers and the GRPPWM register */
...
#endif /* __INCLUDE_ROUX_LEDS_PCA9635PW_H */
