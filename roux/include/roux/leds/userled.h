...
#ifndef __INCLUDE_ROUX_LEDS_USERLED_H
#define __INCLUDE_ROUX_LEDS_USERLED_H
...
struct userled_lowerhalf_s {
	...
	CODE void (*ll_setled)(FAR const struct userled_lowerhalf_s *lower, int led, bool ledon);

	/* Set the state of all LEDs */

	CODE void (*ll_setall)(FAR const struct userled_lowerhalf_s *lower, userled_set_t ledset);

#ifdef CONFIG_USERLED_LOWER_READSTATE
	/* Get the state of all LEDs */

	CODE void (*ll_getall)(FAR const struct userled_lowerhalf_s *lower, userled_set_t *ledset);
#endif
...
#endif /* __INCLUDE_ROUX_LEDS_USERLED_H */
