...
#ifndef __INCLUDE_ROUX_LEDS_WS2812_H
#define __INCLUDE_ROUX_LEDS_WS2812_H
...
struct ws2812_dev_s {
	...
	FAR ssize_t (*write)(FAR struct file *filep, FAR const char *data, size_t len);

	FAR ssize_t (*read)(FAR struct file *filep, FAR char *data, size_t len);
...
#endif /* CONFIG_WS2812 */
#endif /* __INCLUDE_ROUX_LEDS_WS2812_H */
