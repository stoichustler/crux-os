...
#ifndef __INCLUDE_ROUX_SYMTAB_H
#define __INCLUDE_ROUX_SYMTAB_H
...
FAR const struct symtab_s *symtab_findbyname(FAR const struct symtab_s *symtab,
...
FAR const struct symtab_s *symtab_findbyvalue(FAR const struct symtab_s *symtab, FAR void *value,
											  int nsyms);
