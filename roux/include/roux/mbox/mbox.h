...
#ifndef __INCLUDE_ROUX_MBOX_MBOX_H
#define __INCLUDE_ROUX_MBOX_MBOX_H
...
struct mbox_ops_s {
	...
	CODE int (*registercallback)(FAR struct mbox_dev_s *dev, uint32_t ch, mbox_receive_t callback,
								 FAR void *arg);
};
...
#endif /* __INCLUDE_ROUX_MBOX_MBOX_H */
