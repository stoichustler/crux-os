...
#ifndef __INCLUDE_ROUX_SDIO_SLAVE_H
#define __INCLUDE_ROUX_SDIO_SLAVE_H
...
typedef CODE void sdio_slave_finish(bool recv, FAR void *buf, ssize_t result, FAR void *arg);

struct sdio_slave_s {
	CODE int (*setcallback)(FAR struct sdio_slave_s *dev, sdio_slave_finish callback,
							FAR void *arg);
	CODE int (*recvbuffer)(FAR struct sdio_slave_s *dev, FAR void *buf, ssize_t len);
	CODE int (*sendbuffer)(FAR struct sdio_slave_s *dev, FAR const void *buf, ssize_t len);
	CODE int (*cancelbuffer)(FAR struct sdio_slave_s *dev, FAR const void *buf);
};
...
#endif /* __INCLUDE_ROUX_SDIO_SLAVE_H */
