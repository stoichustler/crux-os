...
#ifndef __INCLUDE_ROUX_SEMAPHORE_H
#define __INCLUDE_ROUX_SEMAPHORE_H
...
int nxsem_clockwait(FAR sem_t *sem, clockid_t clockid, FAR const struct timespec *abstime);
...
int nxsem_timedwait_uninterruptible(FAR sem_t *sem, FAR const struct timespec *abstime);
...
int nxsem_setprioceiling(FAR sem_t *sem, int prioceiling, FAR int *old_ceiling);
...
#endif /* __ASSEMBLY__ */
#endif /* __INCLUDE_ROUX_SEMAPHORE_H */
