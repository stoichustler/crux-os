...
#ifndef __INCLUDE_ROUX_EVENT_H
#define __INCLUDE_ROUX_EVENT_H
...
#define NXEVENT_INITIALIZER(e, v)                                                                  \
	{                                                                                              \
		LIST_INITIAL_VALUE((e).list), (v)                                                          \
	}
 ...
 *   hence follows the ROUX internal error return policy:  Zero (OK) is
 *   returned on success.  A negated errno value is returned on failure.
 *
 ****************************************************************************/
...
int nxevent_post(FAR nxevent_t *event, nxevent_mask_t events, nxevent_flags_t eflags);
...
nxevent_mask_t nxevent_wait(FAR nxevent_t *event, nxevent_mask_t events, nxevent_flags_t eflags);
...
nxevent_mask_t nxevent_tickwait(FAR nxevent_t *event, nxevent_mask_t events, nxevent_flags_t eflags,
								uint32_t delay);
...
nxevent_mask_t nxevent_trywait(FAR nxevent_t *event, nxevent_mask_t events, nxevent_flags_t eflags);
...
int nxevent_open(FAR nxevent_t **event, FAR const char *name, int oflags, ...);
