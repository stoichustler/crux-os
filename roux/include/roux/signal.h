...
#ifndef __INCLUDE_ROUX_SIGNAL_H
#define __INCLUDE_ROUX_SIGNAL_H
...
int nxsig_nandset(FAR sigset_t *dest, FAR const sigset_t *left, FAR const sigset_t *right);
...
int nxsig_xorset(FAR sigset_t *dest, FAR const sigset_t *left, FAR const sigset_t *right);
...
int nxsig_action(int signo, FAR const struct sigaction *act, FAR struct sigaction *oact,
				 bool force);
...
int nxsig_clockwait(int clockid, int flags, FAR const struct timespec *rqtp,
