...
#ifndef __INCLUDE_ROUX_CAN_CAN_H
#define __INCLUDE_ROUX_CAN_CAN_H
...
#define CAN_ERROR_PROTOCOL                                                                         \
	(1 << 3) /* Bit 3: Protocol error (see CAN_ERROR2_* and CAN_ERROR3_* definitions) */
#define CAN_ERROR_TRANSCEIVER                                                                      \
	(1 << 4)						/* Bit 4: Transceiver error (See CAN_ERROR4_* definitions)    */
...
#define CAN_ERROR_INTERNAL                                                                         \
	(1 << 9) /* Bit 9: Stack internal error (See CAN_ERROR5_* definitions)                         \
			  */
			 /* Bit 10: Available */
...
struct can_transv_ops_s {
	...
	CODE int (*ct_getstate)(FAR struct can_transv_s *transv, FAR int *state);
};
...
#endif /* CONFIG_CAN */
#endif /* __INCLUDE_ROUX_CAN_CAN_H */
