...
#ifndef __INCLUDE_ROUX_CAN_SENDER_H
#define __INCLUDE_ROUX_CAN_SENDER_H
...
#define TX_FULL(sender)                                                                            \
	({                                                                                             \
		FAR struct can_txcache_s *__sender = (sender);                                             \
		(__sender->tx_head == (__sender->tx_tail + 1) % CONFIG_CAN_TXFIFOSIZE);                    \
	})
...
#define PENDING_COUNT(sender)                                                                      \
	({                                                                                             \
		FAR struct can_txcache_s *__sender = (sender);                                             \
		(CONFIG_CAN_TXFIFOSIZE + __sender->tx_tail - __sender->tx_queue) % CONFIG_CAN_TXFIFOSIZE;  \
	})

#define SENDING_COUNT(sender)                                                                      \
	({                                                                                             \
		FAR struct can_txcache_s *__sender = (sender);                                             \
		(CONFIG_CAN_TXFIFOSIZE + __sender->tx_queue - __sender->tx_head) % CONFIG_CAN_TXFIFOSIZE;  \
	})
...
void can_add_sendnode(FAR struct can_txcache_s *cd_sender, FAR struct can_msg_s *msg, int msglen);
...
void can_revert_msg(FAR struct can_txcache_s *cd_sender, FAR struct can_msg_s *msg);
...
#endif /* CONFIG_CAN */
#endif /* __INCLUDE_ROUX_CAN_SENDER_H */
