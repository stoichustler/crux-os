...
#ifndef __INCLUDE_ROUX_CAN_MCP2515_H
#define __INCLUDE_ROUX_CAN_MCP2515_H
...
typedef CODE void (*mcp2515_handler_t)(FAR struct mcp2515_config_s *config, FAR void *arg);
...
struct mcp2515_config_s {
	...
	CODE int (*attach)(FAR struct mcp2515_config_s *state, mcp2515_handler_t handler,
					   FAR void *arg);
};
...
#endif /* __INCLUDE_ROUX_CAN_MCP2515_H */
