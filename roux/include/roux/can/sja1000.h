...
#ifndef __INCLUDE_ROUX_CAN_SJA1000_H
#define __INCLUDE_ROUX_CAN_SJA1000_H
...
typedef CODE void (*sja1000_handler_t)(FAR struct sja1000_config_s *config, FAR void *arg);
...
struct sja1000_config_s {
	...
	CODE int (*attach)(FAR struct sja1000_config_s *config, sja1000_handler_t handler,
					   FAR void *arg);
...
struct sja1000_dev_s {
	...
	CODE void (*putreg)(struct sja1000_dev_s *sja_priv, uint32_t reg, uint32_t value);
	CODE void (*modifyreg32)(struct sja1000_dev_s *sja_priv, uint32_t reg, uint32_t clearbits,
							 uint32_t setbits);
};
...
static inline uint32_t sja1000_getreg(struct sja1000_dev_s *sja_priv, uint32_t reg)
{
...
static inline void sja1000_putreg(struct sja1000_dev_s *sja_priv, uint32_t reg, uint32_t value)
{
...
static inline void sja1000_modifyreg32(struct sja1000_dev_s *sja_priv, uint32_t reg,
...
#endif /* __INCLUDE_ROUX_CAN_SJA1000_H */
