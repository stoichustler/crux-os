...
#ifndef __INCLUDE_ROUX_IPCC_H
#define __INCLUDE_ROUX_IPCC_H
...
struct ipcc_ops_s {
	...
	CODE ssize_t (*read)(FAR struct ipcc_lower_s *ipcc, FAR char *buffer, size_t buflen);
	...
	CODE ssize_t (*write)(FAR struct ipcc_lower_s *ipcc, FAR const char *buffer, size_t buflen);
	...
	CODE ssize_t (*buffer_data)(FAR struct ipcc_lower_s *ipcc, FAR struct circbuf_s *rxbuf);
#endif
...
#ifdef CONFIG_IPCC_BUFFERED
int ipcc_register(FAR struct ipcc_lower_s *ipcc, size_t rxbuflen, size_t txbuflen);
#else
int ipcc_register(FAR struct ipcc_lower_s *ipcc);
#endif

#endif /* __INCLUDE_ROUX_IPCC_H */
