...
#ifndef __INCLUDE_ROUX_CORESIGHT_CORESIGHT_TMC_H
#define __INCLUDE_ROUX_CORESIGHT_CORESIGHT_TMC_H
...
#define TMC_600_ETR_CAPS (TMC_ETR_SAVE_RESTORE | TMC_ETR_AXI_ARCACHE)
...
FAR struct coresight_tmc_dev_s *tmc_register(FAR const struct coresight_desc_s *desc);
...
#endif //__INCLUDE_ROUX_CORESIGHT_CORESIGHT_TMC_H
