...
#ifndef __INCLUDE_ROUX_POWER_PM_H
#define __INCLUDE_ROUX_POWER_PM_H
...
struct pm_callback_s {
	...
	CODE int (*prepare)(FAR struct pm_callback_s *cb, int domain, enum pm_state_e pmstate);
	...
	CODE void (*notify)(FAR struct pm_callback_s *cb, int domain, enum pm_state_e pmstate);
...
void pm_wakelock_init(FAR struct pm_wakelock_s *wakelock, FAR const char *name, int domain,
					  enum pm_state_e state);
...
#endif /* CONFIG_PM */
#endif /* __INCLUDE_ROUX_POWER_PM_H */
