...
#ifndef __INCLUDE_ROUX_POWER_BQ769X0_H
#define __INCLUDE_ROUX_POWER_BQ769X0_H
...
#define BQ769X0_LOAD_PRESENT                                                                       \
	(1 << 7) /* CHG pin is higher than VLOAD_DETECT, external load is present */
/* Bit 6: Reserved */
/* Bit 5: Reserved */
#define BQ769X0_ADC_EN (1 << 4) /* Enable voltage, temperature measurement and OV protection */
#define BQ769X0_TEMP_SEL                                                                           \
	(1 << 3)					/* 0 = use onboard temp sensors, 1 = use external temp sensors     \
								 */
								/* Bit 2: Reserved */
...
#endif /* __INCLUDE_ROUX_POWER_BQ769X0_H */
