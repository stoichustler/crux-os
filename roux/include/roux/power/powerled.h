...
#ifndef __INCLUDE_ROUX_POWER_POWERLED_H
#define __INCLUDE_ROUX_POWER_POWERLED_H
...
#include <roux/power/power_ioctl.h>
...
struct powerled_ops_s {
	...
	CODE int (*params_set)(FAR struct powerled_dev_s *dev, FAR struct powerled_params_s *param);
	...
	CODE int (*limits_set)(FAR struct powerled_dev_s *dev, FAR struct powerled_limits_s *limits);
	...
	CODE int (*state_get)(FAR struct powerled_dev_s *dev, FAR struct powerled_state_s *state);
...
#endif /* __INCLUDE_ROUX_POWER_POWERLED_H */
