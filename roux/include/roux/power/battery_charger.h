...
#ifndef __INCLUDE_ROUX_POWER_BATTERY_CHARGER_H
#define __INCLUDE_ROUX_POWER_BATTERY_CHARGER_H
...
struct battery_charger_operations_s {
	...
	CODE int (*chipid)(FAR struct battery_charger_dev_s *dev, FAR unsigned int *value);

	/* Get the actual output voltage for charging */

	CODE int (*get_voltage)(FAR struct battery_charger_dev_s *dev, FAR int *value);

	/* the voltage information for charging */

	CODE int (*voltage_info)(FAR struct battery_charger_dev_s *dev, FAR int *value);

	/* Get charge protocol */

	CODE int (*get_protocol)(FAR struct battery_charger_dev_s *dev, FAR int *value);
};
...
#endif /* __INCLUDE_ROUX_POWER_BATTERY_H */
