...
#ifndef __INCLUDE_ROUX_POWER_PM_RUNTIME_H
#define __INCLUDE_ROUX_POWER_PM_RUNTIME_H
...
void pm_runtime_set_autosuspend_delay(FAR struct pm_runtime_s *rpm, unsigned int delay);
...
#endif /* __INCLUDE_ROUX_POWER_PM_RUNTIME_H */
