...
#ifndef __INCLUDE_ROUX_POWER_REGULATOR_H
#define __INCLUDE_ROUX_POWER_REGULATOR_H
...
struct regulator_ops_s {
	CODE int (*list_voltage)(FAR struct regulator_dev_s *rdev, unsigned int selector);
	CODE int (*set_voltage)(FAR struct regulator_dev_s *rdev, int min_uv, int max_uv,
							FAR unsigned int *selector);
	CODE int (*set_voltage_sel)(FAR struct regulator_dev_s *rdev, unsigned int selector);
	...
	CODE int (*set_mode)(FAR struct regulator_dev_s *rdev, enum regulator_mode_e mode);
	CODE enum regulator_mode_e (*get_mode)(FAR struct regulator_dev_s *rdev);
	CODE int (*set_suspend_mode)(FAR struct regulator_dev_s *rdev, enum regulator_mode_e mode);
...
FAR struct regulator_dev_s *regulator_register(FAR const struct regulator_desc_s *desc,
											   FAR const struct regulator_ops_s *ops,
											   FAR void *priv);
...
#endif /* __ASSEMBLY__ */
#endif /* __INCLUDE_ROUX_POWER_REGULATOR_H */
