...
#ifndef __INCLUDE_ROUX_POWER_BATTERY_MONITOR_H
#define __INCLUDE_ROUX_POWER_BATTERY_MONITOR_H
...
struct battery_monitor_operations_s {
	...
	CODE int (*clearfaults)(FAR struct battery_monitor_dev_s *dev, uintptr_t param);
	...
	CODE int (*chipid)(FAR struct battery_monitor_dev_s *dev, FAR unsigned int *value);
};
