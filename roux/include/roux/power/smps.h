...
#ifndef __INCLUDE_ROUX_POWER_SMPS_H
#define __INCLUDE_ROUX_POWER_SMPS_H
...
struct smps_ops_s {
	...
	CODE int (*params_set)(FAR struct smps_dev_s *dev, FAR struct smps_params_s *param);
	...
	CODE int (*limits_set)(FAR struct smps_dev_s *dev, FAR struct smps_limits_s *limits);
	...
	CODE int (*state_get)(FAR struct smps_dev_s *dev, FAR struct smps_state_s *state);
...
#endif /* __INCLUDE_ROUX_POWER_SMPS_H */
