...
#ifndef __INCLUDE_ROUX_POWER_BATTERY_GAUGE_H
#define __INCLUDE_ROUX_POWER_BATTERY_GAUGE_H
...
struct battery_gauge_operations_s {
	...
	CODE int (*chipid)(FAR struct battery_gauge_dev_s *dev, FAR unsigned int *value);
...
#endif /* __INCLUDE_ROUX_POWER_BATTERY_GAUGE_H */
