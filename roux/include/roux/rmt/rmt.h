...
#ifndef __INCLUDE_ROUX_RMT_RMT_H
#define __INCLUDE_ROUX_RMT_RMT_H
...
struct rmt_ops_s {
	...
	CODE ssize_t (*write)(FAR struct rmt_dev_s *dev, FAR const char *buffer, size_t buflen);
	CODE ssize_t (*read)(FAR struct rmt_dev_s *dev, FAR char *buffer, size_t buflen);
};
...
#endif /* CONFIG_RMT */
#endif /* __INCLUDE_ROUX_RMT_RMT_H */
