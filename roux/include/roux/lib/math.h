...
#ifndef __INCLUDE_ROUX_LIB_MATH_H
#define __INCLUDE_ROUX_LIB_MATH_H
...
#define isfinite(x)                                                                                \
	(sizeof(x) == sizeof(float) ? finitef(x) : sizeof(x) == sizeof(double) ? finite(x) : finitel(x))
...
#endif /* CONFIG_LIBM */
#endif /* __INCLUDE_ROUX_LIB_MATH_H */
