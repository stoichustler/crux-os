...
#ifndef __INCLUDE_ROUX_LIB_LIB_H
#define __INCLUDE_ROUX_LIB_LIB_H
...
/* The ROUX C library can be built in two modes: (1) as a standard,
 ...
 * If ROUX is not being built as separated kernel- and user-space modules,
...
#endif /* __ASSEMBLY__ */
#endif /* __INCLUDE_ROUX_LIB_LIB_H */
