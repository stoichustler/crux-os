...
#ifndef __INCLUDE_ROUX_LIB_MATH32_H
#define __INCLUDE_ROUX_LIB_MATH32_H
...
#define FLS(n) ((n)&UINT64_C(0xffffffff00000000) ? 32 + FLS32((size_t)(n) >> 32) : FLS32(n))
#else
...
#define umul64_const(res, m, n, bias) (res) = up_umul64_const(m, n, bias)
#else
...
void uadd64(FAR const struct uint64_s *term1, FAR const struct uint64_s *term2,
...
void usub64(FAR const struct uint64_s *minuend, FAR const struct uint64_s *subtrahend,
			FAR struct uint64_s *difference);
...
void umul64(FAR const struct uint64_s *factor1, FAR const struct uint64_s *factor2,
...
#endif /* __INCLUDE_ROUX_LIB_MATH32_H */
