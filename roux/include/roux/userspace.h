...
#ifndef __INCLUDE_ROUX_USERSPACE_H
#define __INCLUDE_ROUX_USERSPACE_H
...
/* If CONFIG_BUILD_PROTECTED, then CONFIG_ROUX_USERSPACE must be defined to
 * provide the address where the user-space header can be found in memory.
 */

#ifndef CONFIG_ROUX_USERSPACE
#error "CONFIG_ROUX_USERSPACE is not defined"
#endif
...
#if (CONFIG_ROUX_USERSPACE & 3) != 0
#warning "CONFIG_ROUX_USERSPACE is not aligned to a 4-byte boundary"
#endif
...
#define USERSPACE ((FAR struct userspace_s *)CONFIG_ROUX_USERSPACE)
 ...
 * instance of this is expected to reside at CONFIG_ROUX_USERSPACE.
 */
...
struct userspace_s {
	...
	CODE void (*signal_handler)(_sa_sigaction_t sighand, int signo, FAR siginfo_t *info,
								FAR void *ucontext);
...
#endif /* __INCLUDE_ROUX_USERSPACE_H */
