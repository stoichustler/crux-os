...
#ifndef __INCLUDE_ROUX_ANALOG_COMP_H
#define __INCLUDE_ROUX_ANALOG_COMP_H
...
struct comp_ops_s {
	...
	CODE int (*ao_bind)(FAR struct comp_dev_s *dev, FAR const struct comp_callback_s *callback);
...
#endif /* __INCLUDE_ROUX_ANALOG_COMP_H */
