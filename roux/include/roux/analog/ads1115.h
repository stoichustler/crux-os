...
#ifndef __INCLUDE_ROUX_ANALOG_ADS1115_H
#define __INCLUDE_ROUX_ANALOG_ADS1115_H
...
FAR struct adc_dev_s *ads1115_initialize(struct i2c_master_s *i2c, uint8_t addr);

#endif /* __INCLUDE_ROUX_ANALOG_ADS1115_H */
