...
#ifndef __INCLUDE_ROUX_ANALOG_DAC_H
#define __INCLUDE_ROUX_ANALOG_DAC_H
...
FAR struct dac_dev_s *mcp48xx_initialize(FAR struct spi_dev_s *spi, uint32_t spidev);

#if defined(__cplusplus)
}
#endif

#endif /* __INCLUDE_ROUX_ANALOG_DAC_H */
