...
#ifndef __INCLUDE_ROUX_ANALOG_IOCTL_H
#define __INCLUDE_ROUX_ANALOG_IOCTL_H
...
#define ANIOC_TRIGGER                                                                              \
	_ANIOC(0x0001) /* Trigger one conversion                                                       \
					* IN: None                                                                     \
					* OUT: None */
#define ANIOC_WDOG_UPPER                                                                           \
	_ANIOC(0x0002) /* Set upper threshold for                                                      \
					* watchdog                                                                     \
					* IN: Threshold value                                                          \
					* OUT: None */
#define ANIOC_WDOG_LOWER                                                                           \
	_ANIOC(0x0003) /* Set lower threshold for                                                      \
					* watchdog                                                                     \
					* IN: Threshold value                                                          \
					* OUT: None */
#define ANIOC_GET_NCHANNELS                                                                        \
	_ANIOC(0x0004) /* Get the number of                                                            \
					* configured channels                                                          \
					* IN: None                                                                     \
					* OUT: Number of channels */
#define ANIOC_RESET_FIFO                                                                           \
	_ANIOC(0x0005) /* Clear data receive FIFO                                                      \
					* IN: None                                                                     \
					* OUT: None */
#define ANIOC_SAMPLES_ON_READ                                                                      \
	_ANIOC(0x0006) /* Get the number of                                                            \
					* samples to be read                                                           \
					* IN: None                                                                     \
...
#endif /* __INCLUDE_ROUX_ANALOG_IOCTL_H */
