...
#ifndef __INCLUDE_ROUX_SEGGER_RTT_H
#define __INCLUDE_ROUX_SEGGER_RTT_H
...
void lib_rttinstream_open(FAR struct lib_rttinstream_s *stream, int channel, size_t size);
...
ssize_t syslog_rtt_write(FAR syslog_channel_t *channel, FAR const char *buffer, size_t buflen);
#endif
