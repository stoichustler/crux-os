 ...
 *
 ****************************************************************************/
#ifndef __INCLUDE_ROUX_MTD_NAND_RAM_H
#define __INCLUDE_ROUX_MTD_NAND_RAM_H
...
#define NAND_RAM_N_BLOCKS                                                                          \
	((uint32_t)(NAND_RAM_SIZE / (NAND_RAM_PAGES_PER_BLOCK * NAND_RAM_PAGE_SIZE)))
