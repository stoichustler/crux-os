...
#ifndef __INCLUDE_ROUX_LCD_ILI9225_H
#define __INCLUDE_ROUX_LCD_ILI9225_H
...
#define ILI9225_DRIVER_OUTPUT_CTRL_NL(n)                                                           \
	(((uint16_t)(n) << ILI9225_DRIVER_OUTPUT_CTRL_NL_SHIFT) & ILI9225_DRIVER_OUTPUT_CTRL_NL_MASK)
...
#define ILI9225_DRIVER_OUTPUT_CTRL_EPL                                                             \
	(1 << 12) /* Inverts the polarity of signals from ENABLE pin */
#define ILI9225_DRIVER_OUTPUT_CTRL_DPL                                                             \
	(1 << 13) /* Inverts the polarity of signals from DOTCLK pin */
#define ILI9225_DRIVER_OUTPUT_CTRL_HSPL                                                            \
	(1 << 14) /* Inverts the polarity of signals from HSYNC pin */
#define ILI9225_DRIVER_OUTPUT_CTRL_VSPL                                                            \
	(1 << 15) /* Inverts the polarity of signals from VSYNC pin */
...
#define ILI9225_ENTRY_MODE_ID(n)                                                                   \
	(((uint16_t)(n) << ILI9225_ENTRY_MODE_ID_SHIFT) & ILI9225_ENTRY_MODE_ID_MASK)
#define ILI9225_ENTRY_MODE_MDT_SHIFT (8)
#define ILI9225_ENTRY_MODE_MDT_MASK (3 << ILI9225_ENTRY_MODE_MDT_SHIFT)
#define ILI9225_ENTRY_MODE_MDT                                                                     \
	(((uint16_t)(n) << ILI9225_ENTRY_MODE_MDT_SHIFT) & ILI9225_ENTRY_MODE_MDT_MASK)
...
#define ILI9225_DISP_CTRL1_D(n)                                                                    \
	(((uint16_t)(n) << ILI9225_DISP_CTRL1_D_SHIFT) & ILI9225_DISP_CTRL1_D_MASK)
...
#define ILI9225_DISP_CTRL2_BP(n)                                                                   \
	(((uint16_t)(n) << ILI9225_DISP_CTRL2_BP_SHIFT) & ILI9225_DISP_CTRL2_BP_MASK)
...
#define ILI9225_DISP_CTRL2_FP(n)                                                                   \
	(((uint16_t)(n) << ILI9225_DISP_CTRL2_FP_SHIFT) & ILI9225_DISP_CTRL2_FP_MASK)
...
#define ILI9225_FRAME_CYCLE_CTRL_RTN(n)                                                            \
	(((uint16_t)(n) << ILI9225_FRAME_CYCLE_CTRL_RTN_SHIFT) & ILI9225_FRAME_CYCLE_CTRL_RTN_MASK)
...
#define ILI9225_FRAME_CYCLE_CTRL_STD(n)                                                            \
	(((uint16_t)(n) << ILI9225_FRAME_CYCLE_CTRL_STD_SHIFT) & ILI9225_FRAME_CYCLE_CTRL_STD_MASK)
...
#define ILI9225_FRAME_CYCLE_CTRL_NO(n)                                                             \
	(((uint16_t)(n) << ILI9225_FRAME_CYCLE_CTRL_NO_SHIFT) & ILI9225_FRAME_CYCLE_CTRL_NO_MASK)
...
#define ILI9225_RGB_DISP_INT_CTRL1_RIM(n)                                                          \
	(((uint16_t)(n) << ILI9225_RGB_DISP_INT_CTRL1_RIM_SHIFT) & ILI9225_RGB_DISP_INT_CTRL1_RIM_MASK)
...
#define ILI9225_OSC_CTRL_FOSC(n)                                                                   \
	(((uint16_t)(n) << ILI9225_OSC_CTRL_FOSC_SHIFT) & ILI9225_OSC_CTRL_FOSC_MASK)
...
#define ILI9225_POWER_CTRL1_SAP(n)                                                                 \
	(((uint16_t)(n) << ILI9225_POWER_CTRL1_SAP_SHIFT) & ILI9225_POWER_CTRL1_SAP_MASK)
...
#define ILI9225_POWER_CTRL2_VC(n)                                                                  \
	(((uint16_t)(n) << ILI9225_POWER_CTRL2_VC_SHIFT) & ILI9225_POWER_CTRL2_VC_MASK)
...
#define ILI9225_POWER_CTRL2_PON2                                                                   \
	(1 << 10) /* Operation starting bit for booster circuit 2 (VGL)                                \
			   */
#define ILI9225_POWER_CTRL2_PON3                                                                   \
	(1 << 11)							   /* Operation starting bit for booster circout 3 (VCL)   \
											*/
...
#define ILI9225_POWER_CTRL3_DC3(n)                                                                 \
	(((uint16_t)(n) << ILI9225_POWER_CTRL3_DC3_SHIFT) & ILI9225_POWER_CTRL3_DC3_MASK)
...
#define ILI9225_POWER_CTRL3_DC2(n)                                                                 \
	(((uint16_t)(n) << ILI9225_POWER_CTRL3_DC2_SHIFT) & ILI9225_POWER_CTRL3_DC2_MASK)
...
#define ILI9225_POWER_CTRL3_DC1(n)                                                                 \
	(((uint16_t)(n) << ILI9225_POWER_CTRL3_DC1_SHIFT) & ILI9225_POWER_CTRL3_DC1_MASK)
...
#define ILI9225_POWER_CTRL3_BT(n)                                                                  \
	(((uint16_t)(n) << ILI9225_POWER_CTRL3_BT_SHIFT) & ILI9225_POWER_CTRL3_BT_MASK)
...
#define ILI9225_POWER_CTRL4_GVD(n)                                                                 \
	(((uint16_t)(n) << ILI9225_POWER_CTRL4_GVD_SHIFT) & ILI9225_POWER_CTRL4_GVD_MASK)
...
#define ILI9225_POWER_CTRL5_VML(n)                                                                 \
	(((uint16_t)(n) << ILI9225_POWER_CTRL5_VML_SHIFT) & ILI9225_POWER_CTRL5_VML_MASK)
...
#define ILI9225_POWER_CTRL5_VCM(n)                                                                 \
	(((uint16_t)(n) << ILI9225_POWER_CTRL5_VCM_SHIFT) & ILI9225_POWER_CTRL5_VCM_MASK)
...
#define ILI9225_VCI_REC_VCIR(n)                                                                    \
	(((uint16_t)(n) << ILI9225_VCI_REC_VCIR_SHIFT) & ILI9225_VCI_REC_VCIR_MASK)

/* ILI9225_HORIZONTAL_GRAM_ADDR_SET,
 * Horizontal GRAM Address Set, Offset: 0x20
 */

#define ILI9225_HORIZONTAL_GRAM_ADDR_SET_AD_SHIFT                                                  \
	(0) /* Set the initial value of address counter                                                \
		 */
#define ILI9225_HORIZONTAL_GRAM_ADDR_SET_AD_MASK (0xff << ILI9225_HORIZONTAL_GRAM_ADDR_SET_AD_SHIFT)
#define ILI9225_HORIZONTAL_GRAM_ADDR_SET_AD(n)                                                     \
	(((uint16_t)(n) << ILI9225_HORIZONTAL_GRAM_ADDR_SET_AD_SHIFT) &                                \
	 ILI9225_HORIZONTAL_GRAM_ADDR_SET_AD_MASK)
...
#define ILI9225_VERTICAL_GRAM_ADDR_SET_AD(n)                                                       \
	(((uint16_t)(n) << ILI9225_VERTICAL_GRAM_ADDR_SET_AD_SHIFT) &                                  \
	 ILI9225_VERTICAL_GRAM_ADDR_SET_AD_MASK)
...
#define ILI9225_GRAM_DATA_REG_WD(n)                                                                \
	(((uint16_t)(n) << ILI9225_GRAM_DATA_REG_WD_SHIFT) & ILI9225_GRAM_DATA_REG_WD_MASK)

#define ILI9225_GRAM_DATA_REG_RD_SHIFT (0)
#define ILI9225_GRAM_DATA_REG_RD_MASK (0xffff << ILI9225_GRAM_DATA_REG_RD_SHIFT)
#define ILI9225_GRAM_DATA_REG_RD(n)                                                                \
	(((uint16_t)(n) << ILI9225_GRAM_DATA_REG_RD_SHIFT) & ILI9225_GRAM_DATA_REG_RD_MASK)
...
#define ILI9225_SOFT_RESET_CODE(n)                                                                 \
	(((uint16_t)(n) << ILI9225_SOFT_RESET_CODE_SHIFT) & ILI9225_SOFT_RESET_CODE_MASK)

/* ILI9225_GATE_SCAN_CTRL, Gate Scan Control, Offset: 0x30 */

#define ILI9225_GATE_SCAN_CTRL_SCN_SHIFT                                                           \
	(0) /* Specify the gate line from which the draver starts scan */
#define ILI9225_GATE_SCAN_CTRL_SCN_MASK (0x1f << ILI9225_GATE_SCAN_CTRL_SCN_SHIFT)
#define ILI9225_GATE_SCAN_CTRL_SCN(n)                                                              \
	(((uint16_t)(n) << ILI9225_GATE_SCAN_CTRL_SCN_SHIFT) & ILI9225_GATE_SCAN_CTRL_SCN_MASK)
...
#define ILI9225_VER_SCROLL_CTRL1_SEA(n)                                                            \
	(((uint16_t)(n) << ILI9225_VER_SCROLL_CTRL1_SEA_SHIFT) & ILI9225_VER_SCROLL_CTRL1_SEA_MASK)
...
#define ILI9225_VER_SCROLL_CTRL2_SSA(n)                                                            \
	(((uint16_t)(n) << ILI9225_VER_SCROLL_CTRL2_SSA_SHIFT) & ILI9225_VER_SCROLL_CTRL2_SSA_MASK)
...
#define ILI9225_VER_SCROLL_CTRL3_SST(n)                                                            \
	(((uint16_t)(n) << ILI9225_VER_SCROLL_CTRL3_SST_SHIFT) & ILI9225_VER_SCROLL_CTRL3_SST_MASK)

/* ILI9225_PART_SCR_DRIV_POS1, Partial Screen Driving Position 1,
 * Offset: 0x34
 */

#define ILI9225_PART_SCR_DRIV_POS1_SE_SHIFT                                                        \
	(0) /* Specify the driving end position for the screen */
#define ILI9225_PART_SCR_DRIV_POS1_SE_MASK (0xff << ILI9225_PART_SCR_DRIV_POS1_SE_SHIFT)
#define ILI9225_PART_SCR_DRIV_POS1_SE(n)                                                           \
	(((uint16_t)(n) << ILI9225_PART_SCR_DRIV_POS1_SE_SHIFT) & ILI9225_PART_SCR_DRIV_POS1_SE_MASK)

/* ILI9225_PART_SCR_DRIV_POS2, Partial Screen Driving Position 2,
 * Offset: 0x35
 */

#define ILI9225_PART_SCR_DRIV_POS2_SS_SHIFT                                                        \
	(0) /* Specify the driving start position for the screen */
#define ILI9225_PART_SCR_DRIV_POS2_SS_MASK (0xff << ILI9225_PART_SCR_DRIV_POS2_SS_SHIFT)
#define ILI9225_PART_SCR_DRIV_POS2_SS(n)                                                           \
	(((uint16_t)(n) << ILI9225_PART_SCR_DRIV_POS2_SS_SHIFT) & ILI9225_PART_SCR_DRIV_POS2_SS_MASK)

/* ILI9225_HORIZONTAL_ADDR_END,
 * Horizontal Address End Position, Offset: 0x36
 */

#define ILI9225_HORIZONTAL_ADDR_END_HEA_SHIFT                                                      \
	(0) /* End of the window address area in horizontal direction */
#define ILI9225_HORIZONTAL_ADDR_END_HEA_MASK (0xff << ILI9225_HORIZONTAL_ADDR_END_HEA_SHIFT)
#define ILI9225_HORIZONTAL_ADDR_END_HEA(n)                                                         \
	(((uint16_t)(n) << ILI9225_HORIZONTAL_ADDR_END_HEA_SHIFT) &                                    \
	 ILI9225_HORIZONTAL_ADDR_END_HEA_MASK)

/* ILI9225_HORIZONTAL_ADDR_START,
 * Horizontal Address Start Position, Offset: 0x37
 */

#define ILI9225_HORIZONTAL_ADDR_START_HSA_SHIFT                                                    \
	(0) /* Start of the window address area in horizontal direction */
#define ILI9225_HORIZONTAL_ADDR_START_HSA_MASK (0xff << ILI9225_HORIZONTAL_ADDR_START_HSA_SHIFT)
#define ILI9225_HORIZONTAL_ADDR_START_HSA(n)                                                       \
	(((uint16_t)(n) << ILI9225_HORIZONTAL_ADDR_START_HSA_SHIFT) &                                  \
	 ILI9225_HORIZONTAL_ADDR_START_HSA_MASK)

/* ILI9225_VERTICAL_ADDR_END,
 * Vertical Address End Position, Offset: 0x38
 */

#define ILI9225_VERTICAL_ADDR_END_VEA_SHIFT                                                        \
	(0) /* End of the window address area in vertical direction */
#define ILI9225_VERTICAL_ADDR_END_VEA_MASK (0xff << ILI9225_VERTICAL_ADDR_END_VEA_SHIFT)
#define ILI9225_VERTICAL_ADDR_END_VEA(n)                                                           \
	(((uint16_t)(n) << ILI9225_VERTICAL_ADDR_END_VEA_SHIFT) & ILI9225_VERTICAL_ADDR_END_VEA_MASK)

/* ILI9225_VERTICAL_ADDR_START,
 * Vertical Address Start Position, Offset: 0x39
 */

#define ILI9225_VERTICAL_ADDR_START_VSA_SHIFT                                                      \
	(0) /* Start of the window address area in vertical direction */
#define ILI9225_VERTICAL_ADDR_START_VSA_MASK (0xff << ILI9225_VERTICAL_ADDR_START_VSA_SHIFT)
#define ILI9225_VERTICAL_ADDR_START_VSA(n)                                                         \
	(((uint16_t)(n) << ILI9225_VERTICAL_ADDR_START_VSA_SHIFT) &                                    \
	 ILI9225_VERTICAL_ADDR_START_VSA_MASK)
...
#define ILI9225_GAMMA_CTRL1_KP0(n)                                                                 \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL1_KP0_SHIFT) & ILI9225_GAMMA_CTRL1_KP0_MASK)
#define ILI9225_GAMMA_CTRL1_KP1_SHIFT (8)
#define ILI9225_GAMMA_CTRL1_KP1_MASK (0xf << ILI9225_GAMMA_CTRL1_KP1_SHIFT)
#define ILI9225_GAMMA_CTRL1_KP1(n)                                                                 \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL1_KP1_SHIFT) & ILI9225_GAMMA_CTRL1_KP1_MASK)
...
#define ILI9225_GAMMA_CTRL2_KP2(n)                                                                 \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL2_KP2_SHIFT) & ILI9225_GAMMA_CTRL2_KP2_MASK)
#define ILI9225_GAMMA_CTRL2_KP3_SHIFT (8)
#define ILI9225_GAMMA_CTRL2_KP3_MASK (0xf << ILI9225_GAMMA_CTRL2_KP3_SHIFT)
#define ILI9225_GAMMA_CTRL2_KP3(n)                                                                 \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL2_KP3_SHIFT) & ILI9225_GAMMA_CTRL2_KP3_MASK)
...
#define ILI9225_GAMMA_CTRL3_KP4(n)                                                                 \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL3_KP4_SHIFT) & ILI9225_GAMMA_CTRL3_KP4_MASK)
#define ILI9225_GAMMA_CTRL3_KP5_SHIFT (8)
#define ILI9225_GAMMA_CTRL3_KP5_MASK (0xf << ILI9225_GAMMA_CTRL3_KP5_SHIFT)
#define ILI9225_GAMMA_CTRL3_KP5(n)                                                                 \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL3_KP5_SHIFT) & ILI9225_GAMMA_CTRL3_KP5_MASK)
...
#define ILI9225_GAMMA_CTRL4_RP0(n)                                                                 \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL4_RP0_SHIFT) & ILI9225_GAMMA_CTRL4_RP0_MASK)
#define ILI9225_GAMMA_CTRL4_RP1_SHIFT (8)
#define ILI9225_GAMMA_CTRL4_RP1_MASK (0xf << ILI9225_GAMMA_CTRL4_RP1_SHIFT)
#define ILI9225_GAMMA_CTRL4_RP1(n)                                                                 \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL4_RP1_SHIFT) & ILI9225_GAMMA_CTR4_RP1_MASK)
...
#define ILI9225_GAMMA_CTRL5_KN0(n)                                                                 \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL5_KN0_SHIFT) & ILI9225_GAMMA_CTRL5_KN0_MASK)
#define ILI9225_GAMMA_CTRL5_KN1_SHIFT (8)
#define ILI9225_GAMMA_CTRL5_KN1_MASK (0xf << ILI9225_GAMMA_CTRL5_KN1_SHIFT)
#define ILI9225_GAMMA_CTRL5_KN1(n)                                                                 \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL5_KN1_SHIFT) & ILI9225_GAMMA_CTRL5_KN1_MASK)
...
#define ILI9225_GAMMA_CTRL6_KN2(n)                                                                 \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL6_KN2_SHIFT) & ILI9225_GAMMA_CTRL6_KN2_MASK)
#define ILI9225_GAMMA_CTRL6_KN3_SHIFT (8)
#define ILI9225_GAMMA_CTRL6_KN3_MASK (0xf << ILI9225_GAMMA_CTRL6_KN3_SHIFT)
#define ILI9225_GAMMA_CTRL6_KN3(n)                                                                 \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL6_KN3_SHIFT) & ILI9225_GAMMA_CTRL6_KN3_MASK)
...
#define ILI9225_GAMMA_CTRL7_KN4(n)                                                                 \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL7_KN4_SHIFT) & ILI9225_GAMMA_CTRL7_KN4_MASK)
#define ILI9225_GAMMA_CTRL7_KN5_SHIFT (8)
#define ILI9225_GAMMA_CTRL7_KN5_MASK (0xf << ILI9225_GAMMA_CTRL7_KN5_SHIFT)
#define ILI9225_GAMMA_CTRL7_KN5(n)                                                                 \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL7_KN5_SHIFT) & ILI9225_GAMMA_CTRL7_KN5_MASK)
...
#define ILI9225_GAMMA_CTRL8_RN0(n)                                                                 \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL8_RN0_SHIFT) & ILI9225_GAMMA_CTRL8_RN0_MASK)
#define ILI9225_GAMMA_CTRL8_RN1_SHIFT (8)
#define ILI9225_GAMMA_CTRL8_RN1_MASK (0xf << ILI9225_GAMMA_CTRL8_RN1_SHIFT)
#define ILI9225_GAMMA_CTRL8_RN1(n)                                                                 \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL8_RN1_SHIFT) & ILI9225_GAMMA_CTRL8_RN1_MASK)
...
#define ILI9225_GAMMA_CTRL9_VRP0(n)                                                                \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL9_VRP0_SHIFT) & ILI9225_GAMMA_CTRL9_VRP0_MASK)
#define ILI9225_GAMMA_CTRL9_VRP1_SHIFT (8)
#define ILI9225_GAMMA_CTRL9_VRP1_MASK (0x1f << ILI9225_GAMMA_CTRL9_VRP1_SHIFT)
#define ILI9225_GAMMA_CTRL9_VRP1(n)                                                                \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL9_VRP1_SHIFT) & ILI9225_GAMMA_CTRL9_VRP1_MASK)
...
#define ILI9225_GAMMA_CTRL10_VRN0(n)                                                               \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL10_VRN0_SHIFT) & ILI9225_GAMMA_CTRL10_VRN0_MASK)
#define ILI9225_GAMMA_CTRL10_VRN1_SHIFT (8)
#define ILI9225_GAMMA_CTRL10_VRN1_MASK (0x1f << ILI9225_GAMMA_CTRL10_VRN1_SHIFT)
#define ILI9225_GAMMA_CTRL10_VRN1(n)                                                               \
	(((uint16_t)(n) << ILI9225_GAMMA_CTRL10_VRN1_SHIFT) & ILI9225_GAMMA_CTRL10_VRN1_MASK)
...
#define ILI9225_NV_MEM_DATA_VM(n)                                                                  \
	(((uint16_t)(n) << ILI9225_NV_MEM_DATA_VM_SHIFT) & ILI9225_NV_MEM_DATA_VM_MASK)
...
#define ILI9225_NV_MEM_DATA_VM(n)                                                                  \
	(((uint16_t)(n) << ILI9225_NV_MEM_STS_VCM_SHIFT) & ILI9225_NV_MEM_STS_VCM_MASK)
#define ILI9225_NV_MEM_STS_PGM_CNT_SHIFT (0)
#define ILI9225_NV_MEM_STS_PGM_CNT_MASK (0x3 << ILI9225_NV_MEM_STS_PGM_CNT_SHIFT)
#define ILI9225_NV_MEM_DATA_PGM_CNT(n)                                                             \
	(((uint16_t)(n) << ILI9225_NV_MEM_STS_PGM_CNT_SHIFT) & ILI9225_NV_MEM_STS_PGM_CNT_MASK)
...
#define ILI9225_NV_MEM_PROTECTION_KEY(n)                                                           \
	(((uint16_t)(n) << ILI9225_NV_MEM_PROTECTION_KEY_SHIFT) & ILI9225_NV_MEM_PROTECTION_KEY_MASK)
...
#define ILI9225_ID_CODE_ID(n)                                                                      \
	(((uint16_t)(n) << ILI9225_ID_CODE_ID_SHIFT) & ILI9225_ID_CODE_ID_MASK)
...
#endif /* __INCLUDE_ROUX_LCD_ILI9225_H */
