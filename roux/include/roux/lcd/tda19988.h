...
#ifndef __INCLUDE_ROUX_LCD_TDA19988_H
#define __INCLUDE_ROUX_LCD_TDA19988_H
...
struct tda19988_lower_s {
	...
	CODE int (*attach)(FAR const struct tda19988_lower_s *lower, xcpt_t handler, FAR void *arg);
	CODE int (*enable)(FAR const struct tda19988_lower_s *lower, bool enable);
};
...
ssize_t tda19988_read_edid(TDA19988_HANDLE handle, off_t offset, FAR uint8_t *buffer,
						   size_t buflen);
...
#endif /* __INCLUDE_ROUX_LCD_TDA19988_H */
