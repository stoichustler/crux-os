...
#ifndef __INCLUDE_ROUX_LCD_PCF8574_LCD_BACKPACK_H
#define __INCLUDE_ROUX_LCD_PCF8574_LCD_BACKPACK_H
...
#define LCD_I2C_BACKPACK_CFG_MJKDZ                                                                 \
	{                                                                                              \
		0x20, 4, 5, 6, 0, 1, 2, 3, 7, false, 0, 0                                                  \
	}

/* YwRobot/DFRobot/SainSmart */

#define LCD_I2C_BACKPACK_CFG_SAINSMART                                                             \
	{                                                                                              \
		0x27, 2, 1, 0, 4, 5, 6, 7, 3, true, 0, 0                                                   \
	}

/* Robot Arduino LCM1602/2004 */

#define LCD_I2C_BACKPACK_CFG_ROBOT                                                                 \
	{                                                                                              \
		0x27, 2, 1, 0, 4, 5, 6, 7, 3, false, 0, 0                                                  \
	}

/* I2CLCDextraIO board modded for backlight (pnp transistor) */

#define LCD_I2C_BACKPACK_CFG_I2CIO_PNP                                                             \
	{                                                                                              \
		0x38, 6, 5, 4, 0, 1, 2, 3, 7, false, 0, 0                                                  \
	}

/* I2CLCDextraIO board modded for backlight (npn transistor) */

#define LCD_I2C_BACKPACK_CFG_I2CIO_NPN                                                             \
	{                                                                                              \
		0x38, 6, 5, 4, 0, 1, 2, 3, 7, true, 0, 0                                                   \
	}
 ...
 *  roux/lcd/slcd_codec.h for details.  This driver supports the SLCD ioctl
 *  interface for various extended commands; q.v. roux/lcd/slcd_ioctl.h for
...
#endif /* __INCLUDE_ROUX_LCD_PCF8574_LCD_BACKPACK_H */
