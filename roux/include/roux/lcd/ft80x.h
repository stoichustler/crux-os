...
#ifndef __INCLUDE_ROUX_LCD_FT80X_H
#define __INCLUDE_ROUX_LCD_FT80X_H
...
#define FT80X_ROM_CHIPID                                                                           \
	0x0c0000						 /* FT80x chip identification and revision                     \
									  * information (4b):                                          \
...
#define FT80X_REG_CPURESET                                                                         \
	0x10241c /* Graphics, audio and touch engines reset                                            \
			  * control */
#define FT80X_REG_TAP_CRC                                                                          \
	0x102420						 /* Live video tap crc. Frame CRC is computed                  \
									  * every DL SWAP. */
...
#define FT80X_REG_GPIO                                                                             \
	0x102490								/* Pin value (bits 0,1,7); Drive strength              \
											 * (bits 2-6) */
											/* 0x102494 Reserved */
...
#define FT80X_REG_PWM_DUTY                                                                         \
	0x1024c4					   /* BACKLIGHT PWM output duty cycle 0=0%,                        \
									* 128=100% */
...
#if defined(CONFIG_LCD_FT800)
#define FT80X_REG_TOUCH_ADC_MODE                                                                   \
	0x1024f4								/* Select single ended (low power) or                  \
...
#define FT80X_REG_TOUCH_TAG_XY                                                                     \
	0x102514								 /* Touch-screen screen (x-MSB16; y-LSB16)             \
											  * used for tag lookup */
...
#define FT80X_REG_TOUCH_DIRECT_XY                                                                  \
	0x102574 /* Touch screen direct (x-MSB16; y-LSB16)                                             \
			  * conversions */
#define FT80X_REG_TOUCH_DIRECT_Z1Z2                                                                \
	0x102578 /* Touch screen direct (z1-MSB16; z2-LSB16)                                           \
			  * conversions */
#elif defined(CONFIG_LCD_FT801)
/* 0x1024d0 – 0x1024d4 Reserved */
#define FT80X_REG_CTOUCH_EXTENDED                                                                  \
	0x1024f4 /* Set capacitive touch operation mode:                                               \
			  * 0: extended mode (multi-touch)                                                     \
			  * 1: FT800 compatibility mode (single touch) */
#define FT80X_REG_CTOUCH_REG                                                                       \
	0x1024f8 /* CTPM configure register write                                                      \
			  * Bits [7:0]: configure register address                                             \
			  * Bits [15:8]: configure register value */
/* 0x1024fc - 0x102504 Reserved */
#define FT80X_REG_CTOUCH_RAW_XY                                                                    \
	0x102508 /* Compatibility mode: touch-screen raw                                               \
			  * (x-MSB16; y-LSB16) */
#define FT80X_REG_CTOUCH_TOUCH1_XY                                                                 \
	0x102508 /* Extended mode: touch-screen screen data for touch 1                                \
			  * (x-MSB16; y-LSB16) */
#define FT80X_REG_CTOUCH_TOUCH4_Y                                                                  \
	0x10250c /* Extended mode: touch-screen screen Y data for touch 4 */
#define FT80X_REG_CTOUCH_SCREEN_XY                                                                 \
	0x102510 /* Compatibility mode: touch-screen screen                                            \
			  * (x-MSB16; y-LSB16) */
#define FT80X_REG_CTOUCH_TOUCH0_XY                                                                 \
	0x102510 /* Extended mode: touch-screen screen data for touch 0                                \
			  * (x-MSB16; y-LSB16) */
#define FT80X_REG_CTOUCH_TAG_XY                                                                    \
	0x102514								  /* Touch-screen screen (x-MSB16; y-LSB16)            \
											   * used for tag lookup */
...
/* 0x102534 Reserved */
#define FT80X_REG_CTOUCH_TOUCH4_X                                                                  \
	0x102538 /* Extended mode: touch-screen screen X data for                                      \
			  * touch 4 */
/* 0x10253c – 0x102450 Reserved */
#define FT80X_REG_SCREENSHOT_READ                                                                  \
	0x102554					/* Set to enable readout of the screenshot of the                  \
								 * selected Y line */
/* 0x10253c – 0x102468 Reserved */
#define FT80X_REG_TRIM 0x10256c /* Internal relaxation clock trimming */
/* 0x102570 Reserved */
#define FT80X_REG_CTOUCH_DIRECT_XY                                                                 \
	0x102574 /* Compatibility mode: Touch screen direct                                            \
			  * (x-MSB16; y-LSB16) conversions */
#define FT80X_REG_CTOUCH_TOUCH2_XY                                                                 \
	0x102574 /* Extended mode: touch-screen screen data for                                        \
			  * touch 2 (x-MSB16; y-LSB16) */
#define FT80X_REG_CTOUCH_DIRECT_Z1Z2                                                               \
	0x102578 /* Compatibility mode: Touch screen direct                                            \
			  * (z1-MSB16; z2-LSB16) conversions */
#define FT80X_REG_CTOUCH_TOUCH3_XY                                                                 \
	0x102578 /* Extended mode: touch-screen screen data for                                        \
			  * touch 3 (x-MSB16; y-LSB16) */
#endif

#define FT80X_REG_TRACKER                                                                          \
	0x109000 /* Track register (Track value – MSB16;                                             \
			  * Tag value - LSB8) */
...
#define DLSWAP_LINE                                                                                \
	1 /* Bits 0-1: 1=Graphics engine will render                                                   \
	   * the screen immediately after current line.                                                \
	   * May cause a tearing effect.                                                               \
	   */
#define DLSWAP_FRAME                                                                               \
	2 /* Bits 0-1: 2=Graphics engine will render                                                   \
...
#define TOUCH_MODE_OFF                                                                             \
	0 /* Acquisition stopped, touch detection                                                      \
	   * interrupt is still valid. */
#define TOUCH_MODE_ONESHOT                                                                         \
	1 /* Perform acquisition once every write of 1                                                 \
	   * to REG_TOUCH_MODE. */
#define TOUCH_MODE_FRAMESYNC                                                                       \
	2 /* Perform acquisition for every frame sync                                                  \
	   * (~60 data acquisition/second). */
#define TOUCH_MODE_CONTINUOUS                                                                      \
	3 /* Perform acquisition continuously at                                                       \
...
#define FT80X_ALPHA_FUNC(func, ref) ((9 << 24) | (((func)&7) << 8) | (((ref)&255) << 0))

/* BITMAP_HANDLE (0x05) - Set the bitmap handle */

#define FT80X_BITMAP_HANDLE(handle) ((5 << 24) | (((handle)&31) << 0))
...
#define FT80X_BITMAP_LAYOUT(format, linestride, height)                                            \
	((7 << 24) | (((format)&31) << 19) | (((linestride)&1023) << 9) | (((height)&511) << 0))
...
#define FT80X_BITMAP_SOURCE(addr) ((1 << 24) | (((addr)&1048575) << 0))

/* BITMAP_TRANSFORM_A (0x15) - F (0x1a) - Set the components of the bitmap
 * transform matrix
 */

#define FT80X_BITMAP_TRANSFORM_A(a) ((21 << 24) | (((a)&131071) << 0))
#define FT80X_BITMAP_TRANSFORM_B(b) ((22 << 24) | (((b)&131071) << 0))
#define FT80X_BITMAP_TRANSFORM_C(c) ((23 << 24) | (((c)&16777215) << 0))
#define FT80X_BITMAP_TRANSFORM_D(d) ((24 << 24) | (((d)&131071) << 0))
#define FT80X_BITMAP_TRANSFORM_E(e) ((25 << 24) | (((e)&131071) << 0))
#define FT80X_BITMAP_TRANSFORM_F(f) ((26 << 24) | (((f)&16777215) << 0))

/* BLEND_FUNC(0x0b) - Set pixel arithmetic */

#define FT80X_BLEND_FUNC(src, dest) ((11 << 24) | (((src)&7) << 3) | (((dest)&7) << 0))
...
#define FT80X_CELL(cell) ((6 << 24) | (((cell)&127) << 0))

/* CLEAR (0x26) - Clear buffers to preset values */

#define FT80X_CLEAR(c, s, t) ((38 << 24) | (((c)&1) << 2) | (((s)&1) << 1) | (((t)&1) << 0))

/* CLEAR_COLOR_A (0x0f) - Set clear value for the alpha channel */

#define FT80X_CLEAR_COLOR_A(alpha) ((15 << 24) | (((alpha)&255) << 0))
...
#define FT80X_CLEAR_STENCIL(s) ((17 << 24) | (((s)&255) << 0))

/* CLEAR_TAG (0x12) - Set clear value for the tag buffer */

#define FT80X_CLEAR_TAG(s) ((18 << 24) | (((s)&255) << 0))

/* COLOR_A (0x10) - Set the current color alpha */

#define FT80X_COLOR_A(alpha) ((16 << 24) | (((alpha)&255) << 0))
...
#define FT80X_SCISSOR_XY(x, y) ((27 << 24) | (((x)&511) << 9) | (((y)&511) << 0))
...
#define FT80X_STENCIL_MASK(mask) ((19 << 24) | (((mask)&255) << 0))

/* STENCIL_OP (0x0c) - Set stencil test actions */

#define FT80X_STENCIL_OP(sfail, spass) ((12 << 24) | (((sfail)&7) << 3) | (((spass)&7) << 0))
...
#define FT80X_TAG(s) ((3 << 24) | (((s)&255) << 0))

/* TAG_MASK (0x14) - Control the writing of the tag buffer */

#define FT80X_TAG_MASK(mask) ((20 << 24) | (((mask)&1) << 0))

/* Drawing actions */

/* BEGIN (0x1f) - Start drawing a graphics primitive */

#define FT80X_BEGIN(prim) ((31 << 24) | (((prim)&15) << 0))
...
#define FT80X_CMD_GETPROPS                                                                         \
	0xffffff25 /* Get info for image in RAM_G from last CMD_LOADIMAGE command */
...
#define FT80X_OPT_NOTICKS                                                                          \
	0x00002000 /* Co-processor clock widget is drawn without hour ticks.                           \
				* Gauge widget is drawn without major and minor ticks */
#define FT80X_OPT_NOHM                                                                             \
	0x00004000 /* Co-processor clock widget is drawn without hour and minutes                      \
...
#define FT80X_OPT_NOHANDS                                                                          \
	0x0000c000 /* Co-processor clock widget is drawn without hour, minutes or                      \
				* seconds hands */
...
struct ft80x_config_s {
	...
	CODE int (*attach)(FAR const struct ft80x_config_s *lower, xcpt_t isr, FAR void *arg);
...
int ft80x_register(FAR struct spi_dev_s *spi, FAR const struct ft80x_config_s *lower);
#elif defined(CONFIG_LCD_FT80X_I2C)
int ft80x_register(FAR struct i2c_master_s *i2c, FAR const struct ft80x_config_s *lower);
#endif
...
#endif /* __INCLUDE_ROUX_LCD_FT80X_H */
