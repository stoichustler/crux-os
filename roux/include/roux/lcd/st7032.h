...
#ifndef __INCLUDE_ROUX_LCD_ST7032_H
#define __INCLUDE_ROUX_LCD_ST7032_H
...
#define ST7032_FUNCTION_SET                                                                        \
	0x20 /* DL=interf. 8/4-bit; N=number lines 2/1; DH=Double Font Height IS= Inst. Table Select   \
		  */
...
#define ENTRY_MODE_SET_ID                                                                          \
	0x02					   /* I/D : Increment / decrement of DDRAM address (cursor or blink)   \
								*/
...
#endif /* __INCLUDE_ROUX_LCD_ST7032_H */
