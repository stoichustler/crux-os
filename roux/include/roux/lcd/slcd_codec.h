...
#ifndef __INCLUDE_ROUX_LCD_SLCD_CODEC_H
#define __INCLUDE_ROUX_LCD_SLCD_CODEC_H
...
void slcd_encode(enum slcdcode_e code, uint8_t count, FAR struct lib_outstream_s *stream);
...
#endif /* __INCLUDE_ROUX_LCD_SLCD_CODEC_H */
