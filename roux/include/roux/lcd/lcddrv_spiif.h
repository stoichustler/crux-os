...
#ifndef __INCLUDE_ROUX_LCD_LCDDRV_SPIIF_H
#define __INCLUDE_ROUX_LCD_LCDDRV_SPIIF_H
...
struct lcddrv_lcd_s {
	...
	CODE int (*recvgram)(FAR struct lcddrv_lcd_s *lcd, FAR uint16_t *wd, uint32_t nwords);
	CODE int (*sendgram)(FAR struct lcddrv_lcd_s *lcd, FAR const uint16_t *wd, uint32_t nwords);
...
#endif /* __INCLUDE_ROUX_LCD_LCDDRV_SPIIF_H */
