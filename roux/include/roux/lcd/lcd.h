...
#ifndef __INCLUDE_ROUX_LCD_LCD_H
#define __INCLUDE_ROUX_LCD_LCD_H
...
struct lcd_planeinfo_s {
	...
	CODE int (*putrun)(FAR struct lcd_dev_s *dev, fb_coord_t row, fb_coord_t col,
	...
	CODE int (*putarea)(FAR struct lcd_dev_s *dev, fb_coord_t row_start, fb_coord_t row_end,
	...
	CODE int (*getrun)(FAR struct lcd_dev_s *dev, fb_coord_t row, fb_coord_t col,
	...
	CODE int (*getarea)(FAR struct lcd_dev_s *dev, fb_coord_t row_start, fb_coord_t row_end,
						fb_coord_t col_start, fb_coord_t col_end, FAR uint8_t *buffer,
						fb_coord_t stride);
...
struct lcd_dev_s {
	...
	CODE int (*getvideoinfo)(FAR struct lcd_dev_s *dev, FAR struct fb_videoinfo_s *vinfo);
	...
	CODE int (*getcursor)(FAR struct lcd_dev_s *dev, FAR struct fb_cursorattrib_s *attrib);
	CODE int (*setcursor)(FAR struct lcd_dev_s *dev, FAR struct fb_setcursor_s *settings);
#endif
	...
	CODE int (*getareaalign)(FAR struct lcd_dev_s *dev, FAR struct lcddev_area_align_s *align);
...
#endif /* __INCLUDE_ROUX_LCD_LCD_H */
