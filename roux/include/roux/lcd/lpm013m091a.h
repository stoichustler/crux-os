...
#ifndef __INCLUDE_ROUX_LCD_LPM013M091A_H
#define __INCLUDE_ROUX_LCD_LPM013M091A_H
...
struct lpm013m091a_lcd_s {
	...
	int (*recvgram)(FAR struct lpm013m091a_lcd_s *lcd, uint16_t *wd, uint32_t nwords);
	int (*sendgram)(FAR struct lpm013m091a_lcd_s *lcd, const uint16_t *wd, uint32_t nwords);
...
#endif /* __INCLUDE_ROUX_LCD_LPM013M091A_H */
