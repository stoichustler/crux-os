...
#ifndef __INCLUDE_ROUX_LCD_ST7565_H
#define __INCLUDE_ROUX_LCD_ST7565_H
...
struct st7565_lcd_s {
	...
	int (*senddata)(FAR struct st7565_lcd_s *lcd, FAR const uint8_t *data, int size);
...
#endif /* __INCLUDE_ROUX_LCD_ST7567_H */
