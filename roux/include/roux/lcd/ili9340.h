...
#ifndef __INCLUDE_ROUX_LCD_ILI9340_H
#define __INCLUDE_ROUX_LCD_ILI9340_H
...
#define ILI9340_WRITE_CONTENT_ADAPT_BRIGHTNESS                                                     \
...
struct ili9340_lcd_s {
	...
	int (*recvgram)(FAR struct ili9340_lcd_s *lcd, uint16_t *wd, uint32_t nwords);
	int (*sendgram)(FAR struct ili9340_lcd_s *lcd, const uint16_t *wd, uint32_t nwords);
...
#endif /* __INCLUDE_ROUX_LCD_ILI9340_H */
