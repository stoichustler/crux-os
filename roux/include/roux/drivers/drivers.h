...
#ifndef __INCLUDE_ROUX_DRIVERS_DRIVERS_H
#define __INCLUDE_ROUX_DRIVERS_DRIVERS_H
...
int bchdev_register(FAR const char *blkdev, FAR const char *chardev, int oflags);
...
ssize_t bchlib_read(FAR void *handle, FAR char *buffer, off_t offset, size_t len);
...
ssize_t bchlib_write(FAR void *handle, FAR const char *buffer, off_t offset, size_t len);
...
#endif /* __INCLUDE_ROUX_DRIVERS_DRIVERS_H */
