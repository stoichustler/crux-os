...
#ifndef __INCLUDE_ROUX_DRIVERS_RWBUFFER_H
#define __INCLUDE_ROUX_DRIVERS_RWBUFFER_H
...
typedef CODE ssize_t (*rwbreload_t)(FAR void *dev, FAR uint8_t *buffer, off_t startblock,
									size_t nblocks);
typedef CODE ssize_t (*rwbflush_t)(FAR void *dev, FAR const uint8_t *buffer, off_t startblock,
								   size_t nblocks);
...
ssize_t rwb_read(FAR struct rwbuffer_s *rwb, off_t startblock, size_t blockcount,
				 FAR uint8_t *rdbuffer);
ssize_t rwb_write(FAR struct rwbuffer_s *rwb, off_t startblock, size_t blockcount,
...
#endif /* __INCLUDE_ROUX_DRIVERS_RWBUFFER_H */
