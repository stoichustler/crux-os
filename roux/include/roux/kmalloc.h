...
#ifndef __INCLUDE_ROUX_KMALLOC_H
#define __INCLUDE_ROUX_KMALLOC_H
...
/* For a monolithic, kernel-mode ROUX build.  Special allocators must be
 ...
 * include/roux/mm/mm.h and we can call them directly.
 */
...
FAR void *group_realloc(FAR struct task_group_s *group, FAR void *oldmem, size_t newsize);
...
#endif /* __INCLUDE_ROUX_KMALLOC_H */
