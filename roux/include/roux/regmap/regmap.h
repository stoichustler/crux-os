...
#ifndef __INCLUDE_ROUX_REGMAP_REGMAP_H
#define __INCLUDE_ROUX_REGMAP_REGMAP_H
...
typedef CODE int (*reg_read_t)(FAR struct regmap_bus_s *bus, unsigned int reg, FAR void *val);
typedef CODE int (*reg_write_t)(FAR struct regmap_bus_s *bus, unsigned int reg, unsigned int val);

/* Bulk read/write */

typedef CODE int (*read_t)(FAR struct regmap_bus_s *bus, FAR const void *reg_buf,
						   unsigned int reg_size, FAR void *val_buf, unsigned int val_size);
typedef CODE int (*write_t)(FAR struct regmap_bus_s *bus, FAR const void *data, unsigned int count);
...
FAR struct regmap_s *regmap_init_spi(FAR struct spi_dev_s *spi, uint32_t freq, uint32_t devid,
...
int regmap_write(FAR struct regmap_s *map, unsigned int reg, unsigned int val);
...
int regmap_bulk_write(FAR struct regmap_s *map, unsigned int reg, FAR const void *val,
...
int regmap_bulk_read(FAR struct regmap_s *map, unsigned int reg, FAR void *val,
					 unsigned int val_count);
...
#endif
#endif /* __INCLUDE_ROUX_REGMAP_REGMAP_H */
