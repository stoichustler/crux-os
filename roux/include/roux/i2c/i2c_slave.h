...
#ifndef __INCLUDE_ROUX_I2C_I2C_SLAVE_H
#define __INCLUDE_ROUX_I2C_I2C_SLAVE_H
...
typedef CODE int(i2c_slave_callback_t)(FAR void *arg, i2c_slave_complete_t state, size_t len);

/* The I2C vtable */

struct i2c_slave_s;
struct i2c_slaveops_s {
	CODE int (*setownaddress)(FAR struct i2c_slave_s *dev, int addr, int nbits);

	CODE int (*write)(FAR struct i2c_slave_s *dev, FAR const uint8_t *buffer, int buflen);

	CODE int (*read)(FAR struct i2c_slave_s *dev, FAR uint8_t *buffer, int buflen);

	CODE int (*registercallback)(FAR struct i2c_slave_s *dev, FAR i2c_slave_callback_t *callback,
								 FAR void *arg);
...
#endif /* __INCLUDE_ROUX_I2C_I2C_SLAVE_H */
