...
#ifndef __INCLUDE_ROUX_I2C_I2C_MASTER_H
#define __INCLUDE_ROUX_I2C_I2C_MASTER_H
...
int i2c_writeread(FAR struct i2c_master_s *dev, FAR const struct i2c_config_s *config,
				  FAR const uint8_t *wbuffer, int wbuflen, FAR uint8_t *rbuffer, int rbuflen);
...
#endif
#endif /* __INCLUDE_ROUX_I2C_I2C_MASTER_H */
