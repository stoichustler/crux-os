...
#ifndef __INCLUDE_ROUX_MODEM_IOCTL_H
#define __INCLUDE_ROUX_MODEM_IOCTL_H
 ...
 * may include the modem commands from include/roux/serial/ioctl.h such as
 * the following:
 *
...
#endif /* __INCLUDE_ROUX_MODEM_IOCTL_H */
