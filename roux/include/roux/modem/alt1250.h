...
#ifndef __INCLUDE_ROUX_MODEM_ALT1250_H
#define __INCLUDE_ROUX_MODEM_ALT1250_H
...
typedef CODE int32_t (*compose_handler_t)(FAR void **arg, size_t arglen, uint8_t altver,
										  FAR uint8_t *pktbuf, const size_t pktsz,
										  FAR uint16_t *altcid);
typedef CODE int32_t (*parse_handler_t)(FAR struct alt1250_dev_s *dev, FAR uint8_t *pktbuf,
...
#endif /* __INCLUDE_ROUX_MODEM_ALT1250_H */
