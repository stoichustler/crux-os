...
#ifndef __INCLUDE_ROUX_SPI_SPI_BITBANG_H
#define __INCLUDE_ROUX_SPI_SPI_BITBANG_H
...
struct spi_bitbang_ops_s {
	...
	void (*select)(FAR struct spi_bitbang_s *priv, uint32_t devid, bool selected);
	...
	int (*cmddata)(FAR struct spi_bitbang_s *priv, uint32_t devid, bool cmd);
#endif
};
...
#endif /* __INCLUDE_ROUX_SPI_SPI_BITBANG_H */
