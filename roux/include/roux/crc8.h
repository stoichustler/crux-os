...
#ifndef __INCLUDE_ROUX_CRC8_H
#define __INCLUDE_ROUX_CRC8_H
...
uint8_t crc8table(const uint8_t table[256], const uint8_t *src, size_t len, uint8_t crc8val);
