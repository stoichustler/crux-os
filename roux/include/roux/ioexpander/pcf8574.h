...
#ifndef __INCLUDE_ROUX_IOEXPANDER_PCF8574_H
#define __INCLUDE_ROUX_IOEXPANDER_PCF8574_H
...
struct pcf8574_config_s {
	...
	CODE int (*attach)(FAR struct pcf8574_config_s *state, pcf8574_handler_t handler,
					   FAR void *arg);
...
#endif /* __INCLUDE_ROUX_IOEXPANDER_PCF8574_H */
