...
#ifndef __INCLUDE_ROUX_IOEXPANDER_ICJX_H
#define __INCLUDE_ROUX_IOEXPANDER_ICJX_H
...
struct icjx_config_s {
	...
	CODE int (*attach)(FAR struct icjx_config_s *config, xcpt_t handler, FAR void *arg);
...
#endif /* __INCLUDE_ROUX_IOEXPANDER_ICJX_H */
