...
#ifndef __INCLUDE_ROUX_IOEXPANDER_IOEXPANDER_H
#define __INCLUDE_ROUX_IOEXPANDER_IOEXPANDER_H
...
#define IOEXPANDER_OPTION_NONGENERIC                                                               \
	4 /* Non generic option interface. Some                                                        \
...
#define IOEP_ATTACH(dev, pinset, callback, arg) ((dev)->ops->ioe_attach(dev, pinset, callback, arg))
#endif
...
typedef CODE int (*ioe_callback_t)(FAR struct ioexpander_dev_s *dev, ioe_pinset_t pinset,
								   FAR void *arg);
...
struct ioexpander_ops_s {
	CODE int (*ioe_direction)(FAR struct ioexpander_dev_s *dev, uint8_t pin, int direction);
	CODE int (*ioe_option)(FAR struct ioexpander_dev_s *dev, uint8_t pin, int opt, FAR void *val);
	CODE int (*ioe_writepin)(FAR struct ioexpander_dev_s *dev, uint8_t pin, bool value);
	CODE int (*ioe_readpin)(FAR struct ioexpander_dev_s *dev, uint8_t pin, FAR bool *value);
	CODE int (*ioe_readbuf)(FAR struct ioexpander_dev_s *dev, uint8_t pin, FAR bool *value);
#ifdef CONFIG_IOEXPANDER_MULTIPIN
	CODE int (*ioe_multiwritepin)(FAR struct ioexpander_dev_s *dev, FAR const uint8_t *pins,
								  FAR const bool *values, int count);
	CODE int (*ioe_multireadpin)(FAR struct ioexpander_dev_s *dev, FAR const uint8_t *pins,
								 FAR bool *values, int count);
	CODE int (*ioe_multireadbuf)(FAR struct ioexpander_dev_s *dev, FAR const uint8_t *pins,
								 FAR bool *values, int count);
#endif
#ifdef CONFIG_IOEXPANDER_INT_ENABLE
	CODE FAR void *(*ioe_attach)(FAR struct ioexpander_dev_s *dev, ioe_pinset_t pinset,
...
#endif /* __INCLUDE_ROUX_IOEXPANDER_IOEXPANDER_H */
