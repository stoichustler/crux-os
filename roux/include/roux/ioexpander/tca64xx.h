...
#ifndef __INCLUDE_ROUX_IOEXPANDER_TCA64XX_H
#define __INCLUDE_ROUX_IOEXPANDER_TCA64XX_H
...
struct tca64_config_s {
	...
	CODE int (*attach)(FAR struct tca64_config_s *state, tca64_handler_t handler, FAR void *arg);
...
#endif /* __INCLUDE_ROUX_IOEXPANDER_TCA64XX_H */
