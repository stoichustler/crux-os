...
#ifndef ___INCLUDE_ROUX_MQUEUE_H
#define ___INCLUDE_ROUX_MQUEUE_H
 ...
 *   It follows the ROUX internal error return policy:  Zero (OK) is
...
int nxmq_send(mqd_t mqdes, FAR const char *msg, size_t msglen, unsigned int prio);
...
int nxmq_timedsend(mqd_t mqdes, FAR const char *msg, size_t msglen, unsigned int prio,
...
ssize_t nxmq_timedreceive(mqd_t mqdes, FAR char *msg, size_t msglen, FAR unsigned int *prio,
						  FAR const struct timespec *abstime);
...
int file_mq_open(FAR struct file *mq, FAR const char *mq_name, int oflags, ...);
...
int file_mq_send(FAR struct file *mq, FAR const char *msg, size_t msglen, unsigned int prio);
...
int file_mq_timedsend(FAR struct file *mq, FAR const char *msg, size_t msglen, unsigned int prio,
					  FAR const struct timespec *abstime);
...
int file_mq_ticksend(FAR struct file *mq, FAR const char *msg, size_t msglen, unsigned int prio,
					 sclock_t ticks);
...
ssize_t file_mq_timedreceive(FAR struct file *mq, FAR char *msg, size_t msglen,
							 FAR unsigned int *prio, FAR const struct timespec *abstime);
...
ssize_t file_mq_tickreceive(FAR struct file *mq, FAR char *msg, size_t msglen,
							FAR unsigned int *prio, sclock_t ticks);
...
#endif /* ___INCLUDE_ROUX_MQUEUE_H */
