...
#ifndef __INCLUDE_ROUX_HASHTABLE_H
#define __INCLUDE_ROUX_HASHTABLE_H
...
#define hashtable_add(table, item, key) dq_addfirst(item, &table[HASH(key, hashtable_bits(table))])

#define hashtable_delete(table, item, key) dq_rem(item, &table[HASH(key, hashtable_bits(table))])
...
#endif /* __INCLUDE_ROUX_HASHTABLE_H */
