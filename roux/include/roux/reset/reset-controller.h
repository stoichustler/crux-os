...
#ifndef __INCLUDE_ROUX_RESET_CONTROLLER_H
#define __INCLUDE_ROUX_RESET_CONTROLLER_H
...
struct reset_control_ops {
	CODE int (*acquire)(FAR struct reset_controller_dev *rcdev, unsigned int id, bool shared,
						bool acquired);
	CODE int (*release)(FAR struct reset_controller_dev *rcdev, unsigned int id);
	CODE int (*reset)(FAR struct reset_controller_dev *rcdev, unsigned int id);
	CODE int (*assert)(FAR struct reset_controller_dev *rcdev, unsigned int id);
	CODE int (*deassert)(FAR struct reset_controller_dev *rcdev, unsigned int id);
	CODE int (*status)(FAR struct reset_controller_dev *rcdev, unsigned int id);
};
...
#endif /* __INCLUDE_ROUX_RESET_CONTROLLER_H */
