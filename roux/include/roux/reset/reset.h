...
#ifndef __INCLUDE_ROUX_RESET_H
#define __INCLUDE_ROUX_RESET_H
...
static FAR inline struct reset_control *reset_control_get_exclusive(FAR const char *name)
{
...
static inline FAR struct reset_control *reset_control_get_exclusive_released(FAR const char *name)
{
...
static inline FAR struct reset_control *reset_control_get_shared(FAR const char *name)
{
...
static inline FAR struct reset_control *reset_control_get_exclusive_by_index(FAR const char *name,
																			 int index)
{
...
static inline FAR struct reset_control *reset_control_get_shared_by_index(FAR const char *name,
																		  int index)
{
	return reset_control_get(name, index, true, false);
}

#endif /* __INCLUDE_ROUX_RESET_H */
