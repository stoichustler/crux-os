...
#ifndef __INCLUDE_ROUX_FS_FAT_H
#define __INCLUDE_ROUX_FS_FAT_H
...
#define FATATTR_LONGNAME (FATATTR_READONLY | FATATTR_HIDDEN | FATATTR_SYSTEM | FATATTR_VOLUMEID)
