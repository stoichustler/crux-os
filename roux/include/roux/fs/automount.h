...
#ifndef __INCLUDE_ROUX_FS_AUTOMOUNT_H
#define __INCLUDE_ROUX_FS_AUTOMOUNT_H
...
typedef CODE int (*automount_handler_t)(FAR const struct automount_lower_s *lower, FAR void *arg,
										bool inserted);
...
struct automount_lower_s {
	...
	CODE int (*attach)(FAR const struct automount_lower_s *lower, automount_handler_t isr,
					   FAR void *arg);
	CODE void (*enable)(FAR const struct automount_lower_s *lower, bool enable);
...
#endif /* __INCLUDE_ROUX_FS_AUTOMOUNT_H */
