...
#ifndef __INCLUDE_ROUX_FS_IOCTL_H
#define __INCLUDE_ROUX_FS_IOCTL_H
...
/* Each ROUX ioctl commands are uint16_t's consisting of an 8-bit type
...
/* ROUX file system ioctl definitions **************************************/
...
#define FIOC_GETFLAGS                                                                              \
	_FIOC(0x0016) /* IN:  None                                                                     \
				   * OUT: None                                                                     \
				   */
#define FIOC_SETFLAGS                                                                              \
	_FIOC(0x0017) /* IN:  The flags that need to set to file                                       \
				   * OUT: None                                                                     \
				   */
#define FIOGCLEX                                                                                   \
	_FIOC(0x0018) /* IN:  FAR int *                                                                \
				   * OUT: None                                                                     \
				   */
...
/* ROUX block driver ioctl definitions *************************************/
...
#define BIOC_BLKGETSIZE                                                                            \
	_BIOC(0x0010) /* Get block device sector numbers.                                              \
				   ...
				   *      buffer. */
#define BIOC_DISCARD                                                                               \
	_BIOC(0x0011) /* Discards the block device read buffer                                         \
				   * IN:  None                                                                     \
				   * OUT: None (ioctl return value provides                                        \
				   *      success/failure indication). */

/* ROUX MTD driver ioctl definitions ***************************************/
...
/* ROUX Audio driver ioctl definitions *************************************/

/* (see roux/audio/audio.h) */
...
/* (see roux/include/lcd/slcd_codec.h */
...
/* (see roux/include/wireless/ioctl.h */
...
/* Discrete Joystick (see roux/include/input/djoystick.h */
...
/* (see roux/include/sensor/zerocross.h */
...
/* see roux/include/modem/ioctl.h */
...
/* see roux/include/i2c/i2c_master.h */
...
/* see roux/include/spi/spi_transfer.h */
...
/* see roux/include/ioexpander/gpio.h */
...
/* (see roux/include/contactless/ioctl.h */
...
/* (see roux/include/wireless/ieee802154/ieee802154_mac.h */
...
/* ROUX RF ioctl definitions (see roux/rf/ioctl.h) ************************/
...
/* (see roux/include/crypto/se05x.h */
...
/* (see roux/include/wireless/wireless.h */
...
/* see roux/include/i3c/i3c_driver.h */
...
/* see roux/include/pinctrl/pinctrl.h */
...
#endif /* __INCLUDE_ROUX_FS_IOCTL_H */
