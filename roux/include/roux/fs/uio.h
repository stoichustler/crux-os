...
#ifndef __INCLUDE_ROUX_FS_UIO_H
#define __INCLUDE_ROUX_FS_UIO_H
 ...
 * (Thus it doesn't have the ROUX-style "_s" suffix.)
 */
...
void uio_copyfrom(FAR struct uio *uio, size_t offset, FAR const void *buf, size_t len);
...
void uio_copyto(FAR struct uio *uio, size_t offset, FAR void *buf, size_t len);

#endif /* __INCLUDE_ROUX_FS_UIO_H */
