...
#ifndef __INCLUDE_ROUX_FDT_H
#define __INCLUDE_ROUX_FDT_H
...
int fdt_get_irq_by_path(FAR const void *fdt, int offset, FAR const char *path, int irqbase);
...
uintptr_t fdt_get_reg_size_by_index(FAR const void *fdt, int offset, int index);
