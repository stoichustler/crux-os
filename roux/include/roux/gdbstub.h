...
#ifndef __INCLUDE_ROUX_GDBSTUB_H
#define __INCLUDE_ROUX_GDBSTUB_H
...
struct gdb_state_s;
typedef CODE ssize_t (*gdb_send_func_t)(FAR void *priv, FAR const char *buf, size_t len);
typedef CODE ssize_t (*gdb_recv_func_t)(FAR void *priv, FAR void *buf, size_t len);

typedef CODE int (*gdb_monitor_func_t)(FAR struct gdb_state_s *state, FAR const char *cmd);

/****************************************************************************
 * Name: gdbstub_debugpoint_add
 ****************************************************************************/

int gdb_debugpoint_add(int type, void *addr, size_t size, debug_callback_t callback, void *arg);
...
#endif /* __INCLUDE_ROUX_GDBSTUB_H */
