...
#ifndef __INCLUDE_ROUX_SERIAL_UART_16550_H
#define __INCLUDE_ROUX_SERIAL_UART_16550_H
...
#if CONFIG_16550_ADDRWIDTH != 0 && CONFIG_16550_ADDRWIDTH != 8 && CONFIG_16550_ADDRWIDTH != 16 &&  \
...
#define UART_FCR_RXTRIGGER_14                                                                      \
	(3 << UART_FCR_RXTRIGGER_SHIFT) /* Trigger level 3 (14 characters)                             \
									 */
...
struct u16550_ops_s {
	...
	CODE uart_datawidth_t (*getreg)(FAR struct u16550_s *priv, unsigned int offset);
	CODE void (*putreg)(FAR struct u16550_s *priv, unsigned int offset, uart_datawidth_t value);
	CODE int (*ioctl)(FAR struct u16550_s *priv, int cmd, unsigned long arg);
	CODE FAR struct dma_chan_s *(*dmachan)(FAR struct u16550_s *priv, unsigned int ident);
};
...
struct dma_chan_s;
FAR struct dma_chan_s *uart_dmachan(FAR struct u16550_s *priv, unsigned int ident);

#endif /* CONFIG_16550_UART */
#endif /* __INCLUDE_ROUX_SERIAL_UART_16550_H */
