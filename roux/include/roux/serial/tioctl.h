 ...
 * Rather, it should be included indirectly via include/roux/fs/ioctl.h.
 */

#ifndef __INCLUDE_ROUX_SERIAL_TIOCTL_H
#define __INCLUDE_ROUX_SERIAL_TIOCTL_H
...
#define TCSETSW                                                                                    \
	_TIOC(0x0003) /* Drain output and set serial port settings: FAR const struct termios* */
#define TCSETSF                                                                                    \
	_TIOC(0x0004) /* Drain output, discard input, and set serial port settings: FAR const struct   \
			 termios* */
...
#define TIOCGICOUNT                                                                                \
	_TIOC(0x002a) /* Read serial port interrupt count: FAR  struct serial_icounter_struct */
...
#define SER_SINGLEWIRE_PULLDOWN                                                                    \
	(2 << SER_SINGLEWIRE_PULL_SHIFT)	 /* Enable Pull down the RX/TX Line */
...
#endif /* __INCLUDE_ROUX_SERIAL_TIOCTL_H */
