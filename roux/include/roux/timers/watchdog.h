...
#ifndef __INCLUDE_ROUX_TIMERS_WATCHDOG_H
#define __INCLUDE_ROUX_TIMERS_WATCHDOG_H
...
#define WDFLAGS_CAPTURE                                                                            \
	(1 << 2) /* 1=Call the user function when the                                                  \
...
#endif /* __INCLUDE_ROUX_TIMERS_WATCHDOG_H */
