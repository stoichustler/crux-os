...
#ifndef __INCLUDE_ROUX_TIMERS_RTC_H
#define __INCLUDE_ROUX_TIMERS_RTC_H
 ...
 *   ROUX timer and the ROUX system timer provides for higher resolution
 *   time.
 *
 ...
 *   "seed" the normal ROUX timer and the ROUX timer provides for higher
 *   resolution time.
 *
 *   If CONFIG_RTC_HIRES is enabled in the ROUX configuration, then the
...
#endif /* CONFIG_RTC */
#endif /* __INCLUDE_ROUX_TIMERS_RTC_H */
