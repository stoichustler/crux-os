...
#ifndef __INCLUDE_ROUX_TIMERS_ONESHOT_H
#define __INCLUDE_ROUX_TIMERS_ONESHOT_H
...
#define ONESHOT_CANCEL(l, t) ((l)->ops->cancel ? (l)->ops->cancel(l, t) : oneshot_cancel(l, t))
...
#define ONESHOT_CURRENT(l, t) ((l)->ops->current ? (l)->ops->current(l, t) : oneshot_current(l, t))
...
typedef CODE void (*oneshot_callback_t)(FAR struct oneshot_lowerhalf_s *lower, FAR void *arg);

/* The one short operations supported by the lower half driver */

struct timespec;
struct oneshot_operations_s {
	CODE int (*max_delay)(FAR struct oneshot_lowerhalf_s *lower, FAR struct timespec *ts);
	CODE int (*start)(FAR struct oneshot_lowerhalf_s *lower, oneshot_callback_t callback,
					  FAR void *arg, FAR const struct timespec *ts);
	CODE int (*cancel)(FAR struct oneshot_lowerhalf_s *lower, FAR struct timespec *ts);
	CODE int (*current)(FAR struct oneshot_lowerhalf_s *lower, FAR struct timespec *ts);
	CODE int (*tick_max_delay)(FAR struct oneshot_lowerhalf_s *lower, FAR clock_t *ticks);
	CODE int (*tick_start)(FAR struct oneshot_lowerhalf_s *lower, oneshot_callback_t callback,
						   FAR void *arg, clock_t ticks);
	CODE int (*tick_cancel)(FAR struct oneshot_lowerhalf_s *lower, FAR clock_t *ticks);
	CODE int (*tick_current)(FAR struct oneshot_lowerhalf_s *lower, FAR clock_t *ticks);
};
...
static inline int oneshot_max_delay(FAR struct oneshot_lowerhalf_s *lower, FAR struct timespec *ts)
{
	clock_t tick;
	int ret;
...
static inline int oneshot_start(FAR struct oneshot_lowerhalf_s *lower, oneshot_callback_t callback,
								FAR void *arg, FAR const struct timespec *ts)
{
	clock_t tick;
...
static inline int oneshot_cancel(FAR struct oneshot_lowerhalf_s *lower, FAR struct timespec *ts)
{
	clock_t tick;
	int ret;
...
static inline int oneshot_current(FAR struct oneshot_lowerhalf_s *lower, FAR struct timespec *ts)
{
	clock_t tick;
	int ret;
...
static inline int oneshot_tick_max_delay(FAR struct oneshot_lowerhalf_s *lower, FAR clock_t *ticks)
{
	struct timespec ts;
	int ret;
...
static inline int oneshot_tick_start(FAR struct oneshot_lowerhalf_s *lower,
									 oneshot_callback_t callback, FAR void *arg, clock_t ticks)
{
	struct timespec ts;
...
static inline int oneshot_tick_cancel(FAR struct oneshot_lowerhalf_s *lower, FAR clock_t *ticks)
{
	struct timespec ts;
	int ret;
...
static inline int oneshot_tick_current(FAR struct oneshot_lowerhalf_s *lower, FAR clock_t *ticks)
{
	struct timespec ts;
	int ret;
...
#endif /* __INCLUDE_ROUX_TIMERS_ONESHOT_H */
