...
#ifndef __INCLUDE_ROUX_I3C_MASTER_H
#define __INCLUDE_ROUX_I3C_MASTER_H
...
struct i3c_device_ibi_info {
	...
	CODE void (*handler)(FAR struct i3c_device *dev, const struct i3c_ibi_payload *payload);
};
...
struct i3c_master_controller_ops {
	...
	CODE int (*reattach_i3c_dev)(FAR struct i3c_dev_desc *dev, unsigned char old_dyn_addr);
	...
	CODE int (*send_ccc_cmd)(FAR struct i3c_master_controller *master, FAR struct i3c_ccc_cmd *cmd);
	CODE int (*priv_xfers)(FAR struct i3c_dev_desc *dev, FAR struct i3c_priv_xfer *xfers,
						   int nxfers);
	...
	CODE int (*request_ibi)(FAR struct i3c_dev_desc *dev, FAR const struct i3c_ibi_setup *req);
	...
	CODE void (*recycle_ibi_slot)(FAR struct i3c_dev_desc *dev, FAR struct i3c_ibi_slot *slot);
};
...
struct i3c_master_controller {
	...
	FAR const struct i3c_master_controller_ops
		*ops; /* operation callback implemented in IP driver */
...
static inline FAR void *i3c_dev_get_master_data(FAR const struct i3c_dev_desc *dev)
{
...
static inline void i3c_dev_set_master_data(FAR struct i3c_dev_desc *dev, FAR void *data)
{
...
static inline FAR void *i2c_dev_get_master_data(FAR const struct i2c_dev_desc *dev)
{
	return dev->common.master_priv;
}
...
static inline void i2c_dev_set_master_data(FAR struct i2c_dev_desc *dev, FAR void *data)
{
	dev->common.master_priv = data;
}
...
static inline FAR struct i3c_master_controller *i3c_dev_get_master(FAR struct i3c_dev_desc *dev)
{
...
static inline FAR struct i3c_master_controller *i2c_dev_get_master(FAR struct i2c_dev_desc *dev)
{
	return dev->common.master;
}
...
static inline FAR struct i3c_bus *i3c_master_get_bus(FAR struct i3c_master_controller *master)
{
	return &master->bus;
}
...
FAR struct i3c_ibi_slot *i3c_master_get_free_ibi_slot(FAR struct i3c_dev_desc *dev);
...
#endif /* __INCLUDE_ROUX_I3C_MASTER_H */
