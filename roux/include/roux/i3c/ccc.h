...
#ifndef __INCLUDE_ROUX_I3C_CCC_H
#define __INCLUDE_ROUX_I3C_CCC_H
...
#define I3C_CCC_STATUS_ACTIVITY_MODE(status) (((status)&I3C_GENMASK(7, 6)) >> 6)
...
#endif /* __INCLUDE_ROUX_I3C_CCC_H */
