...
#ifndef __INCLUDE_ROUX_I3C_DEV_H
#define __INCLUDE_ROUX_I3C_DEV_H
...
#define I3C_DEVICE(_manufid, _partid, _drvdata)                                                    \
	{                                                                                              \
		.match_flags = I3C_MATCH_MANUF_AND_PART, .manuf_id = _manufid, .part_id = _partid,         \
		.data = _drvdata,                                                                          \
	}

#define I3C_DEVICE_EXTRA_INFO(_manufid, _partid, _info, _drvdata)                                  \
	{                                                                                              \
		.match_flags = I3C_MATCH_MANUF_AND_PART | I3C_MATCH_EXTRA_INFO, .manuf_id = _manufid,      \
		.part_id = _partid, .extra_info = _info, .data = _drvdata,                                 \
	}

#define I3C_CLASS(_dcr, _drvdata)                                                                  \
	{                                                                                              \
		.match_flags = I3C_MATCH_DCR, .dcr = _dcr,                                                 \
	}
...
struct i3c_ibi_setup {
	...
	CODE void (*handler)(FAR struct i3c_device *dev, FAR const struct i3c_ibi_payload *payload);
};
...
int i3c_device_do_priv_xfers(FAR const struct i3c_device *dev, FAR struct i3c_priv_xfer *xfers,
							 int nxfers);
...
void i3c_device_get_info(FAR const struct i3c_device *dev, FAR struct i3c_device_info *info);
...
int i3c_device_request_ibi(FAR const struct i3c_device *dev, FAR const struct i3c_ibi_setup *req);
...
FAR const struct i3c_device *i3c_master_find_i3c_dev(FAR struct i3c_master_controller *master,
...
int i3c_device_send_ccc_cmd(FAR const struct i3c_device *dev, FAR struct i3c_ccc_cmd *cmd);

#endif /* __INCLUDE_ROUX_I3C_DEV_H */
