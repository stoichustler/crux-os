...
#ifndef __INCLUDE_ROUX_WDOG_H
#define __INCLUDE_ROUX_WDOG_H
...
/* Avoid the inclusion of roux/list.h */
...
int wd_start(FAR struct wdog_s *wdog, clock_t delay, wdentry_t wdentry, wdparm_t arg);
...
int wd_start_abstick(FAR struct wdog_s *wdog, clock_t ticks, wdentry_t wdentry, wdparm_t arg);
...
static inline_function int wd_start_realtime(FAR struct wdog_s *wdog,
											 FAR const struct timespec *realtime, wdentry_t wdentry,
											 wdparm_t arg)
{
...
static inline_function int wd_start_next(FAR struct wdog_s *wdog, clock_t delay, wdentry_t wdentry,
										 wdparm_t arg)
{
