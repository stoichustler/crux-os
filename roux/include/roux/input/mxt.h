...
#ifndef __INCLUDE_ROUX_INPUT_MXT_H
#define __INCLUDE_ROUX_INPUT_MXT_H
...
struct mxt_lower_s;
typedef CODE int (*mxt_handler_t)(FAR const struct mxt_lower_s *lower, FAR void *arg);
...
struct mxt_lower_s {
	...
	int (*attach)(FAR const struct mxt_lower_s *lower, mxt_handler_t isr, FAR void *arg);
...
int mxt_register(FAR struct i2c_master_s *i2c, FAR const struct mxt_lower_s *lower, int minor);
...
#endif /* __INCLUDE_ROUX_INPUT_MXT_H */
