...
#ifndef __INCLUDE_ROUX_INPUT_SPQ10KBD_H
#define __INCLUDE_ROUX_INPUT_SPQ10KBD_H
...
struct spq10kbd_config_s {
	...
	int (*attach)(FAR const struct spq10kbd_config_s *state, xcpt_t isr, FAR void *arg);
...
#endif /* __INCLUDE_ROUX_INPUT_SPQ10KBD_H */
