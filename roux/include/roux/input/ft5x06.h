...
#ifndef __INCLUDE_ROUX_INPUT_FT5X06_H
#define __INCLUDE_ROUX_INPUT_FT5X06_H
...
struct ft5x06_config_s {
	...
	int (*attach)(FAR const struct ft5x06_config_s *config, xcpt_t isr, FAR void *arg);
	...
	void (*nreset)(FAR const struct ft5x06_config_s *config, bool state);
};
...
#endif /* __INCLUDE_ROUX_INPUT_FT5X06_H */
