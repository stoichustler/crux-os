...
#ifndef __INCLUDE_ROUX_INPUT_FF_H
#define __INCLUDE_ROUX_INPUT_FF_H
...
struct ff_lowerhalf_s {
	...
	CODE int (*upload)(FAR struct ff_lowerhalf_s *lower, FAR struct ff_effect *effect,
	...
	CODE int (*playback)(FAR struct ff_lowerhalf_s *lower, int effect_id, int value);
	...
	CODE void (*set_autocenter)(FAR struct ff_lowerhalf_s *lower, uint16_t magnitude);
	...
	CODE int (*set_calibvalue)(FAR struct ff_lowerhalf_s *lower, unsigned long arg);
	...
	CODE int (*calibrate)(FAR struct ff_lowerhalf_s *lower, unsigned long arg);
...
#endif /* __INCLUDE_ROUX_INPUT_FF_H */
