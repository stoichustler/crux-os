...
#ifndef __INCLUDE_ROUX_INPUT_GT9XX_H
#define __INCLUDE_ROUX_INPUT_GT9XX_H
...
struct gt9xx_board_s {
	...
	int (*irq_attach)(const struct gt9xx_board_s *state, xcpt_t isr, FAR void *arg);
...
int gt9xx_register(FAR const char *devpath, FAR struct i2c_master_s *dev, uint8_t i2c_devaddr,
				   const struct gt9xx_board_s *board_config);

#endif /* __INCLUDE_ROUX_INPUT_GT9XX_H */
