 ...
 *
 * This header file documents the generic interface that all ROUX discrete
 * joystick devices must conform.  It adds standards and conventions on top
 * of the standard character driver interface.
 */

#ifndef __INCLUDE_ROUX_INPUT_DJOYSTICK_H
#define __INCLUDE_ROUX_INPUT_DJOYSTICK_H
...
typedef CODE void (*djoy_interrupt_t)(FAR const struct djoy_lowerhalf_s *lower, FAR void *arg);
...
struct djoy_lowerhalf_s {
	...
	CODE void (*dl_enable)(FAR const struct djoy_lowerhalf_s *lower, djoy_buttonset_t press,
...
#endif /* __INCLUDE_ROUX_INPUT_DJOYSTICK_H */
