 ...
 *
 * This header file documents the generic interface that all ROUX analog
 * joystick devices must conform.  It adds standards and conventions on top
 * of the standard character driver interface.
 */

#ifndef __INCLUDE_ROUX_INPUT_AJOYSTICK_H
#define __INCLUDE_ROUX_INPUT_AJOYSTICK_H
 ...
 * structure (with no wheel) defined in include/roux/input/mouse.h and can
...
typedef CODE void (*ajoy_handler_t)(FAR const struct ajoy_lowerhalf_s *lower, FAR void *arg);
...
struct ajoy_lowerhalf_s {
	...
	CODE void (*al_enable)(FAR const struct ajoy_lowerhalf_s *lower, ajoy_buttonset_t press,
						   ajoy_buttonset_t release, ajoy_handler_t handler, FAR void *arg);
};
...
#endif /* __INCLUDE_ROUX_INPUT_AJOYSTICK_H */
