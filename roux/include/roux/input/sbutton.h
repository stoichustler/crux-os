...
#ifndef __INCLUDE_ROUX_INPUT_SBUTTON_H
#define __INCLUDE_ROUX_INPUT_SBUTTON_H
...
struct sbutton_config_s {
	...
	int (*attach)(FAR const struct sbutton_config_s *config, xcpt_t isr, FAR void *arg);
...
#endif /* __INCLUDE_ROUX_INPUT_SBUTTON_H */
