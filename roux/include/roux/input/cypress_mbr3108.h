...
#ifndef __INCLUDE_ROUX_INPUT_CYPRESS_MBR3108_H
#define __INCLUDE_ROUX_INPUT_CYPRESS_MBR3108_H
...
struct mbr3108_board_s {
	CODE int (*irq_attach)(FAR struct mbr3108_board_s *state, xcpt_t isr, FAR void *arg);
...
int cypress_mbr3108_register(FAR const char *devpath, FAR struct i2c_master_s *dev,
							 uint8_t i2c_devaddr, FAR struct mbr3108_board_s *board_config,
							 FAR const struct mbr3108_sensor_conf_s *sensor_conf);

#endif /* __INCLUDE_ROUX_INPUT_CYPRESS_MBR3108_H */
