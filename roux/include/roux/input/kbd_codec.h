...
#ifndef __INCLUDE_ROUX_INPUT_KBD_CODEC_H
#define __INCLUDE_ROUX_INPUT_KBD_CODEC_H
...
int kbd_decode(FAR struct lib_instream_s *stream, FAR struct kbd_getstate_s *state,
			   FAR uint8_t *pch);
...
#endif /* __INCLUDE_ROUX_INPUT_KBD_CODEC_H */
