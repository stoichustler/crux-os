...
#ifndef __INCLUDE_ROUX_INPUT_MOUSE_H
#define __INCLUDE_ROUX_INPUT_MOUSE_H
...
struct mouse_lowerhalf_s {
	...
	CODE int (*control)(FAR struct mouse_lowerhalf_s *lower, int cmd, unsigned long arg);
...
#endif /* __INCLUDE_ROUX_INPUT_MOUSE_H */
