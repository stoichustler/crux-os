...
#ifndef __INCLUDE_ROUX_WQUEUE_H
#define __INCLUDE_ROUX_WQUEUE_H
...
int work_queue_wq(FAR struct kwork_wqueue_s *wqueue, FAR struct work_s *work, worker_t worker,
...
int work_queue_next(int qid, FAR struct work_s *work, worker_t worker, FAR void *arg,
					clock_t delay);
int work_queue_next_wq(FAR struct kwork_wqueue_s *wqueue, FAR struct work_s *work, worker_t worker,
					   FAR void *arg, clock_t delay);
...
int work_cancel_wq(FAR struct kwork_wqueue_s *wqueue, FAR struct work_s *work);
...
int work_cancel_sync_wq(FAR struct kwork_wqueue_s *wqueue, FAR struct work_s *work);
