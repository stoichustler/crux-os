...
#ifndef __INCLUDE_ROUX_SDIO_H
#define __INCLUDE_ROUX_SDIO_H
...
#define MMCSD_CMDIDX0                                                                              \
	0 /* GO_IDLE_STATE: Resets all cards to idle state                                             \
	   * -Broadcast, no response */
#define MMC_CMDIDX1                                                                                \
	1 /* SEND_OP_COND: Sends capacity support information                                          \
	   * -Broadcast, R3 response, 31:0=OCR */
#define MMCSD_CMDIDX2                                                                              \
	2 /* ALL_SEND_CID                                                                              \
...
#define MMCSD_CMDIDX7                                                                              \
	7				  /* SELECT/DESELECT CARD                                                      \
					   * -Addressed Command, R1 response 31:16=RCA */
#define MMC_CMDIDX8 8 /* SEND_EXT_CSD: get extended CSD register 512 bytes R1 response */
#define SD_CMDIDX8                                                                                 \
	8 /* SEND_IF_COND: Sends SD Memory Card interface condition                                    \
	   * R7 response */
#define MMCSD_CMDIDX9                                                                              \
	9 /* SEND_CSD: Asks card to send its card specific data (CSD)                                  \
	   * -Addressed Command, R2 response 31:16=RCA */
#define MMCSD_CMDIDX10                                                                             \
	10 /* SEND_CID: Asks card to send its card identification (CID)                                \
		* -Addressed Command, R2 response 31:16=RCA */
#define MMC_CMDIDX11                                                                               \
...
#define MMCSD_CMDIDX12                                                                             \
	12 /* STOP_TRANSMISSION: Forces the card to stop transmission                                  \
		* -Addressed Command, R1b response */
#define MMCSD_CMDIDX13                                                                             \
	13					  /* SEND_STATUS: Asks card to send its status register                    \
						   * -Addressed Command, R1 response 31:16=RCA */
#define MMCSD_CMDIDX14 14 /* HS_BUSTEST_READ: */
#define MMCSD_CMDIDX15                                                                             \
	15 /* GO_INACTIVE_STATE                                                                        \
		* Addressed Command, no response 31:16=RCA */
#define MMCSD_CMDIDX16                                                                             \
	16 /* SET_BLOCKLEN: Sets a block length (in bytes)                                             \
		* -Addressed Command, R1 response 31:0=BLEN */
#define MMCSD_CMDIDX17                                                                             \
	17 /* READ_SINGLE_BLOCK: Reads a block of the selected size                                    \
		* -Addressed data transfer command, R1 response 31:0=DADR */
#define MMCSD_CMDIDX18                                                                             \
	18					/* READ_MULTIPLE_BLOCK: Continuously transfers blocks from card to host    \
						 * -Addressed data transfer command, R1 response 31:0=DADR */
...
#define MMC_CMDIDX20                                                                               \
	20 /* WRITE_DAT_UNTIL_STOP: (MMC)                                                              \
		* -Addressed data transfer command, R1 response 31:0=DADR */
#define SD_CMDIDX20                                                                                \
	20 /* SPEED_CLASS_CONTROL: (SD)                                                                \
		* -Addressed command, R1b response */
#define MMC_CMDIDX21                                                                               \
	21 /* SEND_TUNING_BLOCK: (MMC)                                                                 \
		* -Addressed data transfer command, R1 response */
#define SD_CMDIDX22                                                                                \
	22 /* ADDRESS_EXTENSION: (SD)                                                                  \
		* -Addressed command, R1 response */
#define MMCSD_CMDIDX23                                                                             \
	23 /* SET_BLOCK_COUNT: Sets the block count for read/write                                     \
		* -Addressed command, R1 response 31:0=BCNT */
#define MMCSD_CMDIDX24                                                                             \
	24 /* WRITE_BLOCK: Writes a block of the selected size                                         \
		* -Addressed data transfer command, R1 response 31:0=DADR */
#define MMCSD_CMDIDX25                                                                             \
	25 /* WRITE_MULTIPLE_BLOCK: Continuously writes blocks of data                                 \
		* -Addressed data transfer command, R1 response 31:0=DADR */
#define MMCSD_CMDIDX26                                                                             \
	26 /* PROGRAM_CID: (Manufacturers only)                                                        \
		* -Addressed data transfer command, R1 response */
#define MMCSD_CMDIDX27                                                                             \
	27 /* PROGRAM_CSD: Set programmable bits of the CSD                                            \
		* -Addressed data transfer command, R1 response */
#define MMCSD_CMDIDX28                                                                             \
	28 /* SET_WRITE_PROT: Sets the write protection bit of group                                   \
		* -Addressed Command, R1b response 31:0=DADR */
#define MMCSD_CMDIDX29                                                                             \
	29 /* CLR_WRITE_PROT: Clears the write protection bit of group                                 \
		* -Addressed Command, R1b response 31:0=DADR */
#define MMCSD_CMDIDX30                                                                             \
	30 /* SEND_WRITE_PROT: Asks card to send state of write protection bits                        \
		* -Addressed data transfer command, R1 response 31:0=WADR */
#define MMC_CMDIDX31                                                                               \
	31 /* SEND_WRITE_PROT_TYPE: Asks card to send state of write protection type bits              \
		* -Addressed data transfer command, R1 response 31:0=WADR */
#define SD_CMDIDX32                                                                                \
	32 /* ERASE_GRP_START: Sets address of first block to erase (SD)                               \
		* -Addressed Command, R1 response 31:0=DADR */
#define SD_CMDIDX33                                                                                \
	33 /* ERASE_GRP_END: Sets address of last block to erase (SD)                                  \
		* -Addressed Command, R1 response 31:0=DADR */
#define MMC_CMDIDX34                                                                               \
	34 /* UNTAG_SECTOR: (MMC)                                                                      \
		* -Addressed Command, R1 response 31:0=DADR */
#define MMC_CMDIDX35                                                                               \
	35 /* TAG_ERASE_GROUP_START: Sets address of first block to erase (MMC)                        \
		* -Addressed Command, R1 response 31:0=DADR */
#define MMC_CMDIDX36                                                                               \
	36 /* TAG_ERASE_GROUP_END: Sets address of last block to erase (MMC)                           \
		* -Addressed Command, R1 response 31:0=DADR */
#define MMC_CMDIDX37                                                                               \
	37 /* UNTAG_ERASE_GROUP: (MMC)                                                                 \
		* -Addressed Command, R1 response 31:0=DADR */
#define MMCSD_CMDIDX38                                                                             \
	38 /* ERASE: Erases all previously selected write blocks                                       \
		* -Addressed Command, R1b response */
#define MMC_CMDIDX39                                                                               \
	39 /* FAST_IO: (MMC)                                                                           \
...
#define SD_CMDIDX40                                                                                \
	40 /* DPS: (SD)                                                                                \
		* -Addressed data transfer command, R1 response */
#define MMCSD_CMDIDX42                                                                             \
	42 /* LOCK_UNLOCK: Used to Set/Reset the Password or lock/unlock card                          \
		* -Addressed data transfer command, R1 response */
#define MMC_CMDIDX44                                                                               \
	44 /* QUEUED_TASK_PARAMS: (MMC)                                                                \
		* -Addressed Command, R1 response */
#define MMC_CMDIDX45                                                                               \
	45 /* QUEUED_TASK_ADDRESS: (MMC)                                                               \
		* -Addressed Command, R1 response */
#define MMC_CMDIDX46                                                                               \
	46 /* EXECUTE_READ_TASK: (MMC)                                                                 \
		* -Addressed data transfer command, R1 response */
#define MMC_CMDIDX47                                                                               \
	47 /* EXECUTE_WRITE_TASK: (MMC)                                                                \
		* -Addressed data transfer command, R1 response */
#define MMC_CMDIDX48                                                                               \
	48 /* CMDQ_TASK_MGMT: (MMC)                                                                    \
		* -Addressed Command, R1b response */
#define MMC_CMDIDX49                                                                               \
	49 /* SET_TIME: (MMC)                                                                          \
		* -Addressed data transfer command, R1 response */
#define SDIO_CMDIDX52                                                                              \
	52 /* IO_RW_DIRECT: (SDIO)                                                                     \
		* -Addressed command, R5 response */
#define MMC_CMDIDX53                                                                               \
	53 /* PROTOCOL_RD: (MMC)                                                                       \
		* -Addressed data transfer command, R1 response */
#define SDIO_CMDIDX53                                                                              \
	53 /* IO_RW_EXTENDED: (SDIO)                                                                   \
		* -Addressed data transfer command, R5 response */
#define MMC_CMDIDX54                                                                               \
	54 /* PROTOCOL_WR: (MMC)                                                                       \
		* -Addressed data transfer command, R1 response */
#define SD_CMDIDX55                                                                                \
	55 /* APP_CMD: Tells card that the next command is an application specific command             \
		* - Addressed Command, R1 response 31:16=RCA */
#define MMCSD_CMDIDX56                                                                             \
	56 /* GEN_CMD: Used transfer a block to or get block from card                                 \
		* -Addressed data transfer command, R1 Response */
...
#define SD_ACMDIDX13                                                                               \
	13					/* SD_STATUS: Send the SD Status                                           \
						 * -Addressed data transfer command, R1 response */
#define SD_ACMDIDX18 18 /* SECURE_READ_MULTIPLE_BLOCK: */
#define SD_ACMDIDX22                                                                               \
	22 /* SEND_NUM_WR_BLOCKS: Send number of the errorfree blocks                                  \
		* -Addressed data transfer command, R1 response */
#define SD_ACMDIDX23                                                                               \
	23					/* SET_WR_BLK_ERASE_COUNT: Set number blocks to erase before writing       \
...
#define SD_ACMDIDX41                                                                               \
	41 /* SD_SEND_OP_COND: Sends host capacity support information                                 \
		* -Broadcast command, R3 response 31:0=OCR */
#define SD_ACMDIDX42                                                                               \
	42					/* SET_CLR_CARD_DETECT: Connect/disconnect pull-up resistor on CS          \
...
#define SD_ACMDIDX51                                                                               \
	51 /* SEND_SCR: Reads the SD Configuration Register (SCR)                                      \
		* Addressed data transfer command, R1 response */
#define SD_ACMDIDX52                                                                               \
...
#define MMCSD_CMD7D                                                                                \
	(MMCSD_CMDIDX7 | MMCSD_NO_RESPONSE | MMCSD_NODATAXFR) /* No response when de-selecting card */
...
#define SDIO_GOTEXTCSD(dev, buffer) ((dev)->gotextcsd ? (dev)->gotextcsd(dev, buffer) : OK)
...
/* This structure defines the interface between the ROUX SDIO driver and
 ...
 * support this interface is registered with the ROUX SDIO driver by
...
struct sdio_dev_s {
	...
	CODE int (*sendcmd)(FAR struct sdio_dev_s *dev, uint32_t cmd, uint32_t arg);
#ifdef CONFIG_SDIO_BLOCKSETUP
	CODE void (*blocksetup)(FAR struct sdio_dev_s *dev, unsigned int blocklen,
							unsigned int nblocks);
#endif
	CODE int (*recvsetup)(FAR struct sdio_dev_s *dev, FAR uint8_t *buffer, size_t nbytes);
	CODE int (*sendsetup)(FAR struct sdio_dev_s *dev, FAR const uint8_t *buffer, size_t nbytes);
	CODE int (*cancel)(FAR struct sdio_dev_s *dev);

	CODE int (*waitresponse)(FAR struct sdio_dev_s *dev, uint32_t cmd);
	CODE int (*recv_r1)(FAR struct sdio_dev_s *dev, uint32_t cmd, FAR uint32_t *R1);
	CODE int (*recv_r2)(FAR struct sdio_dev_s *dev, uint32_t cmd, FAR uint32_t R2[4]);
	CODE int (*recv_r3)(FAR struct sdio_dev_s *dev, uint32_t cmd, FAR uint32_t *R3);
	CODE int (*recv_r4)(FAR struct sdio_dev_s *dev, uint32_t cmd, FAR uint32_t *R4);
	CODE int (*recv_r5)(FAR struct sdio_dev_s *dev, uint32_t cmd, FAR uint32_t *R5);
	CODE int (*recv_r6)(FAR struct sdio_dev_s *dev, uint32_t cmd, FAR uint32_t *R6);
	CODE int (*recv_r7)(FAR struct sdio_dev_s *dev, uint32_t cmd, FAR uint32_t *R7);

	/* Event/Callback support */

	CODE void (*waitenable)(FAR struct sdio_dev_s *dev, sdio_eventset_t eventset, uint32_t timeout);
	CODE sdio_eventset_t (*eventwait)(FAR struct sdio_dev_s *dev);
	CODE void (*callbackenable)(FAR struct sdio_dev_s *dev, sdio_eventset_t eventset);

#if defined(CONFIG_SCHED_WORKQUEUE) && defined(CONFIG_SCHED_HPWORK)
	CODE int (*registercallback)(FAR struct sdio_dev_s *dev, worker_t callback, FAR void *arg);
#endif
	...
	CODE int (*dmapreflight)(FAR struct sdio_dev_s *dev, FAR const uint8_t *buffer, size_t buflen);
#endif
	CODE int (*dmarecvsetup)(FAR struct sdio_dev_s *dev, FAR uint8_t *buffer, size_t buflen);
	CODE int (*dmasendsetup)(FAR struct sdio_dev_s *dev, FAR const uint8_t *buffer, size_t buflen);
#endif /* CONFIG_SDIO_DMA */
	CODE void (*gotextcsd)(FAR struct sdio_dev_s *dev, FAR const uint8_t *buffer);
};
...
int sdio_set_blocksize(FAR struct sdio_dev_s *dev, uint8_t function, uint16_t blocksize);
...
int sdio_io_rw_direct(FAR struct sdio_dev_s *dev, bool write, uint8_t function, uint32_t address,
					  uint8_t inb, FAR uint8_t *outb);

int sdio_io_rw_extended(FAR struct sdio_dev_s *dev, bool write, uint8_t function, uint32_t address,
						bool inc_addr, FAR uint8_t *buf, unsigned int blocklen,
						unsigned int nblocks);
