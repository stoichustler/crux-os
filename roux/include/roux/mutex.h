...
#ifndef __INCLUDE_ROUX_MUTEX_H
#define __INCLUDE_ROUX_MUTEX_H
...
int nxmutex_clocklock(FAR mutex_t *mutex, clockid_t clockid, FAR const struct timespec *abstime);
...
int nxrmutex_clocklock(FAR rmutex_t *rmutex, clockid_t clockid, FAR const struct timespec *abstime);
...
#define nxrmutex_set_protocol(rmutex, protocol) nxmutex_set_protocol(&(rmutex)->mutex, protocol)
...
static inline_function int nxmutex_breaklock(FAR mutex_t *mutex, FAR unsigned int *locked)
{
	int ret = OK;
...
static inline_function int nxmutex_restorelock(FAR mutex_t *mutex, unsigned int locked)
{
...
static inline_function int nxmutex_set_protocol(FAR mutex_t *mutex, int protocol)
{
...
static inline_function int nxmutex_getprioceiling(FAR const mutex_t *mutex, FAR int *prioceiling)
{
...
#ifdef CONFIG_PRIORITY_PROTECT
static inline_function int nxmutex_setprioceiling(FAR mutex_t *mutex, int prioceiling,
												  FAR int *old_ceiling)
{
