...
#ifndef __INCLUDE_ROUX_STREAMS_H
#define __INCLUDE_ROUX_STREAMS_H
...
#define lib_stream_putc(stream, ch)                                                                \
	((FAR struct lib_outstream_s *)(stream))->putc((FAR struct lib_outstream_s *)(stream), ch)
...
#define lib_stream_getc(stream)                                                                    \
	((FAR struct lib_instream_s *)(stream))->getc((FAR struct lib_instream_s *)(stream))
#define lib_stream_gets(stream, buf, len)                                                          \
	((FAR struct lib_instream_s *)(stream))->gets((FAR struct lib_instream_s *)(stream), buf, len)
#define lib_stream_flush(stream)                                                                   \
	((FAR struct lib_outstream_s *)(stream))->flush((FAR struct lib_outstream_s *)(stream))
#define lib_stream_seek(stream, offset, whence)                                                    \
	((FAR struct lib_sostream_s *)(stream))                                                        \
		->seek((FAR struct lib_sostream_s *)(stream), offset, whence)
...
/* These are the generic representations of a streams used by the ROUX */

struct lib_instream_s;
typedef CODE int (*lib_getc_t)(FAR struct lib_instream_s *self);
typedef CODE ssize_t (*lib_gets_t)(FAR struct lib_instream_s *self, FAR void *buf, size_t len);

struct lib_outstream_s;
typedef CODE void (*lib_putc_t)(FAR struct lib_outstream_s *self, int ch);
typedef CODE ssize_t (*lib_puts_t)(FAR struct lib_outstream_s *self, FAR const void *buf,
								   size_t len);
...
typedef CODE ssize_t (*lib_sigets_t)(FAR struct lib_sistream_s *self, FAR void *buf, size_t len);
typedef CODE off_t (*lib_siseek_t)(FAR struct lib_sistream_s *self, off_t offset, int whence);

struct lib_sostream_s;
typedef CODE void (*lib_soputc_t)(FAR struct lib_sostream_s *self, int ch);
typedef CODE ssize_t (*lib_soputs_t)(FAR struct lib_sostream_s *self, FAR const void *buf,
									 size_t len);
typedef CODE int (*lib_soflush_t)(FAR struct lib_sostream_s *self);
typedef CODE off_t (*lib_soseek_t)(FAR struct lib_sostream_s *self, off_t offset, int whence);
...
void lib_meminstream(FAR struct lib_meminstream_s *stream, FAR const char *bufstart, size_t buflen);
void lib_memoutstream(FAR struct lib_memoutstream_s *stream, FAR char *bufstart, size_t buflen);
void lib_memsistream(FAR struct lib_memsistream_s *stream, FAR const char *bufstart, size_t buflen);
void lib_memsostream(FAR struct lib_memsostream_s *stream, FAR char *bufstart, size_t buflen);
...
void lib_stdinstream(FAR struct lib_stdinstream_s *stream, FAR FILE *handle);
void lib_stdoutstream(FAR struct lib_stdoutstream_s *stream, FAR FILE *handle);
void lib_stdsistream(FAR struct lib_stdsistream_s *stream, FAR FILE *handle);
void lib_stdsostream(FAR struct lib_stdsostream_s *stream, FAR FILE *handle);
...
int lib_fileinstream_open(FAR struct lib_fileinstream_s *stream, FAR const char *path, int oflag,
						  mode_t mode);
void lib_fileinstream_close(FAR struct lib_fileinstream_s *stream);
int lib_fileoutstream_open(FAR struct lib_fileoutstream_s *stream, FAR const char *path, int oflag,
						   mode_t mode);
...
void lib_hexdumpstream(FAR struct lib_hexdumpstream_s *stream, FAR struct lib_outstream_s *backend);
...
#ifdef CONFIG_LIBC_LZF
void lib_lzfoutstream(FAR struct lib_lzfoutstream_s *stream, FAR struct lib_outstream_s *backend);
#endif
...
#ifndef CONFIG_DISABLE_MOUNTPOINT
int lib_blkoutstream_open(FAR struct lib_blkoutstream_s *stream, FAR const char *name);
#endif
...
#if !defined(CONFIG_DISABLE_MOUNTPOINT) && defined(CONFIG_MTD)
int lib_mtdoutstream_open(FAR struct lib_mtdoutstream_s *stream, FAR const char *name);
#endif
...
#if !defined(CONFIG_DISABLE_MOUNTPOINT) && defined(CONFIG_MTD)
int lib_mtdsostream_open(FAR struct lib_mtdsostream_s *stream, FAR const char *name);
#endif
...
int lib_bsprintf(FAR struct lib_outstream_s *s, FAR const IPTR char *fmt, FAR const void *buf);
...
int lib_sprintf_internal(FAR struct lib_outstream_s *stream, FAR const IPTR char *fmt, ...)
	printf_like(2, 3);
...
int lib_vsprintf_internal(FAR struct lib_outstream_s *stream, FAR const IPTR char *fmt, va_list ap)
	printf_like(2, 0);
...
int lib_vsprintf(FAR struct lib_outstream_s *stream, FAR const IPTR char *src, va_list ap)
	printf_like(2, 0);
...
int lib_scanf(FAR struct lib_instream_s *stream, FAR int *lastc, FAR const IPTR char *fmt, ...)
	scanf_like(3, 4);
...
int lib_vscanf(FAR struct lib_instream_s *stream, FAR int *lastc, FAR const IPTR char *fmt,
			   va_list ap) scanf_like(3, 0);
...
int lib_bscanf(FAR struct lib_instream_s *stream, FAR int *lastc, FAR const IPTR char *fmt,
			   FAR void *data);
...
#endif /* __INCLUDE_ROUX_STREAMS_H */
