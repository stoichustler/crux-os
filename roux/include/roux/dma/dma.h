...
#ifndef __INCLUDE_ROUX_DMA_DMA_H
#define __INCLUDE_ROUX_DMA_DMA_H
...
struct dma_chan_s;
typedef CODE void (*dma_callback_t)(FAR struct dma_chan_s *chan, FAR void *arg, ssize_t len);
...
struct dma_ops_s {
	CODE int (*config)(FAR struct dma_chan_s *chan, FAR const struct dma_config_s *cfg);
	CODE int (*start)(FAR struct dma_chan_s *chan, dma_callback_t callback, FAR void *arg,
					  uintptr_t dst, uintptr_t src, size_t len);
	CODE int (*start_cyclic)(FAR struct dma_chan_s *chan, dma_callback_t callback, FAR void *arg,
							 uintptr_t dst, uintptr_t src, size_t len, size_t period_len);
#ifdef CONFIG_DMA_LINK
	CODE int (*start_link)(FAR struct dma_chan_s *chan, dma_callback_t callback, FAR void *arg,
						   unsigned int work_mode, FAR struct dma_link_config_s *cfg);
#endif
...
struct dma_dev_s {
	CODE FAR struct dma_chan_s *(*get_chan)(FAR struct dma_dev_s *dev, unsigned int ident);
	CODE void (*put_chan)(FAR struct dma_dev_s *dev, FAR struct dma_chan_s *chan);
};

#endif /* __INCLUDE_ROUX_DMA_DMA_H */
