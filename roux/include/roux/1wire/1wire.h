...
#ifndef __INCLUDE_ROUX_1WIRE_1WIRE_H
#define __INCLUDE_ROUX_1WIRE_1WIRE_H
...
struct onewire_ops_s {
	...
	CODE int (*write)(FAR struct onewire_dev_s *dev, FAR const uint8_t *buffer, int buflen);
	CODE int (*read)(FAR struct onewire_dev_s *dev, FAR uint8_t *buffer, int buflen);
	CODE int (*exchange)(FAR struct onewire_dev_s *dev, bool reset, FAR const uint8_t *txbuffer,
						 int txbuflen, FAR uint8_t *rxbuffer, int rxbuflen);
	CODE int (*writebit)(FAR struct onewire_dev_s *dev, FAR const uint8_t *bit);
...
#endif /* __INCLUDE_ROUX_1WIRE_1WIRE_H */
