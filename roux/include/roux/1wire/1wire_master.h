...
#ifndef __INCLUDE_ROUX_1WIRE_1WIRE_MASTER_H
#define __INCLUDE_ROUX_1WIRE_1WIRE_MASTER_H
...
int onewire_write(FAR struct onewire_master_s *master, FAR const struct onewire_config_s *config,
...
int onewire_read(FAR struct onewire_master_s *master, FAR const struct onewire_config_s *config,
...
int onewire_writeread(FAR struct onewire_master_s *master,
					  FAR const struct onewire_config_s *config, FAR const uint8_t *wbuffer,
...
int onewire_search(FAR struct onewire_master_s *master, int family, bool alarmonly,
...
int onewire_isalarm(FAR struct onewire_master_s *master, FAR const struct onewire_config_s *config);
...
FAR struct onewire_master_s *onewire_initialize(FAR struct onewire_dev_s *dev, int maxslaves);
...
#endif /* __INCLUDE_ROUX_1WIRE_1WIRE_MASTER_H */
