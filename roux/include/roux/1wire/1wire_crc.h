...
#ifndef __INCLUDE_ROUX_1WIRE_1WIRE_CRC_H
#define __INCLUDE_ROUX_1WIRE_1WIRE_CRC_H
...
uint16_t onewire_crc16(FAR const uint8_t *input, uint16_t len, uint16_t initial_crc);
...
bool onewire_check_crc16(FAR const uint8_t *input, uint16_t len, FAR const uint8_t *inverted_crc);

#endif /* __INCLUDE_ROUX_1WIRE_1WIRE_CRC_H */
