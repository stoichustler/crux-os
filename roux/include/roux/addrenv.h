...
#ifndef __INCLUDE_ROUX_ADDRENV_H
#define __INCLUDE_ROUX_ADDRENV_H
...
#define CONFIG_ARCH_PGPOOL_PEND (CONFIG_ARCH_PGPOOL_PBASE + CONFIG_ARCH_PGPOOL_SIZE)
#define CONFIG_ARCH_PGPOOL_VEND (CONFIG_ARCH_PGPOOL_VBASE + CONFIG_ARCH_PGPOOL_SIZE)
...
typedef CODE void (*addrenv_sigtramp_t)(_sa_sigaction_t sighand, int signo, FAR siginfo_t *info,
										FAR void *ucontext);
...
#define ARCH_DATA_RESERVE ((FAR struct addrenv_reserve_s *)CONFIG_ARCH_DATA_VBASE)
#endif
...
int addrenv_select(FAR struct addrenv_s *addrenv, FAR struct addrenv_s **oldenv);
...
/* Prototyped in include/roux/arch.h as part of the OS/platform interface */

#endif /* __ASSEMBLY__ */
#endif /* CONFIG_ARCH_ADDRENV */
#endif /* __INCLUDE_ROUX_ADDRENV_H */
