...
#ifndef __INCLUDE_ROUX_NOTIFIER_H
#define __INCLUDE_ROUX_NOTIFIER_H
...
typedef CODE int (*notifier_fn_t)(FAR struct notifier_block *nb, unsigned long action,
								  FAR void *data);
...
#endif /* __INCLUDE_ROUX_NOTIFIER_H */
