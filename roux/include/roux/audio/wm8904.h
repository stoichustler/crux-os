...
#ifndef __INCLUDE_ROUX_AUDIO_WM8904_H
#define __INCLUDE_ROUX_AUDIO_WM8904_H
...
typedef CODE int (*wm8904_handler_t)(FAR const struct wm8904_lower_s *lower, FAR void *arg);
...
struct wm8904_lower_s {
	...
	CODE int (*attach)(FAR const struct wm8904_lower_s *lower, wm8904_handler_t isr, FAR void *arg);
...
struct i2c_master_s;	  /* Forward reference. Defined in include/roux/i2c/i2c_master.h */
struct i2s_dev_s;		  /* Forward reference. Defined in include/roux/audio/i2s.h */
struct audio_lowerhalf_s; /* Forward reference. Defined in roux/audio/audio.h */
...
void wm8904_dump_registers(FAR struct audio_lowerhalf_s *dev, FAR const char *msg);
#else
...
void wm8904_clock_analysis(FAR struct audio_lowerhalf_s *dev, FAR const char *msg);
#else
/* This eliminates the need for any conditional compilation in the
 * including file.
 */
...
#endif /* __INCLUDE_ROUX_AUDIO_WM8904_H */
