...
#ifndef __INCLUDE_ROUX_AUDIO_I2S_H
#define __INCLUDE_ROUX_AUDIO_I2S_H
...
#define I2S_GETMCLKFREQUENCY(d)                                                                    \
	((d)->ops->i2s_getmclkfrequency ? (d)->ops->i2s_getmclkfrequency(d) : -ENOTTY)
...
#define I2S_SETMCLKFREQUENCY(d, f)                                                                 \
	((d)->ops->i2s_setmclkfrequency ? (d)->ops->i2s_setmclkfrequency(d, f) : -ENOTTY)
...
struct i2s_dev_s;
typedef CODE void (*i2s_callback_t)(FAR struct i2s_dev_s *dev, FAR struct ap_buffer_s *apb,
...
struct i2s_ops_s {
	...
	CODE int (*i2s_receive)(FAR struct i2s_dev_s *dev, FAR struct ap_buffer_s *apb,
							i2s_callback_t callback, FAR void *arg, uint32_t timeout);
	...
	CODE int (*i2s_send)(FAR struct i2s_dev_s *dev, FAR struct ap_buffer_s *apb,
						 i2s_callback_t callback, FAR void *arg, uint32_t timeout);

	/* Master Clock methods */

	CODE uint32_t (*i2s_getmclkfrequency)(FAR struct i2s_dev_s *dev);
	CODE uint32_t (*i2s_setmclkfrequency)(FAR struct i2s_dev_s *dev, uint32_t frequency);

	/* Ioctl */

	CODE int (*i2s_ioctl)(FAR struct i2s_dev_s *dev, int cmd, unsigned long arg);
};
...
#endif /* CONFIG_I2S */
#endif /* __INCLUDE_ROUX_AUDIO_I2S_H */
