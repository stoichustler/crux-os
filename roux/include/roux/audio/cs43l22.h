...
#ifndef __INCLUDE_ROUX_AUDIO_CS43L22_H
#define __INCLUDE_ROUX_AUDIO_CS43L22_H
...
typedef CODE int (*cs43l22_handler_t)(FAR const struct cs43l22_lower_s *lower, FAR void *arg);
...
struct cs43l22_lower_s {
	...
	CODE int (*attach)(FAR const struct cs43l22_lower_s *lower, cs43l22_handler_t isr,
					   FAR void *arg);
...
void cs43l22_dump_registers(FAR struct audio_lowerhalf_s *dev, FAR const char *msg);
#else
...
void cs43l22_clock_analysis(FAR struct audio_lowerhalf_s *dev, FAR const char *msg);
#else
/* This eliminates the need for any conditional compilation in the
 * including file.
 */
...
#endif /* __INCLUDE_ROUX_AUDIO_CS43L22_H */
