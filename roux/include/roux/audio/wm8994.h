...
#ifndef __INCLUDE_ROUX_AUDIO_WM8994_H
#define __INCLUDE_ROUX_AUDIO_WM8994_H
...
typedef CODE int (*wm8994_handler_t)(FAR const struct wm8994_lower_s *lower, FAR void *arg);
...
struct wm8994_lower_s {
	...
	CODE int (*attach)(FAR const struct wm8994_lower_s *lower, wm8994_handler_t isr, FAR void *arg);
...
void wm8994_dump_registers(FAR struct audio_lowerhalf_s *dev, FAR const char *msg);
#else
...
void wm8994_clock_analysis(FAR struct audio_lowerhalf_s *dev, FAR const char *msg);
#else
/* This eliminates the need for any conditional compilation in the
 * including file.
 */
...
#endif /* __INCLUDE_ROUX_AUDIO_WM8994_H */
