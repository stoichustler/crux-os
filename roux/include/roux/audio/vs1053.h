...
#ifndef __INCLUDE_ROUX_AUDIO_VS1053_H
#define __INCLUDE_ROUX_AUDIO_VS1053_H
...
struct vs1053_lower_s {
	int (*attach)(FAR const struct vs1053_lower_s *lower, xcpt_t handler, FAR void *arg);
...
struct audio_lowerhalf_s; /* See roux/audio/audio.h */
...
#endif /* __INCLUDE_ROUX_AUDIO_VS1053_H */
