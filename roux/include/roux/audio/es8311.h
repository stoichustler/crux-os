...
#ifndef __INCLUDE_ROUX_AUDIO_ES8311_H
#define __INCLUDE_ROUX_AUDIO_ES8311_H
...
void es8311_dump_registers(FAR struct audio_lowerhalf_s *dev, FAR const char *msg);
#else
...
#endif /* __INCLUDE_ROUX_AUDIO_ES8311_H */
