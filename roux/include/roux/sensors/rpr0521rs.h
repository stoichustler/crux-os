/****************************************************************************
 * include/roux/sensors/rpr0521rs.h
 *
...
#ifndef __INCLUDE_ROUX_SENSORS_RPR0521RS_H
#define __INCLUDE_ROUX_SENSORS_RPR0521RS_H
...
#include <roux/config.h>
	...
	(defined(CONFIG_SENSORS_RPR0521RS) || defined(CONFIG_SENSORS_RPR0521RS_SCU))
...
int rpr0521rsals_register(FAR const char *devpath, int minor, FAR struct i2c_master_s *i2c,
						  int port);
...
int rpr0521rsps_register(FAR const char *devpath, int minor, FAR struct i2c_master_s *i2c,
						 int port);
...
#endif /* __INCLUDE_ROUX_SENSORS_RPR0521RS_H */
