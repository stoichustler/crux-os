...
#ifndef __INCLUDE_ROUX_SENSORS_LSM303AGR_H
#define __INCLUDE_ROUX_SENSORS_LSM303AGR_H
...
struct lsm303agr_ops_s {
	...
	CODE int (*selftest)(FAR struct lsm303agr_dev_s *priv, uint32_t mode);
};
...
#endif /* __INCLUDE_ROUX_SENSORS_LSM303AGR_H */
