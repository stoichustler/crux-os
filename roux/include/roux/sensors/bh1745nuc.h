/****************************************************************************
 * include/roux/sensors/bh1745nuc.h
 *
...
#ifndef __INCLUDE_ROUX_SENSORS_BH1745NUC_H
#define __INCLUDE_ROUX_SENSORS_BH1745NUC_H
...
#include <roux/config.h>
	...
	(defined(CONFIG_SENSORS_BH1745NUC) || defined(CONFIG_SENSORS_BH1745NUC_SCU))
...
int bh1745nuc_register(FAR const char *devpath, int minor, FAR struct i2c_master_s *i2c, int port);
...
#endif /* __INCLUDE_ROUX_SENSORS_BH1745NUC_H */
