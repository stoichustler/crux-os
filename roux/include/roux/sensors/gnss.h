...
#ifndef __INCLUDE_ROUX_SENSORS_GNSS_H
#define __INCLUDE_ROUX_SENSORS_GNSS_H
...
struct gnss_ops_s {
	...
	CODE int (*activate)(FAR struct gnss_lowerhalf_s *lower, FAR struct file *filep, bool enable);
	...
	CODE int (*set_interval)(FAR struct gnss_lowerhalf_s *lower, FAR struct file *filep,
	...
	CODE int (*control)(FAR struct gnss_lowerhalf_s *lower, FAR struct file *filep, int cmd,
						unsigned long arg);
	...
	CODE ssize_t (*inject_data)(FAR struct gnss_lowerhalf_s *lower, FAR struct file *filep,
...
typedef CODE void (*gnss_push_data_t)(FAR void *priv, FAR const void *data, size_t bytes,
									  bool is_nmea);

typedef CODE void (*gnss_push_event_t)(FAR void *priv, FAR const void *data, size_t bytes,
									   int type);
...
int gnss_register(FAR struct gnss_lowerhalf_s *dev, int devno, uint32_t nbuffer[], size_t count);
...
#endif /* __INCLUDE_ROUX_SENSORS_GNSS_H */
