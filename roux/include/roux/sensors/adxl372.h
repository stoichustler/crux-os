...
#ifndef __INCLUDE_ROUX_SENSORS_ADXL372_H
#define __INCLUDE_ROUX_SENSORS_ADXL372_H
 ...
 * The driver will register itself with ROUX under the /dev path that is
...
struct adxl372_dvr_entry_vector_s {
	...
	CODE void (*driver_spiexc)(FAR void *instance_handle, FAR const void *txbuffer,
...
#endif /* __INCLUDE_ROUX_SENSORS_ADXL372_H */
