/****************************************************************************
 * include/roux/sensors/lt1pa01.h
 *
...
#ifndef __INCLUDE_ROUX_SENSORS_LT1PA01_H
#define __INCLUDE_ROUX_SENSORS_LT1PA01_H
...
int lt1pa01als_register(FAR const char *devpath, int minor, FAR struct i2c_master_s *i2c, int port);
...
int lt1pa01prox_register(FAR const char *devpath, int minor, FAR struct i2c_master_s *i2c,
						 int port);
...
#endif /* __INCLUDE_ROUX_SENSORS_LT1PA01_H */
