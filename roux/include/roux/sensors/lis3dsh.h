...
#ifndef __INCLUDE_ROUX_SENSORS_LIS3DSH_H
#define __INCLUDE_ROUX_SENSORS_LIS3DSH_H
...
#define LIS3DSH_CTRL_REG_6_BOOT_BM                                                                 \
	(1 << 7) /* Force reboot, cleared as soon as the reboot is finished. Active high */
...
#define LIS3DSH_CTRL_REG_6_ADD_INC_BM                                                              \
	(1 << 4) /* Register address automatically incremented during a multiple byte access with a    \
		serial interface */
...
#endif /* __INCLUDE_ROUX_SENSORS_LIS3DSH_H */
