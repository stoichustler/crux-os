...
#ifndef __INCLUDE_ROUX_SENSORS_ZEROCROSS_H
#define __INCLUDE_ROUX_SENSORS_ZEROCROSS_H
...
typedef CODE void (*zc_interrupt_t)(FAR const struct zc_lowerhalf_s *lower, FAR void *arg);
...
struct zc_lowerhalf_s {
	...
	CODE void (*zc_enable)(FAR const struct zc_lowerhalf_s *lower, zc_interrupt_t handler,
						   FAR void *arg);
};
...
#endif /* __INCLUDE_ROUX_SENSORS_ZEROCROSS_H */
