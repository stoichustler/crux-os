...
#ifndef __INCLUDE_ROUX_SENSORS_APDS9960_H
#define __INCLUDE_ROUX_SENSORS_APDS9960_H
...
struct apds9960_config_s {
	CODE int (*irq_attach)(FAR struct apds9960_config_s *state, xcpt_t isr, FAR void *arg);
...
#endif /* __INCLUDE_ROUX_SENSORS_APDS9960_H */
