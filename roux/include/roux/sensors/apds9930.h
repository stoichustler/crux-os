/****************************************************************************
 * include/roux/sensors/apds9930.h
 *
...
#ifndef __INCLUDE_ROUX_SENSORS_APDS9930_H
#define __INCLUDE_ROUX_SENSORS_APDS9930_H
...
#include <roux/config.h>
	...
	(defined(CONFIG_SENSORS_APDS9930) || defined(CONFIG_SENSORS_APDS9930_SCU))
...
int apds9930als_register(FAR const char *devpath, int minor, FAR struct i2c_master_s *i2c,
						 int port);
...
int apds9930ps_register(FAR const char *devpath, int minor, FAR struct i2c_master_s *i2c, int port);
...
#endif /* __INCLUDE_ROUX_SENSORS_APDS9930_H */
