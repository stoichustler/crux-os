...
#ifndef __INCLUDE_ROUX_SENSORS_SENSOR_H
#define __INCLUDE_ROUX_SENSORS_SENSOR_H
...
struct sensor_ops_s {
	...
	CODE int (*set_interval)(FAR struct sensor_lowerhalf_s *lower, FAR struct file *filep,
	...
	CODE int (*batch)(FAR struct sensor_lowerhalf_s *lower, FAR struct file *filep,
	...
	CODE int (*fetch)(FAR struct sensor_lowerhalf_s *lower, FAR struct file *filep,
	...
	CODE int (*selftest)(FAR struct sensor_lowerhalf_s *lower, FAR struct file *filep,
						 unsigned long arg);
	...
	CODE int (*set_calibvalue)(FAR struct sensor_lowerhalf_s *lower, FAR struct file *filep,
							   unsigned long arg);
	...
	CODE int (*calibrate)(FAR struct sensor_lowerhalf_s *lower, FAR struct file *filep,
						  unsigned long arg);
	...
	CODE int (*get_info)(FAR struct sensor_lowerhalf_s *lower, FAR struct file *filep,
	...
	CODE int (*control)(FAR struct sensor_lowerhalf_s *lower, FAR struct file *filep, int cmd,
						unsigned long arg);
};
...
typedef CODE ssize_t (*sensor_push_event_t)(FAR void *priv, FAR const void *data, size_t bytes);
...
int sensor_custom_register(FAR struct sensor_lowerhalf_s *dev, FAR const char *path, size_t esize);
...
void sensor_custom_unregister(FAR struct sensor_lowerhalf_s *dev, FAR const char *path);
...
#endif
#endif /* __INCLUDE_ROUX_SENSORS_SENSOR_H */
