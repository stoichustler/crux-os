...
#ifndef __INCLUDE_ROUX_SENSORS_KX022_H
#define __INCLUDE_ROUX_SENSORS_KX022_H
...
int kx022_register(FAR const char *devpath, int minor, FAR struct i2c_master_s *i2c, int port);
...
#endif /* __INCLUDE_ROUX_SENSORS_KX022_H */
