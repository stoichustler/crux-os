...
#ifndef __INCLUDE_ROUX_SENSORS_DS18B20_H
#define __INCLUDE_ROUX_SENSORS_DS18B20_H
...
int ds18b20_register(int devno, FAR struct onewire_master_s *dev, uint64_t romcode);
#undef EXTERN
#ifdef __cplusplus
}
#endif
...
#endif /* __INCLUDE_ROUX_SENSORS_DS18B20_H */
