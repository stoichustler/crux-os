...
#ifndef __INCLUDE_ROUX_SENSORS_APDS9922_H
#define __INCLUDE_ROUX_SENSORS_APDS9922_H
...
struct apds9922_config_s {
	int (*irq_attach)(FAR struct apds9922_config_s *state, xcpt_t isr, FAR void *arg);
...
struct apds9922_als_setup_s {
	...
	struct adps9922_als_thresh thresh; /* Upper and lower thresholds        */
...
struct apds9922_ps_setup_s {
	...
	struct adps9922_ps_thresh thresh; /* Upper and lower thresholds        */
...
#endif /* __INCLUDE_ROUX_SENSORS_APDS9922_H */
