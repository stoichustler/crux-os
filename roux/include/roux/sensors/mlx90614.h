/****************************************************************************
 * include/roux/sensors/mlx90614.h
 *
...
#ifndef __INCLUDE_ROUX_SENSORS_MLX90614_H
#define __INCLUDE_ROUX_SENSORS_MLX90614_H
...
#define CONFIG_REG1_IIR_0p57_0p42                                                                  \
	(7 << CONFIG_REG1_IIR_SHIFT) /* a1 = 0.571428571 and b1 = 0.428571428 */
#define CONFIG_REG1_IIR_0p66_0p33                                                                  \
	(6 << CONFIG_REG1_IIR_SHIFT)							 /* a1 = 0.666... and b1 = 0.333...    \
															  */
#define CONFIG_REG1_IIR_0p8_0p2 (5 << CONFIG_REG1_IIR_SHIFT) /* a1 = 0.8 and b1 = 0.2 */
#define CONFIG_REG1_IIR_BYPASS                                                                     \
	(4 << CONFIG_REG1_IIR_SHIFT) /* a1 = 1 and b1 = 0 => IIR bypassed                              \
								  */
...
#define CONFIG_REG1_DATA_PWM_TA_IR1                                                                \
	(0 << CONFIG_REG1_DATA_PWM_SHIFT) /* Data1 = Ta and Data2 = IR1 */
#define CONFIG_REG1_DATA_PWM_TA_IR2                                                                \
	(1 << CONFIG_REG1_DATA_PWM_SHIFT) /* Data1 = Ta and Data2 = IR2 */
#define CONFIG_REG1_DATA_PWM_IR1_IR2                                                               \
	(2 << CONFIG_REG1_DATA_PWM_SHIFT) /* Data1 = IR1 and Data2 = IR2 */
#define CONFIG_REG1_DATA_PWM_IR1_UND                                                               \
	(3 << CONFIG_REG1_DATA_PWM_SHIFT) /* Data1 = IR2 and Data2 = Undefined */
...
#define CONFIG_REG1_FIR_N(n)                                                                       \
	(((n >> 3) - 1) << CONFIG_REG1_FIR_SHIFT) /* n = 8, 16, 32, 64 ... 1024 */
...
#define CONFIG_REG1_AMP_GAIN_1                                                                     \
	(0 << CONFIG_REG1_AMP_GAIN_SHIFT) /* Gain = 1 => preamplifier bypassed */
...
#define CONFIG_REG1_THERMOSHOCK_NEG                                                                \
	(1 << 15) /* Define the sign of thermosock: 1 - negative, 0 - positive */
...
int mlx90614_register(FAR const char *devpath, FAR struct i2c_master_s *i2c, uint8_t addr);
...
#endif /* __INCLUDE_ROUX_SENSORS_MLX90614_H */
