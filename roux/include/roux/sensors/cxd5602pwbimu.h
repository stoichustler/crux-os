...
#ifndef __INCLUDE_ROUX_SENSORS_CXD5602PWBIMU_H
#define __INCLUDE_ROUX_SENSORS_CXD5602PWBIMU_H
...
typedef struct cxd5602pwbimu_config_s {
	CODE int (*irq_attach)(FAR const struct cxd5602pwbimu_config_s *state, xcpt_t isr,
						   FAR void *arg);
	CODE void (*irq_enable)(FAR const struct cxd5602pwbimu_config_s *state, bool enable);
	CODE void (*csx)(FAR const struct cxd5602pwbimu_config_s *state, bool pol);
	CODE void (*power)(FAR const struct cxd5602pwbimu_config_s *state, bool pol);
	CODE void (*reset)(FAR const struct cxd5602pwbimu_config_s *state, bool assert);
...
#endif /* __INCLUDE_ROUX_SENSORS_CXD5602PWBIMU_H */
