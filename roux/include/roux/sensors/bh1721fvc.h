/****************************************************************************
 * include/roux/sensors/bh1721fvc.h
 *
...
#ifndef __INCLUDE_ROUX_SENSORS_BH1721FVC_H
#define __INCLUDE_ROUX_SENSORS_BH1721FVC_H
...
#if defined(CONFIG_I2C) && defined(CONFIG_SENSORS_BH1721FVC) ||                                    \
	defined(CONFIG_SENSORS_BH1721FVC_SCU)
...
int bh1721fvc_register(FAR const char *devpath, int minor, FAR struct i2c_master_s *i2c, int port);
...
#endif /* __INCLUDE_ROUX_SENSORS_BH1721FVC_H */
