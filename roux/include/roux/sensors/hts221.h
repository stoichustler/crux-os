...
#ifndef __INCLUDE_ROUX_SENSORS_HTS221_H
#define __INCLUDE_ROUX_SENSORS_HTS221_H
...
typedef struct hts221_config_s {
	int irq;
	CODE int (*irq_attach)(FAR struct hts221_config_s *state, xcpt_t isr, FAR void *arg);
	CODE void (*irq_enable)(FAR const struct hts221_config_s *state, bool enable);
...
#endif /* __INCLUDE_ROUX_SENSORS_HTS221_H */
