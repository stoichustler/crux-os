/****************************************************************************
 * include/roux/sensors/cluster_driver.h
 *
...
#ifndef __INCLUDE_ROUX_SENSORS_CLUSTER_DRIVER_H
#define __INCLUDE_ROUX_SENSORS_CLUSTER_DRIVER_H
...
struct sensor_cluster_operations_s {
	...
	CODE ssize_t (*driver_read)(FAR void *instance_handle, FAR char *buffer, size_t buflen);
	CODE ssize_t (*driver_write)(FAR void *instance_handle, FAR const char *buffer, size_t buflen);
	CODE off_t (*driver_seek)(FAR void *instance_handle, off_t offset, int whence);
	CODE int (*driver_ioctl)(FAR void *instance_handle, int cmd, unsigned long arg);
 ...
 *
 *   int spi_devid;   The spi device id, which is used by ROUX to
 ...
 *
 *   int i2c_devid;   The i2c device id, which is used by ROUX to
...
#endif /* __INCLUDE_ROUX_SENSORS_CLUSTER_DRIVER_H */
