...
#ifndef __INCLUDE_ROUX_SENSORS_HALL3PH_H
#define __INCLUDE_ROUX_SENSORS_HALL3PH_H
...
struct hall3_ops_s {
	...
	CODE int (*position)(FAR struct hall3_lowerhalf_s *lower, FAR uint8_t *pos);
};
...
#endif /* __INCLUDE_ROUX_SENSORS_HALL3PH_H */
