...
#ifndef __INCLUDE_ROUX_SENSORS_LPS25H_H
#define __INCLUDE_ROUX_SENSORS_LPS25H_H
...
typedef struct lps25h_config_s {
	...
	CODE int (*irq_attach)(FAR struct lps25h_config_s *state, xcpt_t isr, FAR void *arg);
	CODE void (*irq_enable)(FAR const struct lps25h_config_s *state, bool enable);
...
#endif /* __INCLUDE_ROUX_SENSORS_LPS25H_H */
