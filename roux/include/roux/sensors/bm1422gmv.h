/****************************************************************************
 * include/roux/sensors/bm1422gmv.h
 *
...
#ifndef __INCLUDE_ROUX_SENSORS_BM1422GMV_H
#define __INCLUDE_ROUX_SENSORS_BM1422GMV_H
...
#include <roux/config.h>
	...
	(defined(CONFIG_SENSORS_BM1422GMV) || defined(CONFIG_SENSORS_BM1422GMV_SCU))
...
int bm1422gmv_register(FAR const char *devpath, int minor, FAR struct i2c_master_s *i2c, int port);
...
#endif /* __INCLUDE_ROUX_SENSORS_BM1422GMV_H */
