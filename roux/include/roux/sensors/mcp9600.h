...
#ifndef __INCLUDE_ROUX_SENSORS_MCP9600_H
#define __INCLUDE_ROUX_SENSORS_MCP9600_H
...
struct mcp9600_alert_conf_s {
	enum mcp9600_alert_e alert; /* The alert associated with this configuration */
...
#endif /* __INCLUDE_ROUX_SENSORS_MCP9600_H */
