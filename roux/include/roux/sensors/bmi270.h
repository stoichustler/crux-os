...
#ifndef __INCLUDE_ROUX_SENSORS_BMI270_H
#define __INCLUDE_ROUX_SENSORS_BMI270_H
...
int bmi270_register_uorb(int devno, FAR struct i2c_master_s *dev, uint8_t addr);
#elif defined(CONFIG_SENSORS_BMI270_I2C) && !defined(CONFIG_SENSORS_BMI270_UORB)
int bmi270_register(FAR const char *devpath, FAR struct i2c_master_s *dev, uint8_t addr);
#elif !defined(CONFIG_SENSORS_BMI270_I2C) && defined(CONFIG_SENSORS_BMI270_UORB)
...
#endif /* __INCLUDE_ROUX_SENSORS_BMI270_H */
