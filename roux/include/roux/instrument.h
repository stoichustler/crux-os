...
#ifndef __INCLUDE_ROUX_INSTRUMENT_H
#define __INCLUDE_ROUX_INSTRUMENT_H
...
typedef CODE void(instrument_fun_t)(FAR void *this_fn, FAR void *call_site, FAR void *arg);
...
#endif /* __INCLUDE_ROUX_INSTRUMENT_H */
