					   ...
					   FAR void *arg, clock_t delay)
{
	...
	if (wqueue == NULL || work == NULL || worker == NULL || delay > WDOG_MAX_DELAY) {
		return -EINVAL;
	}
...
int work_queue_next(int qid, FAR struct work_s *work, worker_t worker, FAR void *arg, clock_t delay)
{
