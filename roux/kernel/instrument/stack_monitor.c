...
static void stack_monitor_enter(FAR void *this_fn, FAR void *call_site,
								FAR void *arg) noinstrument_function nooptimiziation_function;
...
struct instrument_s g_stack_monitor = {.enter = stack_monitor_enter, .leave = stack_monitor_leave};
...
static void stack_monitor_enter(FAR void *this_fn, FAR void *call_site, FAR void *arg)
{
...
static void stack_monitor_leave(FAR void *this_fn, FAR void *call_site, FAR void *arg)
{
	FAR struct tcb_s *tcb = running_task();
	FAR void *sp = &tcb;
