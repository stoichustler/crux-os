...
static int nxmq_verify_send(FAR FAR struct file *mq, FAR const char *msg, size_t msglen,
							unsigned int prio)
{
...
static void nxmq_add_queue(FAR struct mqueue_inode_s *msgq, FAR struct mqueue_msg_s *mqmsg,
						   unsigned int prio)
{
...
static int file_mq_timedsend_internal(FAR struct file *mq, FAR const char *msg, size_t msglen,
...
int mq_timedsend(mqd_t mqdes, FAR const char *msg, size_t msglen, unsigned int prio,
				 FAR const struct timespec *abstime)
{
	int ret;
