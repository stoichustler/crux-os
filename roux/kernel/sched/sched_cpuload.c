...
#define CPULOAD_TIMECONSTANT                                                                       \
	(CONFIG_SMP_NCPUS * CONFIG_SCHED_CPULOAD_TIMECONSTANT * CPULOAD_TICKSPERSEC)

/* The sampling period in system timer ticks */

#define CPULOAD_SAMPLING_PERIOD (TICK_PER_SEC / CONFIG_SCHED_CPULOAD_TICKSPERSEC)
...
{
	wd_start(&g_cpuload_wdog, CPULOAD_SAMPLING_PERIOD, cpuload_callback, (wdparm_t)&g_cpuload_wdog);
}
#endif
