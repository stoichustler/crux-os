...
#
############################################################################
"""Python script that prepares the ROUX image to be used with NX bootloader"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Tool for ROUX Bootloader")
    parser.add_argument(
        "--version",
        default="0.0.0",
    ...
    parser.add_argument(
        "PATH",
        default="roux.bin",
        help="Path to the ROUX image.",
    )
    parser.add_argument(
        "RESULT",
        default="roux.img",
        help="Path where the resulting ROUX image is stored.",
    )
