...
static FAR const char *const g_datemontab[] = {"jan", "feb", "mar", "apr", "may", "jun",
...
#ifndef CONFIG_NSH_DISABLE_DATE
static inline int date_showtime(FAR struct nsh_vtbl_s *vtbl, FAR const char *name, bool utc,
...
#ifndef CONFIG_NSH_DISABLE_DATE
static inline int date_settime(FAR struct nsh_vtbl_s *vtbl, FAR const char *name, bool utc,
							   FAR char *newtime)
{
	struct timespec ts;
	struct tm tm;
