...
typedef void (*codec_callback_t)(FAR char *src, int srclen, FAR char *dest, FAR int *destlen,
								 int mode);
...
#ifdef NEED_CMD_CODECS_PROC
static int cmd_codecs_proc(FAR struct nsh_vtbl_s *vtbl, int argc, FAR char **argv, uint8_t mode,
