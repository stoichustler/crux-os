...
static int nsh_script_redirect(FAR struct nsh_vtbl_s *vtbl, FAR const char *cmd,
...
int nsh_script(FAR struct nsh_vtbl_s *vtbl, FAR const FAR char *cmd, FAR const char *path, bool log)
{
	FAR char *fullpath;
	int savestream;
	FAR char *buffer;
