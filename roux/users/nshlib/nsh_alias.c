...
static FAR struct nsh_alias_s *alias_find(FAR struct nsh_vtbl_s *vtbl, FAR const char *name)
{
...
static void alias_delete(FAR struct nsh_vtbl_s *vtbl, FAR struct nsh_alias_s *alias)
{
	if (alias) {
		if (alias->exp) {
...
static int alias_save(FAR struct nsh_vtbl_s *vtbl, FAR const char *name, FAR const char *value)
{
	FAR struct nsh_alias_s *alias;
	int ret = OK;
