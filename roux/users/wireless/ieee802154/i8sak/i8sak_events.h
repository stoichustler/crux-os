...
typedef void (*i8sak_eventcallback_t)(FAR struct ieee802154_primitive_s *primitive, FAR void *arg);
...
int i8sak_eventlistener_removereceiver(FAR struct i8sak_s *handle, i8sak_eventcallback_t cb);
