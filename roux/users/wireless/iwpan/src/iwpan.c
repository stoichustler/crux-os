...
typedef void (*cmd2_t)(int sock, FAR const char *arg1, FAR const char *arg2);
typedef void (*cmd3_t)(int sock, FAR const char *arg1, FAR const char *arg2, FAR const char *arg3);
...
static void iwpan_cca_cmd(int sock, FAR const char *ifname, FAR const char *ccastr);
static void iwpan_chan_cmd(int sock, FAR const char *ifname, FAR const char *chanstr);
static void iwpan_devmode_cmd(int sock, FAR const char *ifname, FAR const char *modstr);
static void iwpan_eaddr_cmd(int sock, FAR const char *ifname, FAR const char *addrstr);
static void iwpan_panid_cmd(int sock, FAR const char *ifname, FAR const char *panstr);
static void iwpan_promisc_cmd(int sock, FAR const char *ifname, FAR const char *boolstr);
static void iwpan_saddr_cmd(int sock, FAR const char *ifname, FAR const char *addrstr);
static void iwpan_txpwr_cmd(int sock, FAR const char *ifname, FAR const char *pwrstr);
...
static void iwpan_show_cmd(int sock, FAR const char *ifname)
{
	uint8_t eaddr[IEEE802154_EADDRSIZE] = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff};
...
static void iwpan_devmode_cmd(int sock, FAR const char *ifname, FAR const char *modestr)
{
	uint8_t devmode;
	int ret;
