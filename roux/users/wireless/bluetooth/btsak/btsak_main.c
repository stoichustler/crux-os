...
static const struct btsak_command_s g_btsak_commands[] = {
	{"help", btsak_cmd_help, NULL},
	{"info", btsak_cmd_info, "[-h]"},
	{"features", btsak_cmd_features, "[-h] [le]"},
	{"scan", btsak_cmd_scan, "[-h] <start [-d]|get|stop>"},
	{"advertise", btsak_cmd_advertise, "[-h] <start|stop>"},
	{"security", btsak_cmd_security, "[-h] <addr> public|random <level>"},
	{"gatt", btsak_cmd_gatt, "[-h] <cmd> [option [option [option...]]]"}};

#define NCOMMANDS nitems(g_btsak_commands)

static const struct btsak_command_s g_btsak_gatt_commands[] = {
	{"exchange-mtu", btsak_cmd_gatt_exchange_mtu, "[-h] <addr> public|random"},
	{"connect", btsak_cmd_connect, "[-h] <addr> public|random"},
	{"disconnect", btsak_cmd_disconnect, "[-h] <addr> public|random"},
	{"discover", btsak_cmd_discover, "[-h] <addr> public|random <uuid16> [<start> [<end>]]"},
	{"characteristic", btsak_cmd_gatt_discover_characteristic,
	 "[-h] <addr> public|random [<start> [<end>]]"},
	{"descriptor", btsak_cmd_gatt_discover_descriptor,
	 "[-h] <addr> public|random [<start> [<end>]]"},
	{"read", btsak_cmd_gatt_read, "[-h] <addr> public|random <handle> [<offset>]"},
	{"read-multiple", btsak_cmd_gatt_read_multiple,
	 "[-h] <addr> public|random <handle> [<handle> [<handle>]..]"},
	{"write", btsak_cmd_gatt_write,
	 "[-h] <addr> public|random <handle> <byte> [<byte> [<byte>]..]"}};

#define GATT_NCOMMANDS nitems(g_btsak_gatt_commands)

static const bt_addr_t g_default_epaddr = {BTSAK_DEFAULT_EPADDR};
...
void btsak_gatt_showusage(FAR const char *progname, FAR const char *cmd, int exitcode)
{
	int i;
