...
static void btsak_features_showusage(FAR const char *progname, FAR const char *cmd, int exitcode)
{
...
void btsak_cmd_features(FAR struct btsak_s *btsak, int argc, FAR char *argv[])
{
	...
	if (sockfd >= 0) {
		...
		if (ret < 0) {
			...
			printf("Page 0:\n");
			printf("\t%02x %02x %02x %02x  %02x %02x %02x %02x\n", btreq.btr_features0[0],
				   btreq.btr_features0[1], btreq.btr_features0[2], btreq.btr_features0[3],
				   btreq.btr_features0[4], btreq.btr_features0[5], btreq.btr_features0[6],
				   btreq.btr_features0[7]);
			printf("Page 1:\n");
			printf("\t%02x %02x %02x %02x  %02x %02x %02x %02x\n", btreq.btr_features1[0],
				   btreq.btr_features1[1], btreq.btr_features1[2], btreq.btr_features1[3],
				   btreq.btr_features1[4], btreq.btr_features1[5], btreq.btr_features1[6],
				   btreq.btr_features1[7]);
			printf("Page 2:\n");
			printf("\t%02x %02x %02x %02x  %02x %02x %02x %02x\n", btreq.btr_features2[0],
				   btreq.btr_features2[1], btreq.btr_features2[2], btreq.btr_features2[3],
				   btreq.btr_features2[4], btreq.btr_features2[5], btreq.btr_features2[6],
				   btreq.btr_features2[7]);
		}
	}
