...
static void btsak_advertise_showusage(FAR const char *progname, FAR const char *cmd, int exitcode)
{
...
static void btsak_cmd_advertisestart(FAR struct btsak_s *btsak, FAR char *cmd, int argc,
									 FAR char *argv[])
{
...
static void btsak_cmd_advertisestop(FAR struct btsak_s *btsak, FAR char *cmd, int argc,
									FAR char *argv[])
{
	struct btreq_s btreq;
	int sockfd;
