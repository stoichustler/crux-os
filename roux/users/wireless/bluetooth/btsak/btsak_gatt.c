...
static void btsak_cmd_discover_common(FAR struct btsak_s *btsak, int argc, FAR char *argv[],
...
static void btsak_cmd_connect_common(FAR struct btsak_s *btsak, int argc, FAR char *argv[], int cmd)
{
	...
	if (argc != 3) {
		fprintf(stderr, "ERROR:  Invalid number of arguments.  Found %d expected 2\n", argc - 1);
		btsak_gatt_showusage(btsak->progname, argv[0], EXIT_FAILURE);
	}
...
static void btsak_cmd_read_common(FAR struct btsak_s *btsak, int argc, FAR char *argv[],
								  bool multiple)
{
	int i;
	int j;
...
void btsak_cmd_gatt_exchange_mtu(FAR struct btsak_s *btsak, int argc, FAR char *argv[])
{
	struct btreq_s btreq;
	int sockfd;
	int ret;
...
void btsak_cmd_gatt_discover_characteristic(FAR struct btsak_s *btsak, int argc, FAR char *argv[])
{
...
void btsak_cmd_gatt_discover_descriptor(FAR struct btsak_s *btsak, int argc, FAR char *argv[])
{
...
void btsak_cmd_gatt_read(FAR struct btsak_s *btsak, int argc, FAR char *argv[])
{
	if (argc == 2 && strcmp(argv[1], "-h") == 0) {
		btsak_gatt_showusage(btsak->progname, argv[0], EXIT_SUCCESS);
	}
...
void btsak_cmd_gatt_read_multiple(FAR struct btsak_s *btsak, int argc, FAR char *argv[])
{
	if (argc == 2 && strcmp(argv[1], "-h") == 0) {
		btsak_gatt_showusage(btsak->progname, argv[0], EXIT_SUCCESS);
	}
...
void btsak_cmd_gatt_write(FAR struct btsak_s *btsak, int argc, FAR char *argv[])
{
	struct btreq_s btreq;
	int sockfd;
	int ret;
...
void btsak_cmd_connect(FAR struct btsak_s *btsak, int argc, FAR char *argv[])
{
...
void btsak_cmd_disconnect(FAR struct btsak_s *btsak, int argc, FAR char *argv[])
{
