...
#define INTF_SEND(s, intf, buff, i) (s)->intf_stream->ops->send(intf, buff, i)
#define INTF_RECV(s, intf, buff, i) (s)->intf_stream->ops->recv(intf, buff, i)
...
int nxscope_stream_send(FAR struct nxscope_s *s, FAR uint8_t *buff, FAR size_t *buff_i);
