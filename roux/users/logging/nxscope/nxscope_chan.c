...
static int nxscope_ch_validate(FAR struct nxscope_s *s, uint8_t ch, uint8_t type, uint8_t d,
							   uint8_t mlen)
{
	...
	if (utype.s.cri) {
#ifdef CONFIG_DEBUG_FEATURES
		next_i = (s->proto_stream->hdrlen + 1 + type_size * d + mlen + s->proto_stream->footlen);
	...
	next_i = (s->stream_i + 1 + type_size * d + mlen + s->proto_stream->footlen);
...
static int nxscope_put_vector(FAR uint8_t *buff, uint8_t type, FAR void *val, uint8_t d)
{
	int i = 0;
	int j = 0;
...
static int nxscope_put_meta(FAR uint8_t *buff, FAR uint8_t *meta, uint8_t mlen)
{
	int i = 0;
...
static void nxscope_put_sample(FAR uint8_t *buff, FAR size_t *buff_i, uint8_t type, uint8_t ch,
							   FAR void *val, uint8_t d, FAR uint8_t *meta, uint8_t mlen)
{
	size_t i = 0;
...
static int nxscope_put_common_m(FAR struct nxscope_s *s, uint8_t type, uint8_t ch, FAR void *val,
...
int nxscope_chan_init(FAR struct nxscope_s *s, uint8_t ch, FAR char *name, uint8_t type,
...
int nxscope_put_vuint8_m(FAR struct nxscope_s *s, uint8_t ch, FAR uint8_t *val, uint8_t d,
						 FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_UINT8, ch, val, d, meta, mlen);
}
...
int nxscope_put_vint8_m(FAR struct nxscope_s *s, uint8_t ch, FAR int8_t *val, uint8_t d,
						FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_INT8, ch, val, d, meta, mlen);
}
...
int nxscope_put_vuint16_m(FAR struct nxscope_s *s, uint8_t ch, FAR uint16_t *val, uint8_t d,
						  FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_UINT16, ch, val, d, meta, mlen);
}
...
int nxscope_put_vint16_m(FAR struct nxscope_s *s, uint8_t ch, FAR int16_t *val, uint8_t d,
						 FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_INT16, ch, val, d, meta, mlen);
}
...
int nxscope_put_vuint32_m(FAR struct nxscope_s *s, uint8_t ch, FAR uint32_t *val, uint8_t d,
						  FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_UINT32, ch, val, d, meta, mlen);
}
...
int nxscope_put_vint32_m(FAR struct nxscope_s *s, uint8_t ch, FAR int32_t *val, uint8_t d,
						 FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_INT32, ch, val, d, meta, mlen);
}
...
int nxscope_put_vuint64_m(FAR struct nxscope_s *s, uint8_t ch, FAR uint64_t *val, uint8_t d,
						  FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_UINT64, ch, val, d, meta, mlen);
}
...
int nxscope_put_vint64_m(FAR struct nxscope_s *s, uint8_t ch, FAR int64_t *val, uint8_t d,
						 FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_INT64, ch, val, d, meta, mlen);
}
...
int nxscope_put_vfloat_m(FAR struct nxscope_s *s, uint8_t ch, FAR float *val, uint8_t d,
						 FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_FLOAT, ch, val, d, meta, mlen);
}
...
int nxscope_put_vdouble_m(FAR struct nxscope_s *s, uint8_t ch, FAR double *val, uint8_t d,
						  FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_DOUBLE, ch, val, d, meta, mlen);
}
...
int nxscope_put_vub8_m(FAR struct nxscope_s *s, uint8_t ch, FAR ub8_t *val, uint8_t d,
					   FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_UB8, ch, val, d, meta, mlen);
}
...
int nxscope_put_vb8_m(FAR struct nxscope_s *s, uint8_t ch, FAR b8_t *val, uint8_t d,
					  FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_B8, ch, val, d, meta, mlen);
}
...
int nxscope_put_vub16_m(FAR struct nxscope_s *s, uint8_t ch, FAR ub16_t *val, uint8_t d,
						FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_UB16, ch, val, d, meta, mlen);
}
...
int nxscope_put_vb16_m(FAR struct nxscope_s *s, uint8_t ch, FAR b16_t *val, uint8_t d,
					   FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_B16, ch, val, d, meta, mlen);
}
...
int nxscope_put_vub32_m(FAR struct nxscope_s *s, uint8_t ch, FAR ub32_t *val, uint8_t d,
						FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_UB32, ch, val, d, meta, mlen);
}
...
int nxscope_put_vb32_m(FAR struct nxscope_s *s, uint8_t ch, FAR b32_t *val, uint8_t d,
					   FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_B32, ch, val, d, meta, mlen);
}
...
int nxscope_put_vchar_m(FAR struct nxscope_s *s, uint8_t ch, FAR char *val, uint8_t d,
						FAR uint8_t *meta, uint8_t mlen)
{
	return nxscope_put_common_m(s, NXSCOPE_TYPE_CHAR, ch, val, d, meta, mlen);
}
...
int nxscope_put_vuint8(FAR struct nxscope_s *s, uint8_t ch, FAR uint8_t *val, uint8_t d)
{
...
int nxscope_put_vint8(FAR struct nxscope_s *s, uint8_t ch, FAR int8_t *val, uint8_t d)
{
...
int nxscope_put_vuint16(FAR struct nxscope_s *s, uint8_t ch, FAR uint16_t *val, uint8_t d)
{
...
int nxscope_put_vint16(FAR struct nxscope_s *s, uint8_t ch, FAR int16_t *val, uint8_t d)
{
...
int nxscope_put_vuint32(FAR struct nxscope_s *s, uint8_t ch, FAR uint32_t *val, uint8_t d)
{
...
int nxscope_put_vint32(FAR struct nxscope_s *s, uint8_t ch, FAR int32_t *val, uint8_t d)
{
...
int nxscope_put_vuint64(FAR struct nxscope_s *s, uint8_t ch, FAR uint64_t *val, uint8_t d)
{
...
int nxscope_put_vint64(FAR struct nxscope_s *s, uint8_t ch, FAR int64_t *val, uint8_t d)
{
...
int nxscope_put_vfloat(FAR struct nxscope_s *s, uint8_t ch, FAR float *val, uint8_t d)
{
...
int nxscope_put_vdouble(FAR struct nxscope_s *s, uint8_t ch, FAR double *val, uint8_t d)
{
...
int nxscope_put_vub8(FAR struct nxscope_s *s, uint8_t ch, FAR ub8_t *val, uint8_t d)
{
...
int nxscope_put_vb8(FAR struct nxscope_s *s, uint8_t ch, FAR b8_t *val, uint8_t d)
{
...
int nxscope_put_vub16(FAR struct nxscope_s *s, uint8_t ch, FAR ub16_t *val, uint8_t d)
{
...
int nxscope_put_vb16(FAR struct nxscope_s *s, uint8_t ch, FAR b16_t *val, uint8_t d)
{
...
int nxscope_put_vub32(FAR struct nxscope_s *s, uint8_t ch, FAR ub32_t *val, uint8_t d)
{
...
int nxscope_put_vb32(FAR struct nxscope_s *s, uint8_t ch, FAR b32_t *val, uint8_t d)
{
...
int nxscope_put_vchar(FAR struct nxscope_s *s, uint8_t ch, FAR char *val, uint8_t d)
{
...
int nxscope_put_uint8_m(FAR struct nxscope_s *s, uint8_t ch, uint8_t val, FAR uint8_t *meta,
						uint8_t mlen)
{
...
int nxscope_put_int8_m(FAR struct nxscope_s *s, uint8_t ch, int8_t val, FAR uint8_t *meta,
					   uint8_t mlen)
{
...
int nxscope_put_uint16_m(FAR struct nxscope_s *s, uint8_t ch, uint16_t val, FAR uint8_t *meta,
						 uint8_t mlen)
{
...
int nxscope_put_int16_m(FAR struct nxscope_s *s, uint8_t ch, int16_t val, FAR uint8_t *meta,
						uint8_t mlen)
{
...
int nxscope_put_uint32_m(FAR struct nxscope_s *s, uint8_t ch, uint32_t val, FAR uint8_t *meta,
						 uint8_t mlen)
{
...
int nxscope_put_int32_m(FAR struct nxscope_s *s, uint8_t ch, int32_t val, FAR uint8_t *meta,
						uint8_t mlen)
{
...
int nxscope_put_uint64_m(FAR struct nxscope_s *s, uint8_t ch, uint64_t val, FAR uint8_t *meta,
						 uint8_t mlen)
{
...
int nxscope_put_int64_m(FAR struct nxscope_s *s, uint8_t ch, int64_t val, FAR uint8_t *meta,
						uint8_t mlen)
{
...
int nxscope_put_float_m(FAR struct nxscope_s *s, uint8_t ch, float val, FAR uint8_t *meta,
						uint8_t mlen)
{
...
int nxscope_put_double_m(FAR struct nxscope_s *s, uint8_t ch, double val, FAR uint8_t *meta,
						 uint8_t mlen)
{
...
int nxscope_put_b8_m(FAR struct nxscope_s *s, uint8_t ch, b8_t val, FAR uint8_t *meta, uint8_t mlen)
{
...
int nxscope_put_b16_m(FAR struct nxscope_s *s, uint8_t ch, b16_t val, FAR uint8_t *meta,
					  uint8_t mlen)
{
...
int nxscope_put_ub8_m(FAR struct nxscope_s *s, uint8_t ch, ub8_t val, FAR uint8_t *meta,
					  uint8_t mlen)
{
...
int nxscope_put_b32_m(FAR struct nxscope_s *s, uint8_t ch, b32_t val, FAR uint8_t *meta,
					  uint8_t mlen)
{
...
int nxscope_put_ub16_m(FAR struct nxscope_s *s, uint8_t ch, ub16_t val, FAR uint8_t *meta,
					   uint8_t mlen)
{
...
int nxscope_put_ub32_m(FAR struct nxscope_s *s, uint8_t ch, ub32_t val, FAR uint8_t *meta,
					   uint8_t mlen)
{
...
int nxscope_put_char_m(FAR struct nxscope_s *s, uint8_t ch, char val, FAR uint8_t *meta,
					   uint8_t mlen)
{
...
int nxscope_put_none_m(FAR struct nxscope_s *s, uint8_t ch, FAR uint8_t *meta, uint8_t mlen)
{
...
int nxscope_put_user_m(FAR struct nxscope_s *s, uint8_t ch, uint8_t type, FAR uint8_t *val,
					   uint8_t d, FAR uint8_t *meta, uint8_t mlen)
{
	/* User specific type */
