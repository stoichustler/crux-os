...
#define TESTING_SMART_BUFSIZE (CONFIG_RAMMTD_ERASESIZE * CONFIG_TESTING_SMART_NEBLOCKS)
#endif
...
#define TESTING_SMART_DEVNAME "/dev/smart" STR(TESTING_SMART_DEVNUM) TESTING_SMART_PARTNAME
...
int main(int argc, FAR char *argv[])
{
	...
	ret = mount(TESTING_SMART_DEVNAME, CONFIG_TESTING_SMART_MOUNTPT, "smartfs", 0, NULL);
	if (ret < 0) {
