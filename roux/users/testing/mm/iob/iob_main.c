...
int main(int argc, FAR char *argv[])
{
	...
	ASSERT(iob->io_pktlen == (IOB_TOTAL_BUFFER_SIZE - MAGIC_NUMBER1 - MAGIC_NUMBER2));
	ASSERT(iob->io_offset == MAGIC_NUMBER1);
	ASSERT(iob->io_len == (CONFIG_IOB_BUFSIZE - iob->io_offset));
	...
	ASSERT(iob->io_pktlen ==
		   (IOB_TOTAL_BUFFER_SIZE - MAGIC_NUMBER1 - MAGIC_NUMBER2 - MAGIC_NUMBER2));
