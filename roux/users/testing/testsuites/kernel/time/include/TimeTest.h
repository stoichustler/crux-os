...
void test_roux_clock_test_smoke01(FAR void **state);

/* cases/clock_test_timer01.c ***********************************************/

void test_roux_clock_test_timer01(FAR void **state);

/* cases/clock_test_timer03.c ***********************************************/

void test_roux_clock_test_timer03(FAR void **state);

/* cases/clock_test_timer04.c ***********************************************/

void test_roux_clock_test_timer04(FAR void **state);

/* cases/clock_test_timer05.c ***********************************************/

void test_roux_clock_test_timer05(FAR void **state);

/* cases/clock_test_clock01.c ***********************************************/

void test_roux_clock_test_clock01(FAR void **state);

/* cases/clock_test_clock02.c ***********************************************/

void test_roux_clock_test_clock02(FAR void **state);
