...
#define PTHREAD_EXIT_VALUE                                                                         \
	((void *)100) /* The return code of the thread when using pthread_exit(). */
...
void test_roux_pthread_test03(FAR void **state);

/* cases/posix_pthread_test_004.c
 * ************************************************/

void test_roux_pthread_test04(FAR void **state);

/* cases/posix_pthread_test_005.c
 * ************************************************/

void test_roux_pthread_test05(FAR void **state);

/* cases/posix_pthread_test_006.c
 * ************************************************/

void test_roux_pthread_test06(FAR void **state);

/* cases/posix_pthread_test_009.c
 * ************************************************/

void test_roux_pthread_test09(FAR void **state);

/* cases/posix_pthread_test_018.c
 * ************************************************/

void test_roux_pthread_test18(FAR void **state);

/* cases/posix_pthread_test_019.c
 * ************************************************/

void test_roux_pthread_test19(FAR void **state);

/* cases/posix_pthread_test_021.c
 * ************************************************/

void test_roux_pthread_test21(FAR void **state);
#endif
