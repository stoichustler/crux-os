...
static void *clientsthread(void *param)
{
	...
	syslog(LOG_INFO, "[%d]<%d>connected to udp://%s:%d successful", fd, thrno,
		   inet_ntoa(sa.sin_addr), SERVER_PORT);

	const char *msg[] = {
		"ohos, ", "hello, ", "my name is net_socket_test_011, ", "see u next time, ", "Bye!",
	};
...
/****************************************************************************
 * Name: test_roux_net_socket_test11
 ****************************************************************************/
