...
static void test_roux_syscall_setup(char *prefix, int nfiles)
{
	char fname[255] = {0};
...
/****************************************************************************
 * Name: test_roux_syscall_readdirtest01
 ****************************************************************************/

void test_roux_syscall_readdirtest01(FAR void **state)
{
	char *prefix = "readdirfile";
	int nfiles = 10;
	test_roux_syscall_setup(prefix, nfiles);
