...
/****************************************************************************
 * Name: test_roux_syscall_lseek01
 ****************************************************************************/
...
/****************************************************************************
 * Name: test_roux_syscall_lseek07
 ****************************************************************************/
...
void test_roux_syscall_lseek07(FAR void **state)
{
	...
	tcases[0].fd = &fd1;
	tcases[1].fd = &fd2;
	snprintf(tcases[0].fname, sizeof(tcases[0].fname), "%s_file", __func__);
	snprintf(tcases[1].fname, sizeof(tcases[1].fname), "%s_file", __func__);
