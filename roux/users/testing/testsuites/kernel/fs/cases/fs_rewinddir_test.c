...
/****************************************************************************
 * Name: test_roux_fs_cteatfile
 ****************************************************************************/

static void test_roux_fs_cteatfile(char *filename, size_t write_size)
{
	int fd;
...
void test_roux_fs_rewinddir01(FAR void **state)
{
	...
	if (size < 51200) {
		...
		test_roux_fs_cteatfile(TEST_CHILD_FILE1, 10);
		test_roux_fs_cteatfile(TEST_CHILD_FILE2, 10);
		test_roux_fs_cteatfile(TEST_CHILD_FILE3, 10);
