...
static void mps_timer_init(void)
{
	...
	static const int timer_irq_prio[] = {0x60, 0x70};
...
static void drivertest_mps2_zerointerrupt(void **argv)
{
	...
	attr.priority = 255;
	pthread_create(&tid, &attr, test_irq_awaker_thread_entry, NULL);
...
int main(int argc, char *argv[])
{
	const struct CMUnitTest tests[] = {
		cmocka_unit_test_prestate_setup_teardown(drivertest_mps2_zerointerrupt, setup, teardown,
												 NULL),
	};
