...
static int test_regulator_set_mode(FAR struct regulator_dev_s *rdev, enum regulator_mode_e mode);
static enum regulator_mode_e test_regulator_get_mode(FAR struct regulator_dev_s *rdev);
static int test_regulator_suspend_mode(FAR struct regulator_dev_s *rdev,
									   enum regulator_mode_e mode);
static int test_regulator_suspend_voltage(FAR struct regulator_dev_s *, int uv);
...
static int test_regulator_suspend_mode(FAR struct regulator_dev_s *rdev, enum regulator_mode_e mode)
{
	FAR struct test_regulator_s *tr = rdev->priv;
	int ret = 0;
...
static int test_regulator_suspend_voltage(FAR struct regulator_dev_s *rdev, int uv)
{
	FAR struct test_regulator_s *tr = rdev->priv;
	tr->lpuv = uv;
	return 0;
...
static void drivertest_reg_register(FAR void **state)
{
	...
	g_fake_regulator.rdev =
		regulator_register(&g_fake_regulator_desc, &g_fake_regulator_ops, &g_fake_regulator);
	assert_false(NULL == g_fake_regulator.rdev);
	test = regulator_register(&g_fake_regulator_desc, &g_fake_regulator_ops, &g_fake_regulator);
...
static void drivertest_reg_supply_always_on_boot_off(FAR void **state)
{
	...
	g_fake_regulator_supply.rdev = regulator_register(
		&g_fake_regulator_supply_desc, &g_fake_regulator_ops, &g_fake_regulator_supply);
...
static void drivertest_reg_pm_callback(FAR void **state)
{
	...
	g_fake_regulator.rdev =
		regulator_register(&g_fake_regulator_desc, &g_fake_regulator_ops, &g_fake_regulator);
	assert_false(NULL == g_fake_regulator.rdev);
	g_fake_regulator.rdev->pm_cb.notify(&g_fake_regulator.rdev->pm_cb, 2, PM_SLEEP);
	assert_int_equal(g_fake_regulator.lpmode, REGULATOR_MODE_FAST);
	g_fake_regulator.rdev->pm_cb.notify(&g_fake_regulator.rdev->pm_cb, 1, PM_RESTORE);
	assert_int_equal(g_fake_regulator.lpmode, REGULATOR_MODE_NORMAL);
	g_fake_regulator.rdev->pm_cb.notify(&g_fake_regulator.rdev->pm_cb, 1, PM_NORMAL);
	assert_int_equal(g_fake_regulator.lpuv, 1);
	assert_int_equal(g_fake_regulator.lpmode, REGULATOR_MODE_NORMAL);
	g_fake_regulator.rdev->pm_cb.notify(&g_fake_regulator.rdev->pm_cb, 1, PM_IDLE);
	assert_int_equal(g_fake_regulator.lpmode, REGULATOR_MODE_NORMAL);
	assert_int_equal(g_fake_regulator.lpuv, 2);
	g_fake_regulator.rdev->pm_cb.notify(&g_fake_regulator.rdev->pm_cb, 1, PM_STANDBY);
	assert_int_equal(g_fake_regulator.lpmode, REGULATOR_MODE_IDLE);
	assert_int_equal(g_fake_regulator.lpuv, 3);
	g_fake_regulator.rdev->pm_cb.notify(&g_fake_regulator.rdev->pm_cb, 1, PM_SLEEP);
	assert_int_equal(g_fake_regulator.lpmode, REGULATOR_MODE_STANDBY);
...
int main(int argc, FAR char *argv[])
{
	const struct CMUnitTest tests[] = {
		...
		cmocka_unit_test_prestate(drivertest_reg_supply_always_on_boot_off, NULL),
		cmocka_unit_test_prestate(drivertest_reg_supply_boot_on_always_on, NULL),
		cmocka_unit_test_prestate(drivertest_reg_supply_boot_on_always_off, NULL),
		cmocka_unit_test_prestate(drivertest_reg_supply_boot_off_always_off, NULL),
