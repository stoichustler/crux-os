...
static void parse_commandline(int argc, FAR char **argv, FAR struct relay_args_s *relay_args)
{
	int option;
...
int main(int argc, FAR char *argv[])
{
	...
	const struct CMUnitTest tests[] = {
		cmocka_unit_test_prestate_setup_teardown(drivertest_relay, setup, teardown, &relay_args),
	};
