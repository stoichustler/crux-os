...
static const unsigned char g_aes_128_key[16] = {0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6,
												0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f, 0x3c};

static const unsigned int g_message_lengths[4] = {0, 16, 20, 64};
...
static int syscrypt(FAR const unsigned char *key, size_t klen, FAR const unsigned char *message,
					size_t len, FAR unsigned char *output, size_t outlen)
{
...
static int match(FAR const unsigned char *a, FAR const unsigned char *b, size_t len)
{
	int i;
...
int main(int argc, FAR char *argv[])
{
	...
	for (int i = 0; i < 4; i++) {
		ret = syscrypt(g_aes_128_key, sizeof(g_aes_128_key), g_test_message, g_message_lengths[i],
					   out, sizeof(out));
		if (ret) {
