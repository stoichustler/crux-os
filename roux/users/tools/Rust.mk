...
#   - x86: i686-unknown-roux
#   - x86_64: x86_64-unknown-roux
#   - armv7a: armv7a-roux-eabi, armv7a-roux-eabihf
#   - thumbv6m: thumbv6m-roux-eabi
#   - thumbv7a: thumbv7a-roux-eabi, thumbv7a-roux-eabihf
#   - thumbv7m: thumbv7m-roux-eabi
#   - thumbv7em: thumbv7em-roux-eabihf
#   - thumbv8m.main: thumbv8m.main-roux-eabi, thumbv8m.main-roux-eabihf
#   - thumbv8m.base: thumbv8m.base-roux-eabi, thumbv8m.base-roux-eabihf
#   - riscv32: riscv32imc/imac/imafc-unknown-roux-elf
#   - riscv64: riscv64imac/imafdc-unknown-roux-elf
#
# Usage:   $(call RUST_TARGET_TRIPLE)
#
# Output:
#   Rust target triple (e.g. riscv32imac-unknown-roux-elf,
#   thumbv7m-roux-eabi, thumbv7em-roux-eabihf)
...
$(or \
  ...
  $(and $(filter thumb%,$(LLVM_ARCHTYPE)), \
    $(if $(filter thumbv8m%,$(LLVM_ARCHTYPE)), \
      $(if $(filter cortex-m23,$(LLVM_CPUTYPE)),thumbv8m.base,thumbv8m.main)-roux-$(LLVM_ABITYPE), \
      $(LLVM_ARCHTYPE)-roux-$(LLVM_ABITYPE) \
    ) \
  ), \
...
define RUST_CARGO_BUILD
	ROUX_INCLUDE_DIR=$(TOPDIR)/include:$(TOPDIR)/include/arch \
...
#
# Output:
#   Path to the Rust binary (e.g. path/to/project/target/riscv32imac-unknown-roux-elf/release/libhello.a)
