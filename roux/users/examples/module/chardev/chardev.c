...
static ssize_t chardev_read(FAR struct file *filep, FAR char *buffer, size_t buflen);
static ssize_t chardev_write(FAR struct file *filep, FAR const char *buffer, size_t buflen);
...
static ssize_t chardev_read(FAR struct file *filep, FAR char *buffer, size_t len)
{
...
static ssize_t chardev_write(FAR struct file *filep, FAR const char *buffer, size_t len)
{
