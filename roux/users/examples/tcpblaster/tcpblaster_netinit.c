...
#if defined(CONFIG_EXAMPLES_TCPBLASTER_INIT) && defined(CONFIG_EXAMPLES_TCPBLASTER_IPv6) &&        \
...
#endif /* CONFIG_EXAMPLES_TCPBLASTER_INIT && CONFIG_EXAMPLES_TCPBLASTER_IPv6 &&                    \
