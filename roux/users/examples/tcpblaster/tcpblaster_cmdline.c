...
#else
	g_tcpblasterserver_ipv6[0] = HTONS(CONFIG_EXAMPLES_TCPBLASTER_SERVERIPv6ADDR_1);
	g_tcpblasterserver_ipv6[1] = HTONS(CONFIG_EXAMPLES_TCPBLASTER_SERVERIPv6ADDR_2);
	g_tcpblasterserver_ipv6[2] = HTONS(CONFIG_EXAMPLES_TCPBLASTER_SERVERIPv6ADDR_3);
	g_tcpblasterserver_ipv6[3] = HTONS(CONFIG_EXAMPLES_TCPBLASTER_SERVERIPv6ADDR_4);
	g_tcpblasterserver_ipv6[4] = HTONS(CONFIG_EXAMPLES_TCPBLASTER_SERVERIPv6ADDR_5);
	g_tcpblasterserver_ipv6[5] = HTONS(CONFIG_EXAMPLES_TCPBLASTER_SERVERIPv6ADDR_6);
	g_tcpblasterserver_ipv6[6] = HTONS(CONFIG_EXAMPLES_TCPBLASTER_SERVERIPv6ADDR_7);
	g_tcpblasterserver_ipv6[7] = HTONS(CONFIG_EXAMPLES_TCPBLASTER_SERVERIPv6ADDR_8);
#endif
#else
#if defined(CONFIG_EXAMPLES_TCPBLASTER_LOOPBACK) && defined(CONFIG_NET_LOOPBACK)
