...
#ifdef CONFIG_NX_KBD
static const uint8_t g_kbdmsg1[] = "ROUX is cool!";
static const uint8_t g_kbdmsg2[] = "ROUX is fun!";
#endif
...
static void nxeg_initstate(FAR struct nxeg_state_s *st, int wnum, nxgl_mxpixel_t color)
{
#ifdef CONFIG_NX_KBD
...
static int nxeg_initialize(void)
{
	...
	if (g_hnx) {
		...
		struct boardioc_vncstart_s vnc = {0, g_hnx};
