...
int lorawan_radioenge_send_msg(unsigned char *pt_payload_uplink_hexstring, int size_uplink,
							   unsigned char *pt_payload_downlink_hexstring, int max_size_downlink,
							   int time_to_wait_ms);
