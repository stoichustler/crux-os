...
static void put_ad(uint8_t ad_type, uint8_t ad_len, FAR const void *ad, FAR uint8_t *buf,
				   FAR uint8_t *len);
...
static const char *g_gap_name = "ROUX NimBLE";
...
static void update_ad(void)
{
	...
	put_ad(BLE_HS_ADV_TYPE_COMP_NAME, sizeof(g_gap_name), g_gap_name, ad, &ad_len);
