...
#if defined(CONFIG_EXAMPLES_NXTERM_BPP) && CONFIG_EXAMPLES_NXTERM_BPP != 1 &&                      \
	CONFIG_EXAMPLES_NXTERM_BPP != 2 && CONFIG_EXAMPLES_NXTERM_BPP != 4 &&                          \
	CONFIG_EXAMPLES_NXTERM_BPP != 8 && CONFIG_EXAMPLES_NXTERM_BPP != 16 &&                         \
