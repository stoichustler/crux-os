...
int main(int argc, FAR char *argv[])
{
	...
	for (elapsed = 0; elapsed < wdog.pingtime; elapsed = current_time_ms - start_ms) {
		...
		printf("wdog_main:"
			   " flags=%08" PRIu32 " timeout=%" PRIu32 " timeleft=%" PRIu32 "\n",
		...
		current_time_ms = (uint64_t)((tnow.tv_sec * 1000) + (tnow.tv_nsec / 1000000));
	}
