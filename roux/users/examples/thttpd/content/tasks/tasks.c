...
static const char *g_statenames[] = {"INVALID ", "PENDING ", "READY   ",
									 "RUNNING ", "INACTIVE", "WAITSEM ",
...
static const char *g_ttypenames[4] = {"TASK   ", "PTHREAD", "KTHREAD", "--?--  "};

static FAR const char *g_policynames[4] = {"FIFO", "RR  ", "SPOR", "OTHR"};
