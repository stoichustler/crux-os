...
static void pwlines_wndo_redraw(NXTKWINDOW hwnd, FAR const struct nxgl_rect_s *rect, bool morem,
								FAR void *arg);
static void pwlines_wndo_position(NXTKWINDOW hwnd, FAR FAR const struct nxgl_size_s *size,
...
static void pwlines_wndo_redraw(NXTKWINDOW hwnd, FAR const struct nxgl_rect_s *rect, bool more,
								FAR void *arg)
{
...
static void pwlines_wndo_position(NXTKWINDOW hwnd, FAR const struct nxgl_size_s *size,
								  FAR const struct nxgl_point_s *pos,
								  FAR const struct nxgl_rect_s *bounds, FAR void *arg)
{
