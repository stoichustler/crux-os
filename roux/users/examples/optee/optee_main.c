...
#define PTA_DEVICE_ENUM                                                                            \
	{                                                                                              \
		0x7011a688, 0xddde, 0x4053, 0xa5, 0xa9,                                                    \
		{                                                                                          \
...
static int tee_invoke(int fd, uint32_t session, uint32_t func, struct tee_ioctl_param *params,
					  size_t num_params)
{
	...
	ioc_args_len = sizeof(struct tee_ioctl_invoke_arg) + TEE_IOCTL_PARAM_SIZE(num_params);
