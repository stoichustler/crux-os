...
static void do_wake_test(enum e_test_type type, int flags)
{
	...
	for (tidx = 0; tidx < nthreads; tidx++) {
		ret =
			pthread_create(&tid[tidx], NULL, thread_funcs[type].fn, (pthread_addr_t)(intptr_t)tidx);
...
TEST(wake_with_signal, abort_blocking_connect_multithread)
{
	...
	do_wake_test(TEST_TYPE_CONNECT, TEST_FLAG_DAEMON_ABORT | TEST_FLAG_MULTI_THREAD);
}
...
TEST(wake_with_signal, abort_blocking_send_multithread)
{
	...
	do_wake_test(TEST_TYPE_SEND, TEST_FLAG_DAEMON_ABORT | TEST_FLAG_MULTI_THREAD);
}
...
TEST(wake_with_signal, abort_blocking_recv_multithread)
{
	...
	do_wake_test(TEST_TYPE_RECV, TEST_FLAG_DAEMON_ABORT | TEST_FLAG_MULTI_THREAD);
}
...
TEST(wake_with_signal, pending_request_blocking_connect)
{
	...
	do_wake_test(TEST_TYPE_CONNECT, TEST_FLAG_DAEMON_ABORT | TEST_FLAG_PAUSE_USRSOCK_HANDLING);
}
...
TEST(wake_with_signal, pending_request_blocking_send)
{
	...
	do_wake_test(TEST_TYPE_SEND, TEST_FLAG_DAEMON_ABORT | TEST_FLAG_PAUSE_USRSOCK_HANDLING);
}
...
TEST(wake_with_signal, pending_request_blocking_recv)
{
	...
	do_wake_test(TEST_TYPE_RECV, TEST_FLAG_DAEMON_ABORT | TEST_FLAG_PAUSE_USRSOCK_HANDLING);
}
...
TEST(wake_with_signal, pending_request_blocking_open)
{
	...
	do_wake_test(TEST_TYPE_SOCKET, TEST_FLAG_DAEMON_ABORT | TEST_FLAG_PAUSE_USRSOCK_HANDLING);
}
...
TEST(wake_with_signal, pending_request_blocking_close)
{
	...
	do_wake_test(TEST_TYPE_CLOSE, TEST_FLAG_DAEMON_ABORT | TEST_FLAG_PAUSE_USRSOCK_HANDLING);
}
...
TEST(wake_with_signal, pending_request_blocking_poll)
{
	...
	do_wake_test(TEST_TYPE_POLL, TEST_FLAG_DAEMON_ABORT | TEST_FLAG_PAUSE_USRSOCK_HANDLING);
}
...
TEST(wake_with_signal, pending_request_blocking_setsockopt)
{
	...
	do_wake_test(TEST_TYPE_SETSOCKOPT, TEST_FLAG_DAEMON_ABORT | TEST_FLAG_PAUSE_USRSOCK_HANDLING);
}
...
TEST(wake_with_signal, pending_request_blocking_getsockopt)
{
	...
	do_wake_test(TEST_TYPE_GETSOCKOPT, TEST_FLAG_DAEMON_ABORT | TEST_FLAG_PAUSE_USRSOCK_HANDLING);
}
...
TEST_GROUP(wake_with_signal)
{
	...
	RUN_TEST_CASE(wake_with_signal, pending_request_blocking_connect_multithread);
	RUN_TEST_CASE(wake_with_signal, pending_request_blocking_send);
	RUN_TEST_CASE(wake_with_signal, pending_request_blocking_send_multithread);
	RUN_TEST_CASE(wake_with_signal, pending_request_blocking_recv);
	RUN_TEST_CASE(wake_with_signal, pending_request_blocking_recv_multithread);
	RUN_TEST_CASE(wake_with_signal, pending_request_blocking_open);
	RUN_TEST_CASE(wake_with_signal, pending_request_blocking_open_multithread);
	RUN_TEST_CASE(wake_with_signal, pending_request_blocking_close);
	RUN_TEST_CASE(wake_with_signal, pending_request_blocking_close_multithread);
	RUN_TEST_CASE(wake_with_signal, pending_request_blocking_poll);
	RUN_TEST_CASE(wake_with_signal, pending_request_blocking_poll_multithread);
	RUN_TEST_CASE(wake_with_signal, pending_request_blocking_setsockopt);
	RUN_TEST_CASE(wake_with_signal, pending_request_blocking_setsockopt_multithread);
	RUN_TEST_CASE(wake_with_signal, pending_request_blocking_getsockopt);
	RUN_TEST_CASE(wake_with_signal, pending_request_blocking_getsockopt_multithread);
}
