...
#if defined(CONFIG_EXAMPLES_FOC_SENSORLESS) && defined(CONFIG_EXAMPLES_FOC_SENSORED)
...
#if defined(CONFIG_EXAMPLES_FOC_HAVE_POS) && !defined(CONFIG_EXAMPLES_FOC_HAVE_VEL)
#error Position controller needs velocity controller
#endif

/* Velocity controller needs torque controller */

#if defined(CONFIG_EXAMPLES_FOC_HAVE_VEL) && !defined(CONFIG_EXAMPLES_FOC_HAVE_TORQ)
...
#if defined(CONFIG_INDUSTRY_FOC_HANDLER_PRINT) && (CONFIG_EXAMPLES_FOC_STATE_PRINT_FREQ > 0)
#define FOC_STATE_PRINT_PRE                                                                        \
	(CONFIG_EXAMPLES_FOC_NOTIFIER_FREQ / CONFIG_EXAMPLES_FOC_STATE_PRINT_FREQ)
#else
...
#if !defined(CONFIG_EXAMPLES_FOC_SETPOINT_CONST) && !defined(CONFIG_EXAMPLES_FOC_SETPOINT_ADC) &&  \
...
#if !defined(CONFIG_EXAMPLES_FOC_VBUS_CONST) && !defined(CONFIG_EXAMPLES_FOC_VBUS_ADC)
...
#define VBUS_ADC_SCALE                                                                             \
	(CONFIG_EXAMPLES_FOC_ADC_VREF * CONFIG_EXAMPLES_FOC_VBUS_SCALE / CONFIG_EXAMPLES_FOC_ADC_MAX / \
	 1000.0f / 1000.0f)
#endif
...
#define VEL_CONTROL_PRESCALER (CONFIG_EXAMPLES_FOC_NOTIFIER_FREQ / CONFIG_EXAMPLES_FOC_VELCTRL_FREQ)
