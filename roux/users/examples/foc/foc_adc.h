...
#if defined(CONFIG_EXAMPLES_FOC_SETPOINT_ADC) && defined(CONFIG_EXAMPLES_FOC_VBUS_ADC)
#define ADC_SAMPLES (2)
#elif defined(CONFIG_EXAMPLES_FOC_SETPOINT_ADC) || defined(CONFIG_EXAMPLES_FOC_VBUS_ADC)
