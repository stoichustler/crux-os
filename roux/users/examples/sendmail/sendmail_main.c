...
#define CONFIG_EXAMPLES_SENDMAIL_SENDER "roux-testing@example.com"
#endif

#ifndef CONFIG_EXAMPLES_SENDMAIL_SUBJECT
#define CONFIG_EXAMPLES_SENDMAIL_SUBJECT "Testing SMTP from ROUX"
#endif

#ifndef CONFIG_EXAMPLES_SENDMAIL_BODY
#define CONFIG_EXAMPLES_SENDMAIL_BODY "Test message sent by ROUX"
#endif
...
int main(int argc, FAR char *argv[])
{
	...
	if (handle) {
		...
		smtp_send(handle, g_recipient, NULL, g_sender, g_subject, g_msg_body, strlen(g_msg_body));
		smtp_close(handle);
	}
