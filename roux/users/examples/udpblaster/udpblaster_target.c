...
#if defined(CONFIG_EXAMPLES_UDPBLASTER_INIT) && defined(CONFIG_EXAMPLES_UDPBLASTER_IPv6) &&        \
	!defined(CONFIG_NET_ICMPv6_AUTOCONF)
/* Our host IPv6 address */

static const uint16_t g_ipv6_hostaddr[8] = {
	HTONS(CONFIG_EXAMPLES_UDPBLASTER_TARGETIPv6_1), HTONS(CONFIG_EXAMPLES_UDPBLASTER_TARGETIPv6_2),
	HTONS(CONFIG_EXAMPLES_UDPBLASTER_TARGETIPv6_3), HTONS(CONFIG_EXAMPLES_UDPBLASTER_TARGETIPv6_4),
	HTONS(CONFIG_EXAMPLES_UDPBLASTER_TARGETIPv6_5), HTONS(CONFIG_EXAMPLES_UDPBLASTER_TARGETIPv6_6),
...
static const uint16_t g_ipv6_draddr[8] = {
	HTONS(CONFIG_EXAMPLES_UDPBLASTER_HOSTIPv6_1), HTONS(CONFIG_EXAMPLES_UDPBLASTER_HOSTIPv6_2),
	HTONS(CONFIG_EXAMPLES_UDPBLASTER_HOSTIPv6_3), HTONS(CONFIG_EXAMPLES_UDPBLASTER_HOSTIPv6_4),
	HTONS(CONFIG_EXAMPLES_UDPBLASTER_HOSTIPv6_5), HTONS(CONFIG_EXAMPLES_UDPBLASTER_HOSTIPv6_6),
	HTONS(CONFIG_EXAMPLES_UDPBLASTER_HOSTIPv6_7), HTONS(CONFIG_EXAMPLES_UDPBLASTER_HOSTIPv6_8),
};
...
#endif /* CONFIG_EXAMPLES_UDPBLASTER_INIT && CONFIG_EXAMPLES_UDPBLASTER_IPv6 &&                    \
...
static void netest_initialize(void)
{
	...
	netlib_set_ipv6addr("eth0", (FAR const struct in6_addr *)g_ipv6_hostaddr);

	/* Set up the default router address */

	netlib_set_dripv6addr("eth0", (FAR const struct in6_addr *)g_ipv6_draddr);

	/* Setup the subnet mask */

	netlib_set_ipv6netmask("eth0", (FAR const struct in6_addr *)g_ipv6_netmask);
...
int main(int argc, FAR char *argv[])
{
	...
	for (;;) {
		...
		ret = sendto(sockfd, g_udpblaster_text, UDPBLASTER_SENDSIZE, 0, (struct sockaddr *)&host,
					 addrlen);
		if (ret < 0) {
