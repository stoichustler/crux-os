...
static const struct cmdmap_s g_cmdmap[] = {{"cd", cmd_rchdir, 2, 2, "<directory>"},
...
{
	fprintf(stderr, "Usage: ftpc [-46n] host [port]\n\
      \t-4    Use IPv4\n\
      \t-6    Use IPv6\n\
...
#else
		ret = readline_stream(g_line, CONFIG_FTPC_LINELEN, stdin, stdout);
