...
#endif
	{"Points", ft80x_prim_points},		   {"Lines", ft80x_prim_lines},
	{"Line Strip", ft80x_prim_linestrip},  {"Edge Strip R", ft80x_prim_edgestrip_r},
	{"Rectangles", ft80x_prim_rectangles}, {"Scissor", ft80x_prim_scissor},
	{"Stencil", ft80x_prim_stencil},	   {"Alpha Blend", ft80x_prim_alphablend}};
...
static int ft80x_showname(int fd, FAR struct ft80x_dlbuffer_s *buffer, FAR const char *name)
{
	struct {
