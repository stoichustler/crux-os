...
#define BILL_INDICADOR                                                                             \
	(1 << 4) /* This bit is inverted at each                                                       \
			  * replenishment of demand */
#define REACT_INTERVAL                                                                             \
	(1 << 5) /* Reactive Interval Indicator, inverted                                              \
			  * at end of reactive interval                                                        \
			  * consumption */
#define REACT_CAP_PULSE                                                                            \
	(1 << 6) /* If equal 1 means that reactive                                                     \
			  * capacitive pulses are computed to                                                  \
			  * calculate UFER and DMCR */
#define REACT_IND_PULSE                                                                            \
	(1 << 7) /* If equal 1 means that reactive                                                     \
