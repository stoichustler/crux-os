...
struct foc_routine_ops_b16_s {
	...
	CODE int (*run)(FAR foc_routine_b16_t *h, FAR struct foc_routine_in_b16_s *in,
...
int foc_routine_init_b16(FAR foc_routine_b16_t *r, FAR struct foc_routine_ops_b16_s *ops);
...
int foc_routine_run_b16(FAR foc_routine_b16_t *r, FAR struct foc_routine_in_b16_s *in,
						FAR struct foc_routine_out_b16_s *out);
