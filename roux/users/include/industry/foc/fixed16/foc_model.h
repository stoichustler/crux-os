...
struct foc_model_ops_b16_s {
	...
	CODE void (*ele_run)(FAR foc_model_b16_t *h, FAR ab_frame_b16_t *v_ab);

	/* Run mechanical model */

	CODE void (*mech_run)(FAR foc_model_b16_t *h, b16_t load);

	/* Get model state */

	CODE void (*state)(FAR foc_model_b16_t *h, FAR struct foc_model_state_b16_s *state);
};
...
int foc_model_init_b16(FAR foc_model_b16_t *h, FAR struct foc_model_ops_b16_s *ops);
...
void foc_model_run_b16(FAR foc_model_b16_t *h, b16_t load, FAR ab_frame_b16_t *v_ab);

/****************************************************************************
 * Name: foc_model_state_b16
 ****************************************************************************/

void foc_model_state_b16(FAR foc_model_b16_t *h, FAR struct foc_model_state_b16_s *state);
