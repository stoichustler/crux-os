...
struct foc_modulation_ops_b16_s {
	...
	CODE void (*vbase_get)(FAR foc_handler_b16_t *h, b16_t vbus, FAR b16_t *vbase);

	/* Run modulation */

	CODE void (*run)(FAR foc_handler_b16_t *h, FAR ab_frame_b16_t *v_ab_mod, FAR b16_t *duty);

	/* Get modulation state */

	CODE void (*state_get)(FAR foc_handler_b16_t *h, FAR void *state);
};
...
struct foc_control_ops_b16_s {
	...
	CODE void (*input_set)(FAR foc_handler_b16_t *h, FAR b16_t *current, b16_t vbase, b16_t angle);

	/* Run voltage controller */

	CODE void (*voltage_run)(FAR foc_handler_b16_t *h, FAR dq_frame_b16_t *dq_ref,
							 FAR ab_frame_b16_t *v_ab_mod);

	/* Run current controller */

	CODE void (*current_run)(FAR foc_handler_b16_t *h, FAR dq_frame_b16_t *dq_ref,
							 FAR dq_frame_b16_t *vdq_comp, FAR ab_frame_b16_t *v_ab_mod);

	/* Get controller state data */

	CODE void (*state_get)(FAR foc_handler_b16_t *h, FAR struct foc_state_b16_s *state);
};
...
int foc_handler_init_b16(FAR foc_handler_b16_t *h, FAR struct foc_control_ops_b16_s *ctrl,
...
int foc_handler_run_b16(FAR foc_handler_b16_t *h, FAR struct foc_handler_input_b16_s *in,
...
void foc_handler_cfg_b16(FAR foc_handler_b16_t *h, FAR void *ctrl_cfg, FAR void *mod_cfg);

/****************************************************************************
 * Name: foc_handler_state_b16
 ****************************************************************************/

void foc_handler_state_b16(FAR foc_handler_b16_t *h, FAR struct foc_state_b16_s *state,
						   FAR void *mod_state);
