...
struct foc_angle_ops_b16_s {
	...
	CODE int (*run)(FAR foc_angle_b16_t *h, FAR struct foc_angle_in_b16_s *in,
...
int foc_angle_init_b16(FAR foc_angle_b16_t *h, FAR struct foc_angle_ops_b16_s *ops);
...
int foc_angle_run_b16(FAR foc_angle_b16_t *h, FAR struct foc_angle_in_b16_s *in,
					  FAR struct foc_angle_out_b16_s *out);
