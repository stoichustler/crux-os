...
struct foc_velocity_ops_b16_s {
	...
	CODE int (*run)(FAR foc_velocity_b16_t *h, FAR struct foc_velocity_in_b16_s *in,
...
int foc_velocity_init_b16(FAR foc_velocity_b16_t *h, FAR struct foc_velocity_ops_b16_s *ops);
...
int foc_velocity_run_b16(FAR foc_velocity_b16_t *h, FAR struct foc_velocity_in_b16_s *in,
						 FAR struct foc_velocity_out_b16_s *out);
