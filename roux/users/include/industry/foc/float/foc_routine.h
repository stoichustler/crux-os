...
struct foc_routine_ops_f32_s {
	...
	CODE int (*run)(FAR foc_routine_f32_t *h, FAR struct foc_routine_in_f32_s *in,
...
int foc_routine_init_f32(FAR foc_routine_f32_t *r, FAR struct foc_routine_ops_f32_s *ops);
...
int foc_routine_run_f32(FAR foc_routine_f32_t *r, FAR struct foc_routine_in_f32_s *in,
						FAR struct foc_routine_out_f32_s *out);
