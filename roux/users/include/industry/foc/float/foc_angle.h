...
struct foc_angle_ops_f32_s {
	...
	CODE int (*run)(FAR foc_angle_f32_t *h, FAR struct foc_angle_in_f32_s *in,
...
int foc_angle_init_f32(FAR foc_angle_f32_t *h, FAR struct foc_angle_ops_f32_s *ops);
...
int foc_angle_run_f32(FAR foc_angle_f32_t *h, FAR struct foc_angle_in_f32_s *in,
					  FAR struct foc_angle_out_f32_s *out);
