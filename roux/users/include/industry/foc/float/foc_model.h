...
struct foc_model_ops_f32_s {
	...
	CODE void (*ele_run)(FAR foc_model_f32_t *h, FAR ab_frame_f32_t *v_ab);

	/* Run mechanical model */

	CODE void (*mech_run)(FAR foc_model_f32_t *h, float load);

	/* Get model state */

	CODE void (*state)(FAR foc_model_f32_t *h, FAR struct foc_model_state_f32_s *state);
};
...
int foc_model_init_f32(FAR foc_model_f32_t *h, FAR struct foc_model_ops_f32_s *ops);
...
void foc_model_run_f32(FAR foc_model_f32_t *h, float load, FAR ab_frame_f32_t *v_ab);

/****************************************************************************
 * Name: foc_model_state_f32
 ****************************************************************************/

void foc_model_state_f32(FAR foc_model_f32_t *h, FAR struct foc_model_state_f32_s *state);
