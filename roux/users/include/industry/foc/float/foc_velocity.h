...
struct foc_velocity_ops_f32_s {
	...
	CODE int (*run)(FAR foc_velocity_f32_t *h, FAR struct foc_velocity_in_f32_s *in,
...
int foc_velocity_init_f32(FAR foc_velocity_f32_t *h, FAR struct foc_velocity_ops_f32_s *ops);
...
int foc_velocity_run_f32(FAR foc_velocity_f32_t *h, FAR struct foc_velocity_in_f32_s *in,
						 FAR struct foc_velocity_out_f32_s *out);
