...
struct foc_modulation_ops_f32_s {
	...
	CODE void (*vbase_get)(FAR foc_handler_f32_t *h, float vbus, FAR float *vbase);

	/* Run modulation */

	CODE void (*run)(FAR foc_handler_f32_t *h, FAR ab_frame_f32_t *v_ab_mod, FAR float *duty);

	/* Get modulation state */

	CODE void (*state_get)(FAR foc_handler_f32_t *h, FAR void *state);
};
...
struct foc_control_ops_f32_s {
	...
	CODE void (*input_set)(FAR foc_handler_f32_t *h, FAR float *current, float vbase, float angle);

	/* Run voltage controller */

	CODE void (*voltage_run)(FAR foc_handler_f32_t *h, FAR dq_frame_f32_t *dq_ref,
							 FAR ab_frame_f32_t *v_ab_mod);

	/* Run current controller */

	CODE void (*current_run)(FAR foc_handler_f32_t *h, FAR dq_frame_f32_t *dq_ref,
							 FAR dq_frame_f32_t *vdq_comp, FAR ab_frame_f32_t *v_ab_mod);

	/* Get controller state data */

	CODE void (*state_get)(FAR foc_handler_f32_t *h, FAR struct foc_state_f32_s *state);
};
...
int foc_handler_init_f32(FAR foc_handler_f32_t *h, FAR struct foc_control_ops_f32_s *ctrl,
...
int foc_handler_run_f32(FAR foc_handler_f32_t *h, FAR struct foc_handler_input_f32_s *in,
...
void foc_handler_cfg_f32(FAR foc_handler_f32_t *h, FAR void *ctrl_cfg, FAR void *mod_cfg);

/****************************************************************************
 * Name: foc_handler_state_f32
 ****************************************************************************/

void foc_handler_state_f32(FAR foc_handler_f32_t *h, FAR struct foc_state_f32_s *state,
						   FAR void *mod_state);
