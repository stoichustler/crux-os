...
int sixlowpan_get_req(int sock, FAR const char *ifname, FAR struct ieee802154_get_req_s *req);
int sixlowpan_gts_req(int sock, FAR const char *ifname, FAR const struct ieee802154_gts_req_s *req);
...
int sixlowpan_set_req(int sock, FAR const char *ifname, FAR const struct ieee802154_set_req_s *req);
...
int sixlowpan_getdevmode(int fd, FAR const char *ifname, FAR enum ieee802154_devmode_e *devmode);
