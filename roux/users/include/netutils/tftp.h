...
typedef ssize_t (*tftp_callback_t)(FAR void *ctx, uint32_t offset, FAR uint8_t *buf, size_t len);
...
int tftpget_cb(FAR const char *remote, in_addr_t addr, bool binary, tftp_callback_t cb,
			   FAR void *ctx);
