...
#include <roux/net/netfilter/netfilter.h>
...
struct xtables_globals {
	...
	noreturn_function void (*exit_err)(enum xtables_exittype status, FAR const char *msg, ...)
		printf_like(2, 3);
...
struct xtables_match {
	...
	int (*parse)(int c, FAR char **argv, int invert, FAR unsigned int *flags, FAR const void *entry,
				 FAR struct xt_entry_match **match);
	...
	void (*print)(FAR const void *ip, FAR const struct xt_entry_match *match, int numeric);
	...
	int (*xlate)(FAR struct xt_xlate *xl, FAR const struct xt_xlate_mt_params *params);
...
struct xtables_target {
	...
	void (*print)(FAR const void *ip, FAR const struct xt_entry_target *target, int numeric);

	/* Saves the targinfo in parsable form to stdout. */

	void (*save)(FAR const void *ip, FAR const struct xt_entry_target *target);
	...
	int (*xlate)(FAR struct xt_xlate *xl, FAR const struct xt_xlate_tg_params *params);
	size_t udata_size;
...
void xtables_option_tpcall(unsigned int, FAR char **, bool, FAR struct xtables_target *,
						   FAR void *);
void xtables_option_mpcall(unsigned int, FAR char **, bool, FAR struct xtables_match *, FAR void *);
void xtables_option_tfcall(FAR struct xtables_target *);
void xtables_option_mfcall(FAR struct xtables_match *);
FAR struct option *xtables_options_xfrm(FAR struct option *, FAR struct option *,
										FAR const struct xt_option_entry *, FAR unsigned int *);
FAR struct option *xtables_merge_options(FAR struct option *origopts, FAR struct option *oldopts,
										 FAR const struct option *newopts,
										 FAR unsigned int *option_offset);
FAR struct xtables_match *xtables_find_match(FAR const char *name, enum xtables_tryload,
											 FAR struct xtables_rule_match **match);
FAR struct xtables_target *xtables_find_target(FAR const char *name, enum xtables_tryload);
int xtables_compatible_revision(FAR const char *name, uint8_t revision, int opt);
