...
typedef void (*telnet_event_handler_t)(struct telnet_s *telnet, union telnet_event_u *event,
									   void *user_data);
...
struct telnet_s *telnet_init(const struct telnet_telopt_s *telopts, telnet_event_handler_t eh,
...
void telnet_negotiate(struct telnet_s *telnet, unsigned char cmd, unsigned char opt);
...
void telnet_subnegotiation(struct telnet_s *telnet, unsigned char telopt, const char *buffer,
						   size_t size);
...
int telnet_printf(struct telnet_s *telnet, const char *fmt, ...) printf_like(2, 3);
...
int telnet_vprintf(struct telnet_s *telnet, const char *fmt, va_list va) printf_like(2, 0);
...
int telnet_raw_printf(struct telnet_s *telnet, const char *fmt, ...) printf_like(2, 3);
...
int telnet_raw_vprintf(struct telnet_s *telnet, const char *fmt, va_list va) printf_like(2, 0);
...
void telnet_newenviron_value(struct telnet_s *telnet, unsigned char type, const char *string);
