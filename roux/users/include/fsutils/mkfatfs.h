...
#define FAT_FORMAT_INITIALIZER                                                                     \
	{                                                                                              \
		MKFATFS_DEFAULT_NFATS, MKFATFS_DEFAULT_FATTYPE, MKFATFS_DEFAULT_CLUSTSHIFT,                \
			MKFATFS_DEFAULT_VOLUMELABEL, MKFATFS_DEFAULT_BKUPBOOT, MKFATFS_DEFAULT_ROOTDIRENTS,    \
			MKFATFS_DEFAULT_RSVDSECCOUNT, MKFATFS_DEFAULT_HIDSEC, MKFATFS_DEFAULT_VOLUMEID,        \
