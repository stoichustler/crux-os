...
struct termcurses_ops_s {
	...
	CODE int (*setcolors)(FAR struct termcurses_s *dev, FAR struct termcurses_colors_s *colors);
...
int termcurses_setcolors(FAR struct termcurses_s *term, FAR struct termcurses_colors_s *colors);
