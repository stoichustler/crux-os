...
int ft80x_ramg_write(int fd, unsigned int offset, FAR const void *data, unsigned int nbytes);
...
int ft80x_audio_playfile(int fd, FAR struct ft80x_dlbuffer_s *buffer, FAR const char *filepath,
						 uint8_t format, uint16_t frequency, uint8_t volume);
...
int ft80x_gpio_configure(int fd, uint8_t gpio, uint8_t dir, uint8_t drive, bool value);
