...
#define IFD_FIELD_ASCII                                                                            \
	2					  /* 8-bit byte that contains a 7-bit ASCII code.                          \
...
#define IFD_FIELD_RATIONAL                                                                         \
	5					  /* Two LONGs: the first represents the                                   \
						   * numerator of a fraction, the second the                               \
						   * denominator */
#define IFD_FIELD_SBYTE 6 /* An 8-bit signed (twos-complement) integer */
#define IFD_FIELD_UNDEFINED                                                                        \
	7 /* An 8-bit byte that may contain anything,                                                  \
	   * depending on the definition of the field */
#define IFD_FIELD_SSHORT                                                                           \
	8 /* A 16-bit (2-byte) signed (twos-complement)                                                \
	   * integer */
#define IFD_FIELD_SLONG                                                                            \
	9 /* A 32-bit (4-byte) signed (twos-complement)                                                \
	   * integer */
#define IFD_FIELD_SRATIONAL                                                                        \
	10						/* Two SLONG's: the first represents the                               \
							 * numerator of a fraction, the second the                             \
							 * denominator */
...
#define IFD_TAG_BITSPERSAMPLE                                                                      \
	258							/* BitsPerSample, SHORT (Required                                  \
...
#define TAG_FILLORDER_HIGH                                                                         \
	1 /*   Lower column values are stored in the                                                   \
	   *   higher-order bits */
#define TAG_FILLORDER_LOW                                                                          \
	2								 /*   Lower column values are stored in the                    \
									  *   lower-order bits */
...
#define IFD_TAG_SAMPLESPERPIXEL                                                                    \
	277								  /* SamplesPerPixel, SHORT (Required in                       \
...
#define IFD_TAG_COLORMAP                                                                           \
	320								 /* ColorMap, SHORT (Required in palette                       \
									  * color image files) */
...
struct tiff_info_s {
	 ...
	 *             provided in include/roux/video/fb.h.  Only the following
	...
	uint8_t colorfmt;		/* See FB_FMT_* definitions in include/roux/video/fb.h */
