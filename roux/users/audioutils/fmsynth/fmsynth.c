...
int fmsynthsnd_add_subsound(FAR fmsynth_sound_t *top, FAR fmsynth_sound_t *sub)
{
...
int fmsynth_rendering(FAR fmsynth_sound_t *snd, FAR int16_t *sample, int sample_num, int chnum,
