...
static int get_samples(FAR struct music_macro_lang_s *mml, int samples, int num, int dots,
					   bool plus_mode)
{
	int len;
...
static int sample_length(FAR struct music_macro_lang_s *mml, FAR char **score)
{
	int dots = 0;
	int samples = 0;
...
static int handle_note(FAR struct music_macro_lang_s *mml, char code, FAR char **score,
					   FAR struct mml_result_s *result)
{
	result->note_idx[0] = note_index(code) + halfscale(score) + mml->cur_octave * 12;
...
static int handle_rest(FAR struct music_macro_lang_s *mml, FAR char **score,
					   FAR struct mml_result_s *result)
{
...
static int handle_tempo(FAR struct music_macro_lang_s *mml, FAR char **score,
						FAR struct mml_result_s *result)
{
...
static int handle_length(FAR struct music_macro_lang_s *mml, FAR char **score,
						 FAR struct mml_result_s *result)
{
...
static int handle_octave(FAR struct music_macro_lang_s *mml, char code, FAR char **score,
						 FAR struct mml_result_s *result)
{
...
static int handle_volume(FAR struct music_macro_lang_s *mml, FAR char **score,
						 FAR struct mml_result_s *result)
{
...
static int count_tupletnotes(FAR struct music_macro_lang_s *mml, FAR char *score)
{
...
static int handle_starttuplet(FAR struct music_macro_lang_s *mml, FAR char **score,
							  FAR struct mml_result_s *result)
{
	int ret;
...
static int handle_stoptuplet(FAR struct music_macro_lang_s *mml, FAR char **score,
							 FAR struct mml_result_s *result)
{
...
static int handle_tupletnote(FAR struct music_macro_lang_s *mml, char code, FAR char **score,
							 FAR struct mml_result_s *result)
{
...
static int handle_notes(FAR struct music_macro_lang_s *mml, char code, FAR char **score,
						FAR struct mml_result_s *result)
{
	int ret;
...
static int handle_startchord(FAR struct music_macro_lang_s *mml, FAR char **score,
							 FAR struct mml_result_s *result)
{
	char code;
	int note_idx;
...
static int handle_tone(FAR struct music_macro_lang_s *mml, FAR char **score,
					   FAR struct mml_result_s *result)
{
...
int init_mml(FAR struct music_macro_lang_s *mml, int fs, int tempo, int octave, int length)
{
	mml->fs = fs;
	mml->cur_tempo = tempo;
...
int parse_mml(FAR struct music_macro_lang_s *mml, FAR char **score, FAR struct mml_result_s *result)
{
	int ret;
	char code;
