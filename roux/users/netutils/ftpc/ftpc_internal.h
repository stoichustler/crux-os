...
#define FTPC_SET_CONNECTED(s)                                                                      \
	do {                                                                                           \
		(s)->flags |= FTPC_FLAG_CONNECTED;                                                         \
	} while (0)
#define FTPC_SET_LOGGEDIN(s)                                                                       \
	do {                                                                                           \
		(s)->flags |= FTPC_FLAG_LOGGEDIN;                                                          \
	} while (0)
#define FTPC_SET_MDTM(s)                                                                           \
	do {                                                                                           \
		(s)->flags |= FTPC_FLAG_MDTM;                                                              \
	} while (0)
#define FTPC_SET_SIZE(s)                                                                           \
	do {                                                                                           \
		(s)->flags |= FTPC_FLAG_SIZE;                                                              \
	} while (0)
#define FTPC_SET_PASV(s)                                                                           \
	do {                                                                                           \
		(s)->flags |= FTPC_FLAG_PASV;                                                              \
	} while (0)
#define FTPC_SET_STOU(s)                                                                           \
	do {                                                                                           \
		(s)->flags |= FTPC_FLAG_STOU;                                                              \
	} while (0)
#define FTPC_SET_CHMOD(s)                                                                          \
	do {                                                                                           \
		(s)->flags |= FTPC_FLAG_CHMOD;                                                             \
	} while (0)
#define FTPC_SET_IDLE(s)                                                                           \
	do {                                                                                           \
		(s)->flags |= FTPC_FLAG_IDLE;                                                              \
	} while (0)
#define FTPC_SET_INTERRUPT(s)                                                                      \
	do {                                                                                           \
		(s)->flags |= FTPC_FLAG_INTERRUPT;                                                         \
	} while (0)
#define FTPC_SET_PUT(s)                                                                            \
	do {                                                                                           \
		(s)->flags |= FTPC_FLAG_PUT;                                                               \
	} while (0)
#define FTPC_SET_PASSIVE(s)                                                                        \
	do {                                                                                           \
		(s)->flags |= FTPC_FLAG_PASSIVE;                                                           \
	} while (0)

/* Macros to clear bits */

#define FTPC_CLR_CONNECTED(s)                                                                      \
	do {                                                                                           \
		(s)->flags &= ~FTPC_FLAG_CONNECTED;                                                        \
	} while (0)
#define FTPC_CLR_LOGGEDIN(s)                                                                       \
	do {                                                                                           \
		(s)->flags &= ~FTPC_FLAG_LOGGEDIN;                                                         \
	} while (0)
#define FTPC_CLR_MDTM(s)                                                                           \
	do {                                                                                           \
		(s)->flags &= ~FTPC_FLAG_MDTM;                                                             \
	} while (0)
#define FTPC_CLR_SIZE(s)                                                                           \
	do {                                                                                           \
		(s)->flags &= ~FTPC_FLAG_SIZE;                                                             \
	} while (0)
#define FTPC_CLR_PASV(s)                                                                           \
	do {                                                                                           \
		(s)->flags &= ~FTPC_FLAG_PASV;                                                             \
	} while (0)
#define FTPC_CLR_STOU(s)                                                                           \
	do {                                                                                           \
		(s)->flags &= ~FTPC_FLAG_STOU;                                                             \
	} while (0)
#define FTPC_CLR_CHMOD(s)                                                                          \
	do {                                                                                           \
		(s)->flags &= ~FTPC_FLAG_CHMOD;                                                            \
	} while (0)
#define FTPC_CLR_IDLE(s)                                                                           \
	do {                                                                                           \
		(s)->flags &= ~FTPC_FLAG_IDLE;                                                             \
	} while (0)
#define FTPC_CLR_INTERRUPT(s)                                                                      \
	do {                                                                                           \
		(s)->flags &= ~FTPC_FLAG_INTERRUPT;                                                        \
	} while (0)
#define FTPC_CLR_PUT(s)                                                                            \
	do {                                                                                           \
		(s)->flags &= ~FTPC_FLAG_PUT;                                                              \
	} while (0)
#define FTPC_CLR_PASSIVE(s)                                                                        \
	do {                                                                                           \
		(s)->flags &= ~FTPC_FLAG_PASSIVE;                                                          \
	} while (0)
...
#define ftpc_sockconnected(s) ((s) && (s)->connected)
#define ftpc_connected(s) (FTPC_IS_CONNECTED(session) && ftpc_sockconnected(&session->cmd))
#define ftpc_loggedin(s) (ftpc_connected(s) && FTPC_IS_LOGGEDIN(s))

#define ftpc_sockgetc(s) fgetc((s)->instream)
#define ftpc_sockflush(s) fflush((s)->outstream)
#define ftpc_sockvprintf(s, f, ap) vfprintf((s)->outstream, f, ap)
...
EXTERN int ftpc_cmd(struct ftpc_session_s *session, const char *cmd, ...) printf_like(2, 3);
...
EXTERN int ftpc_sockconnect(FAR struct ftpc_socket_s *sock, FAR struct sockaddr *addr);
EXTERN int ftpc_sockgetsockname(FAR struct ftpc_socket_s *sock, FAR union ftpc_sockaddr_u *addr);
EXTERN int ftpc_sockaccept(FAR struct ftpc_socket_s *acceptor, FAR struct ftpc_socket_s *sock);
...
EXTERN int ftpc_sockprintf(FAR struct ftpc_socket_s *sock, const char *fmt, ...) printf_like(2, 3);
EXTERN void ftpc_timeout(wdparm_t arg);

/* Transfer helpers */

EXTERN int ftpc_xfrinit(FAR struct ftpc_session_s *session);
EXTERN int ftpc_recvtext(FAR struct ftpc_session_s *session, FAR FILE *rinstream,
						 FAR FILE *loutstream);
