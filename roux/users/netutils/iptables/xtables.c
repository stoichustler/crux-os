...
int xtables_insmod(FAR const char *modname, FAR const char *modprobe, bool quiet)
{
	return -ENOSYS;
}
...
FAR struct option *xtables_options_xfrm(FAR struct option *orig_opts, FAR struct option *oldopts,
...
FAR struct xtables_match *xtables_find_match(FAR const char *name, enum xtables_tryload tryload,
											 FAR struct xtables_rule_match **match)
{
	return NULL;
}

FAR struct xtables_target *xtables_find_target(FAR const char *name, enum xtables_tryload tryload)
{
	return NULL;
}
