 ...
 * ROUX configuration file.  If they are are defined in the configuration
...
extern int tftp_mkreqpacket(uint8_t *buffer, size_t len, int opcode, const char *path, bool binary);
