...
#define CONFIG_LIBCURL4NX_USERAGENT "ROUX/" CONFIG_VERSION_STRING " (; http://www.nuttx.org/)"
#else
#define CONFIG_LIBCURL4NX_USERAGENT "ROUX/7.x (; http://www.nuttx.org/)"
#endif
#endif
...
static size_t curl4nx_default_writefunc(FAR char *ptr, size_t size, size_t nmemb, FAR void *data)
{
...
void curl4nx_easy_reset(FAR struct curl4nx_s *handle)
{
	...
	handle->port = 80;
	strlcpy(handle->useragent, CONFIG_LIBCURL4NX_USERAGENT, sizeof(handle->useragent));
