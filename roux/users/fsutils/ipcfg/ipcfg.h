...
int ipcfg_read_binary_ipv4(FAR const char *path, FAR struct ipv4cfg_s *ipv4cfg);
#endif
...
int ipcfg_read_binary_ipv6(FAR const char *path, FAR struct ipv6cfg_s *ipv6cfg);
#endif
...
#if defined(CONFIG_IPCFG_WRITABLE) && defined(CONFIG_IPCFG_BINARY) && defined(CONFIG_NET_IPv4)
int ipcfg_write_binary_ipv4(FAR const char *path, FAR const struct ipv4cfg_s *ipv4cfg);
#endif
...
#if defined(CONFIG_IPCFG_WRITABLE) && defined(CONFIG_IPCFG_BINARY) && defined(CONFIG_NET_IPv6)
int ipcfg_write_binary_ipv6(FAR const char *path, FAR const struct ipv6cfg_s *ipv6cfg);
#endif
