...
#define IMGFLAGS_ISBILEV(f) (((f)&IMGFLAGS_BILEV_BIT) != 0)
#define IMGFLAGS_ISGREY(f) (((f)&IMGFLAGS_GREY_BIT) != 0)
#define IMGFLAGS_ISGREY4(f) (((f) & (IMGFLAGS_GREY_BIT | IMGFLAGS_GREY8_BIT)) == IMGFLAGS_GREY_BIT)
#define IMGFLAGS_ISGREY8(f)                                                                        \
	(((f) & (IMGFLAGS_GREY_BIT | IMGFLAGS_GREY8_BIT)) == (IMGFLAGS_GREY_BIT | IMGFLAGS_GREY8_BIT))
#define IMGFLAGS_ISRGB(f) (((f)&IMGFLAGS_FMT_RGB24) != 0)
