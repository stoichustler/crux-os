 ...
 *
 * In order to better support ROUX based platforms, a special graphical user
 * interface has been created called NXWidgets. NXWidgets is written in C++
 * and integrates seamlessly with the ROUX NX graphics subsystem in order to
 * provide graphic objects, or "widgets", in the <a title="NX Graphics
 * Subsystem" href="https://bitbucket.org/roux/documentation/src/master/NXGraphicsSubsystem.html">
 ...
 * friendly" C++ constructs that are fully supported under ROUX. No
 ...
 * that provides windowing under ROUX. By adding NXWidgets, you can
 ...
 *  through serial).
 *
 *  Note 1: The current release of NwWM requires ROUX-7.24 or above.
 *
