...
int main(int argc, char *argv[])
{
  ...
  // Create an instance of the ROUX logo

  CRlePaletteBitmap *rouxBitmap = new CRlePaletteBitmap(&g_rouxBitmap160x160);
  updateMemoryUsage(&g_mmprevious, "After creating the bitmap");

  // Create a CImage instance

  CImage *image = test->createImage(static_cast<IBitmap*>(rouxBitmap));
  if (!image)
    {
