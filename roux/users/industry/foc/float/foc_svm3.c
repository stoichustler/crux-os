...
static void foc_modulation_current_f32(FAR foc_handler_f32_t *h, FAR float *curr);
static void foc_modulation_vbase_get_f32(FAR foc_handler_f32_t *h, float vbus, FAR float *vbase);
static void foc_modulation_run_f32(FAR foc_handler_f32_t *h, FAR ab_frame_f32_t *v_ab_mod,
								   FAR float *duty);
static void foc_modulation_state_f32(FAR foc_handler_f32_t *h, FAR void *v_priv);
...
static void foc_modulation_current_f32(FAR foc_handler_f32_t *h, FAR float *curr)
{
	...
	svm3_current_correct(&svm->state, &curr[0], &curr[1], &curr[2]);
#endif
}
...
static void foc_modulation_state_f32(FAR foc_handler_f32_t *h, FAR void *state)
{
	FAR struct foc_svm3mod_f32_s *svm = NULL;
