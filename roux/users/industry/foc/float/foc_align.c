...
int foc_routine_align_run_f32(FAR foc_routine_f32_t *r, FAR struct foc_routine_in_f32_s *in,
...
static void foc_align_dir_move_f32(FAR struct foc_align_f32_s *align, float dir, float dest)
{
	bool next = false;
...
static void foc_align_dir_hold_f32(FAR struct foc_align_f32_s *align, float dir, bool last,
								   bool diff)
{
	float tmp = 0.0f;
...
int foc_align_dir_run_f32(FAR struct foc_align_f32_s *align, FAR struct foc_routine_in_f32_s *in,
						  FAR struct foc_routine_out_f32_s *out)
{
	int ret = FOC_ROUTINE_RUN_NOTDONE;
	bool last = false;
...
int foc_routine_align_final_f32(FAR foc_routine_f32_t *r, FAR void *data)
{
	...
	memset(&a->final, 0,
		   (sizeof(struct foc_align_f32_s) - sizeof(struct foc_routine_align_cfg_f32_s)));
