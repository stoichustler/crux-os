...
static int foc_velocity_pll_run_f32(FAR foc_velocity_f32_t *h, FAR struct foc_velocity_in_f32_s *in,
...
static int foc_velocity_pll_cfg_f32(FAR foc_velocity_f32_t *h, FAR void *cfg)
{
	...
	motor_sobserver_pll_init(&pll->data, pll->cfg.kp, pll->cfg.ki);
