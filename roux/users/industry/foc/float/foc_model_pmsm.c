...
static void foc_model_pmsm_elerun_f32(FAR foc_model_f32_t *h, FAR ab_frame_f32_t *v_ab);
...
static int foc_model_pmsm_cfg_f32(FAR foc_model_f32_t *h, FAR void *cfg)
{
	...
	pmsm_phy_params_init(&phy, model->cfg.poles, model->cfg.res, model->cfg.ind, model->cfg.iner,
						 model->cfg.flux_link, model->cfg.ind_q, model->cfg.ind_d);
