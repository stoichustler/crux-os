...
static int foc_velocity_div_run_f32(FAR foc_velocity_f32_t *h, FAR struct foc_velocity_in_f32_s *in,
...
static int foc_velocity_div_cfg_f32(FAR foc_velocity_f32_t *h, FAR void *cfg)
{
	...
	motor_sobserver_div_init(&div->data, div->cfg.samples, div->cfg.filter, div->cfg.per);
