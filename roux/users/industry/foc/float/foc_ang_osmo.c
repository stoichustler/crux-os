...
static int foc_angle_osmo_run_f32(FAR foc_angle_f32_t *h, FAR struct foc_angle_in_f32_s *in,
								  ...
								  FAR struct foc_angle_out_f32_s *out)
{
	...
	motor_aobserver_smo(&ob->o, &in->state->iab, &in->state->vab, &ob->cfg.phy, in->dir, in->vel);
