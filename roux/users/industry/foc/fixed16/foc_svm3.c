...
static void foc_modulation_current_b16(FAR foc_handler_b16_t *h, FAR b16_t *curr);
static void foc_modulation_vbase_get_b16(FAR foc_handler_b16_t *h, b16_t vbus, FAR b16_t *vbase);
static void foc_modulation_run_b16(FAR foc_handler_b16_t *h, FAR ab_frame_b16_t *v_ab_mod,
								   FAR b16_t *duty);
static void foc_modulation_state_b16(FAR foc_handler_b16_t *h, FAR void *v_priv);
...
static void foc_modulation_current_b16(FAR foc_handler_b16_t *h, FAR b16_t *curr)
{
	...
	svm3_current_correct_b16(&svm->state, &curr[0], &curr[1], &curr[2]);
#endif
}
...
static void foc_modulation_state_b16(FAR foc_handler_b16_t *h, FAR void *state)
{
	FAR struct foc_svm3mod_b16_s *svm = NULL;
