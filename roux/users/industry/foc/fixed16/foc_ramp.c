...
int foc_ramp_init_b16(FAR struct foc_ramp_b16_s *ramp, b16_t per, b16_t thr, b16_t acc, b16_t dec)
{
	DEBUGASSERT(ramp);
	DEBUGASSERT(per > 0);
	DEBUGASSERT(thr > 0);
...
int foc_ramp_run_b16(FAR struct foc_ramp_b16_s *ramp, b16_t des, b16_t now, FAR b16_t *set)
{
	b16_t sign = b16ONE;
