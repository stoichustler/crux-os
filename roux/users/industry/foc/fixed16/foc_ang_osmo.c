...
static int foc_angle_osmo_run_b16(FAR foc_angle_b16_t *h, FAR struct foc_angle_in_b16_s *in,
								  ...
								  FAR struct foc_angle_out_b16_s *out)
{
	...
	motor_aobserver_smo_b16(&ob->o, &in->state->iab, &in->state->vab, &ob->cfg.phy, in->dir,
							in->vel);
