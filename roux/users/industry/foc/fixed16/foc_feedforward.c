...
int foc_feedforward_pmsm_b16(FAR struct motor_phy_params_b16_s *phy, FAR dq_frame_b16_t *idq,
							 b16_t vel_now, FAR dq_frame_b16_t *vdq_comp)
{
	DEBUGASSERT(phy);
	DEBUGASSERT(idq);
	...
	vdq_comp->q = -b16mulb16(vel_now, (phy->flux_link + b16mulb16(phy->ind, idq->d)));
