...
static int foc_velocity_div_run_b16(FAR foc_velocity_b16_t *h, FAR struct foc_velocity_in_b16_s *in,
...
static int foc_velocity_div_cfg_b16(FAR foc_velocity_b16_t *h, FAR void *cfg)
{
	...
	motor_sobserver_div_init_b16(&div->data, div->cfg.samples, div->cfg.filter, div->cfg.per);
									...
									FAR struct foc_velocity_out_b16_s *out)
{
	...
	out->velocity = b16mulb16(div->sensor_dir, motor_sobserver_speed_get_b16(&div->o));
