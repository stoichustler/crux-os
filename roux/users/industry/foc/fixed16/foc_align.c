...
int foc_routine_align_run_b16(FAR foc_routine_b16_t *r, FAR struct foc_routine_in_b16_s *in,
...
static void foc_align_dir_move_b16(FAR struct foc_align_b16_s *align, b16_t dir, b16_t dest)
{
	bool next = false;
...
static void foc_align_dir_hold_b16(FAR struct foc_align_b16_s *align, b16_t dir, bool last,
								   bool diff)
{
	b16_t tmp = 0;
...
int foc_align_dir_run_b16(FAR struct foc_align_b16_s *align, FAR struct foc_routine_in_b16_s *in,
						  FAR struct foc_routine_out_b16_s *out)
{
	int ret = FOC_ROUTINE_RUN_NOTDONE;
	bool last = false;
...
int foc_routine_align_cfg_b16(FAR foc_routine_b16_t *r, FAR void *cfg)
{
	...
	if (a->cfg.cb.zero == NULL || a->cfg.cb.dir == NULL || a->cfg.cb.priv == NULL) {
...
int foc_routine_align_final_b16(FAR foc_routine_b16_t *r, FAR void *data)
{
	...
	memset(&a->final, 0,
		   (sizeof(struct foc_align_b16_s) - sizeof(struct foc_routine_align_cfg_b16_s)));
