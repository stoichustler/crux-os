...
#include <roux/sensors/hall3ph.h>
...
static int foc_angle_hl_run_b16(FAR foc_angle_b16_t *h, FAR struct foc_angle_in_b16_s *in,
...
static b16_t g_sector_angle[7] = {b16muli(HALL_ANGLE_STEP, 0), b16muli(HALL_ANGLE_STEP, 1),
								  b16muli(HALL_ANGLE_STEP, 2), b16muli(HALL_ANGLE_STEP, 3),
								  b16muli(HALL_ANGLE_STEP, 4), b16muli(HALL_ANGLE_STEP, 5),
								...
								FAR struct foc_angle_out_b16_s *out)
{
	...
	hl->angle = b16mulb16(hl->sensor_dir, g_sector_angle[hl->sector]) + hl->angle_diff;
	...
	angle_norm_2pi_b16(&hl->angle, MOTOR_ANGLE_E_MIN_B16, MOTOR_ANGLE_E_MAX_B16);
