...
static int foc_angle_qe_run_b16(FAR foc_angle_b16_t *h, FAR struct foc_angle_in_b16_s *in,
								...
								FAR struct foc_angle_out_b16_s *out)
{
	...
	angle_norm_2pi_b16(&qe->angle, MOTOR_ANGLE_M_MIN_B16, MOTOR_ANGLE_M_MAX_B16);
