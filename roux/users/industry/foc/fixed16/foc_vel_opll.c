...
static int foc_velocity_pll_run_b16(FAR foc_velocity_b16_t *h, FAR struct foc_velocity_in_b16_s *in,
...
static int foc_velocity_pll_cfg_b16(FAR foc_velocity_b16_t *h, FAR void *cfg)
{
	...
	motor_sobserver_pll_init_b16(&pll->data, pll->cfg.kp, pll->cfg.ki);
									...
									FAR struct foc_velocity_out_b16_s *out)
{
	...
	out->velocity = b16mulb16(pll->sensor_dir, motor_sobserver_speed_get_b16(&pll->o));
