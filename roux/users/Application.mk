...
# Make sure the out-of-tree directory exists and ends with / when setting it.
...
ifneq ($(strip $(PROGNAME)),)
  ...
  PROGLIST := $(addprefix $(BINDIR)/,$(PROGNAME))
  REGLIST := $(addprefix $(BUILTIN_REGISTRY)/,$(addsuffix .bdat,$(PROGNAME)))
...
# HUSTLER: Rename 'main' as '{PROGNAME}_main'
$(MAINCOBJ): $(PREFIX)%.c$(SUFFIX)$(OBJEXT): %.c
