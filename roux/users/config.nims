...
switch "arm.roux.gcc.exe", "arm-none-eabi-gcc"
switch "arm64.roux.gcc.exe", "aarch64-none-elf-gcc"
switch "riscv32.roux.gcc.exe", "riscv64-unknown-elf-gcc"
switch "riscv64.roux.gcc.exe", "riscv64-unknown-elf-gcc"
switch "amd64.roux.gcc.exe", "x86_64-linux-gnu-gcc"
...
const key = "TOPDIR"
let topdir = if existsEnv(key): getEnv(key) else: thisDir() & "/../roux"
