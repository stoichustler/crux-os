...
static int perform_setrestart(FAR struct alt1250_s *dev, FAR struct usrsock_request_buff_s *req,
...
static int perform_seteventctx(FAR struct alt1250_s *dev, FAR struct usrsock_request_buff_s *req,
							   FAR int32_t *usock_result, FAR uint32_t *usock_xid,
							   FAR struct usock_ackinfo_s *ackinfo)
{
	FAR struct lte_ioctl_data_s *ltecmd = &req->req_ioctl.ltecmd;
	...
	if ((in != NULL) && (in->mqname != NULL) && (out != NULL)) {
		 ...
		 * On current ROUX(v10.1) checks strlen of mssage queue name
		 * as MAX_MQUEUE_PATH.
		 */
...
static int perform_geterrinfo(FAR struct alt1250_s *dev, FAR struct usrsock_request_buff_s *req,
							  FAR int32_t *usock_result, FAR uint32_t *usock_xid,
							  FAR struct usock_ackinfo_s *ackinfo)
{
	FAR struct lte_ioctl_data_s *ltecmd = &req->req_ioctl.ltecmd;
...
static int perform_saveapn(FAR struct alt1250_s *dev, FAR struct usrsock_request_buff_s *req,
						   FAR int32_t *usock_result, FAR uint32_t *usock_xid,
						   FAR struct usock_ackinfo_s *ackinfo)
{
	FAR struct lte_ioctl_data_s *ltecmd = &req->req_ioctl.ltecmd;
...
static int perform_getapn(FAR struct alt1250_s *dev, FAR struct usrsock_request_buff_s *req,
						  FAR int32_t *usock_result, FAR uint32_t *usock_xid,
						  FAR struct usock_ackinfo_s *ackinfo)
{
	FAR struct lte_ioctl_data_s *ltecmd = &req->req_ioctl.ltecmd;
	...
	if (ltecmd->outparam && ltecmd->outparam[0]) {
		alt1250_getapn(dev, (FAR lte_apn_setting_t *)(ltecmd->outparam[0]));
		*usock_result = OK;
	}
...
static int perform_setctxcb(FAR struct alt1250_s *dev, FAR struct usrsock_request_buff_s *req,
							FAR int32_t *usock_result, FAR uint32_t *usock_xid,
							FAR struct usock_ackinfo_s *ackinfo)
{
	FAR struct lte_ioctl_data_s *ltecmd = &req->req_ioctl.ltecmd;
