...
void set_container_argument(FAR struct alt_container_s *container, FAR void *argparams[],
							size_t paramsz)
{
...
void set_container_response(FAR struct alt_container_s *container, FAR void *respparams[],
							size_t paramsz)
{
