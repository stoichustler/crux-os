...
#define usockif_sendclose(fff, iii) usockif_sendevent((fff), (iii), USRSOCK_EVENT_REMOTE_CLOSED)

#define usockif_sendabort(fff, iii) usockif_sendevent((fff), (iii), USRSOCK_EVENT_ABORT)

#define usockif_sendtxready(fff, iii) usockif_sendevent((fff), (iii), USRSOCK_EVENT_SENDTO_READY)

#define usockif_sendrxready(fff, iii) usockif_sendevent((fff), (iii), USRSOCK_EVENT_RECVFROM_AVAIL)
...
int usockif_readreqaddr(int fd, FAR struct sockaddr_storage *addr, size_t sz);
...
int usockif_sendack(int fd, int32_t usock_result, uint32_t usock_xid, bool inprogress);
