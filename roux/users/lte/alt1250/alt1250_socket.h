...
#define USOCKET_REP_ADDRLEN(sock) (&(sock)->sock_reply.sock_reply_opt.addr.addrlen)
#define USOCKET_REP_ADDR(sock) (&(sock)->sock_reply.sock_reply_opt.addr.addr)
#define USOCKET_REP_OPTLEN(sock) (&(sock)->sock_reply.sock_reply_opt.opt.optlen)
#define USOCKET_REP_OPTVAL(sock) (&(sock)->sock_reply.sock_reply_opt.opt.value[0])
...
#define IS_STATE_SELECTABLE(s)                                                                     \
	(((s)->state != SOCKET_STATE_CLOSED) && ((s)->state != SOCKET_STATE_PREALLOC) &&               \
...
#define usocket_smssock_writeready(d, s) (usockif_sendtxready((d)->usockfd, USOCKET_USOCKID(s)))
