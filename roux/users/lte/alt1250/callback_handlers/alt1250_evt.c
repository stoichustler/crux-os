...
#include <semaphore.h>
#include <roux/modem/alt1250.h>
#include <roux/wireless/lte/lte_ioctl.h>
#include <roux/net/sms.h>
#include <sys/ioctl.h>
...
#define TABLE_CONTENT(cid, acid, outp)                                                             \
	{                                                                                              \
		.cmdid = LTE_CMDID_##cid, .altcid = APICMDID_##acid, .outparam = outp,                     \
		.outparamlen = nitems(outp)                                                                \
	}

#define TABLE_CONTENT_NOARG(cid, acid)                                                             \
	{                                                                                              \
		.cmdid = LTE_CMDID_##cid, .altcid = APICMDID_##acid, .outparam = NULL, .outparamlen = 0    \
	}

#define NCBTABLES (8 + ALTCOM_NSOCKET) /* 8 is the maximum number of events */

#define IS_REPORT_API(cmdid) (LTE_ISCMDGRP_EVENT(cmdid) || cmdid == LTE_CMDID_SETRESTART)
...
static uint64_t lte_set_report_restart_exec_cb(FAR void *cb, FAR void **cbarg,
											   FAR bool *set_writable);
#ifdef CONFIG_LTE_LAPI_ENABLE_DEPRECATED_API
static uint64_t lte_radio_on_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_radio_off_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
#endif /* CONFIG_LTE_LAPI_ENABLE_DEPRECATED_API */
static uint64_t lte_activate_pdn_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
#ifdef CONFIG_LTE_LAPI_ENABLE_DEPRECATED_API
static uint64_t lte_deactivate_pdn_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_get_netinfo_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_get_imscap_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_get_version_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_get_phoneno_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_get_imsi_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_get_imei_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_get_pinset_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_set_pinenable_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_change_pin_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_enter_pin_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_get_localtime_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_get_operator_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_get_edrx_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_set_edrx_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_get_psm_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_set_psm_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_get_ce_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_set_ce_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_get_siminfo_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_get_current_edrx_exec_cb(FAR void *cb, FAR void **cbarg,
											 FAR bool *set_writable);
static uint64_t lte_get_current_psm_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lte_get_quality_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
#endif /* CONFIG_LTE_LAPI_ENABLE_DEPRECATED_API */
static uint64_t lte_set_report_netinfo_exec_cb(FAR void *cb, FAR void **cbarg,
											   FAR bool *set_writable);
static uint64_t lte_set_report_simstat_exec_cb(FAR void *cb, FAR void **cbarg,
											   FAR bool *set_writable);
static uint64_t lte_set_report_localtime_exec_cb(FAR void *cb, FAR void **cbarg,
												 FAR bool *set_writable);
static uint64_t lte_set_report_quality_exec_cb(FAR void *cb, FAR void **cbarg,
											   FAR bool *set_writable);
static uint64_t lte_set_report_cellinfo_exec_cb(FAR void *cb, FAR void **cbarg,
												FAR bool *set_writable);
static uint64_t tls_config_verify_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);

static uint64_t lwm2m_read_evt_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lwm2m_write_evt_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lwm2m_exec_evt_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lwm2m_ovstart_evt_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lwm2m_ovstop_evt_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lwm2m_operation_evt_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
static uint64_t lwm2m_fwupdate_evt_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
...
struct cbinfo_s {
	uint32_t cmdid;
	CODE uint64_t (*cb)(FAR void *cb, FAR void **cbarg, FAR bool *set_writable);
};
...
static FAR void *g_getverargs[] = {&g_getverret, &g_ver};
...
static FAR void *g_radioonargs[] = {&g_radioonret};

/* event argument for LTE_CMDID_RADIOOFF */

static int g_radiooffret;
static FAR void *g_radiooffargs[] = {&g_radiooffret};
...
static FAR void *g_actpdnargs[] = {&g_actpdnret, &g_pdn};
...
static FAR void *g_enterpinargs[] = {&g_enterpinret, &g_entpinsimstat, &g_entpinattleft};

/* event argument for LTE_CMDID_GETLTIME */

static int g_getltimeret;
static lte_localtime_t g_ltime;
static FAR void *g_getltimeargs[] = {&g_getltimeret, &g_ltime};
...
static FAR void *g_getedrxargs[] = {&g_getedrxret, &g_getedrx, &g_is_getedrxevt};
...
static FAR void *g_getcedrxargs[] = {&g_getcedrxret, &g_getcedrx, &g_is_getcedrxevt};
...
static FAR void *g_getcpsmargs[] = {&g_getcpsmret, &g_getcpsm, &g_is_getcpsmevt};

/* event argument for LTE_CMDID_GETQUAL */

static int g_getqualret;
static lte_quality_t g_getqual;
static FAR void *g_getqualargs[] = {&g_getqualret, &g_getqual};

/* event argument for LTE_CMDID_GETCELL */

static int g_getcellret;
static lte_neighbor_cell_t g_neighbors[LTE_NEIGHBOR_CELL_MAX];
static lte_cellinfo_t g_getcell = {.neighbors = g_neighbors};
static FAR void *g_getcellargs[] = {&g_getcellret, &g_getcell};
...
static FAR void *g_smsreportargs[] = {&g_smsmsg_index, &g_smsrecv_sz, &g_sms_maxnum, &g_sms_seqnum,
									  &g_recvmsg};

/* event argument for LTE_CMDID_LWM2M_READ_EVT */

static struct lwm2mstub_instance_s g_lwm2mread_inst;
static FAR void *g_lwm2mreadargs[] = {NULL, NULL, &g_lwm2mread_inst};
...
static FAR void *g_lwm2mwriteargs[] = {
	NULL, NULL, &g_lwm2mwrite_inst, g_lwm2mwrite_value, NULL, (FAR void *)LWM2MSTUB_MAX_WRITE_SIZE};

/* event argument for LTE_CMDID_LWM2M_EXEC_EVT */

static struct lwm2mstub_instance_s g_lwm2mexec_inst;
static FAR void *g_lwm2mexecargs[] = {NULL, NULL, &g_lwm2mexec_inst, NULL};
...
static FAR void *g_lwm2movstartargs[] = {NULL,
										 NULL,
										 &g_lwm2movstart_inst,
										 g_lwm2movstart_token,
...
static FAR void *g_lwm2movstopargs[] = {NULL, NULL, &g_lwm2movstop_inst, &g_lwm2movstop_token,
										(FAR void *)LWM2MSTUB_MAX_TOKEN_SIZE};

/* event argument for LTE_CMDID_LWM2M_SERVEROP_EVT */

static struct lwm2mstub_instance_s g_lwm2msrvop_inst;
static FAR void *g_lwm2moperationargs[] = {NULL, NULL, &g_lwm2msrvop_inst};

/* event argument for LTE_CMDID_LWM2M_FWUP_EVT */

static FAR void *g_lwm2mfwupargs[] = {NULL};
...
static struct alt_evtbuf_inst_s g_evtbuffers[] = {
	...
	TABLE_CONTENT(SETEDRX, SET_EDRX, g_setedrxargs), TABLE_CONTENT(GETPSM, GET_PSM, g_getpsmargs),
	TABLE_CONTENT(SETPSM, SET_PSM, g_setpsmargs), TABLE_CONTENT(GETCE, GET_CE, g_getceargs),
	...
	TABLE_CONTENT(TLS_CONFIG_VERIFY, TLS_CONFIG_VERIFY_CALLBACK, g_vrfycbargs),
...
static uint64_t lte_get_current_edrx_exec_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable)
{
											   ...
											   FAR bool *set_writable)
{
	...
	FAR struct sockaddr_storage *dnsaddr = (FAR struct sockaddr_storage *)cbarg[2];
	...
	ndnsaddrs = (ndnsaddrs > ALTCOM_DNS_SERVERS) ? ALTCOM_DNS_SERVERS : ndnsaddrs;

	for (i = 0; (i < ndnsaddrs) && (i < CONFIG_NETDB_DNSSERVER_NAMESERVERS); i++) {
		addrlen = (dnsaddr[i].ss_family == AF_INET) ? sizeof(struct sockaddr_in)
...
static uint64_t lwm2m_read_evt_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable)
{
	...
	if (callback) {
		callback((int)cbarg[0], (int)cbarg[1], (FAR struct lwm2mstub_instance_s *)cbarg[2]);
	}
...
static uint64_t lwm2m_ovstart_evt_cb(FAR void *cb, FAR void **cbarg, FAR bool *set_writable)
{
	...
	if (callback) {
		callback((int)cbarg[0], (int)cbarg[1], (FAR struct lwm2mstub_instance_s *)cbarg[2],
				 (FAR char *)cbarg[3], (FAR struct lwm2mstub_ovcondition_s *)cbarg[5]);
	}
							  ...
							  FAR void **arg, FAR bool *set_writable)
{
	...
	if (cmdid == LTE_CMDID_GETPSM || cmdid == LTE_CMDID_GETEDRX || cmdid == LTE_CMDID_REPNETINFO ||
		cmdid == LTE_CMDID_REPSIMSTAT || cmdid == LTE_CMDID_REPLTIME) {
...
static uint64_t alt1250_search_execcb(uint64_t evtbitmap)
{
	...
	CODE uint64_t (*func)(FAR void *cb, FAR void **arg, FAR bool *set_writable);
	bool set_writable;
	...
	for (idx = 0; idx < nitems(g_evtbuffers); idx++) {
		if (evtbitmap & (1ULL << idx)) {
			...
			l_evtbitmap =
				exec_callback(g_evtbuffers[idx].cmdid, func, get_evtarg(idx), &set_writable);
...
bool alt1250_checkcmdid(uint32_t cmdid, uint64_t evtbitmap, FAR uint64_t *bit)
{
	int idx;
	bool ret = false;
...
static int evt_qsend(FAR mqd_t *mqd, uint64_t evtbitmap)
{
	...
	if (*mqd != (mqd_t)-1) {
		ret = mq_send(*mqd, (FAR const char *)&evtbitmap, sizeof(evtbitmap), 0);
		if (ret < 0) {
			ret = -errno;
...
int alt1250_evttask_msgconnect(FAR const char *qname, FAR struct alt1250_s *dev)
{
	int ret = OK;
