...
void set_container_ids(FAR struct alt_container_s *container, int16_t usockid, uint32_t cmdid);

void set_container_argument(FAR struct alt_container_s *container, FAR void *inparams[],
							size_t paramsz);

void set_container_response(FAR struct alt_container_s *container, FAR void *outparams[],
							size_t paramsz);

void set_container_postproc(FAR struct alt_container_s *container, FAR postproc_hdlr_t func,
							unsigned long priv);

void container_free(FAR struct alt_container_s *container);
void container_free_all(FAR struct alt_container_s *head);

FAR struct alt_container_s *container_pick_listtop(FAR struct alt_container_s **head);
