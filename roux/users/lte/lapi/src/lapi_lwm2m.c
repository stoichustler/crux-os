...
int lte_m2m_connection(int cmd)
{
	...
	return lapi_req(LTE_CMDID_LWM2M_CONNECT, (FAR void **)cmd, 1, NULL, 0, NULL);
}
...
int lte_m2m_readresponse(int seq_no, FAR struct lwm2mstub_instance_s *inst, int resp,
						 FAR char *readvalue, int len)
{
	FAR void *inarg[5] = {(FAR void *)seq_no, (FAR void *)resp, inst, readvalue, (FAR void *)len};

	if (!inst || !readvalue || len <= 0 || check_instance(inst) != OK) {
		return -EINVAL;
	}

	return lapi_req(LTE_CMDID_LWM2M_READRESP, (FAR void *)&inarg, 5, NULL, 0, NULL);
}
...
{
	FAR void *inarg[3] = {(FAR void *)seq_no, (FAR void *)resp, inst};

	if (!inst || check_instance(inst) != OK) {
		return -EINVAL;
	}

	return lapi_req(LTE_CMDID_LWM2M_WRITERESP, (FAR void *)&inarg, 3, NULL, 0, NULL);
}
...
int lte_m2m_executeresp(int seq_no, FAR struct lwm2mstub_instance_s *inst, int resp)
{
	...
	return lapi_req(LTE_CMDID_LWM2M_EXECRESP, (FAR void *)&inarg, 3, NULL, 0, NULL);
}
...
{
	FAR void *inarg[2] = {(FAR void *)seq_no, (FAR void *)resp};

	return lapi_req(LTE_CMDID_LWM2M_OBSERVERESP, (FAR void *)&inarg, 2, NULL, 0, NULL);
}
...
int lte_m2m_observeupdate(FAR char *token, FAR struct lwm2mstub_instance_s *inst, FAR char *value,
						  int len)
{
	FAR void *inarg[4] = {token, inst, value, (FAR void *)len};

	if (!token || !inst || !value || len <= 0) {
		return -EINVAL;
	}

	return lapi_req(LTE_CMDID_LWM2M_OBSERVEUPDATE, (FAR void *)&inarg, 4, NULL, 0, NULL);
}
...
{
	return lapi_req(LTE_CMDID_LWM2M_SETEP, (FAR void **)name, 1, NULL, 0, NULL);
}
...
{
	FAR void *outarg[2] = {name, (FAR void *)len};

	if (!name || len <= 0) {
		return -EINVAL;
	}

	return lapi_req(LTE_CMDID_LWM2M_GETEP, NULL, 0, (FAR void *)&outarg, 2, NULL);
}
...
int lte_getm2m_servernum(void)
{
	...
	return lapi_req(LTE_CMDID_LWM2M_GETSRVNUM, NULL, 0, (FAR void **)&dummy_arg, 0, NULL);
}
...
{
	FAR void *inarg[2] = {info, (FAR void *)id};
...
{
	FAR void *outarg[2] = {info, (FAR void *)id};
...
{
	int dummy_arg; /* Dummy for blocking API call */
	return lapi_req(LTE_CMDID_LWM2M_GETACTIVEOBJNUM, NULL, 0, (FAR void *)&dummy_arg, 0, NULL);
}
...
{
	FAR void *outarg[2] = {objids, (FAR void *)objnum};
...
{
	FAR void *inarg[2] = {objids, (FAR void *)objnum};
...
{
	int dummy_arg; /* Dummy for blocking API call */
	return lapi_req(LTE_CMDID_LWM2M_GETOBJRESNUM, &objid, 1, (FAR void *)&dummy_arg, 0, NULL);
}
...
int lte_getm2m_objresourceinfo(uint16_t objid, int res_num, FAR struct lwm2mstub_resource_s *reses)
{
	FAR void *outarg[2] = {reses, (FAR void *)res_num};

	if (!reses || res_num <= 0) {
		return -EINVAL;
	}

	return lapi_req(LTE_CMDID_LWM2M_GETOBJRESOURCE, &objid, 1, outarg, 2, NULL);
}
...
int lte_setm2m_rat(int rat)
{
	...
	return lapi_req(LTE_CMDID_LWM2M_CHANGERAT, &rat, 1, (FAR void *)&dummy_arg, 0, NULL);
}
...
{
	int dummy_arg; /* Dummy for blocking API call */
	return lapi_req(LTE_CMDID_LWM2M_GETRAT, NULL, 0, (FAR void *)&dummy_arg, 0, NULL);
}
...
{
	FAR void *inarg[3] = {(FAR void *)(uint32_t)objids, (FAR void *)res_num, resucs};
...
{
	int dummy_arg; /* Dummy for blocking API call */
	return lapi_req(LTE_CMDID_LWM2M_GETQMODE, NULL, 0, (FAR void **)&dummy_arg, 0, NULL);
}
...
{
	return lapi_req(LTE_CMDID_LWM2M_SETQMODE, (FAR void **)(en ? 1 : 0), 1, NULL, 0, NULL);
}
