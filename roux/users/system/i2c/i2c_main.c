...
static int i2ccmd_help(FAR struct i2ctool_s *i2ctool, int argc, FAR char **argv);
static int i2ccmd_unrecognized(FAR struct i2ctool_s *i2ctool, int argc, FAR char **argv);
...
static int i2ccmd_help(FAR struct i2ctool_s *i2ctool, int argc, FAR char **argv)
{
	...
	i2ctool_printf(i2ctool, "  [-z] instructs the 'dev' command to scan the I2C bus by sending "
	...
	i2ctool_printf(i2ctool, "o An environment variable like $PATH may be used "
							"for any argument.\n");
#endif
	i2ctool_printf(i2ctool, "o Arguments are \"sticky\". For example, once "
							"the I2C address is\n");
	i2ctool_printf(i2ctool, "  specified, that address will be re-used until "
							"it is changed.\n");
	i2ctool_printf(i2ctool, "\nWARNING:\n");
	i2ctool_printf(i2ctool, "o The I2C dev command may have bad side effects "
							"on your I2C devices.\n");
...
static int i2c_execute(FAR struct i2ctool_s *i2ctool, int argc, FAR char *argv[])
{
...
static FAR char *i2c_argument(FAR struct i2ctool_s *i2ctool, int argc, FAR char *argv[],
							  FAR int *pindex)
{
	FAR char *arg;
	int index = *pindex;
...
static int i2c_parse(FAR struct i2ctool_s *i2ctool, int argc, FAR char *argv[])
{
