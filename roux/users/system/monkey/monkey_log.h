...
#define MONKEY_LOG_INFO(format, ...)                                                               \
	monkey_log_printf(MONKEY_LOG_LEVEL_INFO, __func__, format, ##__VA_ARGS__)
#define MONKEY_LOG_NOTICE(format, ...)                                                             \
	monkey_log_printf(MONKEY_LOG_LEVEL_NOTICE, __func__, format, ##__VA_ARGS__)
#define MONKEY_LOG_WARN(format, ...)                                                               \
	monkey_log_printf(MONKEY_LOG_LEVEL_WARN, __func__, format, ##__VA_ARGS__)
#define MONKEY_LOG_ERROR(format, ...)                                                              \
	monkey_log_printf(MONKEY_LOG_LEVEL_ERROR, __func__, format, ##__VA_ARGS__)
...
void monkey_log_printf(enum monkey_log_level_type_e level, FAR const char *func,
					   FAR const char *fmt, ...);
