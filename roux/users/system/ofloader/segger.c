...
const struct FlashDevice FlashDevice locate_data("DevDscr") used_data = {
	ALGO_VERSION,					   /* Algo version */
	"ROUX",							   /* Flash device name */
	...
	{{CONFIG_SYSTEM_OFLOADER_BUFFERSIZE, 0x00000000}, {0xffffffff, 0xffffffff}}};
...
static uint8_t g_stack_buff[CONFIG_SYSTEM_OFLOADER_STACKSIZE +
							CONFIG_SYSTEM_OFLOADER_BUFFERSIZE] locate_data("DevStack") used_data;
