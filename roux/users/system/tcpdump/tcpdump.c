...
static int write_packet(int fd, uint32_t snaplen, uint32_t pkt_len, FAR const void *buf,
...
int main(int argc, FAR char *argv[])
{
	...
	args.snaplen = arg_int0("s", "snapshot-length", "snaplen", "Max dump length of each packet");
	args.end = arg_end(3);
