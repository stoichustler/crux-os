...
typedef CODE int (*orb_datain_cb_t)(FAR struct orb_handle_s *handle, FAR void *arg);
typedef CODE int (*orb_dataout_cb_t)(FAR struct orb_handle_s *handle, FAR void *arg);
typedef CODE int (*orb_eventpri_cb_t)(FAR struct orb_handle_s *handle, FAR void *arg);
typedef CODE int (*orb_eventerr_cb_t)(FAR struct orb_handle_s *handle, FAR void *arg);
...
int orb_advertise_multi_queue(FAR const struct orb_metadata *meta, FAR const void *data,
							  FAR int *instance, unsigned int queue_size);

static inline int orb_advertise(FAR const struct orb_metadata *meta, FAR const void *data)
{
	int instance = 0;
...
static inline int orb_advertise_queue(FAR const struct orb_metadata *meta, FAR const void *data,
...
static inline int orb_advertise_multi(FAR const struct orb_metadata *meta, FAR const void *data,
									  FAR int *instance)
{
	return orb_advertise_multi_queue(meta, data, instance, 1);
}
...
int orb_advertise_multi_queue_persist(FAR const struct orb_metadata *meta, FAR const void *data,
									  FAR int *instance, unsigned int queue_size);
...
static inline int orb_publish(FAR const struct orb_metadata *meta, int fd, FAR const void *data)
{
	int ret;
...
static inline int orb_publish_auto(FAR const struct orb_metadata *meta, FAR int *fd,
...
void orb_info(FAR const char *format, FAR const char *name, FAR const void *data);
...
int orb_fprintf(FAR FILE *stream, FAR const char *format, FAR const void *data);
#endif
...
int orb_handle_init(FAR struct orb_handle_s *handle, int fd, int events, FAR void *arg,
					orb_datain_cb_t datain_cb, orb_dataout_cb_t dataout_cb,
					orb_eventpri_cb_t pri_cb, orb_eventerr_cb_t err_cb);
...
int orb_handle_start(FAR struct orb_loop_s *loop, FAR struct orb_handle_s *handle);
...
int orb_handle_stop(FAR struct orb_loop_s *loop, FAR struct orb_handle_s *handle);
#endif
