...
static const char sensor_accel_format[] = "timestamp:%" PRIu64 ",x:%hf,y:%hf,z:%hf,temperature:%hf";
...
ORB_DEFINE(sensor_linear_accel_uncal, struct sensor_accel, sensor_accel_format);
