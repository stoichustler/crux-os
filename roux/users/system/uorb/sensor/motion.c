...
static const char sensor_event_format[] = "timestamp:%" PRIu64 ",event:%" PRIu32 "";
#endif
...
ORB_DEFINE(sensor_significant_motion, struct sensor_event, sensor_event_format);
...
ORB_DEFINE(sensor_tilt_detector_uncal, struct sensor_event, sensor_event_format);
