...
static const uint32_t g_sampling_freq[4] = {16000, 32000, 44100, 48000};
...
static const uint8_t g_nblocks[4] = {4, 8, 12, 16};
...
static const uint8_t g_nchannels[4] = {1, 2, 2, 2};
...
static const uint8_t g_allocation_method[2] = {SBC_AM_LOUDNESS, SBC_AM_SNR};
...
static const uint8_t g_nsubbands[2] = {4, 8};

/****************************************************************************
 * Private Functions
 ****************************************************************************/

static void init_sbc_frame_header(FAR struct sbc_frame_header *sbc, FAR char *buffer)
{
...
int nxplayer_parse_sbc(int fd, FAR uint32_t *samplerate, FAR uint8_t *chans, FAR uint8_t *bps)
{
