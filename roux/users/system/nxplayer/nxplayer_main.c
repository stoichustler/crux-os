...
#ifndef CONFIG_AUDIO_EXCLUDE_VOLUME
#ifndef CONFIG_AUDIO_EXCLUDE_BALANCE
	{"balance", "d%", nxplayer_cmd_balance,
...
#endif
#ifdef CONFIG_NXPLAYER_INCLUDE_PREFERRED_DEVICE
	{"device", "devfile", nxplayer_cmd_device,
...
static int nxplayer_cmd_playraw(FAR struct nxplayer_s *pplayer, char *parg)
{
	...
	ret = nxplayer_playraw(pplayer, filename, channels, bpsamp, samprate, chmap);
 ...
 *   uses the ROUX audio system to play media files read in from the
