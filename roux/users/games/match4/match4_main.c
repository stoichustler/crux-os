...
static const char g_board_path[] = CONFIG_GAMES_MATCH4_LED_MATRIX_PATH;

/* Game board to show */

uint32_t board[BOARDX_SIZE][BOARDY_SIZE] = {0};
...
static const uint32_t palette[] = {
	RGB24_BLACK,	  P1_COLOUR,  P1_SELECT_COLOUR, P2_COLOUR,
	P2_SELECT_COLOUR, BLUE_COLOR, RED_COLOR,		WHITE_COLOR,
};

/* Game entrance screen that shows one player mode */

uint32_t one_player_scr[BOARDX_SIZE][BOARDY_SIZE] = {
	{BLUE_INDEX, WHITE_INDEX, WHITE_INDEX, WHITE_INDEX, BLUE_INDEX, WHITE_INDEX, WHITE_INDEX,
	 WHITE_INDEX},
	{WHITE_INDEX, BLUE_INDEX, WHITE_INDEX, BLUE_INDEX, WHITE_INDEX, WHITE_INDEX, WHITE_INDEX,
	 WHITE_INDEX},
	{WHITE_INDEX, WHITE_INDEX, BLUE_INDEX, WHITE_INDEX, WHITE_INDEX, WHITE_INDEX, WHITE_INDEX,
	 WHITE_INDEX},
	{WHITE_INDEX, WHITE_INDEX, RED_INDEX, WHITE_INDEX, RED_INDEX, RED_INDEX, RED_INDEX,
	 WHITE_INDEX},
	{WHITE_INDEX, RED_INDEX, RED_INDEX, WHITE_INDEX, WHITE_INDEX, WHITE_INDEX, RED_INDEX,
	 WHITE_INDEX},
	{WHITE_INDEX, WHITE_INDEX, RED_INDEX, WHITE_INDEX, RED_INDEX, RED_INDEX, RED_INDEX,
	 WHITE_INDEX},
	{WHITE_INDEX, WHITE_INDEX, RED_INDEX, WHITE_INDEX, RED_INDEX, WHITE_INDEX, WHITE_INDEX,
	 WHITE_INDEX},
	{WHITE_INDEX, WHITE_INDEX, RED_INDEX, WHITE_INDEX, RED_INDEX, RED_INDEX, RED_INDEX,
	 WHITE_INDEX}};
...
uint32_t two_player_scr[BOARDX_SIZE][BOARDY_SIZE] = {
	{WHITE_INDEX, WHITE_INDEX, WHITE_INDEX, BLUE_INDEX, WHITE_INDEX, WHITE_INDEX, WHITE_INDEX,
	 BLUE_INDEX},
	{WHITE_INDEX, WHITE_INDEX, WHITE_INDEX, WHITE_INDEX, BLUE_INDEX, WHITE_INDEX, BLUE_INDEX,
	 WHITE_INDEX},
	{WHITE_INDEX, WHITE_INDEX, WHITE_INDEX, WHITE_INDEX, WHITE_INDEX, BLUE_INDEX, WHITE_INDEX,
	 WHITE_INDEX},
	{WHITE_INDEX, WHITE_INDEX, RED_INDEX, WHITE_INDEX, RED_INDEX, RED_INDEX, RED_INDEX,
	 WHITE_INDEX},
	{WHITE_INDEX, RED_INDEX, RED_INDEX, WHITE_INDEX, WHITE_INDEX, WHITE_INDEX, RED_INDEX,
...
{
	const char board_icons[] = {' ', 'x', 'X', 'o', 'O', '-', '#', ' ', ' '};
...
static void get_col_input(struct input_state_s *input_st, int turn, int *col, int fd)
{
	int ret = ERROR;
