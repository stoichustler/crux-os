...
WAMR_MODULE_REGISTRY = $(APPDIR)/interpreters/wamr/registry

define WAMR_MODULE_REGISTER
	$(Q) echo Register WAMR Module: $1
	$(Q) echo "$2," > "$(WAMR_MODULE_REGISTRY)/$1.bdat"
	$(Q) echo "bool $2(void);" > "$(WAMR_MODULE_REGISTRY)/$1.pdat"
	$(Q) touch "$(WAMR_MODULE_REGISTRY)/.updated"
endef

ifneq ($(WAMR_MODULE_NAME),)
WAMR_MODULE_LIST := $(addprefix $(WAMR_MODULE_REGISTRY)/,$(addsuffix .bdat,$(WAMR_MODULE_NAME)))
