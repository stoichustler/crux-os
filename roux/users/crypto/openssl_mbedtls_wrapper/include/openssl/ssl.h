...
int X509_VERIFY_PARAM_set_hostflags(X509_VERIFY_PARAM *param, unsigned long flags);

int X509_VERIFY_PARAM_clear_hostflags(X509_VERIFY_PARAM *param, unsigned long flags);

int SSL_CTX_add_client_CA(SSL_CTX *ctx, X509 *x);

int SSL_CTX_add_client_CA_ASN1(SSL_CTX *ssl, int len, const unsigned char *d);
