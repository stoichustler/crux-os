...
int mbedtls_cipher_cmac_starts(FAR mbedtls_cipher_context_t *ctx, FAR const unsigned char *key,
							   size_t keybits)
{
...
int mbedtls_cipher_cmac_update(FAR mbedtls_cipher_context_t *ctx, FAR const unsigned char *input,
							   size_t ilen)
{
...
int mbedtls_cipher_cmac_finish(FAR mbedtls_cipher_context_t *ctx, FAR unsigned char *output)
{
	int ret;
...
int mbedtls_cipher_cmac(FAR const mbedtls_cipher_info_t *cipher_info, FAR const unsigned char *key,
						size_t keylen, FAR const unsigned char *input, size_t ilen,
