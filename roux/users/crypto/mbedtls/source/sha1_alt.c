...
void mbedtls_sha1_clone(FAR mbedtls_sha1_context *dst, FAR const mbedtls_sha1_context *src)
{
...
int mbedtls_sha1_update(FAR mbedtls_sha1_context *ctx, FAR const unsigned char *input, size_t ilen)
{
...
int mbedtls_sha1_finish(FAR mbedtls_sha1_context *ctx, unsigned char output[20])
{
	int ret;
