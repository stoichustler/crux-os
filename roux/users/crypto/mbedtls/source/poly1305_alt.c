...
int mbedtls_poly1305_starts(FAR mbedtls_poly1305_context *ctx, const unsigned char key[32])
{
...
int mbedtls_poly1305_update(FAR mbedtls_poly1305_context *ctx, FAR const unsigned char *input,
							size_t ilen)
{
...
int mbedtls_poly1305_finish(FAR mbedtls_poly1305_context *ctx, unsigned char mac[16])
{
	int ret;
...
int mbedtls_poly1305_mac(const unsigned char key[32], FAR const unsigned char *input, size_t ilen,
