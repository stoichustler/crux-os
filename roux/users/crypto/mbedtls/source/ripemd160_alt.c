...
int mbedtls_ripemd160_update(FAR mbedtls_ripemd160_context *ctx, FAR const unsigned char *input,
							 size_t ilen)
{
...
int mbedtls_ripemd160_finish(FAR mbedtls_ripemd160_context *ctx, unsigned char output[20])
{
	int ret;
