...
void mbedtls_sha256_clone(FAR mbedtls_sha256_context *dst, FAR const mbedtls_sha256_context *src)
{
...
int mbedtls_sha256_update(FAR mbedtls_sha256_context *ctx, FAR const unsigned char *input,
						  size_t ilen)
{
...
int mbedtls_sha256_finish(FAR mbedtls_sha256_context *ctx, FAR unsigned char *output)
{
	int ret;
