...
void mbedtls_md5_clone(FAR mbedtls_md5_context *dst, FAR const mbedtls_md5_context *src)
{
...
int mbedtls_md5_update(FAR mbedtls_md5_context *ctx, FAR const unsigned char *input, size_t ilen)
{
...
int mbedtls_md5_finish(FAR mbedtls_md5_context *ctx, unsigned char output[16])
{
	int ret;
