...
int libelf_insertsymtab(FAR struct module_s *modp, FAR struct mod_loadinfo_s *loadinfo,
...
int libelf_sectname(FAR struct mod_loadinfo_s *loadinfo, FAR const Elf_Shdr *shdr);
...
int libelf_reallocbuffer(FAR struct mod_loadinfo_s *loadinfo, size_t increment);
...
int libelf_addrenv_alloc(FAR struct mod_loadinfo_s *loadinfo, size_t textsize, size_t datasize);
