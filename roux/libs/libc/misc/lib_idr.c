...
static int idr_compare(FAR struct idr_node_s *node, FAR struct idr_node_s *root)
{
...
int idr_alloc_u32(FAR struct idr_s *idr, FAR void *ptr, FAR uint32_t *result, uint32_t max)
{
	FAR struct idr_node_s *node;
