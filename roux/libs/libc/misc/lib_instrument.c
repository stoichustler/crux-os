...
void noinstrument_function __cyg_profile_func_enter(FAR void *this_fn, FAR void *call_site)
{
...
void noinstrument_function __cyg_profile_func_exit(FAR void *this_fn, FAR void *call_site)
{
	FAR struct instrument_s *instrument;
	FAR sq_entry_t *entry;
...
void noinstrument_function instrument_register(FAR struct instrument_s *entry)
{
	if (entry != NULL) {
