...
static inline void slcd_put3(uint8_t slcdcode, FAR struct lib_outstream_s *stream)
{
...
static inline void slcd_put5(uint8_t slcdcode, uint8_t count, FAR struct lib_outstream_s *stream)
{
