...
unsigned long find_next_bit(FAR const unsigned long *addr, unsigned long size, unsigned long offset)
{
...
void bitmap_set(FAR unsigned long *bitmap, unsigned long start, unsigned long len)
{
