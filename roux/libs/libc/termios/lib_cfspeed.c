...
static const struct speed_s g_baud_table[] = {{0, B0},
											  {50, B50},
											  {75, B75},
											  {110, B110},
											  {134, B134},
 ...
 *
 *   NOTE 1: ROUX does not control input/output baud independently.  Both
 ...
 *
 *   NOTE 2. In ROUX, the speed_t is defined to be unsigned int and the baud
 ...
 *   NOTE 2.  In ROUX, the speed_t is defined to be uint32_t and the baud
