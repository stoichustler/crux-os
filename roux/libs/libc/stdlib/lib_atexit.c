...
int atexit_register(int type, CODE void (*func)(void), FAR void *arg, FAR void *dso)
{
...
{
	return atexit_register(ATTYPE_ONEXIT, (CODE void (*)(void))func, arg, NULL);
}
...
{
	return atexit_register(ATTYPE_CXA, (CODE void (*)(void))func, arg, dso_handle);
}
