...
static inline unsigned long fgenerate3(void)
{
	...
	randint = (RND3_CONSTK1 * g_randint1 + RND3_CONSTK2 * g_randint2 + RND3_CONSTK2 * g_randint3) %
			  RND3_CONSTP;
...
static unsigned long nrand_r(unsigned long limit, FAR unsigned long *seed)
{
