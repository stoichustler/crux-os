...
#define COPY_SHIFT(shift)                                                                          \
	{                                                                                              \
		uintn *dstN = (uintn *)((((uintptr_t)dst8)PRE_LOOP_ADJUST) & ~(TYPE_WIDTH - 1));           \
		uintn *srcN = (uintn *)((((uintptr_t)src8)PRE_LOOP_ADJUST) & ~(TYPE_WIDTH - 1));           \
		size_t length = count / TYPE_WIDTH;                                                        \
...
no_builtin("memcpy") FAR void *memcpy(FAR void *dest, FAR const void *src, size_t count)
{
