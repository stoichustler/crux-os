...
typedef CODE int(pwd_foreach_match_t)(FAR const struct passwd *entry, uintptr_t index,
									  uintptr_t arg);
...
static int pwd_match_name(FAR const struct passwd *entry, uintptr_t index, uintptr_t arg)
{
	UNUSED(index);
...
static int pwd_match_uid(FAR const struct passwd *entry, uintptr_t index, uintptr_t arg)
{
	UNUSED(index);
...
static int pwd_match_index(FAR const struct passwd *entry, uintptr_t index, uintptr_t arg)
{
	UNUSED(entry);
...
static int pwd_foreach(pwd_foreach_match_t match, uintptr_t arg, FAR struct passwd *entry,
...
int pwd_findby_name(FAR const char *uname, FAR struct passwd *entry, FAR char *buffer,
					size_t buflen)
{
...
int pwd_findby_uid(uid_t uid, FAR struct passwd *entry, FAR char *buffer, size_t buflen)
{
...
int pwd_findby_index(int index, FAR struct passwd *entry, FAR char *buffer, size_t buflen)
{
	return pwd_foreach(pwd_match_index, (uintptr_t)index, entry, buffer, buflen);
}
