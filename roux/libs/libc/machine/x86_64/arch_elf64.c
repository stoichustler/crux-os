...
int up_relocate(const Elf64_Rel *rel, const Elf64_Sym *sym, uintptr_t addr, FAR void *arch_data)
{
	berr("Not implemented\n");
	return -ENOSYS;
}

int up_relocateadd(const Elf64_Rela *rel, const Elf64_Sym *sym, uintptr_t addr, FAR void *arch_data)
{
	...
	case R_X86_64_REX_GOTPCRELX:
		...
		value = (sym->st_value + rel->r_addend - addr + CONFIG_ARCH_TEXT_VBASE);
