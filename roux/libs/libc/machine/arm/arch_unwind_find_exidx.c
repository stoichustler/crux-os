 ...
 *        flash (0x08000000) (running roux from ram will break this logic)
 *
 *     2. __exidx_start  and  __exidx_end refers to main roux elf image and
 ...
 *
 *     3. TODO: if roux itself is running from ram, this logic will not work
 *
