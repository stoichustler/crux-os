...
int up_relocate(const Elf32_Rel *rel, const Elf32_Sym *sym, uintptr_t addr, void *arch_data)
{
	int32_t offset;
	uint32_t upper_insn;
	uint32_t lower_insn;
	...
	case R_ARM_JUMP24: {
		binfo("Performing PC24 [%" PRId32 "] link at "
			  ...
			  ELF32_R_TYPE(rel->r_info), addr, *(uint32_t *)addr, sym, sym->st_value);
	...
	case R_ARM_THM_JUMP24: {
		...
		binfo("Performing THM_JUMP24 [%" PRId32 "] link "
			  ...
			  "sym=%p st_value=%08" PRIx32 "\n",
			  ELF32_R_TYPE(rel->r_info), addr, (int)upper_insn, (int)lower_insn, sym,
			  sym->st_value);
		...
		binfo("  S=%" PRId32 " J1=%" PRId32 " J2=%" PRId32 " offset=%08" PRIx32
			  " branch target=%08" PRIx32 "\n",
		...
		*(uint16_t *)(addr + 2) = (uint16_t)lower_insn;
		...
		binfo("  S=%" PRId32 " J1=%" PRId32 " J2=%" PRId32 " insn [%04" PRIx32 " %04" PRIx32 "]\n",
			  S, J1, J2, upper_insn, lower_insn);
	} break;

	case R_ARM_V4BX: {
		binfo("Performing V4BX link at addr=%08" PRIxPTR " [%08" PRIx32 "]\n", addr,
			  *(uint32_t *)addr);
...
int up_relocateadd(const Elf32_Rela *rel, const Elf32_Sym *sym, uintptr_t addr, void *arch_data)
{
