...
FAR void *ARCH_LIBCFUN(memcpy)(FAR void *dest, FAR const void *src, size_t n);
#endif
...
FAR void *ARCH_LIBCFUN(memmove)(FAR void *dest, FAR const void *src, size_t n);
#endif
...
FAR char *ARCH_LIBCFUN(strncpy)(FAR char *dest, FAR const char *src, size_t n);
#endif
