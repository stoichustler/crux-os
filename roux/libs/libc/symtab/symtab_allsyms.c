...
static FAR const struct symtab_s *allsyms_lookup(FAR const char *name, FAR void *value,
												 FAR size_t *size)
{
...
FAR const struct symtab_s *allsyms_findbyname(FAR const char *name, FAR size_t *size)
{
...
FAR const struct symtab_s *allsyms_findbyvalue(FAR void *value, FAR size_t *size)
{
