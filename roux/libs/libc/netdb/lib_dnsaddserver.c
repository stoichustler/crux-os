...
union dns_addr_u g_dns_servers[CONFIG_NETDB_DNSSERVER_NAMESERVERS] = {
	...
	{.ipv6.sin6_family = AF_INET6,
	 ...
	 .ipv6.sin6_addr.in6_u.u6_addr16 =
		 {HTONS(CONFIG_NETDB_DNSSERVER_IPv6ADDR_1), HTONS(CONFIG_NETDB_DNSSERVER_IPv6ADDR_2),
		  HTONS(CONFIG_NETDB_DNSSERVER_IPv6ADDR_3), HTONS(CONFIG_NETDB_DNSSERVER_IPv6ADDR_4),
		  HTONS(CONFIG_NETDB_DNSSERVER_IPv6ADDR_5), HTONS(CONFIG_NETDB_DNSSERVER_IPv6ADDR_6),
		  HTONS(CONFIG_NETDB_DNSSERVER_IPv6ADDR_7), HTONS(CONFIG_NETDB_DNSSERVER_IPv6ADDR_8)}}
#endif
};
...
static int dns_check_nameserver(FAR void *arg, FAR struct sockaddr *addr, socklen_t addrlen)
{
...
int dns_add_nameserver(FAR const struct sockaddr *addr, socklen_t addrlen)
{
	...
	for (prev_cnt = 0; prev_cnt < CONFIG_NETDB_DNSSERVER_NAMESERVERS - 1; prev_cnt++) {
