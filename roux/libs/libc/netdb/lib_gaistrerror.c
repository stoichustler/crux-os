...
static const struct errno_strmap_s g_gaierrnomap[] = {
	{EAI_AGAIN, "EAI_AGAIN"},		{EAI_BADFLAGS, "EAI_BADFLAGS"}, {EAI_FAIL, "EAI_FAIL"},
	{EAI_FAMILY, "EAI_FAMILY"},		{EAI_MEMORY, "EAI_MEMORY"},		{EAI_NONAME, "EAI_NONAME"},
	{EAI_SERVICE, "EAI_SERVICE"},	{EAI_SOCKTYPE, "EAI_SOCKTYPE"}, {EAI_SYSTEM, "EAI_SYSTEM"},
...
#endif
#ifdef CONFIG_LIBC_GAISTRERROR_ERRNUM
	if (snprintf(s_err, sizeof(s_err), STRERROR_UNKNOWN " %d", errnum) < sizeof(s_err)) {
		return s_err;
	}
