...
static int getoffs(FAR short *offs, FAR const unsigned char *base, FAR const unsigned char *s)
{
	int i = 0;
...
static int match(FAR int *offset, FAR const unsigned char *base, FAR const unsigned char *dn,
				 FAR const char *end, FAR const unsigned char *lens, int nlen)
{
	int l;
	int o;
	int m = 0;
...
int dn_comp(FAR const char *src, FAR unsigned char *dst, int space, FAR unsigned char **dnptrs,
			FAR unsigned char **lastdnptr)
{
	int i;
	int j;
	int n;
