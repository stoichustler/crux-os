...
static int compare_long_option(FAR const char *cmdarg, FAR const char *optname,
...
static int getopt_long_option(FAR struct getopt_s *go, FAR char *const argv[],
...
int getopt_common(int argc, FAR char *const argv[], FAR const char *optstring,
				  FAR const struct option *longopts, FAR int *longindex, enum getopt_mode_e mode)
{
	int ret;
