...
static ssize_t fileinstream_gets(FAR struct lib_instream_s *self, FAR void *buf, size_t len)
{
	FAR struct lib_fileinstream_s *stream = (FAR struct lib_fileinstream_s *)self;
	ssize_t nread;
