...
{
	FAR struct lib_syslogstream_s *stream = (FAR struct lib_syslogstream_s *)self;
...
static ssize_t syslogstream_puts(FAR struct lib_outstream_s *self, FAR const void *buff, size_t len)
{
	FAR struct lib_syslogstream_s *stream = (FAR struct lib_syslogstream_s *)self;
