...
{
	FAR struct lib_rawinstream_s *stream = (FAR struct lib_rawinstream_s *)self;
	int nread;
	char ch;
...
static ssize_t rawinstream_gets(FAR struct lib_instream_s *self, FAR void *buffer, size_t len)
{
	FAR struct lib_rawinstream_s *stream = (FAR struct lib_rawinstream_s *)self;
	ssize_t nread;
