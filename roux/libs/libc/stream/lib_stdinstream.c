...
{
	FAR struct lib_stdinstream_s *stream = (FAR struct lib_stdinstream_s *)self;
	int ret;
...
static ssize_t stdinstream_gets(FAR struct lib_instream_s *self, FAR void *buffer, size_t len)
{
	FAR struct lib_stdinstream_s *stream = (FAR struct lib_stdinstream_s *)self;
	ssize_t nread = 0;
