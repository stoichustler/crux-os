...
{
	FAR struct lib_stdsostream_s *stream = (FAR struct lib_stdsostream_s *)self;
	int result;
...
static ssize_t stdsostream_puts(FAR struct lib_sostream_s *self, FAR const void *buffer, size_t len)
{
	FAR struct lib_stdsostream_s *stream = (FAR struct lib_stdsostream_s *)self;
	ssize_t result;
...
static off_t stdsostream_seek(FAR struct lib_sostream_s *self, off_t offset, int whence)
{
	FAR struct lib_stdsostream_s *stream = (FAR struct lib_stdsostream_s *)self;
