...
{
	FAR struct lib_stdsistream_s *stream = (FAR struct lib_stdsistream_s *)self;
	int ret;
...
static ssize_t stdsistream_gets(FAR struct lib_instream_s *self, FAR void *buffer, size_t len)
{
	FAR struct lib_stdsistream_s *stream = (FAR struct lib_stdsistream_s *)self;
	ssize_t nread = 0;
...
static off_t stdsistream_seek(FAR struct lib_sistream_s *self, off_t offset, int whence)
{
	FAR struct lib_stdsistream_s *stream = (FAR struct lib_stdsistream_s *)self;
