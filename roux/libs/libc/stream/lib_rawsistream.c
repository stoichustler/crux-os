...
{
	FAR struct lib_rawsistream_s *stream = (FAR struct lib_rawsistream_s *)self;
	int nread;
	char ch;
...
static ssize_t rawsistream_gets(FAR struct lib_instream_s *self, FAR void *buffer, size_t len)
{
	FAR struct lib_rawsistream_s *stream = (FAR struct lib_rawsistream_s *)self;
	ssize_t nread;
...
static off_t rawsistream_seek(FAR struct lib_sistream_s *self, off_t offset, int whence)
{
	FAR struct lib_rawsistream_s *stream = (FAR struct lib_rawsistream_s *)self;
