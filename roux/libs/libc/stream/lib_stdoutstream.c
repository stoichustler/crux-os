...
{
	FAR struct lib_stdoutstream_s *stream = (FAR struct lib_stdoutstream_s *)self;
	int result;
...
static ssize_t stdoutstream_puts(FAR struct lib_outstream_s *self, FAR const void *buffer,
								 size_t len)
{
	FAR struct lib_stdoutstream_s *stream = (FAR struct lib_stdoutstream_s *)self;
	ssize_t result;
