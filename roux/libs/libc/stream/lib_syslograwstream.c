...
static void syslograwstream_addchar(FAR struct lib_syslograwstream_s *stream, int ch)
{
...
static ssize_t syslograwstream_addstring(FAR struct lib_syslograwstream_s *stream,
...
static ssize_t syslograwstream_puts(FAR struct lib_outstream_s *self, FAR const void *buff,
									size_t len)
{
	FAR struct lib_syslograwstream_s *stream = (FAR void *)self;
