...
{
	FAR struct lib_rawsostream_s *stream = (FAR struct lib_rawsostream_s *)self;
	char buffer = ch;
	ssize_t nwritten;
...
static ssize_t rawsostream_puts(FAR struct lib_sostream_s *self, FAR const void *buffer, size_t len)
{
	FAR struct lib_rawsostream_s *stream = (FAR struct lib_rawsostream_s *)self;
	ssize_t nwritten;
...
static off_t rawsostream_seek(FAR struct lib_sostream_s *self, off_t offset, int whence)
{
	FAR struct lib_rawsostream_s *stream = (FAR struct lib_rawsostream_s *)self;
