...
static void clock_utc2calendar(time_t utc, FAR int *year, FAR int *month, FAR int *day);
#ifdef CONFIG_GREGORIAN_TIME
static void clock_utc2gregorian(time_t jdn, FAR int *year, FAR int *month, FAR int *day);
#ifdef CONFIG_JULIAN_TIME
static void clock_utc2julian(time_t jdn, FAR int *year, FAR int *month, FAR int *day);
...
static void clock_utc2gregorian(time_t jd, FAR int *year, FAR int *month, FAR int *day)
{
	long l;
	long n;
	long i;
...
static void clock_utc2julian(time_t jd, FAR int *year, FAR int *month, FAR int *day)
{
	long j;
	long k;
	long l;
...
static void clock_utc2calendar(time_t days, FAR int *year, FAR int *month, FAR int *day)
{
	int value;
	int min;
	int max;
