...
nxgl_mxpixel_t g_bordercolor1[CONFIG_NX_NPLANES] = {CONFIG_NXTK_BORDERCOLOR1
#if CONFIG_NX_NPLANES > 1
#error "Multiple plane border colors not defined"
#endif
};

nxgl_mxpixel_t g_bordercolor2[CONFIG_NX_NPLANES] = {CONFIG_NXTK_BORDERCOLOR2
#if CONFIG_NX_NPLANES > 1
#error "Multiple plane border colors not defined"
#endif
};

nxgl_mxpixel_t g_bordercolor3[CONFIG_NX_NPLANES] = {CONFIG_NXTK_BORDERCOLOR3
#if CONFIG_NX_NPLANES > 1
#error "Multiple plane border colors not defined"
#endif
};
						   ...
						   FAR void *arg)
{
	...
	fwnd = (FAR struct nxtk_framedwindow_s *)lib_uzalloc(sizeof(struct nxtk_framedwindow_s));
	...
	ret = nx_constructwindow(handle, (NXWINDOW)&fwnd->wnd, flags | NXBE_WINDOW_FRAMED, &g_nxtkcb,
							 NULL);
	if (ret < 0) {
