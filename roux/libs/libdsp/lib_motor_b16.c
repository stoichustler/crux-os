...
void motor_openloop_b16(FAR struct openloop_data_b16_s *op, b16_t speed, b16_t dir)
{
	...
	angle_norm_2pi_b16(&op->angle, MOTOR_ANGLE_E_MIN_B16, MOTOR_ANGLE_E_MAX_B16);
}
...
void motor_angle_e_update_b16(FAR struct motor_angle_b16_s *angle, b16_t angle_new, b16_t dir)
{
	...
	angle_norm_2pi_b16(&angle->anglem, MOTOR_ANGLE_M_MIN_B16, MOTOR_ANGLE_M_MAX_B16);
}
