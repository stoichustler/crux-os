...
static void foc_current_controller_b16(FAR struct foc_data_b16_s *foc, FAR dq_frame_b16_t *v_dq_req)
{
...
static void foc_vab_mod_scale_set_b16(FAR struct foc_data_b16_s *foc, b16_t scale)
{
	LIBDSP_DEBUGASSERT(foc != NULL);
...
static void foc_vdq_mag_max_set_b16(FAR struct foc_data_b16_s *foc, b16_t max)
{
	LIBDSP_DEBUGASSERT(foc != NULL);
...
static void foc_vdq_ref_set_b16(FAR struct foc_data_b16_s *foc, FAR dq_frame_b16_t *vdq_ref)
{
	LIBDSP_DEBUGASSERT(foc != NULL);
...
static void foc_idq_ref_set_b16(FAR struct foc_data_b16_s *foc, FAR dq_frame_b16_t *idq_ref)
{
	LIBDSP_DEBUGASSERT(foc != NULL);
...
void foc_current_control_b16(FAR struct foc_data_b16_s *foc, FAR dq_frame_b16_t *idq_ref,
							 FAR dq_frame_b16_t *vdq_comp, FAR dq_frame_b16_t *vdq_ref)
{
	LIBDSP_DEBUGASSERT(foc != NULL);
