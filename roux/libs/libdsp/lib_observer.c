						 ...
						 float dir, float speed)
{
	...
	FAR struct motor_aobserver_smo_f32_s *smo = (FAR struct motor_aobserver_smo_f32_s *)o->ao;
...
void motor_sobserver_div(FAR struct motor_sobserver_f32_s *o, float angle)
{
	...
	FAR struct motor_sobserver_div_f32_s *so = (FAR struct motor_sobserver_div_f32_s *)o->so;
...
void motor_aobserver_nfo(FAR struct motor_aobserver_f32_s *o, FAR ab_frame_f32_t *i_ab,
						 ...
						 float gain)
{
	FAR struct motor_aobserver_nfo_f32_s *nfo = (FAR struct motor_aobserver_nfo_f32_s *)o->ao;
	float angle;
	float err;
	float x1_dot;
	float x2_dot;
...
{
	FAR struct motor_sobserver_pll_f32_s *so = (FAR struct motor_sobserver_pll_f32_s *)o->so;
