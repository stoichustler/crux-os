...
#define ICICLE_GPIO_BUTTON2                                                                        \
	(GPIO_BANK2 | GPIO_PIN30 | GPIO_INPUT | GPIO_IRQ_ENABLE | GPIO_IRQ_EDGE_POS)
#define ICICLE_GPIO_BUTTON2_ALT (GPIO_BANK2 | GPIO_PIN26 | GPIO_OUTPUT)
#define ICICLE_GPIO_BUTTON3                                                                        \
	(GPIO_BANK2 | GPIO_PIN31 | GPIO_INPUT | GPIO_IRQ_ENABLE | GPIO_IRQ_EDGE_POS)
