...
#ifdef CONFIG_IOEXPANDER_INT_ENABLE
static int gplh_handler(FAR struct ioexpander_dev_s *ioe, ioe_pinset_t pinset, FAR void *arg);
#endif
...
static FAR struct gplh_dev_s *gpio_lower_half_internal(FAR struct ioexpander_dev_s *ioe,
													   unsigned int pin,
