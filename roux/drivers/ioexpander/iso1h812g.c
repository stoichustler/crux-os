...
#include <roux/ioexpander/iso1h812g.h>
...
static void iso1h812g_select(FAR struct spi_dev_s *spi, FAR struct iso1h812g_config_s *config,
							 int bits);
static void iso1h812g_deselect(FAR struct spi_dev_s *spi, FAR struct iso1h812g_config_s *config);

/* I/O Expander Methods */

static int iso1h812g_direction(FAR struct ioexpander_dev_s *dev, uint8_t pin, int dir);
static int iso1h812g_option(FAR struct ioexpander_dev_s *dev, uint8_t pin, int opt, void *regval);
static int iso1h812g_writepin(FAR struct ioexpander_dev_s *dev, uint8_t pin, bool value);
static int iso1h812g_readpin(FAR struct ioexpander_dev_s *dev, uint8_t pin, FAR bool *value);
#ifdef CONFIG_IOEXPANDER_MULTIPIN
static int iso1h812g_multiwritepin(FAR struct ioexpander_dev_s *dev, FAR const uint8_t *pins,
								   FAR const bool *values, int count);
static int iso1h812g_multireadpin(FAR struct ioexpander_dev_s *dev, FAR const uint8_t *pins,
...
static const struct ioexpander_ops_s g_iso1h812g_ops = {iso1h812g_direction,
														iso1h812g_option,
														iso1h812g_writepin,
														iso1h812g_readpin,
														iso1h812g_readpin
...
static int iso1h812g_direction(FAR struct ioexpander_dev_s *dev, uint8_t pin, int direction)
{
...
static int iso1h812g_option(FAR struct ioexpander_dev_s *dev, uint8_t pin, int opt, FAR void *value)
{
