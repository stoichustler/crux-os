...
#include <roux/ioexpander/iso1i813t.h>
...
static void iso1i813t_select(FAR struct spi_dev_s *spi, FAR struct iso1i813t_config_s *config,
							 int bits);
static void iso1i813t_deselect(FAR struct spi_dev_s *spi, FAR struct iso1i813t_config_s *config);

/* I/O Expander Methods */

static int iso1i813t_direction(FAR struct ioexpander_dev_s *dev, uint8_t pin, int dir);
static int iso1i813t_option(FAR struct ioexpander_dev_s *dev, uint8_t pin, int opt, void *regval);
static int iso1i813t_writepin(FAR struct ioexpander_dev_s *dev, uint8_t pin, bool value);
static int iso1i813t_readpin(FAR struct ioexpander_dev_s *dev, uint8_t pin, FAR bool *value);
#ifdef CONFIG_IOEXPANDER_MULTIPIN
static int iso1i813t_multiwritepin(FAR struct ioexpander_dev_s *dev, FAR const uint8_t *pins,
								   FAR const bool *values, int count);
static int iso1i813t_multireadpin(FAR struct ioexpander_dev_s *dev, FAR const uint8_t *pins,
...
static const struct ioexpander_ops_s g_iso1i813t_ops = {iso1i813t_direction,
														iso1i813t_option,
														iso1i813t_writepin,
														iso1i813t_readpin,
														iso1i813t_readpin
...
static int iso1i813t_direction(FAR struct ioexpander_dev_s *dev, uint8_t pin, int direction)
{
...
static int iso1i813t_option(FAR struct ioexpander_dev_s *dev, uint8_t pin, int opt, FAR void *value)
{
	FAR struct iso1i813t_dev_s *priv = (FAR struct iso1i813t_dev_s *)dev;
	uint16_t regval;
	int ret = OK;
