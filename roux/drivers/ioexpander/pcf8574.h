...
#define PCF8574_LEVEL_SENSITIVE(d, p) (((d)->trigger & ((ioe_pinset_t)1 << (p))) == 0)
#define PCF8574_LEVEL_HIGH(d, p) (((d)->level[0] & ((ioe_pinset_t)1 << (p))) != 0)
#define PCF8574_LEVEL_LOW(d, p) (((d)->level[1] & ((ioe_pinset_t)1 << (p))) != 0)

#define PCF8574_EDGE_SENSITIVE(d, p) (((d)->trigger & ((ioe_pinset_t)1 << (p))) != 0)
#define PCF8574_EDGE_RISING(d, p) (((d)->level[0] & ((ioe_pinset_t)1 << (p))) != 0)
#define PCF8574_EDGE_FALLING(d, p) (((d)->level[1] & ((ioe_pinset_t)1 << (p))) != 0)
#define PCF8574_EDGE_BOTH(d, p) (PCF8574_LEVEL_RISING(d, p) && PCF8574_LEVEL_FALLING(d, p))
