...
static inline int pca9557_i2c_write(FAR struct pca9557_dev_s *pca, FAR const uint8_t *wbuffer,
									int wbuflen);
static inline int pca9557_i2c_writeread(FAR struct pca9557_dev_s *pca, FAR const uint8_t *wbuffer,
										int wbuflen, FAR uint8_t *rbuffer, int rbuflen);
static int pca9557_setbit(FAR struct pca9557_dev_s *pca, uint8_t reg, uint8_t pin, bool bitval);
static int pca9557_getbit(FAR struct pca9557_dev_s *pca, uint8_t reg, uint8_t pin, FAR bool *val);
static int pca9557_direction(FAR struct ioexpander_dev_s *dev, uint8_t pin, int direction);
static int pca9557_option(FAR struct ioexpander_dev_s *dev, uint8_t pin, int opt, FAR void *value);
static int pca9557_writepin(FAR struct ioexpander_dev_s *dev, uint8_t pin, bool value);
static int pca9557_readpin(FAR struct ioexpander_dev_s *dev, uint8_t pin, FAR bool *value);
static int pca9557_readbuf(FAR struct ioexpander_dev_s *dev, uint8_t pin, FAR bool *value);
#ifdef CONFIG_IOEXPANDER_MULTIPIN
static int pca9557_getmultibits(FAR struct pca9557_dev_s *pca, uint8_t reg, FAR uint8_t *pins,
								FAR bool *values, int count);
static int pca9557_multiwritepin(FAR struct ioexpander_dev_s *dev, FAR const uint8_t *pins,
								 FAR const bool *values, int count);
static int pca9557_multireadpin(FAR struct ioexpander_dev_s *dev, FAR const uint8_t *pins,
								FAR bool *values, int count);
static int pca9557_multireadbuf(FAR struct ioexpander_dev_s *dev, FAR uint8_t *pins,
								FAR bool *values, int count);
#endif
...
static int pca9557_direction(FAR struct ioexpander_dev_s *dev, uint8_t pin, int direction)
{
	...
	return pca9557_setbit((FAR struct pca9557_dev_s *)dev, PCA9557_REG_CONFIG, pin,
...
static int pca9557_option(FAR struct ioexpander_dev_s *dev, uint8_t pin, int opt, FAR void *value)
{
	...
	if (opt == IOEXPANDER_OPTION_INVERT) {
		ret = pca9557_setbit((FAR struct pca9557_dev_s *)dev, PCA9557_REG_POLINV, pin,
...
static int pca9557_writepin(FAR struct ioexpander_dev_s *dev, uint8_t pin, bool value)
{
	return pca9557_setbit((FAR struct pca9557_dev_s *)dev, PCA9557_REG_OUTPUT, pin, value);
}
...
static int pca9557_readpin(FAR struct ioexpander_dev_s *dev, uint8_t pin, FAR bool *value)
{
	return pca9557_getbit((FAR struct pca9557_dev_s *)dev, PCA9557_REG_INPUT, pin, value);
}
...
static int pca9557_readbuf(FAR struct ioexpander_dev_s *dev, uint8_t pin, FAR bool *value)
{
	return pca9557_getbit((FAR struct pca9557_dev_s *)dev, PCA9557_REG_OUTPUT, pin, value);
}
...
static int pca9557_multireadpin(FAR struct ioexpander_dev_s *dev, FAR const uint8_t *pins,
								FAR bool *values, int count)
{
	return pca9557_getmultibits((FAR struct pca9557_dev_s *)dev, PCA9557_REG_INPUT, pins, values,
								count);
}
...
static int pca9557_multireadbuf(FAR struct ioexpander_dev_s *dev, FAR uint8_t *pins,
								FAR bool *values, int count)
{
	return pca9557_getmultibits((FAR struct pca9557_dev_s *)dev, PCA9557_REG_OUTPUT, pins, values,
								count);
}
...
FAR struct ioexpander_dev_s *pca9557_initialize(FAR struct i2c_master_s *i2cdev,
