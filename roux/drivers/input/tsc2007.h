...
#define TSC2007_CMD_PWRDN_IRQEN                                                                    \
	(0 << TSC2007_CMD_PWRDN_SHIFT) /* 00: Power down between cycles; PENIRQ enabled */
#define TSC2007_CMD_ADCON_IRQDIS                                                                   \
	(1 << TSC2007_CMD_PWRDN_SHIFT) /* 01: A/D converter on; PENIRQ disabled */
#define TSC2007_CMD_ADCOFF_IRQEN                                                                   \
	(2 << TSC2007_CMD_PWRDN_SHIFT) /* 10: A/D converter off; PENIRQ enabled. */
