...
#include <roux/rpmsg/rpmsg_port.h>
...
struct rpmsg_port_ops_s {
	...
	CODE void (*register_callback)(FAR struct rpmsg_port_s *port, rpmsg_port_rx_cb_t callback);
};
...
static inline_function uint16_t rpmsg_port_queue_navail(FAR struct rpmsg_port_queue_s *queue)
{
...
static inline_function uint16_t rpmsg_port_queue_nused(FAR struct rpmsg_port_queue_s *queue)
{
