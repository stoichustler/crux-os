...
uint8_t vnc_convert_rgb8_222(lfb_color_t rgb)
{
	...
	return (uint8_t)(((rgb >> 2) & 0x30) | ((rgb >> 1) & 0x0c) | (rgb & 0x03));
}
...
uint16_t vnc_convert_rgb16_555(lfb_color_t rgb)
{
	...
	return (uint8_t)((((uint16_t)rgb << 8) & 0x7000) | (((uint16_t)rgb << 5) & 0x0380) |
...
uint16_t vnc_convert_rgb16_565(lfb_color_t rgb)
{
	...
	return (uint8_t)((((uint16_t)rgb << 8) & 0xe000) | (((uint16_t)rgb << 6) & 0x0700) |
					 (((uint16_t)rgb << 3) & 0x0018));
}
...
uint32_t vnc_convert_rgb32_888(lfb_color_t rgb)
{
	...
	return (((uint32_t)rgb << 16) & 0x00e00000) | (((uint32_t)rgb << 11) & 0x0000e000) |
...
uint8_t vnc_convert_rgb8_222(lfb_color_t rgb)
{
	...
	return (uint8_t)(((rgb >> 10) & 0x0030) | ((rgb >> 7) & 0x000c) | ((rgb >> 3) & 0x0003));
}
...
uint8_t vnc_convert_rgb8_332(lfb_color_t rgb)
{
	...
	return (uint8_t)(((rgb >> 8) & 0x00e0) | ((rgb >> 6) & 0x001c) | ((rgb >> 3) & 0x0003));
}
...
uint32_t vnc_convert_rgb32_888(lfb_color_t rgb)
{
	...
	return (((uint32_t)rgb << 8) & 0x00f80000) | (((uint32_t)rgb << 6) & 0x0000fc00) |
...
uint8_t vnc_convert_rgb8_222(lfb_color_t rgb)
{
	...
	return (uint8_t)(((rgb >> 18) & 0x00000030) | ((rgb >> 12) & 0x0000000c) |
					 ((rgb >> 6) & 0x00000003));
}
...
uint8_t vnc_convert_rgb8_332(lfb_color_t rgb)
{
	...
	return (uint8_t)(((rgb >> 16) & 0x00000070) | ((rgb >> 11) & 0x0000001c) |
					 ((rgb >> 6) & 0x00000003));
}
...
uint16_t vnc_convert_rgb16_555(lfb_color_t rgb)
{
	...
	return (uint16_t)(((rgb >> 9) & 0x00007c00) | ((rgb >> 6) & 0x000003e0) |
					  ((rgb >> 3) & 0x0000001f));
}
...
uint16_t vnc_convert_rgb16_565(lfb_color_t rgb)
{
	...
	return (uint16_t)(((rgb >> 8) & 0x0000f800) | ((rgb >> 5) & 0x000007e0) |
					  ((rgb >> 3) & 0x0000001f));
}
			   ...
			   unsigned int maxcolors, FAR lfb_color_t *colors)
{
	...
	rowstart =
		(FAR lfb_color_t *)(session->fb + RFB_STRIDE * rect->y + RFB_BYTESPERPIXEL * rect->x);
