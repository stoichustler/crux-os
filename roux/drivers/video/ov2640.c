...
static int ov2640_putreg(FAR struct i2c_master_s *i2c, uint8_t regaddr, uint8_t regval);
static uint8_t ov2640_getreg(FAR struct i2c_master_s *i2c, uint8_t regaddr);
static int ov2640_putreglist(FAR struct i2c_master_s *i2c, FAR const struct ovr2640_reg_s *reglist,
							 size_t nentries);
...
static const struct ovr2640_reg_s g_ov2640_reset[] = {{0xff, 0x01}, {0x12, 0x80}};
...
static const struct ovr2640_reg_s g_ov2640_initialregs[] = {
	...
	{0x46, 0x22}, {0x0c, 0x3a}, {0x5d, 0x55}, {0x5e, 0x7d}, {0x5f, 0x7d}, {0x60, 0x55},
	{0x61, 0x70}, {0x62, 0x80}, {0x7c, 0x05}, {0x20, 0x80}, {0x28, 0x30}, {0x6c, 0x00},
	{0x6d, 0x80}, {0x6e, 0x00}, {0x70, 0x02}, {0x71, 0x94}, {0x73, 0xc1}, {0x3d, 0x34},
	{0x12, 0x04}, {0x5a, 0x57}, {0x4f, 0xbb}, {0x50, 0x9c}, {0xff, 0x00}, {0xe5, 0x7f},
	{0xf9, 0xc0}, {0x41, 0x24}, {0xe0, 0x14}, {0x76, 0xff}, {0x33, 0xa0}, {0x42, 0x20},
	{0x43, 0x18}, {0x4c, 0x00}, {0x87, 0xd0}, {0x88, 0x3f}, {0xd7, 0x03}, {0xd9, 0x10},
	...
	{0xc6, 0x51}, {0xbf, 0x80}, {0xc7, 0x10}, {0xb6, 0x66}, {0xb8, 0xa5}, {0xb7, 0x64},
	{0xb9, 0x7c}, {0xb3, 0xaf}, {0xb4, 0x97}, {0xb5, 0xff}, {0xb0, 0xc5}, {0xb1, 0x94},
	{0xb2, 0x0f}, {0xc4, 0x5c}, {0xa6, 0x00}, {0xa7, 0x20}, {0xa7, 0xd8}, {0xa7, 0x1b},
	{0xa7, 0x31}, {0xa7, 0x00}, {0xa7, 0x18}, {0xa7, 0x20}, {0xa7, 0xd8}, {0xa7, 0x19},
	{0xa7, 0x31}, {0xa7, 0x00}, {0xa7, 0x18}, {0xa7, 0x20}, {0xa7, 0xd8}, {0xa7, 0x19},
	{0xa7, 0x31}, {0xa7, 0x00}, {0xa7, 0x18}, {0x7f, 0x00}, {0xe5, 0x1f}, {0xe1, 0x77},
	{0xdd, 0x7f}, {0xc2, 0x0e}};
...
static const struct ovr2640_reg_s g_ov2640_resolution_common[] = {
	{0xff, 0x00}, {0xe0, 0x04}, {0xc0, 0xc8}, {0xc1, 0x96}, {0x86, 0x3d}, {0x51, 0x90},
...
static const struct ovr2640_reg_s g_ov2640_qcif_resolution[] = {
	{0x50, 0x9b}, {0x5a, 0x2c}, {0x5b, 0x24}, {0x5c, 0x00}, {0xd3, 0x04}, {0xe0, 0x00}};
...
static const struct ovr2640_reg_s g_ov2640_qvga_resolution[] = {
	{0x50, 0x92}, {0x5a, 0x50}, {0x5b, 0x3c}, {0x5c, 0x00}, {0xd3, 0x04}, {0xe0, 0x00},
};
...
static const struct ovr2640_reg_s g_ov2640_cif_resolution[] = {
	{0x50, 0x92}, {0x5a, 0x58}, {0x5b, 0x48}, {0x5c, 0x00}, {0xd3, 0x08}, {0xe0, 0x00}};
...
static const struct ovr2640_reg_s g_ov2640_vga_resolution[] = {
	{0x50, 0x80}, {0x5a, 0xa0}, {0x5b, 0x78}, {0x5c, 0x00}, {0xd3, 0x02}, {0xe0, 0x00}};
...
static const struct ovr2640_reg_s g_ov2640_svga_resolution[] = {
	{0x50, 0x89}, {0x5a, 0xc8}, {0x5b, 0x96}, {0x5c, 0x00}, {0xd3, 0x02}, {0xe0, 0x00}};
...
static const struct ovr2640_reg_s g_ov2640_xga_resolution[] = {
	{0x50, 0x80}, {0x5a, 0x00}, {0x5b, 0xc0}, {0x5c, 0x01},
	{0xd3, 0x02}, {0xe0, 0x00}, {0x50, 0x00}};
...
static const struct ovr2640_reg_s g_ov2640_sxga_resolution[] = {
	{0x50, 0x80}, {0x5a, 0x40}, {0x5b, 0x00}, {0x5c, 0x05},
	{0xd3, 0x02}, {0xe0, 0x00}, {0x50, 0x00}, {0xd3, 0x82}};
...
static const struct ovr2640_reg_s g_ov2640_uxga_resolution[] = {
	{0x50, 0x80}, {0x5a, 0x90}, {0x5b, 0x2c}, {0x5c, 0x05},
	{0xd3, 0x00}, {0xe0, 0x00}, {0x50, 0x00}, {0xd3, 0x80}};
...
static const struct ovr2640_reg_s g_ov2640_colorfmt_common[] = {{0xff, 0x00}, {0x05, 0x00}};
...
static const struct ovr2640_reg_s g_ov2640_yuv422_colorfmt[] = {
	{0xda, 0x01}, {0xd7, 0x01}, {0x33, 0xa0}, {0xe1, 0x67}, {0xe0, 0x00}, {0x05, 0x00}};
...
static const struct ovr2640_reg_s g_ov2640_jpeg_init[] = {
	{0xff, 0x00}, {0x2c, 0xff}, {0x2e, 0xdf}, {0xff, 0x01}, {0x3c, 0x32}, {0x11, 0x04},
	{0x09, 0x02}, {0x04, 0x28}, {0x13, 0xe5}, {0x14, 0x48}, {0x2c, 0x0c}, {0x33, 0x78},
	...
	{0x55, 0x00}, {0x5a, 0x2c}, {0x5b, 0x24}, {0x5c, 0x00},
};
...
#ifdef CONFIG_OV2640_JPEG
static const struct ovr2640_reg_s g_ov2640_yuv422[] = {{0xff, 0x00}, {0x05, 0x00}, {0xda, 0x10},
...
#ifdef CONFIG_OV2640_JPEG
static const struct ovr2640_reg_s g_ov2640_jpeg[] = {{0xe0, 0x14}, {0xe1, 0x77}, {0xe5, 0x1f},
...
static const struct ovr2640_reg_s g_ov2640_jpeg_qcif_resolution[] = {
	...
	{0x52, 0x96}, {0x53, 0x00}, {0x54, 0x00}, {0x55, 0x00}, {0x57, 0x00}, {0x5a, 0x2c},
...
static const struct ovr2640_reg_s g_ov2640_jpeg_cif_resolution[] = {
	...
	{0x06, 0x88}, {0x07, 0xc0}, {0x0d, 0x87}, {0x0e, 0x41}, {0x4c, 0x00}, {0xff, 0x00},
	{0xe0, 0x04}, {0xc0, 0x64}, {0xc1, 0x4b}, {0x86, 0x35}, {0x50, 0x89}, {0x51, 0xc8},
	{0x52, 0x96}, {0x53, 0x00}, {0x54, 0x00}, {0x55, 0x00}, {0x57, 0x00}, {0x5a, 0x58},
...
static const struct ovr2640_reg_s g_ov2640_jpeg_svga_resolution[] = {
	...
	{0x5a, 0x57}, {0x6d, 0x80}, {0x3d, 0x34}, {0x39, 0x02}, {0x35, 0x88}, {0x22, 0x0a},
	{0x37, 0x40}, {0x34, 0xa0}, {0x06, 0x02}, {0x0d, 0xb7}, {0x0e, 0x01}, {0xff, 0x00},
	{0xe0, 0x04}, {0xc0, 0xc8}, {0xc1, 0x96}, {0x86, 0x35}, {0x50, 0x89}, {0x51, 0x90},
	{0x52, 0x2c}, {0x53, 0x00}, {0x54, 0x00}, {0x55, 0x88}, {0x57, 0x00}, {0x5a, 0xc8},
...
static const struct ovr2640_reg_s g_ov2640_jpeg_xvga_resolution[] = {
	...
	{0x5a, 0x57}, {0x6d, 0x80}, {0x3d, 0x34}, {0x39, 0x02}, {0x35, 0x88}, {0x22, 0x0a},
	{0x37, 0x40}, {0x34, 0xa0}, {0x06, 0x02}, {0x0d, 0xb7}, {0x0e, 0x01}, {0xff, 0x00},
	{0xc0, 0xc8}, {0xc1, 0x96}, {0x8c, 0x00}, {0x86, 0x3d}, {0x50, 0x00}, {0x51, 0x90},
	{0x52, 0x2c}, {0x53, 0x00}, {0x54, 0x00}, {0x55, 0x88}, {0x5a, 0x00}, {0x5b, 0xc0},
	{0x5c, 0x01}, {0xd3, 0x02}};
...
static const struct ovr2640_reg_s g_ov2640_jpeg_sxvga_resolution[] = {
	...
	{0x52, 0x2c}, {0x53, 0x00}, {0x54, 0x00}, {0x55, 0x88}, {0x57, 0x00}, {0x5a, 0x40},
...
static const struct ovr2640_reg_s g_ov2640_jpeg_uxga_resolution[] = {
	...
	{0x5b, 0x2c}, {0x5c, 0x05}, {0xd3, 0x02}, {0xe0, 0x00}};
...
int ov2640_initialize(FAR struct i2c_master_s *i2c)
{
	...
	ret =
		ov2640_putreglist(i2c, g_ov2640_jpeg_qcif_resolution, OV2640_JPEG_QCIF_RESOUTION_NENTRIES);

#elif defined(CONFIG_OV2640_JPEG_QVGA_RESOLUTION)
	ret =
		ov2640_putreglist(i2c, g_ov2640_jpeg_qvga_resolution, OV2640_JPEG_QVGA_RESOUTION_NENTRIES);

#elif defined(CONFIG_OV2640_JPEG_CIF_RESOLUTION)
	ret = ov2640_putreglist(i2c, g_ov2640_jpeg_cif_resolution, OV2640_JPEG_CIF_RESOUTION_NENTRIES);

#elif defined(CONFIG_OV2640_JPEG_VGA_RESOLUTION)
	ret = ov2640_putreglist(i2c, g_ov2640_jpeg_vga_resolution, OV2640_JPEG_VGA_RESOUTION_NENTRIES);

#elif defined(CONFIG_OV2640_JPEG_SVGA_RESOLUTION)
	ret =
		ov2640_putreglist(i2c, g_ov2640_jpeg_svga_resolution, OV2640_JPEG_SVGA_RESOUTION_NENTRIES);

#elif defined(CONFIG_OV2640_JPEG_XVGA_RESOLUTION)
	ret =
		ov2640_putreglist(i2c, g_ov2640_jpeg_xvga_resolution, OV2640_JPEG_XVGA_RESOUTION_NENTRIES);
	...
	ret =
		ov2640_putreglist(i2c, g_ov2640_jpeg_uxga_resolution, OV2640_JPEG_UXGA_RESOUTION_NENTRIES);
...
#error Unspecified JPEG resolution
	...
	ret = ov2640_putreglist(i2c, g_ov2640_initialregs, OV2640_INITIALREGS_NENTRIES);
	if (ret < 0) {
		gerr("ERROR: ov2640_putreglist failed: %d\n", ret);
		goto errout;
	}
	...
	ret = ov2640_putreglist(i2c, g_ov2640_resolution_common, OV2640_RESOLUTION_COMMON_NENTRIES);
	if (ret < 0) {
		gerr("ERROR: ov2640_putreglist failed: %d\n", ret);
		goto errout;
	}
...
#if defined(CONFIG_OV2640_QCIF_RESOLUTION)
	ret = ov2640_putreglist(i2c, g_ov2640_qcif_resolution, OV2640_QCIF_RESOLUTION_NENTRIES);

#elif defined(CONFIG_OV2640_QVGA_RESOLUTION)
	ret = ov2640_putreglist(i2c, g_ov2640_qvga_resolution, OV2640_QVGA_RESOLUTION_NENTRIES);

#elif defined(CONFIG_OV2640_CIF_RESOLUTION)
	ret = ov2640_putreglist(i2c, g_ov2640_cif_resolution, OV2640_CIF_RESOLUTION_NENTRIES);

#elif defined(CONFIG_OV2640_VGA_RESOLUTION)
	ret = ov2640_putreglist(i2c, g_ov2640_vga_resolution, OV2640_VGA_RESOLUTION_NENTRIES);

#elif defined(CONFIG_OV2640_SVGA_RESOLUTION)
	ret = ov2640_putreglist(i2c, g_ov2640_svga_resolution, OV2640_SVGA_RESOLUTION_NENTRIES);

#elif defined(CONFIG_OV2640_XGA_RESOLUTION)
	ret = ov2640_putreglist(i2c, g_ov2640_xga_resolution, OV2640_XGA_RESOLUTION_NENTRIES);

#elif defined(CONFIG_OV2640_SXGA_RESOLUTION)
	ret = ov2640_putreglist(i2c, g_ov2640_sxga_resolution, OV2640_SXGA_RESOLUTION_NENTRIES);

#elif defined(CONFIG_OV2640_UXGA_RESOLUTION)
	ret = ov2640_putreglist(i2c, g_ov2640_uxga_resolution, OV2640_UXGA_RESOLUTION_NENTRIES);
...
#error Unknown image resolution
	...
	ret = ov2640_putreglist(i2c, g_ov2640_colorfmt_common, OV2640_COLORFMT_COMMON_NENTRIES);
	if (ret < 0) {
		gerr("ERROR: ov2640_putreglist failed: %d\n", ret);
		goto errout;
	}
...
#if defined(CONFIG_OV2640_YUV422_COLORFMT)
	ret = ov2640_putreglist(i2c, g_ov2640_yuv422_colorfmt, OV2640_YUV422_COLORFMT_NENTRIES);

#elif defined(CONFIG_OV2640_RGB565_COLORFMT)
	ret = ov2640_putreglist(i2c, g_ov2640_rgb565_colorfmt, OV2640_RGB565_COLORFMT_NENTRIES);
