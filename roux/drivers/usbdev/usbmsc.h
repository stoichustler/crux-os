...
#define CONFIG_USBMSC_VENDORSTR "ROUX"
#endif
...
#define SIZEOF_USBMSC_CFGDESC (USB_SIZEOF_IFDESC + USBMSC_NENDPOINTS * USB_SIZEOF_EPDESC)
...
int16_t usbmsc_mkcfgdesc(FAR uint8_t *buf, FAR struct usbdev_devinfo_s *devinfo, uint8_t speed,
						 uint8_t type);
