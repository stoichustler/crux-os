...
static int bq2425x_getreg8(FAR struct bq2425x_dev_s *priv, uint8_t regaddr, FAR uint8_t *regval);
static int bq2425x_putreg8(FAR struct bq2425x_dev_s *priv, uint8_t regaddr, uint8_t regval);

static inline int bq2425x_getreport(FAR struct bq2425x_dev_s *priv, uint8_t *report);
...
static int bq2425x_state(FAR struct battery_charger_dev_s *dev, FAR int *status);
static int bq2425x_health(FAR struct battery_charger_dev_s *dev, FAR int *health);
static int bq2425x_online(FAR struct battery_charger_dev_s *dev, FAR bool *status);
...
static int bq2425x_input_current(FAR struct battery_charger_dev_s *dev, int value);
static int bq2425x_operate(FAR struct battery_charger_dev_s *dev, uintptr_t param);
...
static const struct battery_charger_operations_s g_bq2425xops = {
	bq2425x_state,	 bq2425x_health,		bq2425x_online, bq2425x_voltage,
	bq2425x_current, bq2425x_input_current, bq2425x_operate};
...
static inline int bq2425x_getreport(FAR struct bq2425x_dev_s *priv, FAR uint8_t *report)
{
	uint8_t regval = 0;
	int ret;
...
FAR struct battery_charger_dev_s *bq2425x_initialize(FAR struct i2c_master_s *i2c, uint8_t addr,
