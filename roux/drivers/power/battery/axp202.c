...
#include <roux/power/battery_charger.h>
#include <roux/power/battery_ioctl.h>
#include <roux/power/axp202.h>
...
static int axp202_getreg8(FAR struct axp202_dev_s *priv, uint8_t regaddr, FAR uint8_t *regval);
static int axp202_putreg8(FAR struct axp202_dev_s *priv, uint8_t regaddr, uint8_t regval);

/* Battery driver lower half methods */

static int axp202_state(FAR struct battery_charger_dev_s *dev, FAR int *status);
static int axp202_health(FAR struct battery_charger_dev_s *dev, FAR int *health);
static int axp202_online(FAR struct battery_charger_dev_s *dev, FAR bool *status);
...
static int axp202_input_current(FAR struct battery_charger_dev_s *dev, int value);
static int axp202_operate(FAR struct battery_charger_dev_s *dev, uintptr_t param);

static int axp202_set_ldo2_valtage(FAR struct axp202_dev_s *dev, int voltage);
static int axp202_set_ldo3_valtage(FAR struct axp202_dev_s *dev, int voltage);
static int axp202_set_ldo4_valtage(FAR struct axp202_dev_s *dev, int voltage);
static int axp202_set_dc2_valtage(FAR struct axp202_dev_s *dev, int voltage);
static int axp202_set_dc2_valtage(FAR struct axp202_dev_s *dev, int voltage);
...
static const struct battery_charger_operations_s g_axp202ops = {
	axp202_state,	axp202_health,		  axp202_online, axp202_voltage,
	axp202_current, axp202_input_current, axp202_operate};
...
static int axp202_set_ldo2_valtage(FAR struct axp202_dev_s *priv, int voltage)
{
	uint8_t reg = 0;
...
static int axp202_set_ldo3_valtage(FAR struct axp202_dev_s *priv, int voltage)
{
	uint8_t reg = 0;
...
static int axp202_set_ldo4_valtage(FAR struct axp202_dev_s *priv, int voltage)
{
	uint8_t reg = 0;
...
static int axp202_set_dc2_valtage(FAR struct axp202_dev_s *priv, int voltage)
{
	uint8_t reg = 0;
...
static int axp202_set_dc3_valtage(FAR struct axp202_dev_s *priv, int voltage)
{
	uint8_t reg = 0;
...
FAR struct battery_charger_dev_s *axp202_initialize(FAR struct i2c_master_s *i2c, uint8_t addr,
													uint32_t frequency)
{
