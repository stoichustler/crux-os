...
static int mcp73871_state(FAR struct battery_charger_dev_s *dev, FAR int *status);
static int mcp73871_health(FAR struct battery_charger_dev_s *dev, FAR int *health);
static int mcp73871_online(FAR struct battery_charger_dev_s *dev, FAR bool *status);
...
static int mcp73871_input_current(FAR struct battery_charger_dev_s *dev, int value);
static int mcp73871_operate(FAR struct battery_charger_dev_s *dev, intptr_t param);
...
static const struct battery_charger_operations_s g_mcp73871ops = {
	mcp73871_state,	  mcp73871_health,		  mcp73871_online, mcp73871_voltage,
	mcp73871_current, mcp73871_input_current, mcp73871_operate};
...
static int mcp73871_state(FAR struct battery_charger_dev_s *dev, FAR int *status)
{
	...
	value = (priv->config->read_stat1() << 2) | (priv->config->read_stat2() << 1) |
...
static inline int mcp73871_powersupply(FAR struct mcp73871_dev_s *priv, int current)
{
...
static inline int mcp73871_setvolt(FAR struct mcp73871_dev_s *priv, int volts)
{
...
static inline int mcp73871_setcurr(FAR struct mcp73871_dev_s *priv, int current)
{
...
static int mcp73871_operate(FAR struct battery_charger_dev_s *dev, uintptr_t param)
{
	return -ENOSYS;
}
...
FAR struct battery_charger_dev_s *mcp73871_initialize(FAR struct mcp73871_config_s *config)
{
