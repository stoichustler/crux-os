...
#include <roux/power/battery_gauge.h>
#include <roux/power/battery_ioctl.h>
#include <roux/power/bq27426.h>
...
#if defined(CONFIG_BATTERY_GAUGE) && defined(CONFIG_I2C) && defined(CONFIG_BQ27426)
...
static int bq27426_getreg16(FAR struct bq27426_dev_s *priv, uint8_t regaddr, FAR uint16_t *regval);
static int bq27426_putreg16(FAR struct bq27426_dev_s *priv, uint8_t regaddr, uint16_t regval);
static inline int bq27426_getvoltage(FAR struct bq27426_dev_s *priv, b16_t *voltage);
static inline int bq27426_getsoc(FAR struct bq27426_dev_s *priv, b16_t *soc);
static inline int bq27426_getcapacity(FAR struct bq27426_dev_s *priv, uint8_t capacity,
									  b16_t *value);
static inline int bq27426_get_device_id(FAR struct bq27426_dev_s *priv, uint16_t *id);
...
static int bq27426_capacity_full(struct battery_gauge_dev_s *dev, b16_t *capacity_full);
...
static inline int bq27426_get_device_id(FAR struct bq27426_dev_s *priv, uint16_t *id)
{
	...
	ret = bq27426_putreg16(priv, BQ27426_COMMAND_CONTROL, BQ27426_CONTROL_DEVICE_TYPE);
	if (ret == OK) {
...
static int bq27426_capacity_full(struct battery_gauge_dev_s *dev, b16_t *value)
{
	FAR struct bq27426_dev_s *priv = (FAR struct bq27426_dev_s *)dev;
...
FAR struct battery_gauge_dev_s *bq27426_initialize(FAR struct i2c_master_s *i2c, uint8_t addr,
												   uint32_t frequency)
{
