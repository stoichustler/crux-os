...
#define BQ2425X_INP_CURR_LIM_100MA                                                                 \
	(0 << BQ2425X_INP_CURR_LIM_SHIFT) /* USB2.0 host with 100mA current limit */
#define BQ2425X_INP_CURR_LIM_150MA                                                                 \
	(1 << BQ2425X_INP_CURR_LIM_SHIFT) /* USB3.0 host with 150mA current limit */
#define BQ2425X_INP_CURR_LIM_500MA                                                                 \
	(2 << BQ2425X_INP_CURR_LIM_SHIFT) /* USB2.0 host with 500mA current limit */
#define BQ2425X_INP_CURR_LIM_900MA                                                                 \
	(3 << BQ2425X_INP_CURR_LIM_SHIFT) /* USB3.0 host with 900mA current limit */
#define BQ2425X_INP_CURR_LIM_1500MA                                                                \
	(4 << BQ2425X_INP_CURR_LIM_SHIFT) /* Charger with 1500mA current limit */
#define BQ2425X_INP_CURR_LIM_2000MA                                                                \
	(5 << BQ2425X_INP_CURR_LIM_SHIFT) /* Charger with 2000mA current limit */
#define BQ2425X_INP_CURR_EXT_ILIM                                                                  \
	(6 << BQ2425X_INP_CURR_LIM_SHIFT) /* External ILIM current limit */
#define BQ2425X_INP_CURR_NO_LIMIT                                                                  \
	(7 << BQ2425X_INP_CURR_LIM_SHIFT) /* No input current limit with internal clamp at 3A */
...
#define BQ2425X_HZ_MODE                                                                            \
	(1 << 0) /* Sets the charger IC into low power standby mode, but keep BAT FET ON */
...
#define BQ2425X_LOOP_STATUS_SHIFT                                                                  \
	6 /* Show if there is some active loop that slow down safety timer */
