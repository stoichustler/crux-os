...
static ssize_t relay_read(FAR struct file *filep, FAR char *buffer, size_t buflen);
static ssize_t relay_write(FAR struct file *filep, FAR const char *buffer, size_t buflen);
