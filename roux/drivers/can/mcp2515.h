...
#define RXB0CTRL_FILHIT                                                                            \
	(1 << 0) /* Bit 0: Filter Hit bit - 1 = Msg was accepted by Filter 1; 0 = Filter 0 */
#define RXB0CTRL_BUKT1                                                                             \
	(1 << 1) /* Bit 1: Read-only Copy of BUKT bit (used internally by the MCP2515) */
...
#define RXBCTRL_RXM_ALLMSG                                                                         \
	(3 << RXBCTRL_RXM_SHIFT) /* 11: Turn mask/filters off; receive any message */
#define RXBCTRL_RXM_ALLVALID                                                                       \
	(0 << RXBCTRL_RXM_SHIFT) /* 00: Receive all valid msgs using (STD or EXT) that meet filter     \
				criteria */
							 /* Bit 7: Not used */
...
#define RXB1CTRL_FILHIT_SHIFT                                                                      \
	(0) /* Filter Hit bits - indicates which acceptance filter enabled reception of message */
...
#define RXB1CTRL_FILHIT_F1                                                                         \
	(1 << RXB1CTRL_FILHIT_SHIFT) /* Acceptance Filter 1 (RXF1)  (Only if BUKT bit set in RXB0CTRL) \
								  */
#define RXB1CTRL_FILHIT_F0                                                                         \
	(0 << RXB1CTRL_FILHIT_SHIFT) /* Acceptance Filter 0 (RXF0)  (Only if BUKT bit set in RXB0CTRL) \
								  */
...
#define RXBSIDL_SRR                                                                                \
	(1 << 4) /* Bit 4: Standard Frame Remote Transmit Request bit (valid only if IDE bit = '0')*/
...
#define CNF2_PRSEG_SHIFT                                                                           \
	(0) /* Bits 0-2: Propagation Segment Length bits <2:0>, (PRSEG + 1) x TQ                       \
		 */
...
#define MCP2515_INT_ERR                                                                            \
	(1 << 5) /* Bit 5: Error Interrupt Enable bit (multiple sources in EFLG register) */
