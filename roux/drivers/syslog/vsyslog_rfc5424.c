...
int nx_vsyslog(int priority, FAR const IPTR char *fmt, FAR va_list *ap)
{
	...
	/* Get the host name string. ROUX configures this to be empty by default,
	...
	/* End of format string */
							   ...
							   NILVALUE_SPACE /* TODO: MSGID */
								   ...
								   NILVALUE_SPACE /* Empty structured data, print the NILVALUE here
												   * to save `libsprintf` call */
#endif
#ifdef CONFIG_SYSLOG_RFC5424_TIMEQUALITY
