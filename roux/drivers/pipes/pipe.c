...
static int pipe_mmap(FAR struct file *filep, FAR struct mm_map_entry_s *entry);
...
static int pipe_register(size_t bufsize, int flags, FAR char *devname, size_t namesize)
{
