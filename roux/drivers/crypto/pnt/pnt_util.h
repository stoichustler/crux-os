...
#ifndef __INCLUDE_ROUX_CRYPTO_PNT_PNT_UTIL_H_
#define __INCLUDE_ROUX_CRYPTO_PNT_PNT_UTIL_H_
...
bool se05x_identify(pSe05xSession_t session_ctx, FAR identify_rsp_t *response);

#endif /* __INCLUDE_ROUX_CRYPTO_PNT_PNT_UTIL_H_ */
