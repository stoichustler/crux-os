...
#define XHCI_HCSPARAMS1_MAXINTRS(x)                                                                \
	(((x) >> 8) & 0x7ff) /* Bits 8-18: Number of Interrupters (MaxIntrs) */
/* Bits 19-23: Reserved */
#define XHCI_HCSPARAMS1_MAXPORTS(x)                                                                \
	(((x) >> 24) & 0xff) /* Bits 24-31: Number of Ports (MaxPorts) */
...
#define XHCI_HCSPARAMS2_MAXSPB(x) (XHCI_HCSPARAMS2_MAXSPBLO(x) + (XHCI_HCSPARAMS2_MAXSPBHI(x) << 5))
...
#define XHCI_PORTPMSC(n)                                                                           \
	(XHCI_PORT(n) + 0x04)						/* Port Power Management Status and Control (32b)  \
												 */
...
#define XHCI_EP_CTX0_MESITHI_SHIFT                                                                 \
	(24) /* Bits 24-31: Max Endpoint Service Time Interval Payload High */
...
#define XHCI_EP_CTX3_MESITLO_SHIFT                                                                 \
	(16) /* Bits 16-31: Max Endpoint Service Time Interval Payload Low */
