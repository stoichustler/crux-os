...
static const struct xhci_usbhost_trace_s g_trace1[TRACE1_NSTRINGS] = {
	TRENTRY(XHCI_TRACE1_RESET_FAILED, "XHCI ERROR: xhci_reset failed %d\n"),
	...
	TRENTRY(XHCI_VTRACE1_INITIALIZING, "XHCI Initializing XHCI Stack\n"),
...
static const struct xhci_usbhost_trace_s g_trace2[TRACE2_NSTRINGS] = {
	TRENTRY(XHCI_TRACE2_EPSTALLED, "XHCI EP%d Stalled: TOKEN=%04x\n"),

	/* Verbose */

	TRENTRY(XHCI_VTRACE2_PORTSC, "XHCI PORTSC%d: %08x\n"),
