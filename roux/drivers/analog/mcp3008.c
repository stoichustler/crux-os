...
static int mcp3008_bind(FAR struct adc_dev_s *dev, FAR const struct adc_callback_s *callback);
...
static int mcp3008_ioctl(FAR struct adc_dev_s *dev, int cmd, unsigned long arg);
...
static int mcp3008_readchannel(FAR struct mcp3008_dev_s *priv, FAR struct adc_msg_s *msg)
{
