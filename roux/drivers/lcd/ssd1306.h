...
/* Limitations of the current configuration that I hope to fix someday */
	...
	!defined(CONFIG_LCD_HILETGO) && !defined(CONFIG_LCD_SSD1306_CUSTOM)
...
#define SSD1306_DEV_NATIVE_XRES                                                                    \
	CONFIG_LCD_SSD1306_CUSTOM_DEV_NATIVE_XRES /* Only 128 of 131 columns used */
#define SSD1306_DEV_NATIVE_YRES                                                                    \
	CONFIG_LCD_SSD1306_CUSTOM_DEV_NATIVE_YRES					  /* 4 pages each 8 rows           \
																   */
