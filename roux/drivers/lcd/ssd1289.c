...
#define PWRCTRL1_SETTING                                                                           \
	(SSD1289_PWRCTRL1_AP_SMMED | SSD1289_PWRCTRL1_DC_FLINEx24 | SSD1289_PWRCTRL1_BT_p5m4 |         \
	 SSD1289_PWRCTRL1_DCT_FLINEx24)
...
#define PWRCTRL1_SETTING                                                                           \
	(SSD1289_PWRCTRL1_AP_MEDLG | SSD1289_PWRCTRL1_DC_FOSd4 | SSD1289_PWRCTRL1_BT_p5m4 |            \
	 SSD1289_PWRCTRL1_DCT_FOSd4)
...
#ifdef CONFIG_DEBUG_LCD
static void ssd1289_showrun(FAR struct ssd1289_dev_s *priv, fb_coord_t row, fb_coord_t col,
							size_t npixels, bool put);
#else
#define ssd1289_showrun(p, r, c, n, b)
#endif

static int ssd1289_putrun(FAR struct lcd_dev_s *dev, fb_coord_t row, fb_coord_t col,
						  FAR const uint8_t *buffer, size_t npixels);
static int ssd1289_getrun(FAR struct lcd_dev_s *dev, fb_coord_t row, fb_coord_t col,
						  FAR uint8_t *buffer, size_t npixels);

/* LCD Configuration */

static int ssd1289_getvideoinfo(FAR struct lcd_dev_s *dev, FAR struct fb_videoinfo_s *vinfo);
...
static int ssd1289_setpower(FAR struct lcd_dev_s *dev, int power)
{
	...
	if (power > 0) {
		...
		ssd1289_putreg(lcd, SSD1289_DSPCTRL,
					   (SSD1289_DSPCTRL_ON | SSD1289_DSPCTRL_GON | SSD1289_DSPCTRL_DTE |
...
static inline int ssd1289_hwinitialize(FAR struct ssd1289_dev_s *priv)
{
...
#endif
	{
		...
		ssd1289_putreg(lcd, SSD1289_DSPCTRL,
					   (SSD1289_DSPCTRL_INTERNAL | SSD1289_DSPCTRL_GON | SSD1289_DSPCTRL_VLE(0)));
		...
		ssd1289_putreg(lcd, SSD1289_DSPCTRL,
					   (SSD1289_DSPCTRL_ON | SSD1289_DSPCTRL_GON | SSD1289_DSPCTRL_VLE(0)));
		...
		ssd1289_putreg(lcd, SSD1289_DSPCTRL,
					   (SSD1289_DSPCTRL_ON | SSD1289_DSPCTRL_DTE | SSD1289_DSPCTRL_GON |
						SSD1289_DSPCTRL_VLE(0)));
#endif
      ...
      up_mdelay(15);
...
#if defined(CONFIG_LCD_PORTRAIT) || defined(CONFIG_LCD_RPORTRAIT)
		ssd1289_putreg(lcd, SSD1289_OUTCTRL,
					   (SSD1289_OUTCTRL_MUX(319) | SSD1289_OUTCTRL_TB | SSD1289_OUTCTRL_BGR |
						SSD1289_OUTCTRL_REV));
#else
		ssd1289_putreg(lcd, SSD1289_OUTCTRL,
					   (SSD1289_OUTCTRL_MUX(319) | SSD1289_OUTCTRL_BGR | SSD1289_OUTCTRL_REV));
#endif
		...
		ssd1289_putreg(lcd, SSD1289_ACCTRL, (SSD1289_ACCTRL_EOR | SSD1289_ACCTRL_BC));
		...
		ssd1289_putreg(lcd, SSD1289_ENTRY,
					   (SSD1289_ENTRY_ID_HINCVINC | SSD1289_ENTRY_TY_C | SSD1289_ENTRY_DMODE_RAM |
		...
		ssd1289_putreg(lcd, SSD1289_ENTRY,
					   (SSD1289_ENTRY_AM | SSD1289_ENTRY_ID_HINCVINC | SSD1289_ENTRY_TY_C |
