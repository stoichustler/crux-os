...
#define PWRCTRL1_SETTING                                                                           \
	(MIO283QT2_PWRCTRL1_AP_SMMED | MIO283QT2_PWRCTRL1_DC_FLINEx24 | MIO283QT2_PWRCTRL1_BT_p5m4 |   \
	 MIO283QT2_PWRCTRL1_DCT_FLINEx24)
...
#define PWRCTRL1_SETTING                                                                           \
	(MIO283QT2_PWRCTRL1_AP_MEDLG | MIO283QT2_PWRCTRL1_DC_FOSd4 | MIO283QT2_PWRCTRL1_BT_p5m4 |      \
	 MIO283QT2_PWRCTRL1_DCT_FOSd4)
...
#endif
static void mio283qt2_setarea(FAR struct mio283qt2_lcd_s *lcd, uint16_t x0, uint16_t y0,
							  uint16_t x1, uint16_t y1);

/* LCD Data Transfer Methods */

static int mio283qt2_putrun(FAR struct lcd_dev_s *dev, fb_coord_t row, fb_coord_t col,
							FAR const uint8_t *buffer, size_t npixels);
static int mio283qt2_getrun(FAR struct lcd_dev_s *dev, fb_coord_t row, fb_coord_t col,
							FAR uint8_t *buffer, size_t npixels);

/* LCD Configuration */

static int mio283qt2_getvideoinfo(FAR struct lcd_dev_s *dev, FAR struct fb_videoinfo_s *vinfo);
