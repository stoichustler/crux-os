...
#define S1D15G10_DISCTL                                                                            \
	0xca /* Display control; Data: Data: (1) CL div, F1/2 pat, (2) duty, (3) FR inverse (4)        \
		dispersion */
...
#define S1D15G10_DATCTL                                                                            \
	0xbc /* Data scan direction, etc.; Data: (1) inverse, scan dir (2) RGB, (3) gray-scale */
#define S1D15G10_RGBSET8                                                                           \
	0xce /* 256-color position set; Data: (1-8) red tones, (9-16) green tones, (17-20) blue tones  \
		  */
...
#define S1D15G10_ASCSET                                                                            \
	0xaa /* Area scroll set; Data: (1) top addr, (2) bottom addr, (3) Num blocks, (4) scroll mode  \
		  */
...
#define S1D15G10_VOLCTR                                                                            \
	0x81 /* Electronic volume control; Data: (1) volume value, (2) resistance ratio */
...
#define PWCTR_REGULATOR                                                                            \
	(1 << 1) /* P1: Bit 1, Turn on voltage regulator and circuit voltage follower. */
...
#define DATCTL_ADDR_PGDIR                                                                          \
	(1 << 2) /* P1: Bit 2, Address-scan direction in page (vs column) direction. */
