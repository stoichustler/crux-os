...
#include <roux/lcd/ug-2864ambag01.h>
...
#define SH1101A_CLKDIV_SET                                                                         \
	(0xd5) /* Set Display Clock Divide Ratio/Oscillator Frequency: (Double Bytes Command) */
...
#define SH1101A_CMNPAD_CONFIG                                                                      \
	(0xda) /* Set Common pads hardware configuration: (Double Bytes Command) */
...
static int ug2864ambag01_putrun(FAR struct lcd_dev_s *dev, fb_coord_t row, fb_coord_t col,
								FAR const uint8_t *buffer, size_t npixels);
static int ug2864ambag01_getrun(FAR struct lcd_dev_s *dev, fb_coord_t row, fb_coord_t col,
								FAR uint8_t *buffer, size_t npixels);

/* LCD Configuration */

static int ug2864ambag01_getvideoinfo(FAR struct lcd_dev_s *dev, FAR struct fb_videoinfo_s *vinfo);
