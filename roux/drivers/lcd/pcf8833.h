...
#define PCF8833_RGBSET                                                                             \
	0x2d /* Colour set; Data: (1-8) red tones, (9-16) green tones, (17-20) blue tones */
#define PCF8833_PTLAR 0x30 /* Partial area; Data: (1) start address (2) end address */
#define PCF8833_VSCRDEF                                                                            \
	0x33 /* Vertical scroll definition; Data: (1) top fixed, (2) scroll area, (3) bottom fixed */
...
#define PCF8833_TCDF                                                                               \
	0xc5 /* Set divider frequency; Data: Divider factor in region (1) A (2) B (3) C (4) D */
