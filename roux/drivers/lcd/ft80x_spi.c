...
void ft80x_read_memory(FAR struct ft80x_dev_s *priv, uint32_t addr, FAR void *buffer, size_t buflen)
{
	struct ft80x_spiread_s spiread;

	DEBUGASSERT(priv != NULL && (addr & 0xffc00000) == 0 && buffer != NULL && buflen > 0);
...
void ft80x_write_memory(FAR struct ft80x_dev_s *priv, uint32_t addr, FAR const void *buffer,
						size_t buflen)
{
...
void ft80x_write_byte(FAR struct ft80x_dev_s *priv, uint32_t addr, uint8_t data)
{
...
void ft80x_write_hword(FAR struct ft80x_dev_s *priv, uint32_t addr, uint16_t data)
{
...
void ft80x_write_word(FAR struct ft80x_dev_s *priv, uint32_t addr, uint32_t data)
{
