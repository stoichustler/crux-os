...
This describes the use of the pcf8574_lcd_backpack.h, .c driver module for ROUX.
...
also to adopt the ROUX notion of a 'segment lcd codec', which is used to
...
The driver supports the ROUX 'segment lcd codec', which facilitates the
...
to clear the display, move the cursor, etc.  For details, q.v.
    ...
    roux/lcd/slcd_codec.h

Ioctl
-----

The driver supports the ROUX ioctl definitions for segment lcd.  Q.v.

    roux/lcd/slcd_ioctl.h
