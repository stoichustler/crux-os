...
#define SSD1289_PWRCTRL1_DC_SHIFT                                                                  \
	(4) /* Set the step-up cycle of the step-up circuit for 262k-color mode */
...
#define SSD1289_PWRCTRL1_DCT_SHIFT                                                                 \
	(12) /* Step-up cycle of the step-up circuit for 8-color mode                                  \
		  */
...
#define SSD1289_VPORCH_XFP_SHIFT                                                                   \
	(8) /* Delay from last line to falling edge of VSYNC of next frame */
