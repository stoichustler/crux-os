...
#include <roux/lcd/lpm013m091a.h>
...
static void lpm013m091a_selectarea(FAR struct lpm013m091a_lcd_s *lcd, uint16_t x0, int16_t y0,
								   uint16_t x1, int16_t y1);
static int lpm013m091a_hwinitialize(FAR struct lpm013m091a_dev_s *dev);

/* lcd data transfer methods */

static int lpm013m091a_putrun(FAR struct lcd_dev_s *dev, fb_coord_t row, fb_coord_t col,
							  FAR const uint8_t *buffer, size_t npixels);
#ifndef CONFIG_LCD_NOGETRUN
static int lpm013m091a_getrun(FAR struct lcd_dev_s *dev, fb_coord_t row, fb_coord_t col,
							  FAR uint8_t *buffer, size_t npixels);
#endif

/* lcd configuration */

static int lpm013m091a_getvideoinfo(FAR struct lcd_dev_s *dev, FAR struct fb_videoinfo_s *vinfo);
...
static int lpm013m091a_putrun(FAR struct lcd_dev_s *lcd_dev, fb_coord_t row, fb_coord_t col,
							  FAR const uint8_t *buffer, size_t npixels)
{
	FAR struct lpm013m091a_dev_s *dev = (FAR struct lpm013m091a_dev_s *)lcd_dev;
	FAR struct lpm013m091a_lcd_s *lcd = dev->lcd;
...
FAR struct lcd_dev_s *lpm013m091a_initialize(FAR struct lpm013m091a_lcd_s *lcd, int devno)
{
