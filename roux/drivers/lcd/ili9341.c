...
#define ILI9341_IFCTL_PARAM1                                                                       \
	ILI9341_IFCTL_MYEOR | ILI9341_IFCTL_MXEOR | ILI9341_IFCTL_MVEOR | ILI9341_IFCTL_BGREOR |       \
...
#define ILI9341_IFCTL_PARAM3                                                                       \
	ILI9341_IFCTL_RIM | ILI9341_IFCTL_RM | ILI9341_IFCTL_DM | ILI9341_IFCTL_ENDIAN
...
#define ILI9341_MADCTL_LANDSCAPE_PARAM1                                                            \
	(ILI9341_MADCTL_LANDSCAPE_MY | ILI9341_MADCTL_LANDSCAPE_MX | ILI9341_MADCTL_LANDSCAPE_MV |     \
	 ILI9341_MADCTL_LANDSCAPE_ML | ILI9341_MADCTL_LANDSCAPE_BGR | ILI9341_MADCTL_LANDSCAPE_MH)
...
#define ILI9341_MADCTL_PORTRAIT_PARAM1                                                             \
	(ILI9341_MADCTL_PORTRAIT_MY | ILI9341_MADCTL_PORTRAIT_MX | ILI9341_MADCTL_PORTRAIT_MV |        \
	 ILI9341_MADCTL_PORTRAIT_ML | ILI9341_MADCTL_PORTRAIT_BGR | ILI9341_MADCTL_PORTRAIT_MH)
...
#define ILI9341_MADCTL_RLANDSCAPE_PARAM1                                                           \
	(ILI9341_MADCTL_RLANDSCAPE_MY | ILI9341_MADCTL_RLANDSCAPE_MX | ILI9341_MADCTL_RLANDSCAPE_MV |  \
	 ILI9341_MADCTL_RLANDSCAPE_ML | ILI9341_MADCTL_RLANDSCAPE_BGR | ILI9341_MADCTL_RLANDSCAPE_MH)
...
#define ILI9341_MADCTL_RPORTRAIT_PARAM1                                                            \
	(ILI9341_MADCTL_RPORTRAIT_MY | ILI9341_MADCTL_RPORTRAIT_MX | ILI9341_MADCTL_RPORTRAIT_MV |     \
	 ILI9341_MADCTL_RPORTRAIT_ML | ILI9341_MADCTL_RPORTRAIT_BGR | ILI9341_MADCTL_RPORTRAIT_MH)
...
#define ILI9341_PIXSET_16BITMCU_PARAM1 (ILI9341_PIXSET_16BITDPI | ILI9341_PIXSET_16BITDBI)
...
#define ILI9341_PIXSET_18BITMCU_PARAM1 (ILI9341_PIXSET_18BITDPI | ILI9341_PIXSET_18BITDBI)
...
static int ili9341_putrun(FAR struct lcd_dev_s *dev, fb_coord_t row, fb_coord_t col,
						  FAR const uint8_t *buffer, size_t npixels);
#ifndef CONFIG_LCD_NOGETRUN
static int ili9341_getrun(FAR struct lcd_dev_s *dev, fb_coord_t row, fb_coord_t col,
...
static void ili9341_selectarea(FAR struct ili9341_lcd_s *lcd, uint16_t x0, uint16_t y0, uint16_t x1,
							   uint16_t y1)
{
	/* Select column */
...
static int ili9341_putrun(FAR struct lcd_dev_s *lcd_dev, fb_coord_t row, fb_coord_t col,
						  FAR const uint8_t *buffer, size_t npixels)
{
...
#ifndef CONFIG_LCD_NOGETRUN
static int ili9341_getrun(FAR struct lcd_dev_s *lcd_dev, fb_coord_t row, fb_coord_t col,
						  FAR uint8_t *buffer, size_t npixels)
{
	FAR struct ili9341_dev_s *dev = (FAR struct ili9341_dev_s *)lcd_dev;
	FAR struct ili9341_lcd_s *lcd = dev->lcd;
