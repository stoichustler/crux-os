...
static int max7219_putrun(FAR struct lcd_dev_s *dev, fb_coord_t row, fb_coord_t col,
						  FAR const uint8_t *buffer, size_t npixels);
static int max7219_getrun(FAR struct lcd_dev_s *dev, fb_coord_t row, fb_coord_t col,
						  FAR uint8_t *buffer, size_t npixels);

/* LCD Configuration */

static int max7219_getvideoinfo(FAR struct lcd_dev_s *dev, FAR struct fb_videoinfo_s *vinfo);
...
static int max7219_setcontrast(FAR struct lcd_dev_s *dev, unsigned int contrast);
...
FAR struct lcd_dev_s *max7219_initialize(FAR struct spi_dev_s *spi, unsigned int devno)
{
