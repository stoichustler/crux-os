...
#include <roux/lcd/lcddrv_spiif.h>
...
static int lcddrv_spiif_sendmulti(FAR struct lcddrv_lcd_s *lcd, FAR const uint16_t *wd,
								  uint32_t nwords)
{
	uint32_t t;
	FAR struct lcddrv_spiif_lcd_s *priv = (FAR struct lcddrv_spiif_lcd_s *)lcd;
...
static int lcddrv_spiif_recv(FAR struct lcddrv_lcd_s *lcd, FAR uint8_t *param)
{
	FAR struct lcddrv_spiif_lcd_s *priv = (FAR struct lcddrv_spiif_lcd_s *)lcd;
...
static int lcddrv_spiif_send(FAR struct lcddrv_lcd_s *lcd, const uint8_t param)
{
	uint8_t r;
	FAR struct lcddrv_spiif_lcd_s *priv = (FAR struct lcddrv_spiif_lcd_s *)lcd;
...
static int lcddrv_spiif_sendcmd(FAR struct lcddrv_lcd_s *lcd, const uint8_t param)
{
	uint8_t r;
	FAR struct lcddrv_spiif_lcd_s *priv = (FAR struct lcddrv_spiif_lcd_s *)lcd;
...
static int lcddrv_spiif_recvmulti(FAR struct lcddrv_lcd_s *lcd, FAR uint16_t *wd, uint32_t nwords)
{
	FAR struct lcddrv_spiif_lcd_s *priv = (FAR struct lcddrv_spiif_lcd_s *)lcd;
...
FAR struct lcddrv_lcd_s *lcddrv_spiif_initialize(FAR struct spi_dev_s *spi)
{
	FAR struct lcddrv_spiif_lcd_s *priv =
		(FAR struct lcddrv_spiif_lcd_s *)kmm_zalloc(sizeof(struct lcddrv_spiif_lcd_s));
