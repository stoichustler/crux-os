...
#define TABLE_CONTENT(errno_name)                                                                  \
	{                                                                                              \
		ALTCOM_##errno_name, errno_name                                                            \
	}
...
static const struct converrno_s g_converrno_tbl[] = {TABLE_CONTENT(E2BIG),
