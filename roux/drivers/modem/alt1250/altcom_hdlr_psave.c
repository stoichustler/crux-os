...
static const uint8_t g_edrx_ptw_nbs1_table[] = {
	LTE_EDRX_PTW_256,  LTE_EDRX_PTW_512,  LTE_EDRX_PTW_768,	 LTE_EDRX_PTW_1024,
	LTE_EDRX_PTW_1280, LTE_EDRX_PTW_1536, LTE_EDRX_PTW_1792, LTE_EDRX_PTW_2048,
	LTE_EDRX_PTW_2304, LTE_EDRX_PTW_2560, LTE_EDRX_PTW_2816, LTE_EDRX_PTW_3072,
	LTE_EDRX_PTW_3328, LTE_EDRX_PTW_3584, LTE_EDRX_PTW_3840, LTE_EDRX_PTW_4096,
};
...
static int32_t altcombs_convert_api_edrx_value(FAR lte_edrx_setting_t *api_edrx,
											   FAR struct apicmd_cmddat_setedrx_s *cmd_edrx,
											   uint8_t altver)
{
	int i;
	int table_size = 0;
...
static int32_t altcombs_convert_apicmd_edrx_value(FAR struct apicmd_edrxset_s *cmd_edrx,
...
int32_t altcom_getedrx_pkt_compose(FAR void **arg, size_t arglen, uint8_t altver,
...
int32_t altcom_setedrx_pkt_compose(FAR void **arg, size_t arglen, uint8_t altver,
								   FAR uint8_t *pktbuf, const size_t pktsz, FAR uint16_t *altcid)
{
	int32_t size = 0;
	...
	FAR struct apicmd_cmddat_setedrx_s *out = (FAR struct apicmd_cmddat_setedrx_s *)pktbuf;
...
int32_t altcom_getdedrx_pkt_compose(FAR void **arg, size_t arglen, uint8_t altver,
									FAR uint8_t *pktbuf, const size_t pktsz, FAR uint16_t *altcid)
{
	int32_t size = 0;
...
int32_t altcom_getpsm_pkt_compose(FAR void **arg, size_t arglen, uint8_t altver,
								  FAR uint8_t *pktbuf, const size_t pktsz, FAR uint16_t *altcid)
{
	int32_t size = 0;
...
#ifndef CONFIG_MODEM_ALT1250_DISABLE_PV4
		if (altver == ALTCOM_VER4) {
		FAR struct apicmd_cmddat_getpsm_v4_s *out = (FAR struct apicmd_cmddat_getpsm_v4_s *)pktbuf;
...
int32_t altcom_setpsm_pkt_compose(FAR void **arg, size_t arglen, uint8_t altver,
								  FAR uint8_t *pktbuf, const size_t pktsz, FAR uint16_t *altcid)
{
	int32_t size = 0;
	FAR lte_psm_setting_t *settings = (FAR lte_psm_setting_t *)arg[0];

	FAR struct apicmd_cmddat_setpsm_s *out = (FAR struct apicmd_cmddat_setpsm_s *)pktbuf;
...
int32_t altcom_getdpsm_pkt_compose(FAR void **arg, size_t arglen, uint8_t altver,
								   FAR uint8_t *pktbuf, const size_t pktsz, FAR uint16_t *altcid)
{
	int32_t size = 0;
...
int32_t altcom_getce_pkt_compose(FAR void **arg, size_t arglen, uint8_t altver, FAR uint8_t *pktbuf,
...
int32_t altcom_setce_pkt_compose(FAR void **arg, size_t arglen, uint8_t altver, FAR uint8_t *pktbuf,
								 const size_t pktsz, FAR uint16_t *altcid)
{
	int32_t size = 0;
#ifndef CONFIG_MODEM_ALT1250_DISABLE_PV1
...
#ifndef CONFIG_MODEM_ALT1250_DISABLE_PV1
	if (altver == ALTCOM_VER1) {
		FAR struct apicmd_cmddat_setce_s *out = (FAR struct apicmd_cmddat_setce_s *)pktbuf;
...
int32_t altcom_getedrx_pkt_parse(FAR struct alt1250_dev_s *dev, FAR uint8_t *pktbuf, size_t pktsz,
								 ...
								 FAR uint64_t *bitmap)
{
	...
	FAR struct apicmd_cmddat_getedrxres_s *in = (FAR struct apicmd_cmddat_getedrxres_s *)pktbuf;
...
int32_t altcom_setedrx_pkt_parse(FAR struct alt1250_dev_s *dev, FAR uint8_t *pktbuf, size_t pktsz,
								 uint8_t altver, FAR void **arg, size_t arglen,
								 FAR uint64_t *bitmap)
{
	FAR int *ret = (FAR int *)arg[0];
	FAR struct apicmd_cmddat_setedrxres_s *in = (FAR struct apicmd_cmddat_setedrxres_s *)pktbuf;
...
int32_t altcom_getdedrx_pkt_parse(FAR struct alt1250_dev_s *dev, FAR uint8_t *pktbuf, size_t pktsz,
								  uint8_t altver, FAR void **arg, size_t arglen,
								  FAR uint64_t *bitmap)
{
	FAR int *ret = (FAR int *)arg[0];
...
int32_t altcom_getpsm_pkt_parse(FAR struct alt1250_dev_s *dev, FAR uint8_t *pktbuf, size_t pktsz,
								uint8_t altver, FAR void **arg, size_t arglen, FAR uint64_t *bitmap)
{
	...
	FAR struct apicmd_cmddat_getpsmres_s *in = (FAR struct apicmd_cmddat_getpsmres_s *)pktbuf;
...
int32_t altcom_setpsm_pkt_parse(FAR struct alt1250_dev_s *dev, FAR uint8_t *pktbuf, size_t pktsz,
								uint8_t altver, FAR void **arg, size_t arglen, FAR uint64_t *bitmap)
{
	FAR int *ret = (FAR int *)arg[0];
	FAR struct apicmd_cmddat_setpsmres_s *in = (FAR struct apicmd_cmddat_setpsmres_s *)pktbuf;
...
int32_t altcom_getdpsm_pkt_parse(FAR struct alt1250_dev_s *dev, FAR uint8_t *pktbuf, size_t pktsz,
								 uint8_t altver, FAR void **arg, size_t arglen,
								 FAR uint64_t *bitmap)
{
	FAR int *ret = (FAR int *)arg[0];
...
int32_t altcom_getce_pkt_parse(FAR struct alt1250_dev_s *dev, FAR uint8_t *pktbuf, size_t pktsz,
							   uint8_t altver, FAR void **arg, size_t arglen, FAR uint64_t *bitmap)
{
	FAR int *ret = (FAR int *)arg[0];
	FAR lte_ce_setting_t *settings = (FAR lte_ce_setting_t *)arg[1];
	FAR struct apicmd_cmddat_getceres_s *in = (FAR struct apicmd_cmddat_getceres_s *)pktbuf;
...
int32_t altcom_setce_pkt_parse(FAR struct alt1250_dev_s *dev, FAR uint8_t *pktbuf, size_t pktsz,
							   uint8_t altver, FAR void **arg, size_t arglen, FAR uint64_t *bitmap)
{
	FAR int *ret = (FAR int *)arg[0];
	FAR struct apicmd_cmddat_setceres_s *in = (FAR struct apicmd_cmddat_setceres_s *)pktbuf;
