...
typedef CODE int32_t (*lwm2mstub_hndl_t)(FAR uint8_t *, size_t, FAR void **, size_t);
...
lwm2mstub_hndl_t lwm2mstub_get_handler(FAR uint8_t **pktbuf, FAR size_t *pktsz, uint32_t *lcmdid);
