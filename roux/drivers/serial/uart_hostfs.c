...
static int uart_hostfs_ioctl(FAR struct file *filep, int cmd, unsigned long arg);
...
static bool uart_hostfs_rxflowcontrol(FAR struct uart_dev_s *dev, unsigned int nbuffered,
									  bool upper);
#endif
