...
static void pwm_dump(FAR const char *msg, FAR const struct pwm_info_s *info, bool started);
 ...
 *
 * Input Parameters:
 *   path - The full path to the driver to be registered in the ROUX pseudo-
