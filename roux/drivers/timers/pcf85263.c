...
#include <roux/timers/pcf85263.h>
...
int up_rtc_getdatetime(FAR struct tm *tp)
{
	...
	} while ((buffer[0] & PCF85263_RTC_SECONDS_MASK) > (seconds & PCF85263_RTC_SECONDS_MASK));
...
int up_rtc_settime(FAR const struct timespec *tp)
{
	...
	} while ((buffer[2] & PCF85263_RTC_SECONDS_MASK) > (seconds & PCF85263_RTC_SECONDS_MASK));
