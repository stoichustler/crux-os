...
#define PCF85263_RTC_TSR_TSR1M_FE                                                                  \
	(1 << PCF85263_RTC_TSR_TSR1M_SHIFT) /* Record First TS pin Event */
#define PCF85263_RTC_TSR_TSR1M_LE                                                                  \
	(2 << PCF85263_RTC_TSR_TSR1M_SHIFT) /* Record Last TS pin Event                                \
										 */
...
#define PCF85263_RTC_TSR_TSR2M_FB                                                                  \
	(1 << PCF85263_RTC_TSR_TSR2M_SHIFT) /* Record First time switch to Battery event */
#define PCF85263_RTC_TSR_TSR2M_LB                                                                  \
	(2 << PCF85263_RTC_TSR_TSR2M_SHIFT) /* Record Last time switch to Battery event */
#define PCF85263_RTC_TSR_TSR2M_LV                                                                  \
	(3 << PCF85263_RTC_TSR_TSR2M_SHIFT) /* Record Last time switch to VDD event */
#define PCF85263_RTC_TSR_TSR2M_FE                                                                  \
	(4 << PCF85263_RTC_TSR_TSR2M_SHIFT) /* Record First TS pin Event */
#define PCF85263_RTC_TSR_TSR2M_LE                                                                  \
	(5 << PCF85263_RTC_TSR_TSR2M_SHIFT) /* Record Last TS pin Event                                \
										 */
...
#define PCF85263_RTC_TSR_TSR3M_FB                                                                  \
	(1 << PCF85263_RTC_TSR_TSR3M_SHIFT) /* Record First time switch to Battery event */
#define PCF85263_RTC_TSR_TSR3M_LB                                                                  \
	(2 << PCF85263_RTC_TSR_TSR3M_SHIFT) /* Record Last time switch to Battery event */
#define PCF85263_RTC_TSR_TSR3M_LV                                                                  \
	(3 << PCF85263_RTC_TSR_TSR3M_SHIFT) /* Record Last time switch to VDD event */
...
#define PCF85263_STW_TSR_TSR1M_FE                                                                  \
	(1 << PCF85263_STW_TSR_TSR1M_SHIFT) /* Record First TS pin Event */
#define PCF85263_STW_TSR_TSR1M_LE                                                                  \
	(2 << PCF85263_STW_TSR_TSR1M_SHIFT) /* Record Last TS pin Event                                \
										 */
...
#define PCF85263_STW_TSR_TSR2M_FB                                                                  \
	(1 << PCF85263_STW_TSR_TSR2M_SHIFT) /* Record First time switch to Battery event */
#define PCF85263_STW_TSR_TSR2M_LB                                                                  \
	(2 << PCF85263_STW_TSR_TSR2M_SHIFT) /* Record Last time switch to Battery event */
#define PCF85263_STW_TSR_TSR2M_LV                                                                  \
	(3 << PCF85263_STW_TSR_TSR2M_SHIFT) /* Record Last time switch to VDD event */
#define PCF85263_STW_TSR_TSR2M_FE                                                                  \
	(4 << PCF85263_STW_TSR_TSR2M_SHIFT) /* Record First TS pin Event */
#define PCF85263_STW_TSR_TSR2M_LE                                                                  \
	(5 << PCF85263_STW_TSR_TSR2M_SHIFT) /* Record Last TS pin Event                                \
										 */
...
#define PCF85263_STW_TSR_TSR3M_FB                                                                  \
	(1 << PCF85263_STW_TSR_TSR3M_SHIFT) /* Record First time switch to Battery event */
#define PCF85263_STW_TSR_TSR3M_LB                                                                  \
	(2 << PCF85263_STW_TSR_TSR3M_SHIFT) /* Record Last time switch to Battery event */
#define PCF85263_STW_TSR_TSR3M_LV                                                                  \
	(3 << PCF85263_STW_TSR_TSR3M_SHIFT) /* Record Last time switch to VDD event */
...
#define PCF85263_CTL_OSC_OSCD_NORMAL                                                               \
	(0 << PCF85263_CTL_OSC_OSCD_SHIFT) /* Normal drive; RS(max): 100 kohm */
#define PCF85263_CTL_OSC_OSCD_LOW                                                                  \
	(1 << PCF85263_CTL_OSC_OSCD_SHIFT) /* Low drive; RS(max): 60 kohm; reduced IDD */
#define PCF85263_CTL_OSC_OSCD_HIGH                                                                 \
	(2 << PCF85263_CTL_OSC_OSCD_SHIFT) /* High drive; RS(max): 500 kohm; increased IDD */
...
#define PCF85263_CTL_BATTERY_BSM_VTH                                                               \
	(0 << PCF85263_CTL_BATTERY_BSM_SHIFT) /* Switching at the Vth level */
#define PCF85263_CTL_BATTERY_BSM_VBAT                                                              \
	(1 << PCF85263_CTL_BATTERY_BSM_SHIFT) /* Switching at the VBAT level */
#define PCF85263_CTL_BATTERY_BSM_MAX                                                               \
	(2 << PCF85263_CTL_BATTERY_BSM_SHIFT) /* Switching at the higher level of Vth or VBAT */
#define PCF85263_CTL_BATTERY_BSM_MIN                                                               \
	(3 << PCF85263_CTL_BATTERY_BSM_SHIFT) /* Switching at the lower level of Vth or VBAT */
...
#define PCF85263_CTL_TSPM_DISABLED                                                                 \
	(0 << PCF85263_CTL_TSPM_SHIFT) /* Disabled; input can be left floating */
...
#define PCF85263_CTL_FUNC_COF_MASK                                                                 \
	(7 << PCF85263_CTL_FUNC_COF_SHIFT) /* CLK pin    TS pin     INTA pin */
#define PCF85263_CTL_FUNC_COF_32KHZ                                                                \
	(0 << PCF85263_CTL_FUNC_COF_SHIFT) /* 32768      32768      32768    */
#define PCF85263_CTL_FUNC_COF_16KHZ                                                                \
	(1 << PCF85263_CTL_FUNC_COF_SHIFT) /* 16384      16384      16384    */
#define PCF85263_CTL_FUNC_COF_8KHZ                                                                 \
	(2 << PCF85263_CTL_FUNC_COF_SHIFT) /* 8192       8192       8192     */
#define PCF85263_CTL_FUNC_COF_4KHZ                                                                 \
	(3 << PCF85263_CTL_FUNC_COF_SHIFT) /* 4096       4096       4096     */
#define PCF85263_CTL_FUNC_COF_2KHZ                                                                 \
	(4 << PCF85263_CTL_FUNC_COF_SHIFT) /* 2048       2048       2048     */
#define PCF85263_CTL_FUNC_COF_1KHZ                                                                 \
	(5 << PCF85263_CTL_FUNC_COF_SHIFT) /* 1024       1024       1024     */
#define PCF85263_CTL_FUNC_COF_1HZ                                                                  \
	(6 << PCF85263_CTL_FUNC_COF_SHIFT) /* 1          1          1        */
#define PCF85263_CTL_FUNC_COF_LOW                                                                  \
	(7 << PCF85263_CTL_FUNC_COF_SHIFT) /* static LOW static LOW Hi-Z     */
