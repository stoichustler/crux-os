...
#define WM8904_DRC_MINGAIN_SHIFT                                                                   \
	(2) /* Bits 2-3:  Minimum gain the DRC can use to attenuate                                    \
audio*/
...
#define WM8904_DCS_TRIG_SERIES_3                                                                   \
	(1 << 11) /* Bit 11: Series of DC offset corrections for LINEOUTR */
#define WM8904_DCS_TRIG_SERIES_2                                                                   \
	(1 << 10)							  /* Bit 10: Series of DC offset corrections for LINEOUTL */
...
#define WM8904_DCS_SERIES_NO_23_MASK                                                               \
	(0x007f) /* Bits 0-6: Number updates to perform in series for LINEOUTL/R */

/* 0x48 DC Servo 5 */

#define WM8904_DCS_SERIES_NO_01_MASK                                                               \
	(0x007f) /* Bits 0-6: Number updates to perform in series for HPOUTL/R */
...
#define WM8904_GPIO1_SEL_CLKOUT                                                                    \
	(1 << WM8904_GPIO1_SEL_SHIFT)							   /* Clock output (f=SYSCLK/OPCLKDIV) \
																*/
...
#define WM8904_GPIO2_SEL_CLKOUT                                                                    \
	(1 << WM8904_GPIO2_SEL_SHIFT)							   /* Clock output (f=SYSCLK/OPCLKDIV) \
																*/
...
#define WM8904_GPIO3_SEL_CLKOUT                                                                    \
	(1 << WM8904_GPIO3_SEL_SHIFT)							   /* Clock output (f=SYSCLK/OPCLKDIV) \
																*/
...
#define WM8904_GPIO_BCLK_SEL_CLKOUT                                                                \
	(1 << WM8904_GPIO_BCLK_SEL_SHIFT) /* Clock output (f=SYSCLK/OPCLKDIV) */
