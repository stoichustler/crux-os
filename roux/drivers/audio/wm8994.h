...
#include <roux/compiler.h>

#include <pthread.h>

#include <roux/mqueue.h>
#include <roux/mutex.h>
#include <roux/wqueue.h>
#include <roux/fs/ioctl.h>
...
#define WM8994_BIAS_ENA                                                                            \
	(1 << 0) /* Bit 0: Enables the Normal bias current generator (for all analogue functions */
...
#define WM8994_VMID_SEL_2X40K                                                                      \
	(1 << WM8994_VMID_SEL_SHIFT) /* 2*40k divider (for normal operation                            \
								  */
#define WM8994_VMID_SEL_2X240K                                                                     \
	(2 << WM8994_VMID_SEL_SHIFT) /* 2*240k divider (for low power standby*/
								 /* Bit 3: Reserved */
...
#define WM8994_SPKOUTL_ENA                                                                         \
	(1 << 12) /* Bit 12: SPKMIXL Mixer, SPKLVOL PGA and SPKOUTL Output Enable */
#define WM8994_SPKOUTL_ENA_DISABLE (0)				   /* Disabled */
#define WM8994_SPKOUTL_ENA_ENABLE (WM8994_SPKOUTL_ENA) /* Enabled */
#define WM8994_SPKOUTR_ENA                                                                         \
	(1 << 13) /* Bit 13: SPKMIXR Mixer, SPKRVOL PGA and SPKOUTR Output Enable */
...
#define WM8994_DMIC2L_ENA_ENABLE (WM8994_DMIC2L_ENA) /* Enabled */
													 /* Bits 6-7: Reserved */
#define WM8994_AIF1ADC1R_ENA                                                                       \
	(1 << 8) /* Bit 8: Enable AIF1ADC1(Right) output path (AIF1, Timeslot 0) */
#define WM8994_AIF1ADC1R_ENA_DISABLE (0)				   /* Disabled */
#define WM8994_AIF1ADC1R_ENA_ENABLE (WM8994_AIF1ADC1R_ENA) /* Enabled */
#define WM8994_AIF1ADC1L_ENA                                                                       \
	(1 << 9) /* Bit 9: Enable AIF1ADC1(Left) output path (AIF1, Timeslot 0) */
#define WM8994_AIF1ADC1L_ENA_DISABLE (0)				   /* Disabled */
#define WM8994_AIF1ADC1L_ENA_ENABLE (WM8994_AIF1ADC1L_ENA) /* Enabled */
#define WM8994_AIF1ADC2R_ENA                                                                       \
	(1 << 10) /* Bit 10: Enable AIF1ADC2(Right) output path (AIF1, Timeslot 1) */
#define WM8994_AIF1ADC2R_ENA_DISABLE (0)				   /* Disabled */
#define WM8994_AIF1ADC2R_ENA_ENABLE (WM8994_AIF1ADC2L_ENA) /* Enabled */
#define WM8994_AIF1ADC2L_ENA                                                                       \
	(1 << 11) /* Bit 11: Enable AIF1ADC2(Left) output path (AIF1, Timeslot 1) */
...
#define WM8994_AIF1DAC1R_ENA                                                                       \
	(1 << 8) /* Bit 8: Enable AIF1DAC1(Right) input path (AIF1, Timeslot 0) */
#define WM8994_AIF1DAC1L_ENA                                                                       \
	(1 << 9) /* Bit 9: Enable AIF1DAC1(Left) input path (AIF1, Timeslot 0) */
#define WM8994_AIF1DAC2R_ENA                                                                       \
	(1 << 10) /* Bit 10: Enable AIF1DAC2(Right) input path (AIF1, Timeslot 1) */
#define WM8994_AIF1DAC2L_ENA                                                                       \
	(1 << 11) /* Bit 11: Enable AIF1DAC2(Left) input path (AIF1, Timeslot 1) */
...
#define WM8994_IN1LP_MIXINL_BOOST                                                                  \
	(1 << 7) /* Bit 7: IN1LP Pin (PGA Bypass) to MIXINL Gain Boost. The bit seletcs the maximum    \
		gain setting of the IN1LP_MIXINL_VOL register. */
...
#define WM8994_IN1RP_MIXINR_BOOST                                                                  \
	(1 << 8) /* Bit 8: IN1RP Pin (PGA Bypass) to MIXINR Gain Boost. The bit seletcs the maximum    \
		gain setting of the IN1RP_MIXINR_VOL register. */
...
#define WM8994_IN1_VU                                                                              \
	(1 << 8) /* Bit 8: Input PGA Voluem Update. Writing a 1 to this bit cause IN1L and IN1R input  \
		PGA volumes to updated simultaneously */
...
#define WM8994_IN2L_VOL_DEFAULT                                                                    \
	(11 << WM8994_IN2L_VOL_SHIFT)						  /* -16.5dB to +30dB in 1.5dB steps       \
														   */
...
#define WM8994_IN2_VU                                                                              \
	(1 << 8) /* Bit 8: Input PGA Voluem Update. Writing a 1 to this bit cause IN2L and IN2R input  \
		PGA volumes to updated simultaneously */
...
#define WM8994_IN1R_VOL_DEFAULT                                                                    \
	(11 << WM8994_IN1R_VOL_SHIFT)						  /* -16.5dB to +30dB in 1.5dB steps       \
														   */
...
#define WM8994_IN2R_VOL_DEFAULT                                                                    \
	(11 << WM8994_IN2R_VOL_SHIFT)						  /* -16.5dB to +30dB in 1.5dB steps       \
														   */
...
#define WM8994_HPOUT1L_VOL_DEFAULT                                                                 \
	(0 << WM8994_HPOUT1L_VOL_SHIFT)								  /* -57dB to +6dB in 1 dB         \
									 steps*/
#define WM8994_HPOUT1L_VOL_MAX (0x3F << WM8994_HPOUT1L_VOL_SHIFT) /* +6dB */
#define WM8994_HPOUT1L_VOL(n)                                                                      \
	((uint16_t)(n) << WM8994_HPOUT1L_VOL_SHIFT) /* Set volume to defined value */
...
#define WM8994_HPOUT1_VU_ENABLED                                                                   \
	(1 << WM8994_HPOUT1_VU_SHIFT) /* Writing a 1 to this bit will update HPOUT1LVOL and            \
								   * HPOUT1RVOL volumes simultaneously */

/* R29 (0x1D) - Right Output Volume */

#define WM8994_HPOUT1R_VOL_SHIFT                                                                   \
	(0) /* Bits 0-5: HPOUT1RVOL (Right Headphone Output PGA) Volume                                \
		 */
#define WM8994_HPOUT1R_VOL_MIN (0 << WM8994_HPOUT1R_VOL_SHIFT) /* -57dB */
#define WM8994_HPOUT1R_VOL_DEFAULT                                                                 \
	(0 << WM8994_HPOUT1R_VOL_SHIFT)								  /* -57dB to +6dB in 1 dB         \
									 steps*/
#define WM8994_HPOUT1R_VOL_MAX (0x3F << WM8994_HPOUT1R_VOL_SHIFT) /* +6dB */
#define WM8994_HPOUT1R_VOL(n)                                                                      \
	((uint16_t)(n) << WM8994_HPOUT1R_VOL_SHIFT) /* Set volume to defined value */
...
#define WM8994_MIXINL_TO_MIXOUTL                                                                   \
	(1 << 6) /* Bit 6: MIXINL Output(Left ADC bypass) to MIXOUTL Mute */
#define WM8994_MIXINL_TO_MIXOUTL_MUTE (0)						   /* mute */
#define WM8994_MIXINL_TO_MIXOUTL_UNMUTE (WM8994_MIXINL_TO_MIXOUTL) /* Un-mute */
#define WM8994_MIXINR_TO_MIXOUTL                                                                   \
	(1 << 7) /* Bit 7: MIXINR Output(Left ADC bypass) to MIXOUTL Mute */
#define WM8994_MIXINR_TO_MIXOUTL_MUTE (0)						   /* mute */
#define WM8994_MIXINR_TO_MIXOUTL_UNMUTE (WM8994_MIXINR_TO_MIXOUTL) /* Un-mute */
#define WM8994_DAC1L_TO_HPOUT1L                                                                    \
	(1 << 8) /* Bit 8: HPOUT1LVOL(Left Headphone Output PGA) Input Select */
...
#define WM8994_MIXINR_TO_MIXOUTR                                                                   \
	(1 << 6) /* Bit 6: MIXINR Output(Left ADC bypass) to MIXOUTR Mute */
#define WM8994_MIXINR_TO_MIXOUTR_MUTE (0)						   /* mute */
#define WM8994_MIXINR_TO_MIXOUTR_UNMUTE (WM8994_MIXINR_TO_MIXOUTR) /* Un-mute */
#define WM8994_MIXINL_TO_MIXOUTR                                                                   \
	(1 << 7) /* Bit 7: MIXINL Output(Left ADC bypass) to MIXOUTR Mute */
#define WM8994_MIXINL_TO_MIXOUTR_MUTE (0)						   /* mute */
#define WM8994_MIXINL_TO_MIXOUTR_UNMUTE (WM8994_MIXINL_TO_MIXOUTR) /* Un-mute */
#define WM8994_DAC1R_TO_HPOUT1R                                                                    \
	(1 << 8) /* Bit 8: HPOUT1RVOL(Left Headphone Output PGA) Input Select */
...
#define WM8994_CP_DISCH_DISCHARGE                                                                  \
	(WM8994_CP_DISCH) /* Charge Pump outputs discharged when disabled */

/* R81 (0x51) - Class W (1) */

#define WM8994_CP_DYN_SRC_SEL_SHIFT                                                                \
	8 /* Bits 8-9: Selects the digital audio source for                                            \
	   * envelope tracking */
#define WM8994_CP_DYN_SRC_SEL_MASK (3 << WM8994_CP_DYN_SRC_SEL_SHIFT)
#define WM8994_CP_DYN_SRC_SEL_AIF1_TS0                                                             \
	(0 << WM8994_CP_DYN_SRC_SEL_SHIFT) /* AIF1, DAC Timeslot 0                                     \
										*/
#define WM8994_CP_DYN_SRC_SEL_AIF1_TS1                                                             \
	(1 << WM8994_CP_DYN_SRC_SEL_SHIFT)									   /* AIF1, DAC Timeslot 1 \
																			*/
...
#define WM8994_CP_DYN_PWR_CW                                                                       \
	(WM8994_CP_DYN_PWR) /* Charge pump controlled by real-time audio lev. (Class W) */

/* R84 (0x54) - DC Servo (1) */

#define WM8994_DCS_TRIG_SINGLE_1                                                                   \
	(1 << 13) /* Bit 13: Writing 1 to this bit selects a single DC offset                          \
			   * correction for HPOUT1R. In readback, a value of 1                                 \
			   * indicates that the DC Servo single correction is                                  \
			   * in progress                                                                       \
			   */
#define WM8994_DCS_TRIG_SINGLE_0                                                                   \
	(1 << 12) /* Bit 12: Writing 1 to this bit selects a single DC offset                          \
			   * correction for HPOUT1L. In readback, a value of 1                                 \
			   * indicates that the DC Servo single correction is                                  \
			   * in progress                                                                       \
			   */
#define WM8994_DCS_TRIG_SERIES_1                                                                   \
	(1 << 9) /* Bit 9: Writing 1 to this bit selects a series of DC offset                         \
			  * corrections for HPOUT1R. In readback, a value of 1                                 \
			  * indicates that the DC Servo DAC write correction is                                \
			  * in progress                                                                        \
			  */
#define WM8994_DCS_TRIG_SERIES_0                                                                   \
	(1 << 8) /* Bit 8: Writing 1 to this bit selects a series of DC offset                         \
			  * corrections for HPOUT1L. In readback, a value of 1                                 \
			  * indicates that the DC Servo DAC write correction is                                \
			  * in progress                                                                        \
			  */
#define WM8994_DCS_TRIG_STARTUP_1                                                                  \
	(1 << 5) /* Bit 5: Writing 1 to this bit selects Start-Up DC                                   \
			  * Servo mode for HPOUT1R. In readback, a value of 1                                  \
			  * indicates that the DC Servo Start-Up correction is                                 \
			  * in progress                                                                        \
			  */
#define WM8994_DCS_TRIG_STARTUP_0                                                                  \
	(1 << 4) /* Bit 4: Writing 1 to this bit selects Start-Up DC                                   \
			  * Servo mode for HPOUT1L. In readback, a value of 1                                  \
			  * indicates that the DC Servo Start-Up correction is                                 \
			  * in progress                                                                        \
			  */
#define WM8994_DCS_TRIG_DAC_WR_1                                                                   \
	(1 << 3) /* Bit 3: Writing 1 to this bit selects DAC Write                                     \
			  * DC Servo mode for HPOUT1R. In readback, a value of 1                               \
			  * indicates that the DC Servo DAC Write correction is                                \
			  * in progress                                                                        \
			  */
#define WM8994_DCS_TRIG_DAC_WR_0                                                                   \
	(1 << 2)							  /* Bit 2: Writing 1 to this bit selects DAC Write        \
...
#define WM8994_AIF1ADC_TDM_TRI                                                                     \
	(WM8994_AIF1ADC_TDM)			  /* ADCDAT1 is tri-stated when not transmit data */
...
#define WM8994_AIF1ADCR_RIGHT_ADC                                                                  \
	(WM8994_AIF1ADCR_SRC)			  /* Right ADC data is output on right channel */
...
#define WM8994_AIF1ADCL_RIGHT_ADC                                                                  \
	(WM8994_AIF1ADCL_SRC) /* Right ADC data is output on left channel */
...
/* Bits 0-11: Reserved */
#define WM8994_AIF1_LRCLK_FRC                                                                      \
	(1 << 12) /* Bit 12: Forces LRCLK1 and ADCLRCLK1 to enabled when all AIF1 audio channels are   \
		 disabled */
#define WM8994_AIF1_LRCLK_FRC_NORMAL (0) /* Normal */
#define WM8994_AIF1_LRCLK_FRC_YES                                                                  \
	(WM8994_AIF1_LRCLK_FRC) /* LRCLK1 and ADCLRCLK1 always enabled in Master Mode */
#define WM8994_AIF1_CLK_FRC                                                                        \
	(1 << 13) /* Bit 13: Forces BCLK1, LRCLK1 and ADCLRCLK1 to enabled when all AIF1 audio         \
		 channels are disabled */
#define WM8994_AIF1_CLK_FRC_NORMAL (0) /* Normal */
#define WM8994_AIF1_CLK_FRC_YES                                                                    \
	(WM8994_AIF1_CLK_FRC)		   /* BLCK1, LRCLK1 and ADCLRCLK1 always enabled in Master Mode */
...
#define WM8994_AIF1ADC2_HPF_CUT_SHIFT                                                              \
	(13) /* Bits 13-14: AIF1ADC2 output path (AIF1, TS 1), HPF CO */
#define WM8994_AIF1ADC2_HPF_CUT_MASK (3 << WM8994_AIF1ADC2_HPF_CUT_SHIFT)
#define WM8994_AIF1ADC2_HPF_CUT_HIFI                                                               \
	(0 << WM8994_AIF1ADC2_HPF_CUT_SHIFT) /* Hi-fi mode (fc = 4 Hz at fs = 48kHz) */
#define WM8994_AIF1ADC2_HPF_CUT_VOICE1                                                             \
	(1 << WM8994_AIF1ADC2_HPF_CUT_SHIFT) /* Voice mode 1 (fc = 127 Hz at fs = 8kHz) */
#define WM8994_AIF1ADC2_HPF_CUT_VOICE2                                                             \
	(2 << WM8994_AIF1ADC2_HPF_CUT_SHIFT) /* Voice mode 2 (fc = 130 Hz at fs = 8kHz) */
#define WM8994_AIF1ADC2_HPF_CUT_VOICE3                                                             \
	(3 << WM8994_AIF1ADC2_HPF_CUT_SHIFT) /* Voice mode 3 (fc = 267 Hz at fs = 8kHz) */
#define WM8994_AIF1ADC2L_HPF                                                                       \
	(1 << 12) /* Bit 12: AIF1ADC2 (Left) output path (AIF1, TS 1) Dig. HPF */
#define WM8994_AIF1ADC2L_HPF_DISABLE (0)				   /* Disable */
#define WM8994_AIF1ADC2L_HPF_ENABLE (WM8994_AIF1ADC2L_HPF) /* Enable */
#define WM8994_AIF1ADC2R_HPF                                                                       \
	(1 << 11) /* Bit 11: AIF1ADC2 (Right) output path (AIF1, TS 1) Dig. HPF */
...
#define WM8994_AIF1DAC1_MUTE                                                                       \
	(1 << 9) /* Bit 9: AIF1DAC1 input path (AIF1, TS 0) Soft Mute Control */
#define WM8994_AIF1DAC1_MUTE_UNMUTE (0)					 /* Un-mute */
#define WM8994_AIF1DAC1_MUTE_MUTE (WM8994_AIF1DAC1_MUTE) /* Mute */
#define WM8994_AIF1DAC1_MONO                                                                       \
	(1 << 7) /* Bit 7: AIF1DAC1 input path (AIF1, TS 0) Mono Mix Control                           \
			  */
#define WM8994_AIF1DAC1_MONO_DISABLE (0)				   /* Disabled */
#define WM8994_AIF1DAC1_MONO_ENABLE (WM8994_AIF1DAC1_MONO) /* Enabled */
#define WM8994_AIF1DAC1_MUTERATE                                                                   \
	(1 << 5) /* Bit 5: AIF1DAC1 input path (AIF1, TS 0) Soft Mute Ramp Rate */
#define WM8994_AIF1DAC1_MUTERATE_FAST                                                              \
	(0) /* Fast ramp (fs/2, maximum ramp time is 10.7ms at fs=48kHz */
#define WM8994_AIF1DAC1_MUTERATE_SLOW                                                              \
	(WM8994_AIF1DAC1_MUTERATE) /* Slow ramp (fs/32, maximum ramp time is 171ms at fs=48kHz */
#define WM8994_AIF1DAC1_UNMUTE_RAMP                                                                \
	(1 << 4) /* Bit 4: AIF1DAC1 input path (AIF1, TS 0) Unmute Ramp select */
#define WM8994_AIF1DAC1_UNMUTE_RAMP_IMMEDIATE (0) /* Volume change immediately to AIF1DAC1L_VOL */
#define WM8994_AIF1DAC1_UNMUTE_RAMP_GRADUAL                                                        \
	(WM8994_AIF1DAC1_UNMUTE_RAMP) /* Volume change gradually to AIF1DAC1R_VOL */
#define WM8994_AIF1DAC1_DEEMP_SHIFT                                                                \
	(1) /* Bit 1-2: AIF1DAC1 input path (AIF1, TS 0), De-Emphasis                                  \
		 */
...
#define WM8994_AIF1DAC2_MUTE                                                                       \
	(1 << 9) /* Bit 9: AIF1DAC2 input path (AIF1, TS 1) Soft Mute Control */
#define WM8994_AIF1DAC2_MUTE_UNMUTE (0)					 /* Un-mute */
#define WM8994_AIF1DAC2_MUTE_MUTE (WM8994_AIF1DAC2_MUTE) /* Mute */
#define WM8994_AIF1DAC2_MONO                                                                       \
	(1 << 7) /* Bit 7: AIF1DAC2 input path (AIF1, TS 1) Mono Mix Control                           \
			  */
#define WM8994_AIF1DAC2_MONO_DISABLE (0)				   /* Disabled */
#define WM8994_AIF1DAC2_MONO_ENABLE (WM8994_AIF1DAC2_MONO) /* Enabled */
#define WM8994_AIF1DAC2_MUTERATE                                                                   \
	(1 << 5) /* Bit 5: AIF1DAC2 input path (AIF1, TS 1) Soft Mute Ramp Rate */
#define WM8994_AIF1DAC2_MUTERATE_FAST                                                              \
	(0) /* Fast ramp (fs/2, maximum ramp time is 10.7ms at fs=48kHz */
#define WM8994_AIF1DAC2_MUTERATE_SLOW                                                              \
	(WM8994_AIF1DAC2_MUTERATE) /* Slow ramp (fs/32, maximum ramp time is 171ms at fs=48kHz */
#define WM8994_AIF1DAC2_UNMUTE_RAMP                                                                \
	(1 << 4) /* Bit 4: AIF1DAC2 input path (AIF1, TS 1) Unmute Ramp select */
#define WM8994_AIF1DAC2_UNMUTE_RAMP_IMMEDIATE (0) /* Volume change immediately to AIF1DAC1L_VOL */
#define WM8994_AIF1DAC2_UNMUTE_RAMP_GRADUAL                                                        \
	(WM8994_AIF1DAC2_UNMUTE_RAMP) /* Volume change gradually to AIF1DAC1R_VOL */
#define WM8994_AIF1DAC2_DEEMP_SHIFT                                                                \
	(1) /* Bit 1-2: AIF1DAC2 input path (AIF1, TS 1), De-Emphasis                                  \
		 */
...
#define WM8994_AIF1DAC1R_TO_DAC1R_ENA                                                              \
	(1 << 0) /* Bit 0: Enable AIF1(Timeslot 0, Right) to DAC1R                                     \
			  */
#define WM8994_AIF1DAC2R_TO_DAC1R_ENA                                                              \
	(1 << 1)								  /* Bit 1: Enable AIF1(Timeslot 1, Right) to DAC1R    \
											   */
...
#define WM8994_ADCR_DAC2_VOL_MASK                                                                  \
	(0xF << WM8994_ADCR_DAC2_VOL_SHIFT) /* 0000 = -36 DB, 1100 = 0dB */
...
#define WM8994_AIF1DAC1R_TO_DAC2R_ENA                                                              \
	(1 << 0) /* Bit 0: Enable AIF1(Timeslot 0, Right) to DAC2R                                     \
			  */
#define WM8994_AIF1DAC2R_TO_DAC2R_ENA                                                              \
	(1 << 1)								  /* Bit 1: Enable AIF1(Timeslot 1, Right) to DAC2R    \
											   */
