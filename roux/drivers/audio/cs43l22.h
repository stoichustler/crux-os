...
#define CS43L22_PDN_HPB_ON_HW_PIN_LO                                                               \
	(0 << CS43L22_PDN_HPB_SHIFT) /* PDN_HPx[1:0] 00 Headphone channel is ON when the SPK/HP_SW     \
								  * pin, 6, is LO Headphone channel is OFF when the SPK/HP_SW pin, \
								  * 6, is HI                                                       \
								  */
#define CS43L22_PDN_HPB_ON_HW_PIN_HI                                                               \
	(1 << CS43L22_PDN_HPB_SHIFT) /* PDN_HPx[1:0] 01 Headphone channel is ON when the SPK/HP_SW     \
								  * pin, 6, is HI Headphone channel is OFF when the SPK/HP_SW pin, \
								  * 6, is LO                                                       \
								  */
#define CS43L22_PDN_HPB_ON                                                                         \
	(2 << CS43L22_PDN_HPB_SHIFT) /* PDN_HPx[1:0] 10 Headphone channel is always ON */
#define CS43L22_PDN_HPB_OFF                                                                        \
	(3 << CS43L22_PDN_HPB_SHIFT) /* PDN_HPx[1:0] 11 Headphone channel is always OFF */

#define CS43L22_PDN_HPA_SHIFT (4) /* Bits 4-5: Headphone channel A Control */
#define CS43L22_PDN_HPA_ON_HW_PIN_LO                                                               \
	(0 << CS43L22_PDN_HPA_SHIFT) /* PDN_HPx[1:0] 00 Headphone channel is ON when the SPK/HP_SW     \
								  * pin, 6, is LO Headphone channel is OFF when the SPK/HP_SW pin, \
								  * 6, is HI */
#define CS43L22_PDN_HPA_ON_HW_PIN_HI                                                               \
	(1 << CS43L22_PDN_HPA_SHIFT) /* PDN_HPx[1:0] 01 Headphone channel is ON when the SPK/HP_SW     \
								  * pin, 6, is HI Headphone channel is OFF when the SPK/HP_SW pin, \
								  * 6, is LO                                                       \
								  */
#define CS43L22_PDN_HPA_ON                                                                         \
	(2 << CS43L22_PDN_HPA_SHIFT) /* PDN_HPx[1:0] 10 Headphone channel is always ON */
#define CS43L22_PDN_HPA_OFF                                                                        \
	(3 << CS43L22_PDN_HPA_SHIFT) /* PDN_HPx[1:0] 11 Headphone channel is always OFF */

#define CS43L22_PDN_SPKB_SHIFT (2) /* Bits 2-3: Speaker channel B Control */
#define CS43L22_PDN_SPKB_ON_HW_PIN_LO                                                              \
	(0 << CS43L22_PDN_SPKB_SHIFT) /* PDN_HPx[1:0] 00 Speaker channel is ON when the SPK/HP_SW pin, \
								   * 6, is LO Speaker channel is OFF when the SPK/HP_SW pin, 6, is \
								   * HI                                                            \
								   */

#define CS43L22_PDN_SPKB_ON_HW_PIN_HI                                                              \
	(1 << CS43L22_PDN_SPKB_SHIFT) /* PDN_HPx[1:0] 01 Speaker channel is ON when the SPK/HP_SW pin, \
								   * 6, is HI Speaker channel is OFF when the SPK/HP_SW pin, 6, is \
								   * LO                                                            \
								   */
#define CS43L22_PDN_SPKB_ON                                                                        \
	(2 << CS43L22_PDN_SPKB_SHIFT) /* PDN_HPx[1:0] 10 Speaker channel is always ON */
#define CS43L22_PDN_SPKB_OFF                                                                       \
	(3 << CS43L22_PDN_SPKB_SHIFT) /* PDN_HPx[1:0] 11 Speaker channel is always OFF */

#define CS43L22_PDN_SPKA_SHIFT (0) /* Bits 0-1: Speaker channel A Control */
#define CS43L22_PDN_SPKA_ON_HW_PIN_LO                                                              \
	(0 << CS43L22_PDN_SPKA_SHIFT) /* PDN_HPx[1:0] 00 Speaker channel is ON when the SPK/HP_SW pin, \
								   * 6, is LO Speaker channel is OFF when the SPK/HP_SW pin, 6, is \
								   * HI                                                            \
								   */
#define CS43L22_PDN_SPKA_ON_HW_PIN_HI                                                              \
	(1 << CS43L22_PDN_SPKA_SHIFT) /* PDN_HPx[1:0] 01 Speaker channel is ON when the SPK/HP_SW pin, \
								   * 6, is HI Speaker channel is OFF when the SPK/HP_SW pin, 6, is \
								   * LO                                                            \
								   */
#define CS43L22_PDN_SPKA_ON                                                                        \
	(2 << CS43L22_PDN_SPKA_SHIFT) /* PDN_HPx[1:0] 10 Speaker channel is always ON */
#define CS43L22_PDN_SPKA_OFF                                                                       \
	(3 << CS43L22_PDN_SPKA_SHIFT) /* PDN_HPx[1:0] 11 Speaker channel is always OFF */
...
#define CS43L22_SPEED_DOUBLE                                                                       \
	(0 << CS43L22_SPEED_SHIFT) /* Slave: Double-Speed Mode (DSM - 50 kHz -100 kHz Fs) Master:      \
				  MCLK=512 SCLK=64*/
#define CS43L22_SPEED_SINGLE                                                                       \
	(1 << CS43L22_SPEED_SHIFT) /* Slave: Single-Speed Mode (SSM - 4 kHz -50 kHz Fs)   Master:      \
				  MCLK=256 SCLK=64*/
#define CS43L22_SPEED_HALF                                                                         \
	(2 << CS43L22_SPEED_SHIFT) /* Slave: Half-Speed Mode (HSM - 12.5kHz -25 kHz Fs)   Master:      \
				  MCLK=128 SCLK=64*/
#define CS43L22_SPEED_QUARTER                                                                      \
	(3 << CS43L22_SPEED_SHIFT) /* Slave: Quarter-Speed Mode (QSM - 4 kHz -12.5 kHz Fs)Master:      \
				  MCLK=128 SCLK=64*/

#define CS43L22_32k_GROUP_ENABLE                                                                   \
	(1 << 4) /* Bit 4: Specifies whether or not the input/output sample rate is 8 kHz, 16 kHz or   \
		32 kHz */

#define CS43L22_VIDEOCLK_ENABLE                                                                    \
	(1 << 3) /* Bit 3: Specifies whether or not the external MCLK frequency is 27 MHz */

#define CS43L22_MCLK_LRCK_RATIO_SHIFT (1) /* Bits 1-2: Internal MCLK/LRCK Ratio */

#define CS43L22_RATIO_128_64                                                                       \
	(0 << CS43L22_MCLK_LRCK_RATIO_SHIFT) /* RATIO[1:0] Internal MCLK Cycles per LRCK=128,          \
						SCLK/LRCK=64 Ratio in Master Mode */
#define CS43L22_RATIO_125_62                                                                       \
	(1 << CS43L22_MCLK_LRCK_RATIO_SHIFT) /* RATIO[1:0] Internal MCLK Cycles per LRCK=125,          \
						SCLK/LRCK=62 Ratio in Master Mode */
#define CS43L22_RATIO_132_66                                                                       \
	(2 << CS43L22_MCLK_LRCK_RATIO_SHIFT) /* RATIO[1:0] Internal MCLK Cycles per LRCK=132,          \
						SCLK/LRCK=66 Ratio in Master Mode */
#define CS43L22_RATIO_136_68                                                                       \
	(3 << CS43L22_MCLK_LRCK_RATIO_SHIFT) /* RATIO[1:0] Internal MCLK Cycles per LRCK=136,          \
						SCLK/LRCK=68 Ratio in Master Mode */
...
#define CS43L22_DSP_MODE_ENABLE                                                                    \
	(1 << 4) /* Configures a data-packed interface format for the DAC                              \
			  */

#define CS43L22_DAC_IF_FORMAT_SHIFT                                                                \
	(2) /* Bits 2-3: Configures the digital interface format for data on SDIN */
#define CS43L22_DAC_IF_LEFT_JUSTIFIED                                                              \
	(0 << CS43L22_DAC_IF_FORMAT_SHIFT) /* DACDIF[1:0] Left Justified, up to 24-bit data */
#define CS43L22_DAC_IF_I2S                                                                         \
	(1 << CS43L22_DAC_IF_FORMAT_SHIFT) /* DACDIF[1:0] I2S, up to 24-bit data */
#define CS43L22_DAC_IF_RIGHT_JUSTIFIED                                                             \
	(2 << CS43L22_DAC_IF_FORMAT_SHIFT)							   /* DACDIF[1:0] Right Justified */
#define CS43L22_DAC_IF_RESERVED (3 << CS43L22_DAC_IF_FORMAT_SHIFT) /* DACDIF[1:0] Reserved */

#define CS43L22_AUDIO_WORD_LENGHT_SHIFT                                                            \
	(0) /* Bits 0-1: Configures the audio sample word length used for the data into SDIN */
#define CS43L22_AWL_DSP_32_RJ_24                                                                   \
	(0 << CS43L22_AUDIO_WORD_LENGHT_SHIFT) /* AWL[1:0] DSP Mode: 32-bit data, Right Justified:     \
						  24-bit data */
#define CS43L22_AWL_DSP_24_RJ_20                                                                   \
	(1 << CS43L22_AUDIO_WORD_LENGHT_SHIFT) /* AWL[1:0] DSP Mode: 24-bit data, Right Justified:     \
						  20-bit data */
#define CS43L22_AWL_DSP_20_RJ_18                                                                   \
	(2 << CS43L22_AUDIO_WORD_LENGHT_SHIFT) /* AWL[1:0] DSP Mode: 20-bit data, Right Justified:     \
						  18-bit data */
#define CS43L22_AWL_DSP_16_RJ_16                                                                   \
	(3 << CS43L22_AUDIO_WORD_LENGHT_SHIFT) /* AWL[1:0] DSP Mode: 16 bit data, Right Justified:     \
						  16-bit data */

/* 0x0E Miscellaneous Controls */
#define CS43L22_FREEZE (1 << 3) /* Configures a hold on all register settings */
#define CS43L22_DEEMPHASIS_ENABLE                                                                  \
	(1 << 2) /* Configures a 15μs/50μs digital de-emphasis filter response on the headphone/line \
		and speaker outputs */
