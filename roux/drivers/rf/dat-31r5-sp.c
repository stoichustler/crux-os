...
#include <roux/rf/ioctl.h>
#include <roux/rf/attenuator.h>
...
static ssize_t dat31r5sp_read(FAR struct file *filep, FAR char *buffer, size_t buflen);
static ssize_t dat31r5sp_write(FAR struct file *filep, FAR const char *buffer, size_t buflen);
...
static void dat31r5sp_set_attenuation(FAR struct dat31r5sp_dev_s *priv, b16_t attenuation)
{
...
static int dat31r5sp_ioctl(FAR struct file *filep, int cmd, unsigned long arg)
{
	...
	switch (cmd) {
	case RFIOC_SETATT: {
		FAR struct attenuator_control *att = (FAR struct attenuator_control *)((uintptr_t)arg);
...
int dat31r5sp_register(FAR const char *devpath, FAR struct spi_dev_s *spi, int spidev)
{
