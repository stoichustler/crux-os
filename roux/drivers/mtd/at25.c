...
static inline void at25_pagewrite(struct at25_dev_s *priv, FAR const uint8_t *buffer, off_t offset);
...
static inline void at25_pagewrite(struct at25_dev_s *priv, FAR const uint8_t *buffer, off_t page)
{
	off_t offset = page << 8;
