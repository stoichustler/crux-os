...
static ssize_t mtd_reload(FAR void *dev, FAR uint8_t *buffer, off_t startblock, size_t nblocks);
...
static ssize_t mtd_bread(FAR struct mtd_dev_s *dev, off_t block, size_t nsectors, FAR uint8_t *buf);
...
static ssize_t mtd_flush(FAR void *dev, FAR const uint8_t *buffer, off_t startblock, size_t nblocks)
{
	FAR struct mtd_rwbuffer_s *priv = (FAR struct mtd_rwbuffer_s *)dev;
	DEBUGASSERT(priv && priv->dev);
...
static ssize_t mtd_bread(FAR struct mtd_dev_s *dev, off_t sector, size_t nsectors,
						 FAR uint8_t *buffer)
{
	FAR struct mtd_rwbuffer_s *priv = (FAR struct mtd_rwbuffer_s *)dev;
...
static ssize_t mtd_read(FAR struct mtd_dev_s *dev, off_t offset, size_t nbytes, FAR uint8_t *buffer)
{
	FAR struct mtd_rwbuffer_s *priv = (FAR struct mtd_rwbuffer_s *)dev;
