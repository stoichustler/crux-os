...
#define OPTEE_SMC_STD_CALL_VAL(func_num)                                                           \
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_STD_CALL, ARM_SMCCC_SMC_32, ARM_SMCCC_OWNER_TRUSTED_OS, (func_num))
...
#define OPTEE_SMC_CALLS_COUNT                                                                      \
	ARM_SMCCC_CALL_VAL(OPTEE_SMC_FAST_CALL, SMCCC_SMC_32, SMCCC_OWNER_TRUSTED_OS_END,              \
...
#define OPTEE_SMC_CALLS_UID                                                                        \
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL, ARM_SMCCC_SMC_32, ARM_SMCCC_OWNER_TRUSTED_OS_END,      \
