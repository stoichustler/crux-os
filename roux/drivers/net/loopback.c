...
static int lo_ifup(FAR struct net_driver_s *dev)
{
	...
	ninfo("Bringing up: %04x:%04x:%04x:%04x:%04x:%04x:%04x:%04x\n", NTOHS(dev->d_ipv6addr[0]),
		  NTOHS(dev->d_ipv6addr[1]), NTOHS(dev->d_ipv6addr[2]), NTOHS(dev->d_ipv6addr[3]),
		  NTOHS(dev->d_ipv6addr[4]), NTOHS(dev->d_ipv6addr[5]), NTOHS(dev->d_ipv6addr[6]),
		  NTOHS(dev->d_ipv6addr[7]));
#endif
