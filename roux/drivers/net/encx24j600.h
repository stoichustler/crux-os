...
#define ENC_FCMULTIPLE                                                                             \
	(0xe4) /* Enables flow control with periodic pause frames (sets ECON1<7:6> = 10) */
#define ENC_FCCLEAR                                                                                \
	(0xe6) /* Terminates flow control with a final pause frame (sets ECON1<7:6> = 11) */
...
#define ENC_DMACKSUMS                                                                              \
	(0xda)				   /* Starts DMA checksum operation with seed (sets ECON1<5:2> = 1010)     \
							*/
#define ENC_DMACOPY (0xdc) /* Starts DMA copy and checksum operation (sets ECON1<5:2> = 1100) */
#define ENC_DMACOPYS                                                                               \
	(0xde) /* Starts DMA copy and checksum operation with seed (sets ECON1<5:2> = 1110) */
...
#define MACON2_BPEN                                                                                \
	(1 << 13) /* No Backoff During Back Pressure Enable bit (applies to half duplex only) */
...
#define EIR_CRYPTEN                                                                                \
	(1 << 15) /* Modular Exponentiation and AES Cryptographic Modules Enable bit                   \
			   */
