...
#define IGC_CTRL_SLU (1 << 6)	  /* Bit 6: Set Link Up */
								  /* Bits 7-15: Reserved */
#define IGC_CTRL_SDP0GPIEN                                                                         \
	(1 << 16) /* Bit 16: General Purpose Interrupt Detection Enable for SDP0 */
#define IGC_CTRL_SDP1GPIEN                                                                         \
	(1 << 17) /* Bit 17: General Purpose Interrupt Detection Enable for SDP1 */
...
#define IGC_RDESC_STATUS_UDPCS                                                                     \
	(1 << 4) /* Bit 4: UDP checksum or IP payload checksum calculated on packet */
