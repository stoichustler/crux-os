...
/* ROUX SPI mode number for SPI config as defined in OpenAlliance TC6 */
...
#define OA_MAKE_REGID(mms, addr) (((uint32_t)(mms) << 16) | ((uint32_t)(addr)&0xFFFF))
...
#define _oa_control_field(f, fieldname) ((int)((f & OA_##fieldname##_MASK) >> OA_##fieldname##_POS))
