...
static int a4988_work(FAR struct stepper_lowerhalf_s *dev, FAR struct stepper_job_s const *param);
...
static int a4988_microstepping(FAR struct stepper_lowerhalf_s *dev, uint16_t resolution);
static int a4988_ioctl(FAR struct stepper_lowerhalf_s *dev, int cmd, unsigned long arg);
...
static int a4988_work(FAR struct stepper_lowerhalf_s *dev, FAR struct stepper_job_s const *job)
{
	FAR struct a4988_dev_s *priv = (FAR struct a4988_dev_s *)dev->priv;
	int delay;
	int count;
