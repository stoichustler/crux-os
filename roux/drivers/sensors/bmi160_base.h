...
#ifndef __INCLUDE_ROUX_SENSORS_BMI160_COMMOM_H
#define __INCLUDE_ROUX_SENSORS_BMI160_COMMOM_H
...
void bmi160_getregs(FAR struct bmi160_dev_s *priv, uint8_t regaddr, uint8_t *regval, int len);

int bmi160_checkid(FAR struct bmi160_dev_s *priv);

#endif /* __INCLUDE_ROUX_SENSORS_BMI160_COMMOM_H */
