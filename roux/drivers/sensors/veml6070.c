...
#include <roux/sensors/veml6070.h>
...
static int veml6070_read8(FAR struct veml6070_dev_s *priv, int offset, FAR uint8_t *regval);
static int veml6070_write8(FAR struct veml6070_dev_s *priv, uint8_t regval);

/* Character driver methods */

static ssize_t veml6070_read(FAR struct file *filep, FAR char *buffer, size_t buflen);
static ssize_t veml6070_write(FAR struct file *filep, FAR const char *buffer, size_t buflen);
...
int veml6070_register(FAR const char *devpath, FAR struct i2c_master_s *i2c, uint8_t addr)
{
	FAR struct veml6070_dev_s *priv;
	int ret;
