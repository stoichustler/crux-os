...
#ifndef __INCLUDE_ROUX_SENSORS_BMI270_BASE_H
#define __INCLUDE_ROUX_SENSORS_BMI270_BASE_H
...
void bmi270_putreg8(FAR struct bmi270_dev_s *priv, uint8_t regaddr, uint8_t regval);
void bmi270_getregs(FAR struct bmi270_dev_s *priv, uint8_t regaddr, FAR uint8_t *regval, int len);
void bmi270_putregs(FAR struct bmi270_dev_s *priv, uint8_t regaddr, FAR uint8_t *regval, int len);
...
#endif /* __INCLUDE_ROUX_SENSORS_BMI270_BASE_H */
