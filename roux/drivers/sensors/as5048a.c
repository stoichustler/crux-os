...
#include <roux/sensors/as5048a.h>
...
static int as5048a_writeu16(FAR struct as5048a_dev_s *priv, uint16_t regaddr, uint16_t regval);
static int as5048a_exchange(FAR struct as5048a_dev_s *priv, uint16_t regaddr, FAR uint16_t *regval);
static uint16_t calc_even_parity(uint16_t value);
static int as5048a_readzero(FAR struct as5048a_dev_s *priv, FAR uint16_t *zero);
...
static int as5048a_readdiag(FAR struct as5048a_dev_s *priv, FAR uint16_t *diag);
...
static int as5048a_position(FAR struct qe_lowerhalf_s *lower, FAR int32_t *pos);
static int as5048a_reset(FAR struct qe_lowerhalf_s *lower);
static int as5048a_ioctl(FAR struct qe_lowerhalf_s *lower, int cmd, unsigned long arg);
...
FAR struct qe_lowerhalf_s *as5048a_initialize(FAR struct spi_dev_s *spi, int spi_devid)
{
