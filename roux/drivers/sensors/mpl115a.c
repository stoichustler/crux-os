...
#include <roux/sensors/mpl115a.h>
...
static void mpl115a_read_press_temp(FAR struct mpl115a_dev_s *priv)
{
	...
	priv->mpl115a_temperature = mpl115a_getreg8(priv, MPL115A_BASE_CMD | (MPL115A_TADC_MSB << 1))
								<< 8;
	...
	add_sensor_randomness((priv->mpl115a_pressure << 16) ^ priv->mpl115a_temperature);
}
...
static int mpl115a_getpressure(FAR struct mpl115a_dev_s *priv)
{
	...
	if ((priv->mpl115a_cal_a0 == 0) || (priv->mpl115a_cal_b1 == 0) || (priv->mpl115a_cal_b2 == 0) ||
