...
#include <roux/sensors/bh1750fvi.h>
...
static int bh1750fvi_read16(FAR struct bh1750fvi_dev_s *priv, FAR uint16_t *regval);
static int bh1750fvi_write8(FAR struct bh1750fvi_dev_s *priv, uint8_t regval);

/* Character driver methods */

static ssize_t bh1750fvi_read(FAR struct file *filep, FAR char *buffer, size_t buflen);
static ssize_t bh1750fvi_write(FAR struct file *filep, FAR const char *buffer, size_t buflen);
static int bh1750fvi_ioctl(FAR struct file *filep, int cmd, unsigned long arg);
...
int bh1750fvi_register(FAR const char *devpath, FAR struct i2c_master_s *i2c, uint8_t addr)
{
	FAR struct bh1750fvi_dev_s *priv;
	int ret;
