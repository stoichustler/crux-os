...
#include <roux/sensors/adt7320.h>
...
static void adt7320_write_reg16(FAR struct adt7320_dev_s *priv, uint8_t reg, uint16_t data);
static uint16_t adt7320_read_reg16(FAR struct adt7320_dev_s *priv, uint8_t reg);
static void adt7320_write_reg8(FAR struct adt7320_dev_s *priv, uint8_t reg, uint8_t data);
static uint8_t adt7320_read_reg8(FAR struct adt7320_dev_s *priv, uint8_t reg);
...
static ssize_t adt7320_write(FAR struct file *filep, FAR const char *buffer, size_t buflen);
...
static void adt7320_write_reg16(FAR struct adt7320_dev_s *priv, uint8_t reg, const uint16_t data)
{
...
static void adt7320_write_reg8(FAR struct adt7320_dev_s *priv, uint8_t reg, const uint8_t data)
{
	SPI_LOCK(priv->spi, true);
