...
#include <roux/sensors/mcp9844.h>
...
static int mcp9844_read_u16(FAR struct mcp9844_dev_s *priv, uint8_t const regaddr,
							FAR uint16_t *value);
static int mcp9844_write_u16(FAR struct mcp9844_dev_s *priv, uint8_t const regaddr,
							 uint16_t const regval);

/* Character driver methods */

static ssize_t mcp9844_read(FAR struct file *filep, FAR char *buffer, size_t buflen);
static ssize_t mcp9844_write(FAR struct file *filep, FAR const char *buffer, size_t buflen);
...
int mcp9844_register(FAR const char *devpath, FAR struct i2c_master_s *i2c, uint8_t addr)
{
