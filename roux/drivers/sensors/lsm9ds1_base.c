...
static int lsm9ds1accelgyro_setsamplerate(FAR struct lsm9ds1_dev_s *priv, uint32_t samplerate);
static int lsm9ds1accel_setfullscale(FAR struct lsm9ds1_dev_s *priv, uint32_t fullscale);
...
static int lsm9ds1gyro_setfullscale(FAR struct lsm9ds1_dev_s *priv, uint32_t fullscale);
...
static int lsm9ds1mag_setfullscale(FAR struct lsm9ds1_dev_s *priv, uint32_t fullscale);
static int lsm9ds1mag_setsamplerate(FAR struct lsm9ds1_dev_s *priv, uint32_t samplerate);
...
const struct lsm9ds1_ops_s g_lsm9ds1accel_ops = {
	lsm9ds1accelgyro_config,		lsm9ds1accel_start,		   lsm9ds1accel_stop,
	lsm9ds1accelgyro_setsamplerate, lsm9ds1accel_setfullscale,
};

const struct lsm9ds1_ops_s g_lsm9ds1gyro_ops = {
	lsm9ds1accelgyro_config,		lsm9ds1gyro_start,		  lsm9ds1gyro_stop,
	lsm9ds1accelgyro_setsamplerate, lsm9ds1gyro_setfullscale,
};

const struct lsm9ds1_ops_s g_lsm9ds1mag_ops = {
	lsm9ds1mag_config,		  lsm9ds1mag_start,		   lsm9ds1mag_stop,
	lsm9ds1mag_setsamplerate, lsm9ds1mag_setfullscale,
};
...
static int lsm9ds1accel_start(FAR struct lsm9ds1_dev_s *priv)
{
	...
	return lsm9ds1_modifyreg8(priv, LSM9DS1_CTRL_REG6_XL, LSM9DS1_CTRL_REG6_XL_ODR_XL_MASK,
							  setbits);
}
...
static int lsm9ds1accel_setfullscale(FAR struct lsm9ds1_dev_s *priv, uint32_t fullscale)
{
	...
	return lsm9ds1_modifyreg8(priv, LSM9DS1_CTRL_REG6_XL, LSM9DS1_CTRL_REG6_XL_FS_XL_MASK, setbits);
}
...
static int lsm9ds1gyro_start(FAR struct lsm9ds1_dev_s *priv)
{
	...
	return lsm9ds1_modifyreg8(priv, LSM9DS1_CTRL_REG1_G, LSM9DS1_CTRL_REG1_G_ODR_G_MASK, setbits);
}
...
static int lsm9ds1gyro_stop(FAR struct lsm9ds1_dev_s *priv)
{
	...
	return lsm9ds1_modifyreg8(priv, LSM9DS1_CTRL_REG1_G, LSM9DS1_CTRL_REG1_G_ODR_G_MASK,
...
static int lsm9ds1gyro_setfullscale(FAR struct lsm9ds1_dev_s *priv, uint32_t fullscale)
{
	...
	return lsm9ds1_modifyreg8(priv, LSM9DS1_CTRL_REG1_G, LSM9DS1_CTRL_REG1_G_FS_G_MASK, setbits);
}
...
static int lsm9ds1mag_start(FAR struct lsm9ds1_dev_s *priv)
{
	...
	return lsm9ds1_modifyreg8(priv, LSM9DS1_CTRL_REG3_M, LSM9DS1_CTRL_REG3_M_MD_MASK,
...
static int lsm9ds1mag_setfullscale(FAR struct lsm9ds1_dev_s *priv, uint32_t fullscale)
{
	...
	return lsm9ds1_modifyreg8(priv, LSM9DS1_CTRL_REG2_M, LSM9DS1_CTRL_REG2_M_FS_MASK, setbits);
}
...
static int lsm9ds1mag_setsamplerate(FAR struct lsm9ds1_dev_s *priv, uint32_t samplerate)
{
	...
	return lsm9ds1_modifyreg8(priv, LSM9DS1_CTRL_REG1_M, LSM9DS1_CTRL_REG1_M_DO_MASK, setbits);
}
