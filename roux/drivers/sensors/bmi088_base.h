...
#ifndef __INCLUDE_ROUX_SENSORS_BMI088_COMMOM_H
#define __INCLUDE_ROUX_SENSORS_BMI088_COMMOM_H
...
void bmi088_put_acc_reg8(FAR struct bmi088_dev_s *priv, uint8_t regaddr, uint8_t regval);
void bmi088_put_gyro_reg8(FAR struct bmi088_dev_s *priv, uint8_t regaddr, uint8_t regval);
void bmi088_get_acc_regs(FAR struct bmi088_dev_s *priv, uint8_t regaddr, uint8_t *regval, int len);
void bmi088_get_gyro_regs(FAR struct bmi088_dev_s *priv, uint8_t regaddr, uint8_t *regval, int len);

#endif /* __INCLUDE_ROUX_SENSORS_BMI088_COMMOM_H */
