...
#ifndef __INCLUDE_ROUX_SENSORS_LSM9DS1_COMMOM_H
#define __INCLUDE_ROUX_SENSORS_LSM9DS1_COMMOM_H
...
#include <roux/sensors/lsm9ds1.h>
...
#define LSM9DS1_ACT_THS_SLEEP_ON_INACT_EN                                                          \
	(1 << 7) /* Gyroscope operating mode during inactivity                                         \
			  */
...
#define LSM9DS1_CTRL_REG1_G_ODR_G_POWERDOWN                                                        \
	(0 << LSM9DS1_CTRL_REG1_G_ODR_G_SHIFT) /* Power-down mode */
...
#define LSM9DS1_CTRL_REG3_G_HPCF_G_SHIFT                                                           \
	0 /* Gyroscope high-pass filter cutoff frequency selection */
...
#define LSM9DS1_CTRL_REG5_XL_DEC_2SAMPLES                                                          \
	(1 << LSM9DS1_CTRL_REG5_XL_DEC_SHIFT) /* Update every 2 samples */
#define LSM9DS1_CTRL_REG5_XL_DEC_4SAMPLES                                                          \
	(2 << LSM9DS1_CTRL_REG5_XL_DEC_SHIFT) /* Update every 4 samples */
#define LSM9DS1_CTRL_REG5_XL_DEC_8SAMPLES                                                          \
	(3 << LSM9DS1_CTRL_REG5_XL_DEC_SHIFT) /* Update every 8 samples */
...
#define LSM9DS1_CTRL_REG6_XL_ODR_XL_POWERDOWN                                                      \
	(0 << LSM9DS1_CTRL_REG6_XL_ODR_XL_SHIFT) /* Power-down mode */
...
#define LSM9DS1_CTRL_REG7_XL_DCF_SHIFT                                                             \
	5 /* Accelerometer digital filter cutoff frequency selection */
...
#define LSM9DS1_CTRL_REG8_IF_ADD_INC                                                               \
	(1 << 2) /* Register address automatically incremented during a multibyte access */
#define LSM9DS1_CTRL_REG8_SIM (1 << 3) /* SPI serial interface mode selection */
#define LSM9DS1_CTRL_REG8_PP_OD                                                                    \
	(1 << 4) /* Push-pull/open-drain selection on the INT1_A/G and INT2_A/G pins */
...
#define LSM9DS1_FIFO_CTRL_FMODE_CONT_FIFO                                                          \
	(3 << LSM9DS1_FIFO_CTRL_FMODE_SHIFT) /* Continuous-to-FIFO mode */
#define LSM9DS1_FIFO_CTRL_FMODE_BYPASS_CONT                                                        \
	(4 << LSM9DS1_FIFO_CTRL_FMODE_SHIFT) /* Bypass-to-continuous mode */
...
#define LSM9DS1_CTRL_REG1_M_OM_MEDIUM                                                              \
	(1 << LSM9DS1_CTRL_REG1_M_OM_SHIFT) /* Medium-performance mode */
#define LSM9DS1_CTRL_REG1_M_OM_HIGH                                                                \
	(2 << LSM9DS1_CTRL_REG1_M_OM_SHIFT) /* High-performance mode                                   \
										 */
#define LSM9DS1_CTRL_REG1_M_OM_ULTRAHIGH                                                           \
	(3 << LSM9DS1_CTRL_REG1_M_OM_SHIFT) /* Ultra-high performance mode */
...
#define LSM9DS1_CTRL_REG3_M_MD_CONT                                                                \
	(0 << LSM9DS1_CTRL_REG3_M_MD_SHIFT) /* Continuous-conversion mode */
#define LSM9DS1_CTRL_REG3_M_MD_SINGLE                                                              \
	(1 << LSM9DS1_CTRL_REG3_M_MD_SHIFT) /* Single-conversion mode */
#define LSM9DS1_CTRL_REG3_M_MD_POWERDOWN (2 << LSM9DS1_CTRL_REG3_M_MD_SHIFT) /* Power-down mode */
#define LSM9DS1_CTRL_REG3_M_MD_POWERDOWN2                                                          \
	(3 << LSM9DS1_CTRL_REG3_M_MD_SHIFT) /* Power-down mode                                         \
										 */
...
#define LSM9DS1_CTRL_REG4_M_OMZ_MEDIUM                                                             \
	(1 << LSM9DS1_CTRL_REG4_M_OMZ_SHIFT) /* Medium-performance mode */
#define LSM9DS1_CTRL_REG4_M_OMZ_HIGH                                                               \
	(2 << LSM9DS1_CTRL_REG4_M_OMZ_SHIFT) /* High-performance mode */
#define LSM9DS1_CTRL_REG4_M_OMZ_ULTRAHIGH                                                          \
	(3 << LSM9DS1_CTRL_REG4_M_OMZ_SHIFT) /* Ultra-high performance mode */
...
struct lsm9ds1_ops_s {
	...
	CODE int (*setsamplerate)(FAR struct lsm9ds1_dev_s *priv, uint32_t samplerate);
	CODE int (*setfullscale)(FAR struct lsm9ds1_dev_s *priv, uint32_t fullscale);
};
...
int lsm9ds1_readreg8(FAR struct lsm9ds1_dev_s *priv, uint8_t regaddr, FAR uint8_t *regval);
int lsm9ds1_readreg(FAR struct lsm9ds1_dev_s *priv, uint8_t regaddr, FAR uint8_t *regval,
					uint8_t len);
int lsm9ds1_writereg8(FAR struct lsm9ds1_dev_s *priv, uint8_t regaddr, uint8_t regval);
int lsm9ds1_modifyreg8(FAR struct lsm9ds1_dev_s *priv, uint8_t regaddr, uint8_t clearbits,
					   uint8_t setbits);
uint32_t lsm9ds1_midpoint(uint32_t a, uint32_t b);

#endif /* __INCLUDE_ROUX_SENSORS_LSM9DS1_COMMOM_H */
