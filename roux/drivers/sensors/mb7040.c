...
static int mb7040_readrange(FAR struct mb7040_dev_s *priv, FAR uint16_t *range);
static int mb7040_changeaddr(FAR struct mb7040_dev_s *priv, uint8_t addr);

/* Character Driver Methods */

static ssize_t mb7040_read(FAR struct file *filep, FAR char *buffer, size_t buflen);
static ssize_t mb7040_write(FAR struct file *filep, FAR const char *buffer, size_t buflen);
...
int mb7040_register(FAR const char *devpath, FAR struct i2c_master_s *i2c, uint8_t addr)
{
