...
void bmp180_putreg8(FAR struct bmp180_dev_s *priv, uint8_t regaddr, uint8_t regval)
{
	struct i2c_config_s config;
	uint8_t data[2];
	int ret;
...
int bmp180_getpressure(FAR struct bmp180_dev_s *priv, FAR float *temperature)
{
	int32_t x1;
	int32_t x2;
	int32_t x3;
	...
	if ((priv->bmp180_cal_ac1 == 0) || (priv->bmp180_cal_ac2 == 0) || (priv->bmp180_cal_ac3 == 0) ||
		(priv->bmp180_cal_ac4 == 0) || (priv->bmp180_cal_ac5 == 0) || (priv->bmp180_cal_ac6 == 0) ||
		(priv->bmp180_cal_b1 == 0) || (priv->bmp180_cal_b2 == 0) || (priv->bmp180_cal_mb == 0) ||
		(priv->bmp180_cal_mc == 0) || (priv->bmp180_cal_md == 0)) {
