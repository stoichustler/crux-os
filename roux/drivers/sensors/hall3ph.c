...
static ssize_t hall3_read(FAR struct file *filep, FAR char *buffer, size_t buflen);
static ssize_t hall3_write(FAR struct file *filep, FAR const char *buffer, size_t buflen);
...
int hall3_register(FAR const char *devpath, FAR struct hall3_lowerhalf_s *lower)
{
	FAR struct hall3_upperhalf_s *upper = NULL;

	/* Allocate the upper-half data structure */

	upper = (FAR struct hall3_upperhalf_s *)kmm_zalloc(sizeof(struct hall3_upperhalf_s));
	if (upper == NULL) {
