...
#include <roux/segger/note_rtt.h>
...
static void note_driver_instrument_enter(FAR void *this_fn, FAR void *call_site,
										 FAR void *arg) noinstrument_function;
static void note_driver_instrument_leave(FAR void *this_fn, FAR void *call_site,
										 FAR void *arg) noinstrument_function;
#endif
...
#ifdef CONFIG_SCHED_INSTRUMENTATION_FUNCTION
static void note_driver_instrument_enter(FAR void *this_fn, FAR void *call_site, FAR void *arg)
{
	sched_note_event_ip(NOTE_TAG_ALWAYS, (uintptr_t)this_fn, NOTE_DUMP_BEGIN, NULL, 0);
}

static void note_driver_instrument_leave(FAR void *this_fn, FAR void *call_site, FAR void *arg)
{
	sched_note_event_ip(NOTE_TAG_ALWAYS, (uintptr_t)this_fn, NOTE_DUMP_END, NULL, 0);
}
#endif
