...
#endif
static ssize_t i2cdrvr_read(FAR struct file *filep, FAR char *buffer, size_t buflen);
static ssize_t i2cdrvr_write(FAR struct file *filep, FAR const char *buffer, size_t buflen);
...
static ssize_t i2cdrvr_read(FAR struct file *filep, FAR char *buffer, size_t len)
{
	return 0; /* Return EOF */
}
...
static ssize_t i2cdrvr_write(FAR struct file *filep, FAR const char *buffer, size_t len)
{
