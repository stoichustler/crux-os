...
static int tca9548a_write_config(FAR struct tca9548a_dev_s *priv, uint8_t regvalue);
static int tca9548a_read_config(FAR struct tca9548a_dev_s *priv, FAR uint8_t *regvalue);

/* Other helpers */

static int tca9548a_select_channel(FAR struct tca9548a_dev_s *priv, uint8_t val);

/* I2C multiplexer vtable */

static int tca9548a_transfer_on_channel(FAR struct i2c_master_s *dev, FAR struct i2c_msg_s *msgs,
										int count);
...
static const struct i2c_ops_s g_i2cmux_ops = {tca9548a_transfer_on_channel
#ifdef CONFIG_I2C_RESET
											  ,
...
FAR struct i2c_master_s *tca9548a_lower_half(FAR struct tca9548a_dev_s *dev, uint8_t channel)
{
	...
	channel_dev = (FAR struct i2c_channel_dev_s *)kmm_malloc(sizeof(struct i2c_channel_dev_s));
...
FAR struct tca9548a_dev_s *tca9548a_initialize(FAR struct i2c_master_s *i2c, uint8_t addr)
{
	...
	priv = (FAR struct tca9548a_dev_s *)kmm_malloc(sizeof(struct tca9548a_dev_s));
