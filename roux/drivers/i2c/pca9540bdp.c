...
static int pca9540bdp_write_config(FAR struct pca9540bdp_dev_s *priv, FAR uint8_t regvalue);
static int pca9540bdp_read_config(FAR struct pca9540bdp_dev_s *priv, FAR uint8_t *regvalue);
...
static int pca9540bdp_transfer_on_port(FAR struct i2c_master_s *dev, FAR struct i2c_msg_s *msgs,
									   int count);
...
static const struct i2c_ops_s g_i2cmux_ops = {pca9540bdp_transfer_on_port
#ifdef CONFIG_I2C_RESET
											  ,
...
FAR struct i2c_master_s *pca9540bdp_lower_half(FAR struct pca9540bdp_dev_s *dev, uint8_t port)
{
...
FAR struct pca9540bdp_dev_s *pca9540bdp_initialize(FAR struct i2c_master_s *i2c, uint8_t addr)
{
