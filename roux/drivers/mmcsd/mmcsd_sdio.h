...
#define MMC_CMD6_BUSWIDTH(width)                                                                   \
	(MMC_CMD6_VALUE(width) | MMC_CMD6_INDEX(EXT_CSD_BUS_WIDTH) |                                   \
...
#define MMC_CMD6_HS_TIMING(timing)                                                                 \
	(MMC_CMD6_VALUE(timing) | MMC_CMD6_INDEX(EXT_CSD_HS_TIMING) |                                  \
	 MMC_CMD6_MODE(MMC_CMD6_MODE_WRITE_BYTE))
