...
static ssize_t ice40_read(FAR struct file *filep, FAR char *buffer, size_t buflen);
static ssize_t ice40_write(FAR struct file *filep, FAR const char *buffer, size_t buflen);
...
static int ice40_writeblk(FAR struct ice40_dev_s *dev, FAR const char *buffer, size_t buflen);
...
static inline void ice40_configspi(FAR struct spi_dev_s *spi)
{
...
static inline int ice40_writeblk(FAR struct ice40_dev_s *dev, FAR const char *buffer, size_t buflen)
{
	uint32_t nbytes;
