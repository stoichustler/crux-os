...
static ssize_t spidrvr_write(FAR struct file *filep, FAR const char *buffer, size_t buflen);
...
static ssize_t spidrvr_write(FAR struct file *filep, FAR const char *buffer, size_t len)
{
