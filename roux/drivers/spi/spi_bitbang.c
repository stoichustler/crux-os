 ...
 * 2. include/roux/spi/spi_bitbang.h:  This header file provides the
 ...
 *    logic provided in include/roux/spi/spi_bitbang.c.
 * 4. include/roux/spi/spi_bitbang.c.  Despite the .c extension, this is
 *    really an included file.  It is used in this way:  1) The board-
 *    specific logic in boards/<arch>/<chip>/<board>/src/<file> provides
 *    some definitions then 2) includes include/roux/spi/spi_bitbang.c.
 ...
 *    driver.
 *
 *    See include/roux/spi/spi_bitbang.c for more detailed usage
 *    information.
 */
...
static void spi_exchange(FAR struct spi_dev_s *dev, FAR const void *txbuffer, FAR void *rxbuffer,
						 size_t nwords);
