...
#define SX126X_DEFAULT_SYNCWORD                                                                    \
	{                                                                                              \
...
#define SX126X_PKTPARAM3_GFSK_PREAMBLEDETECTORLEN_PARAM                                            \
	2 /* Takes SX126X_GFSK_PREABMLE_DETECT_x                                                       \
	   */
#define SX126X_PKTPARAM4_GFSK_SYNCWORDLEN_PARAM                                                    \
	3 /* 0x00 to 0x40, 0 to 8 bytes from SX126X_SYNCWORD register */
...
#define SX126X_STOPTIMERONPREAMBLE_ENABLE                                                          \
	(1 << 0) /* Bit 0 disabled=stop on syncword/header, enabled=stop on preamble */
