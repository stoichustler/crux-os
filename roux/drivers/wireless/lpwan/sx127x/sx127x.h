...
#define SX127X_CMN_FTEMP                                                                           \
	0x5b /* FSK/OOK/LORA: Stored temperature during the former IQ calibration */
...
#define SX127X_CMN_OPMODE_MODE_RX                                                                  \
	(5 << SX127X_CMN_OPMODE_MODE_SHIFT) /* RX in FSK/OOK, RXCONTINOUS in LORA */
#define SX127X_CMN_OPMODE_MODE_RXSINGLE                                                            \
	(6 << SX127X_CMN_OPMODE_MODE_SHIFT)								   /* RXSINGLE (only LORA) */
...
#define SX127X_CMN_PACFG_MAXPOWER_SHIFT                                                            \
	(4) /* Bits 4-6: Max power output: Pmax=10.8 +0.6*MaxPower */
...
#define SX127X_CMN_AGCTHR1_STEP1(v)                                                                \
	((v << SX127X_CMN_AGCTHR1_STEP1_SHIFT) & SX127X_CMN_AGCTHR1_STEP1_MASK)
...
#define SX127X_CMN_AGCTHR2_STEP3(v)                                                                \
	((v << SX127X_CMN_AGCTHR2_STEP3_SHIFT) & SX127X_CMN_AGCTHR2_STEP3_MASK)
...
#define SX127X_CMN_AGCTHR2_STEP2(v)                                                                \
	((v << SX127X_CMN_AGCTHR2_STEP2_SHIFT) & SX127X_CMN_AGCTHR2_STEP2_MASK)
...
#define SX127X_CMN_AGCTHR3_STEP5(v)                                                                \
	((v << SX127X_CMN_AGCTHR3_STEP5_SHIFT) & SX127X_CMN_AGCTHR3_STEP5_MASK)
...
#define SX127X_CMN_AGCTHR3_STEP4(v)                                                                \
	((v << SX127X_CMN_AGCTHR3_STEP4_SHIFT) & SX127X_CMN_AGCTHR3_STEP4_MASK)
...
#define FSKOOK_BANDWIDTH_GET(mant, exp)                                                            \
	(((exp << SX127X_FOM_RXBW_EXP_SHIFT) & SX127X_FOM_RXBW_EXP_MASK) |                             \
...
#define SX127X_FOM_PREDET_TOL(tol)                                                                 \
	((tol << SX127X_FOM_PREDET_TOL_SHIFT) & SX127X_FOM_PREDET_TOL_MASK)
...
#define SX127X_FOM_OSC_CLKOUT_RCCALSTART                                                           \
	(3 << 1) /* Bit 3: Trigger the RC oscillator calibration                                       \
			  */
...
#define SX127X_FOM_SYNCCFG_SYNCSIZE(s)                                                             \
	(((s) << SX127X_FOM_SYNCCFG_SYNCSIZE_SHIFT) & SX127X_FOM_SYNCCFG_SYNCSIZE_MASK)
...
#define SX127X_FOM_PKTCFG1_CRCTYPE                                                                 \
	(1 << 0) /* Bit 0: CRC type: 0 -> CCITT CRC, 1 -> IBM CRC with alternate whitening */
...
#define SX127X_FOM_SEQCFG1_TX                                                                      \
	(1 << 0) /* Bit 0: From Transmit  0 -> LowPowerSelection, 1 -> Receive */
...
#define SX127X_LRM_HOPCHAN_FHHSP_SHIFT                                                             \
	(0) /* Bits 0-5: current value of frequency hopping in use                                     \
		 */
...
#define SX127X_LRM_FEI(msb, mid, lsb)                                                              \
	((lsb << 0) | (mid << 8) | ((msb & SX127X_LRM_FEIMSB_MASK) << 16))
...
#define SX127X_LRM_DETECTOPT_DO_SF7SF12                                                            \
	(3 << SX127X_LRM_DETECTOPT_DO_SHIFT)								 /* 0x03: SF7 to SF12      \
																		  */
