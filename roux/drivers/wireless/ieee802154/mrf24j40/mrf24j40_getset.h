...
int mrf24j40_setcoordsaddr(FAR struct mrf24j40_radio_s *dev, FAR const uint8_t *saddr);
...
int mrf24j40_setcca(FAR struct mrf24j40_radio_s *dev, FAR struct ieee802154_cca_s *cca);
