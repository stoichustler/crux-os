...
#include <roux/wireless/ieee802154/mrf24j40.h>
...
void mrf24j40_norm_setup(FAR struct mrf24j40_radio_s *dev, FAR struct iob_s *frame, bool csma)
{
	uint8_t reg;
...
void mrf24j40_gts_setup(FAR struct mrf24j40_radio_s *dev, uint8_t fifo, FAR struct iob_s *frame)
{
}
...
void mrf24j40_setup_fifo(FAR struct mrf24j40_radio_s *dev, FAR const uint8_t *buf, uint8_t length,
						 uint32_t fifo_addr)
{
	uint16_t frame_ctrl;
	uint16_t addrmode;
	...
	addrmode = (frame_ctrl & IEEE802154_FRAMECTRL_DADDR) >> IEEE802154_FRAMECTRL_SHIFT_DADDR;
	...
	addrmode = (frame_ctrl & IEEE802154_FRAMECTRL_SADDR) >> IEEE802154_FRAMECTRL_SHIFT_SADDR;
