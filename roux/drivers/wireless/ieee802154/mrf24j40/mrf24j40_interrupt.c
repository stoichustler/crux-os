...
static void mrf24j40_irqwork_txgts(FAR struct mrf24j40_radio_s *dev, uint8_t gts_num);
...
static void mrf24j40_irqwork_txnorm(FAR struct mrf24j40_radio_s *dev)
{
	...
	framepending = (mrf24j40_getreg(dev->spi, MRF24J40_TXNCON) & MRF24J40_TXNCON_FPSTAT);
...
static void mrf24j40_irqwork_txgts(FAR struct mrf24j40_radio_s *dev, uint8_t gts)
{
	uint8_t txstat;
