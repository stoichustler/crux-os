...
struct bcmf_bus_dev_s {
	...
	int (*txframe)(FAR struct bcmf_dev_s *priv, FAR struct bcmf_frame_s *frame, bool control);
	...
	struct bcmf_frame_s *(*allocate_frame)(FAR struct bcmf_dev_s *priv, unsigned int len,
										   bool block, bool control);

	void (*free_frame)(FAR struct bcmf_dev_s *priv, FAR struct bcmf_frame_s *frame);
};
...
int bcmf_wl_set_mac_address(FAR struct bcmf_dev_s *priv, FAR struct ifreq *req);
...
int bcmf_wl_get_scan_results(FAR struct bcmf_dev_s *priv, FAR struct iwreq *iwr);

/* IOCTLs authentication interface implementation */

int bcmf_wl_set_auth_param(FAR struct bcmf_dev_s *priv, FAR struct iwreq *iwr);
