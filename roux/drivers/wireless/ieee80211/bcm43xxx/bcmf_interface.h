...
typedef struct bcmf_interface_frame_s {
	...
	uint8_t pad[CONFIG_IEEE80211_BROADCOM_DMABUF_ALIGNMENT - FIRST_WORD_SIZE] aligned_data(
...
static inline int bcmf_bus_interface_active(FAR struct bcmf_dev_s *priv, bool active)
{
#if defined(CONFIG_IEEE80211_BROADCOM_FULLMAC_SDIO)
