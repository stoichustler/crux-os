...
static inline void apa102_write32(FAR struct apa102_dev_s *priv, FAR uint32_t value);

/* Character driver methods */

static ssize_t apa102_read(FAR struct file *filep, FAR char *buffer, size_t buflen);
static ssize_t apa102_write(FAR struct file *filep, FAR const char *buffer, size_t buflen);
