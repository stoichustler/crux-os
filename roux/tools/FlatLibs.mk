...
ROUXLIBS += staging/libc$(LIBEXT)
ROUXLIBS += staging/libmm$(LIBEXT)
ROUXLIBS += staging/libarch$(LIBEXT)

# Add toolchain library support

ifeq ($(CONFIG_LIB_BUILTIN),y)
ROUXLIBS += staging/libbuiltin$(LIBEXT)
endif

# Add libraries for math support.

ifeq ($(CONFIG_LIBM_TOOLCHAIN)$(CONFIG_LIBM_NONE),)
ROUXLIBS += staging/libm$(LIBEXT)
endif

ifeq ($(CONFIG_LIB_SYSCALL),y)
ROUXLIBS += staging/libstubs$(LIBEXT)
USERLIBS  += staging/libproxies$(LIBEXT)
endif
...
ROUXLIBS += staging/libxx$(LIBEXT)
endif

# Add library for application support.

ifneq ($(APPDIR),)
ROUXLIBS += staging/libapps$(LIBEXT)
endif
