...
EXPORTSUBDIR="roux-export${VERSION}"
...
echo "ROUX_ARCH       = ${ROUX_ARCH}" >>"${EXPORTDIR}/scripts/Make.defs"
echo "ROUX_ARCH_CHIP  = ${ROUX_ARCH_CHIP}" >>"${EXPORTDIR}/scripts/Make.defs"
echo "ROUX_BOARD      = ${ROUX_BOARD}" >>"${EXPORTDIR}/scripts/Make.defs"
echo "ROUX_BUILD      = ${ROUX_BUILD}" >>"${EXPORTDIR}/scripts/Make.defs"
echo "ROUX_CXX        = ${ROUX_CXX}" >>"${EXPORTDIR}/scripts/Make.defs"
...
echo "set(ROUX_ARCH          \"${ROUX_ARCH}\")"       >>"${EXPORTDIR}/scripts/target.cmake"
echo "set(ROUX_ARCH_CHIP     \"${ROUX_ARCH_CHIP}\")"  >>"${EXPORTDIR}/scripts/target.cmake"
echo "set(ROUX_BOARD         \"${ROUX_BOARD}\")"      >>"${EXPORTDIR}/scripts/target.cmake"
echo "set(ROUX_BUILD         \"${ROUX_BUILD}\")"      >>"${EXPORTDIR}/scripts/target.cmake"
echo "set(ROUX_CXX           \"${ROUX_CXX}\")"        >>"${EXPORTDIR}/scripts/target.cmake"
...
# Copy the ROUX include directory (retaining attributes and following symbolic links)
