...
# Helper script to set up host route to ROUX simulator
...
# on the roux executable to allow ROUX to access the tap device:
#
# sudo setcap cap_net_admin+ep ./roux
...
net_on() {
  ...
  # nat to allow ROUX to access the internet
