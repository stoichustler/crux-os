...
Assuming that you already flashed to firmware (roux.bin) with the LWL
...
Currently the lwl driver on ROUX side is doing polling, but for
...
roux/arch/arm/src/common/arm_lwl_console.c for more information.
