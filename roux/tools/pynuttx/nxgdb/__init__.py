############################################################################
# tools/pyroux/nxgdb/__init__.py
#
...
if __name__ == "__main__":
    ...
    gdb.write("Use roux/tools/pyroux/gdbinit.py instead")
    sys.exit(1)
...
def register_commands(event):
    ...
    gdb.write(f"Registering ROUX GDB commands from {here}\n")
...
if len(gdb.objfiles()) == 0:
    gdb.write("No objectfile, defer to register ROUX commands.\n")
