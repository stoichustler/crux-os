...
static void audio_callback(FAR void *priv, uint16_t reason, FAR struct ap_buffer_s *apb,
...
#ifdef CONFIG_AUDIO_MULTI_SESSION
static inline void audio_complete(FAR struct audio_upperhalf_s *upper, FAR struct ap_buffer_s *apb,
								  uint16_t status, FAR void *session)
#else
static inline void audio_complete(FAR struct audio_upperhalf_s *upper, FAR struct ap_buffer_s *apb,
								  uint16_t status)
...
#ifdef CONFIG_AUDIO_MULTI_SESSION
static inline void audio_message(FAR struct audio_upperhalf_s *upper, FAR struct ap_buffer_s *apb,
								 uint16_t status, FAR void *session)
#else
static inline void audio_message(FAR struct audio_upperhalf_s *upper, FAR struct ap_buffer_s *apb,
								 uint16_t status)
...
#ifdef CONFIG_AUDIO_MULTI_SESSION
static inline void audio_ioerr(FAR struct audio_upperhalf_s *upper, FAR struct ap_buffer_s *apb,
							   uint16_t status, FAR void *session)
#else
static inline void audio_ioerr(FAR struct audio_upperhalf_s *upper, FAR struct ap_buffer_s *apb,
							   uint16_t status)
...
#ifdef CONFIG_AUDIO_MULTI_SESSION
static inline void audio_underrun(FAR struct audio_upperhalf_s *upper, FAR struct ap_buffer_s *apb,
								  uint16_t status, FAR void *session)
#else
static inline void audio_underrun(FAR struct audio_upperhalf_s *upper, FAR struct ap_buffer_s *apb,
								  uint16_t status)
...
#ifdef CONFIG_AUDIO_MULTI_SESSION
static void audio_callback(FAR void *handle, uint16_t reason, FAR struct ap_buffer_s *apb,
						   uint16_t status, FAR void *session)
#else
static void audio_callback(FAR void *handle, uint16_t reason, FAR struct ap_buffer_s *apb,
						   uint16_t status)
