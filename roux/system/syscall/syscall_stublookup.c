...
#define STUB_PROT0(f) uintptr_t STUB_NAME(f)(int nbr)
#define STUB_PROT1(f) uintptr_t STUB_NAME(f)(int nbr, uintptr_t parm1)
#define STUB_PROT2(f) uintptr_t STUB_NAME(f)(int nbr, uintptr_t parm1, uintptr_t parm2)
#define STUB_PROT3(f)                                                                              \
	uintptr_t STUB_NAME(f)(int nbr, uintptr_t parm1, uintptr_t parm2, uintptr_t parm3)
#define STUB_PROT4(f)                                                                              \
	uintptr_t STUB_NAME(f)(int nbr, uintptr_t parm1, uintptr_t parm2, uintptr_t parm3,             \
						   uintptr_t parm4)
#define STUB_PROT5(f)                                                                              \
