...
void hmca_md5_init(FAR HMAC_MD5_CTX *ctx, FAR const uint8_t *key, u_int key_len)
{
...
void hmac_md5_update(FAR HMAC_MD5_CTX *ctx, FAR const uint8_t *data, u_int len)
{
...
void hmac_sha1_init(FAR HMAC_SHA1_CTX *ctx, FAR const uint8_t *key, u_int key_len)
{
...
void hmac_sha1_update(FAR HMAC_SHA1_CTX *ctx, FAR const uint8_t *data, u_int len)
{
...
void hmac_sha256_init(FAR HMAC_SHA256_CTX *ctx, FAR const uint8_t *key, u_int key_len)
{
...
void hmac_sha256_update(FAR HMAC_SHA256_CTX *ctx, FAR const uint8_t *data, u_int len)
{
	sha256update(&ctx->ctx, data, len);
}

void hmac_sha256_final(FAR uint8_t *digest, FAR HMAC_SHA256_CTX *ctx)
{
