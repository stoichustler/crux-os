...
static void poly1305_blocks(FAR poly1305_state *st, FAR const unsigned char *m, size_t bytes)
{
...
void poly1305_update(FAR poly1305_state *st, FAR const unsigned char *m, size_t bytes)
{
	size_t i;
