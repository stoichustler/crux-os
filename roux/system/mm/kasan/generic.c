...
#define KASAN_FIRST_WORD_MASK(start) (UINTPTR_MAX << ((start) & (KASAN_BITS_PER_WORD - 1)))
...
static inline_function FAR uintptr_t *kasan_mem_to_shadow(FAR const void *ptr, size_t size,
