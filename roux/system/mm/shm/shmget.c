...
struct shm_info_s g_shminfo = {NXMUTEX_INITIALIZER};
 ...
 *       The ROUX ipc_perm structure, however, does not support these
 *       fields because user and group IDs are not yet supported by ROUX.
 *
 ****************************************************************************/
