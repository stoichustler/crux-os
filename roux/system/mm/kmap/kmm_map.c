...
static int get_user_pages(FAR struct tcb_s *tcb, FAR void **pages, size_t npages, uintptr_t vaddr)
{
	uintptr_t page;
	int i;
...
void kmm_map_initialize(void)
{
	...
	g_kmm_map_vpages =
		gran_initialize((FAR void *)CONFIG_ARCH_KMAP_VBASE, CONFIG_ARCH_KMAP_NPAGES << MM_PGSHIFT,
