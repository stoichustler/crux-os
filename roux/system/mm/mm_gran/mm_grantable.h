...
#define GRAN_INRANGE(g, m) (g->heapstart <= (uintptr_t)(m) && (uintptr_t)(m) < GRANENDA(g))
...
#define NUM_RSRV(g, m, s) (((END_RSRV(g, m, s) - MEM_RSRV(g, m)) >> g->log2gran) + 1)
...
bool gran_match(const gran_t *gran, size_t posi, size_t size, bool used, size_t *mism);
