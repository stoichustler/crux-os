...
#define IOB_ALIGN_SIZE ALIGN_UP(sizeof(struct iob_s) + CONFIG_IOB_BUFSIZE, CONFIG_IOB_ALIGNMENT)
#else
#define IOB_ALIGN_SIZE ALIGN_UP(sizeof(struct iob_s), CONFIG_IOB_ALIGNMENT)
#endif

#define IOB_BUFFER_SIZE (IOB_ALIGN_SIZE * CONFIG_IOB_NBUFFERS + CONFIG_IOB_ALIGNMENT - 1)
...
void iob_initialize(void)
{
	...
	buf =
		ALIGN_UP((uintptr_t)g_iob_buffer + offsetof(struct iob_s, io_data), CONFIG_IOB_ALIGNMENT) -
		offsetof(struct iob_s, io_data);
