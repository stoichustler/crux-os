...
#if !defined(CONFIG_IEEE802154_PRIMITIVE_PREALLOC) || CONFIG_IEEE802154_PRIMITIVE_PREALLOC < 0
#undef CONFIG_IEEE802154_PRIMITIVE_PREALLOC
#define CONFIG_IEEE802154_PRIMITIVE_PREALLOC 20
#endif

#if !defined(CONFIG_IEEE802154_PRIMITIVE_IRQRESERVE) || CONFIG_IEEE802154_PRIMITIVE_IRQRESERVE < 0
...
FAR struct ieee802154_primitive_s *ieee802154_primitive_allocate(void)
{
	...
	/* We were not called from an interrupt handler. */
...
#endif
		{
			...
			leave_critical_section(flags);
			prim = (FAR struct ieee802154_priv_primitive_s *)kmm_malloc(
				(sizeof(struct ieee802154_priv_primitive_s)));
...
#if CONFIG_IEEE802154_PRIMITIVE_PREALLOC > 0
	irqstate_t flags;
	FAR struct ieee802154_priv_primitive_s *priv = (FAR struct ieee802154_priv_primitive_s *)prim;
