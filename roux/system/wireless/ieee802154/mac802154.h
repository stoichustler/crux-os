...
int mac802154_get_mhrlen(MACHANDLE mac, FAR const struct ieee802154_frame_meta_s *meta);
...
int mac802154_req_data(MACHANDLE mac, FAR const struct ieee802154_frame_meta_s *meta,
...
int mac802154_req_disassociate(MACHANDLE mac, FAR struct ieee802154_disassoc_req_s *req);
...
int mac802154_req_rxenable(MACHANDLE mac, FAR struct ieee802154_rxenable_req_s *req);
...
int mac802154_req_get(MACHANDLE mac, enum ieee802154_attr_e, FAR union ieee802154_attr_u *attrval);
...
int mac802154_resp_orphan(MACHANDLE mac, FAR struct ieee802154_orphan_resp_s *resp);
