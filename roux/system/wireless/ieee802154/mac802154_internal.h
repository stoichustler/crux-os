...
#define IEEE802154_SETBLE(ptr, index) IEEE802154_SETBITS_U16(ptr, index, IEEE802154_SFSPEC_BLE)
...
#define IEEE802154_GETBEACONORDER(ptr, index)                                                      \
	((GETHOST16(ptr, index) & IEEE802154_SFSPEC_BEACONORDER) >> IEEE802154_SFSPEC_SHIFT_BEACONORDER)

#define IEEE802154_GETSFORDER(ptr, index)                                                          \
	((GETHOST16(ptr, index) & IEEE802154_SFSPEC_SFORDER) >> IEEE802154_SFSPEC_SHIFT_SFORDER)

#define IEEE802154_GETFINCAPSLOT(ptr, index)                                                       \
	((GETHOST16(ptr, index) & IEEE802154_SFSPEC_FINCAPSLOT) >> IEEE802154_SFSPEC_SHIFT_FINCAPSLOT)

#define IEEE802154_GETBLE(ptr, index)                                                              \
	((GETHOST16(ptr, index) & IEEE802154_SFSPEC_BLE) >> IEEE802154_SFSPEC_SHIFT_BLE)

#define IEEE802154_GETPANCOORD(ptr, index)                                                         \
	((GETHOST16(ptr, index) & IEEE802154_SFSPEC_PANCOORD) >> IEEE802154_SFSPEC_SHIFT_PANCOORD)

#define IEEE802154_GETASSOCPERMIT(ptr, index)                                                      \
	((GETHOST16(ptr, index) & IEEE802154_SFSPEC_ASSOCPERMIT) >> IEEE802154_SFSPEC_SHIFT_ASSOCPERMIT)

/* Helper macros for setting/receiving bits for GTS specification */

#define IEEE802154_GETGTSDESCCOUNT(ptr, index)                                                     \
	((GETHOST16(ptr, index) & IEEE802154_GTSSPEC_DESCCOUNT) >> IEEE802154_GTSSPEC_SHIFT_DESCCOUNT)

#define IEEE802154_GETGTSPERMIT(ptr, index)                                                        \
	((GETHOST16(ptr, index) & IEEE802154_GTSSPEC_PERMIT) >> IEEE802154_GTSSPEC_SHIFT_PERMIT)

/* Helper macros for setting/receiving bits for GTS Directions */

#define IEEE802154_GETGTSDIRMASK(ptr, index)                                                       \
	((GETHOST16(ptr, index) & IEEE802154_GTSDIR_MASK) >> IEEE802154_GTSDIR_SHIFT_MASK)

/* Helper macros for setting/receiving bits for Pending Address */

#define IEEE802154_GETNPENDSADDR(ptr, index)                                                       \
	((GETHOST16(ptr, index) & IEEE802154_PENDADDR_NSADDR) >> IEEE802154_PENDADDR_SHIFT_NSADDR)

#define IEEE802154_GETNPENDEADDR(ptr, index)                                                       \
	((GETHOST16(ptr, index) & IEEE802154_PENDADDR_NEADDR) >> IEEE802154_PENDADDR_SHIFT_NEADDR)
...
static inline uint32_t mac802154_symtoticks(FAR struct ieee802154_privmac_s *priv, uint32_t symbols)
{
	...
	priv->radio->getattr(priv->radio, IEEE802154_ATTR_PHY_SYMBOL_DURATION, &attrval);
...
static inline void mac802154_timerstart(FAR struct ieee802154_privmac_s *priv, uint32_t numsymbols,
										worker_t worker)
{
	...
	work_queue(HPWORK, &priv->timer_work, worker, priv, mac802154_symtoticks(priv, numsymbols));
}
...
static inline void mac802154_setchannel(FAR struct ieee802154_privmac_s *priv, uint8_t channel)
{
	priv->radio->setattr(priv->radio, IEEE802154_ATTR_PHY_CHAN,
						 (FAR const union ieee802154_attr_u *)&channel);
}

static inline void mac802154_setchpage(FAR struct ieee802154_privmac_s *priv, uint8_t chpage)
{
...
static inline void mac802154_setrxonidle(FAR struct ieee802154_privmac_s *priv, bool rxonidle)
{
...
static inline void mac802154_setdevmode(FAR struct ieee802154_privmac_s *priv, uint8_t mode)
{
	priv->devmode = mode;
