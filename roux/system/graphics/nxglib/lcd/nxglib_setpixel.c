...
void NXGL_FUNCNAME(nxgl_setpixel, NXGLIB_SUFFIX)(FAR struct lcd_planeinfo_s *pinfo,
...
#error "Unsupported pixel depth"
	...
	pinfo->putrun(pinfo->dev, pos->y, pos->x, (FAR uint8_t *)&pixel, 8 / NXGLIB_BITSPERPIXEL);
#else
