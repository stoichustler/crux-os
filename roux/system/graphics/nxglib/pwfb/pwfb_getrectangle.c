...
void NXGL_FUNCNAME(pwfb_getrectangle, NXGLIB_SUFFIX)(FAR struct nxbe_window_s *bwnd,
													 ...
													 FAR void *dest, unsigned int deststride)
{
	...
	sline = (FAR uint8_t *)bwnd->fbmem + rect->pt1.y * fbstride + NXGL_SCALEX(rect->pt1.x);
