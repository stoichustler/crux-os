...
static inline void nxgl_copyrun_1bpp(FAR const uint8_t *src, FAR uint8_t *dest,
...
static inline void nxgl_copyrun_2bpp(FAR const uint8_t *src, FAR uint8_t *dest,
									 unsigned int remainder, size_t npixels)
{
	uint8_t indata;
	uint8_t outdata;
...
static inline void nxgl_copyrun_4bpp(FAR const uint8_t *src, FAR uint8_t *dest,
									 unsigned int remainder, size_t npixels)
{
	uint8_t indata;
	uint8_t outdata;
