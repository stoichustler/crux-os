...
static const struct vt100_sequence_s g_vt100sequences[] = {
	{g_erasetoeol, nxterm_erasetoeol, sizeof(g_erasetoeol)}, {NULL, NULL, 0}};
...
FAR const struct vt100_sequence_s *nxterm_vt100part(FAR struct nxterm_state_s *priv, int seqsize)
{
...
static enum nxterm_vt100state_e nxterm_vt100seq(FAR struct nxterm_state_s *priv, int seqsize)
{
	FAR const struct vt100_sequence_s *seq;
