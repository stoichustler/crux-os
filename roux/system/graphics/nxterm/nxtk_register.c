...
static int nxtkcon_fill(FAR struct nxterm_state_s *priv, FAR const struct nxgl_rect_s *rect,
						nxgl_mxpixel_t wcolor[CONFIG_NX_NPLANES]);
#ifndef CONFIG_NX_WRITEONLY
static int nxtkcon_move(FAR struct nxterm_state_s *priv, FAR const struct nxgl_rect_s *rect,
						FAR const struct nxgl_point_s *offset);
#endif
static int nxtkcon_bitmap(FAR struct nxterm_state_s *priv, FAR const struct nxgl_rect_s *dest,
...
static const struct nxterm_operations_s g_nxtkops = {nxtkcon_fill,
#ifndef CONFIG_NX_WRITEONLY
													 nxtkcon_move,
#endif
													 nxtkcon_bitmap};
