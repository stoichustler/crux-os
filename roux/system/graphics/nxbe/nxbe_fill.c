...
static void nxbe_clipfill(FAR struct nxbe_clipops_s *cops, FAR struct nxbe_plane_s *plane,
...
static inline void nxbe_fill_dev(FAR struct nxbe_window_s *wnd, FAR const struct nxgl_rect_s *rect,
								 nxgl_mxpixel_t color[CONFIG_NX_NPLANES])
{
...
#endif
	{
		...
		nxbe_clipper(wnd->above, rect, NX_CLIPORDER_DEFAULT, &info.cops, &wnd->be->plane[i]);
...
static inline void nxbe_fill_pwfb(FAR struct nxbe_window_s *wnd, FAR const struct nxgl_rect_s *rect,
								  nxgl_mxpixel_t color[CONFIG_NX_NPLANES])
{
