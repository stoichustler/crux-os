...
#include <roux/nx/nx.h>
#include <roux/nx/nxglib.h>
#include <roux/nx/nxcursor.h>
#include <roux/nx/nxbe.h>
...
#define NXBE_STATE_MODAL                                                                           \
	(1 << 0) /* Bit 0: One window is in a focused,                                                 \
			  *        modal state */

/* Helpful flag macros */

#define NXBE_STATE_ISMODAL(nxbe) (((nxbe)->flags & NXBE_STATE_MODAL) != 0)
#define NXBE_STATE_SETMODAL(nxbe)                                                                  \
	do {                                                                                           \
		(nxbe)->flags |= NXBE_STATE_MODAL;                                                         \
	} while (0)
...
struct nxbe_dev_vtable_s {
	CODE void (*setpixel)(FAR NX_PLANEINFOTYPE *pinfo, FAR const struct nxgl_point_s *pos,
						  nxgl_mxpixel_t color);
	CODE void (*fillrectangle)(FAR NX_PLANEINFOTYPE *pinfo, FAR const struct nxgl_rect_s *rect,
							   nxgl_mxpixel_t color);
	CODE void (*getrectangle)(FAR NX_PLANEINFOTYPE *pinfo, FAR const struct nxgl_rect_s *rect,
							  FAR void *dest, unsigned int deststride);
	CODE void (*filltrapezoid)(FAR NX_PLANEINFOTYPE *pinfo, FAR const struct nxgl_trapezoid_s *trap,
							   FAR const struct nxgl_rect_s *bounds, nxgl_mxpixel_t color);
	CODE void (*moverectangle)(FAR NX_PLANEINFOTYPE *pinfo, FAR const struct nxgl_rect_s *rect,
							   FAR struct nxgl_point_s *offset);
	CODE void (*copyrectangle)(FAR NX_PLANEINFOTYPE *pinfo, FAR const struct nxgl_rect_s *dest,
...
struct nxbe_pwfb_vtable_s {
	CODE void (*setpixel)(FAR struct nxbe_window_s *bwnd, FAR const struct nxgl_point_s *pos,
						  nxgl_mxpixel_t color);
	CODE void (*fillrectangle)(FAR struct nxbe_window_s *bwnd, FAR const struct nxgl_rect_s *rect,
							   nxgl_mxpixel_t color);
	CODE void (*getrectangle)(FAR struct nxbe_window_s *bwnd, FAR const struct nxgl_rect_s *rect,
							  FAR void *dest, unsigned int deststride);
	CODE void (*filltrapezoid)(FAR struct nxbe_window_s *bwnd,
							   FAR const struct nxgl_trapezoid_s *trap,
							   FAR const struct nxgl_rect_s *bounds, nxgl_mxpixel_t color);
	CODE void (*moverectangle)(FAR struct nxbe_window_s *bwnd, FAR const struct nxgl_rect_s *rect,
							   FAR struct nxgl_point_s *offset);
	CODE void (*copyrectangle)(FAR struct nxbe_window_s *bwnd, FAR const struct nxgl_rect_s *dest,
							   FAR const void *src, FAR const struct nxgl_point_s *origin,
							   unsigned int srcstride);
};
#endif
...
struct nxbe_cursorops_s {
	CODE void (*draw)(FAR struct nxbe_state_s *be, FAR const struct nxgl_rect_s *bounds,
					  int planeno);
	CODE void (*erase)(FAR struct nxbe_state_s *be, FAR const struct nxgl_rect_s *bounds,
					   int planeno);
	CODE void (*backup)(FAR struct nxbe_state_s *be, FAR const struct nxgl_rect_s *bounds,
						int planeno);
};
#endif
...
struct nxbe_clipops_s {
	CODE void (*visible)(FAR struct nxbe_clipops_s *cops, FAR struct nxbe_plane_s *plane,
						 FAR const struct nxgl_rect_s *rect);

	CODE void (*obscured)(FAR struct nxbe_clipops_s *cops, FAR struct nxbe_plane_s *plane,
						  FAR const struct nxgl_rect_s *rect);
};
...
void nxbe_notify_rectangle(FAR NX_DRIVERTYPE *dev, FAR const struct nxgl_rect_s *rect);
#endif
...
void nxbe_cursor_setimage(FAR struct nxbe_state_s *be, FAR struct nx_cursorimage_s *image);
#endif
...
void nxbe_cursor_setposition(FAR struct nxbe_state_s *be, FAR const struct nxgl_point_s *pos);
...
void nxbe_cursor_backupdraw(FAR struct nxbe_window_s *wnd, FAR const struct nxgl_rect_s *rect,
							int plane);
void nxbe_cursor_backupdraw_dev(FAR struct nxbe_state_s *be, FAR const struct nxgl_rect_s *rect,
								int plane);
...
void nxbe_cursor_backupdraw_all(FAR struct nxbe_window_s *wnd, FAR const struct nxgl_rect_s *rect);
void nxbe_cursor_backupdraw_devall(FAR struct nxbe_state_s *be, FAR const struct nxgl_rect_s *rect);
#endif /*  */
...
void nxbe_setposition(FAR struct nxbe_window_s *wnd, FAR const struct nxgl_point_s *pos);
...
void nxbe_setsize(FAR struct nxbe_window_s *wnd, FAR const struct nxgl_size_s *size);
...
void nxbe_setpixel(FAR struct nxbe_window_s *wnd, FAR const struct nxgl_point_s *pos,
...
void nxbe_fill(FAR struct nxbe_window_s *wnd, FAR const struct nxgl_rect_s *rect,
			   nxgl_mxpixel_t color[CONFIG_NX_NPLANES]);
...
void nxbe_filltrapezoid(FAR struct nxbe_window_s *wnd, FAR const struct nxgl_rect_s *clip,
						FAR const struct nxgl_trapezoid_s *trap,
						nxgl_mxpixel_t color[CONFIG_NX_NPLANES]);
...
void nxbe_getrectangle(FAR struct nxbe_window_s *wnd, FAR const struct nxgl_rect_s *rect,
					   unsigned int plane, FAR uint8_t *dest, unsigned int deststride);
...
void nxbe_bitmap_dev(FAR struct nxbe_window_s *wnd, FAR const struct nxgl_rect_s *dest,
					 FAR const void *src[CONFIG_NX_NPLANES], FAR const struct nxgl_point_s *origin,
					 unsigned int stride);
...
#ifdef CONFIG_NX_RAMBACKED
void nxbe_flush(FAR struct nxbe_window_s *wnd, FAR const struct nxgl_rect_s *dest,
				FAR const void *src[CONFIG_NX_NPLANES], FAR const struct nxgl_point_s *origin,
				unsigned int stride);
#endif
...
void nxbe_redraw(FAR struct nxbe_state_s *be, FAR struct nxbe_window_s *wnd,
				 FAR const struct nxgl_rect_s *rect);
...
bool nxbe_isvisible(FAR struct nxbe_window_s *wnd, FAR const struct nxgl_point_s *pos);
...
void nxbe_clipper(FAR struct nxbe_window_s *wnd, FAR const struct nxgl_rect_s *dest, uint8_t order,
				  FAR struct nxbe_clipops_s *cops, FAR struct nxbe_plane_s *plane);
...
void nxbe_clipnull(FAR struct nxbe_clipops_s *cops, FAR struct nxbe_plane_s *plane,
				   FAR const struct nxgl_rect_s *rect);
