...
if(NOT EXISTS ${CMAKE_CURRENT_LIST_DIR}/libmetal)
  FetchContent_Declare(
    ...
    PATCH_COMMAND
      ...
      ${CMAKE_CURRENT_LIST_DIR}/0004-lib-system-roux-fix-unused-parameter-compile-error.patch
      && patch -p0 -d ${CMAKE_CURRENT_LIST_DIR} <
      ${CMAKE_CURRENT_LIST_DIR}/0005-libmetal-cmake-set-HAVE_STDATOMIC_H-default-true-in-.patch
      && patch -p0 -d ${CMAKE_CURRENT_LIST_DIR} <
      ${CMAKE_CURRENT_LIST_DIR}/0006-lib-system-roux-io.c-include-stddef.h-in-roux-io.c.patch
...
roux_create_symlink(${CMAKE_CURRENT_BINARY_DIR}/libmetal/lib/include/metal
                     ${CMAKE_BINARY_DIR}/include/metal)

roux_add_external_library(metal-static MODE KERNEL)
