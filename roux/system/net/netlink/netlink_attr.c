...
static const uint8_t g_nla_attr_len[NLA_TYPE_MAX + 1] = {
	0, sizeof(uint8_t), sizeof(uint16_t), sizeof(uint32_t), sizeof(uint64_t), 0, 0, 0, 0, 0, 0,
	0, sizeof(int8_t),	sizeof(int16_t),  sizeof(int32_t),	sizeof(int64_t),
};
...
static int validate_nla_bitfield32(FAR const struct nlattr *nla, FAR uint32_t *valid_flags_mask)
{
