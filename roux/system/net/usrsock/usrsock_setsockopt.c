...
static uint16_t setsockopt_event(FAR struct net_driver_s *dev, FAR void *pvpriv, uint16_t flags)
{
...
static int do_setsockopt_request(FAR struct usrsock_conn_s *conn, int level, int option,
