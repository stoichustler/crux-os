...
static uint16_t bind_event(FAR struct net_driver_s *dev, FAR void *pvpriv, uint16_t flags)
{
...
static int do_bind_request(FAR struct usrsock_conn_s *conn, FAR const struct sockaddr *addr,
						   socklen_t addrlen)
{
