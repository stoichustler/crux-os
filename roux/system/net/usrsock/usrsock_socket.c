...
static uint16_t socket_event(FAR struct net_driver_s *dev, FAR void *pvpriv, uint16_t flags)
{
...
static int do_socket_request(FAR struct usrsock_conn_s *conn, int domain, int type, int protocol)
{
