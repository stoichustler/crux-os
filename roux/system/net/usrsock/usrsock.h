...
#define USRSOCK_EVENT_INTERNAL_MASK (USRSOCK_EVENT_CONNECT_READY | USRSOCK_EVENT_REQ_COMPLETE)
...
int usrsock_setup_request_callback(FAR struct usrsock_conn_s *conn,
								   ...
								   FAR devif_callback_event_t event, uint16_t flags);
...
void usrsock_setup_datain(FAR struct usrsock_conn_s *conn, FAR struct iovec *iov,
						  unsigned int iovcnt);
...
int usrsock_bind(FAR struct socket *psock, FAR const struct sockaddr *addr, socklen_t addrlen);
...
int usrsock_connect(FAR struct socket *psock, FAR const struct sockaddr *addr, socklen_t addrlen);
...
int usrsock_accept(FAR struct socket *psock, FAR struct sockaddr *addr, FAR socklen_t *addrlen,
...
ssize_t usrsock_sendmsg(FAR struct socket *psock, FAR struct msghdr *msg, int flags);
...
ssize_t usrsock_recvmsg(FAR struct socket *psock, FAR struct msghdr *msg, int flags);
...
int usrsock_getsockopt(FAR struct socket *psock, int level, int option, FAR void *value,
...
int usrsock_setsockopt(FAR struct socket *psock, int level, int option, FAR const void *value,
					   socklen_t value_len);
...
int usrsock_getsockname(FAR struct socket *psock, FAR struct sockaddr *addr,
...
int usrsock_getpeername(FAR struct socket *psock, FAR struct sockaddr *addr,
						FAR socklen_t *addrlen);
