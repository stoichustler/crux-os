...
const net_ipv6addr_t g_ipv6_loopback = /* An address of loopback */
	{0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, HTONS(0x0001)};

/* IPv6 Multi-cast IP addresses.  See RFC 2375 */

const net_ipv6addr_t g_ipv6_allnodes = /* All link local nodes */
	{HTONS(0xff02), 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, HTONS(0x0001)};
...
const net_ipv6addr_t g_ipv6_allrouters = /* All link local routers */
	{HTONS(0xff02), 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, HTONS(0x0002)};
...
const net_ipv6addr_t g_ipv6_allmldv2routers = /* All MLDv2 link local routers */
	{HTONS(0xff02), 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, HTONS(0x0016)};
#endif
