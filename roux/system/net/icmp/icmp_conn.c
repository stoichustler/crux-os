...
NET_BUFPOOL_DECLARE(g_icmp_connections, sizeof(struct icmp_conn_s), CONFIG_NET_ICMP_PREALLOC_CONNS,
...
{
	FAR struct icmp_conn_s *conn = (FAR struct icmp_conn_s *)g_active_icmp_connections.head;
