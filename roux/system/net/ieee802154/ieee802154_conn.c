...
NET_BUFPOOL_DECLARE(g_ieee802154_connections, sizeof(struct ieee802154_conn_s),
					CONFIG_NET_IEEE802154_PREALLOC_CONNS, CONFIG_NET_IEEE802154_ALLOC_CONNS,
...
FAR struct ieee802154_conn_s *ieee802154_conn_active(FAR const struct ieee802154_data_ind_s *meta)
{
	...
	for (conn = (FAR struct ieee802154_conn_s *)g_active_ieee802154_connections.head; conn != NULL;
...
{
	if (!conn) {
		return (FAR struct ieee802154_conn_s *)g_active_ieee802154_connections.head;
	} else {
