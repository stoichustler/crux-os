...
FAR struct ieee802154_conn_s *ieee802154_conn_active(FAR const struct ieee802154_data_ind_s *meta);
...
FAR struct ieee802154_conn_s *ieee802154_conn_next(FAR struct ieee802154_conn_s *conn);
...
/* ieee802154_input() is prototyped in include/roux/net/ieee802154.h */
...
uint16_t ieee802154_callback(FAR struct radio_driver_s *radio, FAR struct ieee802154_conn_s *conn,
							 uint16_t flags);
...
ssize_t ieee802154_recvmsg(FAR struct socket *psock, FAR struct msghdr *msg, int flags);
...
FAR struct radio_driver_s *ieee802154_find_device(FAR struct ieee802154_conn_s *conn,
...
void ieee802154_poll(FAR struct net_driver_s *dev, FAR struct ieee802154_conn_s *conn);
