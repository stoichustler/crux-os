...
static int ieee802154_queue_frame(FAR struct ieee802154_conn_s *conn, FAR struct iob_s *frame,
...
int ieee802154_input(FAR struct radio_driver_s *radio, FAR struct iob_s *framelist,
					 FAR struct ieee802154_data_ind_s *meta)
{
