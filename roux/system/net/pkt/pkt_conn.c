...
NET_BUFPOOL_DECLARE(g_pkt_connections, sizeof(struct pkt_conn_s), CONFIG_NET_PKT_PREALLOC_CONNS,
...
{
	FAR struct pkt_conn_s *conn = (FAR struct pkt_conn_s *)g_active_pkt_connections.head;
