...
uint16_t pkt_callback(FAR struct net_driver_s *dev, FAR struct pkt_conn_s *conn, uint16_t flags);
...
/* pkt_input() is prototyped in include/roux/net/pkt.h */
...
ssize_t pkt_sendmsg(FAR struct socket *psock, FAR struct msghdr *msg, int flags);
