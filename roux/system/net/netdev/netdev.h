...
#ifdef CONFIG_NET_IPv4
FAR struct net_driver_s *netdev_findby_ripv4addr(in_addr_t lipaddr, in_addr_t ripaddr);
#endif
...
#ifdef CONFIG_NETDOWN_NOTIFIER
int netdown_notifier_setup(worker_t worker, FAR struct net_driver_s *dev, FAR void *arg);
#endif
...
void netdev_ipv6_addmcastmac(FAR struct net_driver_s *dev, const net_ipv6addr_t addr);
void netdev_ipv6_removemcastmac(FAR struct net_driver_s *dev, const net_ipv6addr_t addr);
#else
