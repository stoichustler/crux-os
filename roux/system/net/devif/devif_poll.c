...
static void devif_packet_conversion(FAR struct net_driver_s *dev, enum devif_packet_type pkttype)
{
	if (dev->d_len > 0) {
...
static int devif_poll_local_out(FAR struct net_driver_s *dev, devif_poll_callback_t callback)
{
...
static int devif_poll_pkt_connections(FAR struct net_driver_s *dev, devif_poll_callback_t callback)
{
...
static int devif_poll_can_connections(FAR struct net_driver_s *dev, devif_poll_callback_t callback)
{
...
static inline int devif_poll_icmp(FAR struct net_driver_s *dev, devif_poll_callback_t callback)
{
...
static inline int devif_poll_icmpv6(FAR struct net_driver_s *dev, devif_poll_callback_t callback)
{
...
static inline int devif_poll_forward(FAR struct net_driver_s *dev, devif_poll_callback_t callback)
{
...
static inline int devif_poll_igmp(FAR struct net_driver_s *dev, devif_poll_callback_t callback)
{
...
static inline int devif_poll_mld(FAR struct net_driver_s *dev, devif_poll_callback_t callback)
{
...
static int devif_poll_udp_connections(FAR struct net_driver_s *dev, devif_poll_callback_t callback)
{
...
static int devif_poll_ipfrag(FAR struct net_driver_s *dev, devif_poll_callback_t callback)
{
...
static int devif_poll_connections(FAR struct net_driver_s *dev, devif_poll_callback_t callback)
{
	int bstop = false;
...
static int devif_iob_poll(FAR struct net_driver_s *dev, devif_poll_callback_t callback)
{
	int bstop;
...
int devif_poll_out(FAR struct net_driver_s *dev, devif_poll_callback_t callback)
{
	int bstop;
...
#if (defined(CONFIG_NET_IPv6) && defined(CONFIG_NET_ICMPv6) &&                                     \
	 !defined(CONFIG_NET_ICMPv6_NO_STACK) && CONFIG_NET_ICMPv6_PMTU_ENTRIES > 0)
	if (IFF_IS_IPv6(dev->d_flags)) {
		FAR struct ipv6_hdr_s *ipv6 = IPv6BUF;

		if (!net_ipv6addr_cmp(ipv6->destipaddr, g_ipv6_unspecaddr)) {
			FAR struct icmpv6_pmtu_entry *entry = icmpv6_find_pmtu_entry(ipv6->destipaddr);
...
#if (defined(CONFIG_NET_IPv4) && defined(CONFIG_NET_ICMP) && !defined(CONFIG_NET_ICMP_NO_STACK) && \
