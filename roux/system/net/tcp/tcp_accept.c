...
static inline void accept_tcpsender(FAR struct tcp_conn_s *listener, FAR struct tcp_conn_s *conn,
...
static int accept_eventhandler(FAR struct tcp_conn_s *listener, FAR struct tcp_conn_s *conn)
{
	...
	if (pstate) {
		...
		accept_tcpsender(listener, conn, pstate->acpt_addr, pstate->acpt_addrlen);
