...
typedef int (*route_handler_ipv4_t)(FAR struct net_route_ipv4_s *route, FAR void *arg);
...
#ifdef CONFIG_NET_IPv4
int net_ipv4_router(in_addr_t target, FAR in_addr_t *router, int8_t prefixlen);
#endif
...
#ifdef CONFIG_NET_IPv6
int net_ipv6_router(const net_ipv6addr_t target, net_ipv6addr_t router, int16_t prefixlen);
#endif
...
#ifdef CONFIG_NET_IPv4
struct net_driver_s;
void netdev_ipv4_router(FAR struct net_driver_s *dev, in_addr_t target, FAR in_addr_t *router);
#endif
...
#ifdef CONFIG_NET_IPv6
struct net_driver_s;
void netdev_ipv6_router(FAR struct net_driver_s *dev, FAR const net_ipv6addr_t target,
