...
#ifdef CONFIG_ROUTE_IPv4_RAMROUTE
static struct net_route_ipv4_entry_s g_prealloc_ipv4routes[CONFIG_ROUTE_MAX_IPv4_RAMROUTES];
#endif

#ifdef CONFIG_ROUTE_IPv6_RAMROUTE
static struct net_route_ipv6_entry_s g_prealloc_ipv6routes[CONFIG_ROUTE_MAX_IPv6_RAMROUTES];
#endif
...
void net_freeroute_ipv4(FAR struct net_route_ipv4_s *route)
{
	...
	ramroute_ipv4_addlast((FAR struct net_route_ipv4_entry_s *)route, &g_free_ipv4routes);
	net_unlock();
}
#endif
...
void net_freeroute_ipv6(FAR struct net_route_ipv6_s *route)
{
	...
	ramroute_ipv6_addlast((FAR struct net_route_ipv6_entry_s *)route, &g_free_ipv6routes);
	net_unlock();
}
#endif
