...
FAR struct net_route_ipv4_entry_s *ramroute_ipv4_remfirst(FAR struct net_route_ipv4_queue_s *list);
FAR struct net_route_ipv4_entry_s *ramroute_ipv4_remafter(FAR struct net_route_ipv4_entry_s *entry,
														  FAR struct net_route_ipv4_queue_s *list);
#endif
...
FAR struct net_route_ipv6_entry_s *ramroute_ipv6_remfirst(FAR struct net_route_ipv6_queue_s *list);
FAR struct net_route_ipv6_entry_s *ramroute_ipv6_remafter(FAR struct net_route_ipv6_entry_s *entry,
														  FAR struct net_route_ipv6_queue_s *list);
#endif
