...
void neighbor_add(FAR struct net_driver_s *dev, FAR net_ipv6addr_t ipaddr, FAR uint8_t *addr);
...
int neighbor_lookup(FAR const net_ipv6addr_t ipaddr, FAR struct neighbor_addr_s *laddr);
...
unsigned int neighbor_snapshot(FAR struct neighbor_entry_s *snapshot, unsigned int nentries);
#endif
