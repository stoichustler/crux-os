...
static int mld_group_startup(FAR const struct ipv6_mreq *mrec, FAR struct net_driver_s *dev,
...
int mld_joingroup(FAR const struct ipv6_mreq *mrec)
{
	...
	mldinfo("Join group: %04x:%04x:%04x:%04x:%04x:%04x:%04x:%04x\n",
			NTOHS(mrec->ipv6mr_multiaddr.s6_addr16[0]), NTOHS(mrec->ipv6mr_multiaddr.s6_addr16[1]),
			NTOHS(mrec->ipv6mr_multiaddr.s6_addr16[2]), NTOHS(mrec->ipv6mr_multiaddr.s6_addr16[3]),
			NTOHS(mrec->ipv6mr_multiaddr.s6_addr16[4]), NTOHS(mrec->ipv6mr_multiaddr.s6_addr16[5]),
			NTOHS(mrec->ipv6mr_multiaddr.s6_addr16[6]), NTOHS(mrec->ipv6mr_multiaddr.s6_addr16[7]));
