...
NET_BUFPOOL_DECLARE(g_fwdpool, sizeof(struct forward_s), CONFIG_NET_IPFORWARD_NSTRUCT,
					CONFIG_NET_IPFORWARD_ALLOC_STRUCT, CONFIG_IOB_NBUFFERS - CONFIG_IOB_THROTTLE);
