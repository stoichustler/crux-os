...
FAR struct bluetooth_conn_s *bluetooth_conn_active(FAR const struct bluetooth_frame_meta_s *meta);
...
FAR struct bluetooth_conn_s *bluetooth_conn_next(FAR struct bluetooth_conn_s *conn);
...
/* bluetooth_input() is prototyped in include/roux/net/bluetooth.h */
...
uint16_t bluetooth_callback(FAR struct radio_driver_s *radio, FAR struct bluetooth_conn_s *conn,
							uint16_t flags);
...
ssize_t bluetooth_recvmsg(FAR struct socket *psock, FAR struct msghdr *msg, int flags);
...
FAR struct radio_driver_s *bluetooth_find_device(FAR struct bluetooth_conn_s *conn,
...
void bluetooth_poll(FAR struct net_driver_s *dev, FAR struct bluetooth_conn_s *conn);
