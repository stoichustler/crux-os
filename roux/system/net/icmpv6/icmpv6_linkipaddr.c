...
static inline void icmpv6_linkipaddr_0(FAR struct net_driver_s *dev, net_ipv6addr_t ipaddr)
{
...
static inline void icmpv6_linkipaddr_1(FAR const void *mac_, net_ipv6addr_t ipaddr)
{
...
static inline void icmpv6_linkipaddr_2(FAR const void *mac_, net_ipv6addr_t ipaddr)
{
	FAR const uint8_t *mac = mac_;
...
static inline void icmpv6_linkipaddr_6(FAR const void *mac_, net_ipv6addr_t ipaddr)
{
	FAR const uint8_t *mac = mac_;
...
static inline void icmpv6_linkipaddr_8(FAR const void *mac_, net_ipv6addr_t ipaddr)
{
	FAR const uint8_t *mac = mac_;
