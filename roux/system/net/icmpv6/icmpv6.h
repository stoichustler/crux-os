...
typedef CODE int (*icmpv6_callback_t)(FAR struct icmpv6_conn_s *conn, FAR void *arg);
#endif
...
#ifdef CONFIG_NET_ICMPv6_NEIGHBOR
int icmpv6_neighbor(FAR struct net_driver_s *dev, const net_ipv6addr_t ipaddr);
#else
...
void icmpv6_solicit(FAR struct net_driver_s *dev, FAR const net_ipv6addr_t ipaddr);
...
void icmpv6_advertise(FAR struct net_driver_s *dev, const net_ipv6addr_t tgtaddr,
...
#ifdef CONFIG_NET_ICMPv6_NEIGHBOR
void icmpv6_wait_setup(const net_ipv6addr_t ipaddr, FAR struct icmpv6_notify_s *notify);
#else
...
#ifdef CONFIG_NET_ICMPv6_AUTOCONF
void icmpv6_setaddresses(FAR struct net_driver_s *dev, const net_ipv6addr_t draddr,
...
#ifdef CONFIG_NET_ICMPv6_AUTOCONF
void icmpv6_rwait_setup(FAR struct net_driver_s *dev, FAR struct icmpv6_rnotify_s *notify);
#else
...
#ifdef CONFIG_NET_ICMPv6_SOCKET
ssize_t icmpv6_sendmsg(FAR struct socket *psock, FAR struct msghdr *msg, int flags);
#endif
...
#ifdef CONFIG_NET_ICMPv6_SOCKET
ssize_t icmpv6_recvmsg(FAR struct socket *psock, FAR struct msghdr *msg, int flags);
#endif
...
FAR struct icmpv6_pmtu_entry *icmpv6_find_pmtu_entry(net_ipv6addr_t destipaddr);
