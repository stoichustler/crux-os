...
static const uint16_t g_icmpv_mcastaddr[6] = {HTONS(0xff02), HTONS(0x0000), HTONS(0x0000),
											  HTONS(0x0000), HTONS(0x0000), HTONS(0x0001)};
...
void icmpv6_solicit(FAR struct net_driver_s *dev, FAR const net_ipv6addr_t ipaddr)
{
	...
	ipv6_build_header(IPv6BUF, l3size, IP_PROTO_ICMP6, netdev_ipv6_srcaddr(dev, ipaddr), dstaddr,
					  255, 0);
