...
ssize_t psock_6lowpan_tcp_send(FAR struct socket *psock, FAR const void *buf, size_t len);
#endif
...
void sixlowpan_icmpv6_send(FAR struct net_driver_s *dev, FAR struct net_driver_s *fwddev,
						   FAR struct ipv6_hdr_s *ipv6);
#endif
...
ssize_t psock_6lowpan_udp_send(FAR struct socket *psock, FAR const void *buf, size_t len);
#endif
...
ssize_t psock_6lowpan_udp_sendto(FAR struct socket *psock, FAR const void *buf, size_t len,
