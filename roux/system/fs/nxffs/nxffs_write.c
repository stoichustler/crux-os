...
static inline int nxffs_hdrerased(FAR struct nxffs_volume_s *volume,
								  FAR struct nxffs_wrfile_s *wrfile, size_t size)
{
	int ret;
...
static inline ssize_t nxffs_wrappend(FAR struct nxffs_volume_s *volume,
									 FAR struct nxffs_wrfile_s *wrfile, FAR const char *buffer,
									 size_t buflen)
{
	ssize_t maxsize;
...
static inline ssize_t nxffs_zappend(FAR struct nxffs_volume_s *volume,
									FAR struct nxffs_wrfile_s *wrfile, off_t nzeros)
{
	ssize_t maxsize;
 ...
 *
 * Description:
 *   This is an implementation of the ROUX standard file system write
 *   method.
 *
 ****************************************************************************/
