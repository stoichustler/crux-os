...
static ssize_t nxffs_rdseek(FAR struct nxffs_volume_s *volume, FAR struct nxffs_entry_s *entry,
							off_t fpos, FAR struct nxffs_blkentry_s *blkentry)
{
	size_t datstart;
	size_t datend;
	off_t offset;
 ...
 *
 * Description:
 *   This is an implementation of the ROUX standard file system read
 *   method.
 *
 ****************************************************************************/
