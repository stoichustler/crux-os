...
#ifdef CONFIG_MTD
int register_partition_with_mtd(FAR const char *partition, mode_t mode,
								FAR struct mtd_dev_s *parent, off_t firstblock, off_t nblocks);
#endif
...
#ifdef CONFIG_MTD
int mtd_proxy(FAR const char *mtddev, int mountflags, FAR struct inode **ppinode);
#endif
