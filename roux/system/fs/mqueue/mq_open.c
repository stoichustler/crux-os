...
static int nxmq_file_poll(FAR struct file *filep, FAR struct pollfd *fds, bool setup);
...
static int file_mq_vopen(FAR struct file *mq, FAR const char *mq_name, int oflags, mode_t umask,
						 va_list ap, FAR int *created)
{
