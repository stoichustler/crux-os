...
static ssize_t skel_write(FAR struct file *filep, FAR const char *buffer, size_t buflen);
...
static int skel_readdir(FAR struct fs_dirent_s *dir, FAR struct dirent *entry);
...
static int skel_opendir(FAR const char *relpath, FAR struct fs_dirent_s **dir)
{
	...
	level1 = (FAR struct skel_level1_s *)fs_heap_zalloc(sizeof(struct skel_level1_s));
