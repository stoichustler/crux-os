...
static ssize_t sock_file_read(FAR struct file *filep, FAR char *buffer, size_t buflen);
static ssize_t sock_file_write(FAR struct file *filep, FAR const char *buffer, size_t buflen);
static int sock_file_ioctl(FAR struct file *filep, int cmd, unsigned long arg);
static int sock_file_poll(FAR struct file *filep, struct pollfd *fds, bool setup);
...
static struct inode g_sock_inode = {NULL,					/* i_parent */
									NULL,					/* i_peer */
									NULL,					/* i_child */
									1,						/* i_crefs */
...
static int sock_file_poll(FAR struct file *filep, FAR struct pollfd *fds, bool setup)
{
