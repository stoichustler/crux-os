...
static int file_shm_open(FAR struct file *shm, FAR const char *name, int oflags, mode_t mode)
{
	...
	snprintf(fullpath, sizeof(fullpath), CONFIG_FS_SHMFS_VFS_PATH "/%s", name);
