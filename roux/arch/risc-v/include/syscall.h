...
static inline uintptr_t sys_call0(unsigned int nbr)
{
	...
	asm volatile("ecall" ::"r"(r0) : "memory");
...
static inline uintptr_t sys_call1(unsigned int nbr, uintptr_t parm1)
{
	...
	asm volatile("ecall" ::"r"(r0), "r"(r1) : "memory");
...
static inline uintptr_t sys_call2(unsigned int nbr, uintptr_t parm1, uintptr_t parm2)
{
	...
	asm volatile("ecall" ::"r"(r0), "r"(r1), "r"(r2) : "memory");
								  ...
								  uintptr_t parm3)
{
	...
	asm volatile("ecall" ::"r"(r0), "r"(r1), "r"(r2), "r"(r3) : "memory");
								  ...
								  uintptr_t parm3, uintptr_t parm4, uintptr_t parm5)
{
	...
	asm volatile("ecall" ::"r"(r0), "r"(r1), "r"(r2), "r"(r3), "r"(r4), "r"(r5) : "memory");
								  ...
								  uintptr_t parm6)
{
	...
	asm volatile("ecall" ::"r"(r0), "r"(r1), "r"(r2), "r"(r3), "r"(r4), "r"(r5), "r"(r6)
				 : "memory");
