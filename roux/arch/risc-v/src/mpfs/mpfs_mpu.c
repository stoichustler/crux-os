...
#define MPFS_MPUCFG_MODE_MASK (((1ul << MPFS_MPUCFG_MODE_WIDTH) - 1) << MPFS_MPUCFG_MODE_SHIFT)

/* PMP entry bits [35:0] */

#define MPFS_MPUCFG_PMP_SHIFT 0
#define MPFS_MPUCFG_PMP_WIDTH 36
#define MPFS_MPUCFG_PMP_MASK (((1ul << MPFS_MPUCFG_PMP_WIDTH) - 1) << MPFS_MPUCFG_PMP_SHIFT)
...
int mpfs_mpu_set(uintptr_t reg, uintptr_t perm, uintptr_t base, uintptr_t size)
{
	uintptr_t mode;
	uintptr_t napot;
...
bool mpfs_mpu_access_ok(uintptr_t reg, uintptr_t perm, uintptr_t base, uintptr_t size)
{
	uintptr_t mode;
	uintptr_t napot;
	uintptr_t reg_base;
