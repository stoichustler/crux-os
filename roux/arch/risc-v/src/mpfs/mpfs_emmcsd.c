...
#include <roux/semaphore.h>
#include <roux/signal.h>
#include <roux/mmcsd.h>
#include <roux/irq.h>
...
#define MPFS_EMMCSD_CARD_INTS                                                                      \
	(MPFS_EMMCSD_SRS14_CINT_IE | MPFS_EMMCSD_SRS14_CIN_IE | MPFS_EMMCSD_SRS14_CR_IE)

#define MPFS_EMMCSD_CMDDONE_STA (MPFS_EMMCSD_SRS12_CC)

#define MPFS_EMMCSD_RESPDONE_STA (MPFS_EMMCSD_SRS12_ECT | MPFS_EMMCSD_SRS12_ECCRC)

#define MPFS_EMMCSD_XFRDONE_STA (MPFS_EMMCSD_SRS12_TC)

#define MPFS_EMMCSD_CMDDONE_MASK (MPFS_EMMCSD_CARD_INTS | MPFS_EMMCSD_SRS14_CC_IE)

#define MPFS_EMMCSD_RESPDONE_MASK                                                                  \
	(MPFS_EMMCSD_CARD_INTS | MPFS_EMMCSD_SRS14_ECCRC_IE | MPFS_EMMCSD_SRS14_ECT_IE)

#define MPFS_EMMCSD_XFRDONE_MASK (MPFS_EMMCSD_CARD_INTS | MPFS_EMMCSD_SRS14_TC_IE)

#define MPFS_EMMCSD_CMDDONE_ICR (MPFS_EMMCSD_SRS12_CC)

#define MPFS_EMMCSD_RESPDONE_ICR (MPFS_EMMCSD_SRS12_ECT | MPFS_EMMCSD_SRS12_ECCRC)

#define MPFS_EMMCSD_XFRDONE_ICR                                                                    \
	(MPFS_EMMCSD_SRS12_EDCRC | MPFS_EMMCSD_SRS12_EDT | MPFS_EMMCSD_SRS12_TC)

#define MPFS_EMMCSD_WAITALL_ICR                                                                    \
	(MPFS_EMMCSD_CMDDONE_ICR | MPFS_EMMCSD_RESPDONE_ICR | MPFS_EMMCSD_XFRDONE_ICR)

#define MPFS_EMMCSD_RECV_MASKDMA                                                                   \
	(MPFS_EMMCSD_CARD_INTS | MPFS_EMMCSD_SRS14_EADMA_IE | MPFS_EMMCSD_SRS14_DMAINT_IE |            \
	 MPFS_EMMCSD_SRS14_EDT_IE | MPFS_EMMCSD_SRS14_ECT_IE | MPFS_EMMCSD_SRS14_BRR_IE |              \
	 MPFS_EMMCSD_SRS14_TC_IE)

#define MPFS_EMMCSD_RECV_MASK                                                                      \
	(MPFS_EMMCSD_CARD_INTS | MPFS_EMMCSD_SRS14_EDT_IE | MPFS_EMMCSD_SRS14_ECT_IE |                 \
	 MPFS_EMMCSD_SRS14_BRR_IE | MPFS_EMMCSD_SRS14_TC_IE)

#define MPFS_EMMCSD_SEND_MASKDMA                                                                   \
	(MPFS_EMMCSD_CARD_INTS | MPFS_EMMCSD_SRS14_EADMA_IE | MPFS_EMMCSD_SRS14_DMAINT_IE |            \
	 MPFS_EMMCSD_SRS14_EDT_IE | MPFS_EMMCSD_SRS14_ECT_IE | MPFS_EMMCSD_SRS14_BWR_IE |              \
	 MPFS_EMMCSD_SRS14_TC_IE)

#define MPFS_EMMCSD_SEND_MASK                                                                      \
	(MPFS_EMMCSD_CARD_INTS | MPFS_EMMCSD_SRS14_EDT_IE | MPFS_EMMCSD_SRS14_ECT_IE |                 \
	 MPFS_EMMCSD_SRS14_BWR_IE | MPFS_EMMCSD_SRS14_TC_IE)
...
#define MPFS_SYSREG_IOMUX1 (MPFS_SYSREG_BASE + MPFS_SYSREG_IOMUX1_CR_OFFSET)
#define MPFS_SYSREG_IOMUX2 (MPFS_SYSREG_BASE + MPFS_SYSREG_IOMUX2_CR_OFFSET)
#define MPFS_SYSREG_IOMUX6 (MPFS_SYSREG_BASE + MPFS_SYSREG_IOMUX6_CR_OFFSET)
#define MPFS_SYSREG_B4_CFG (MPFS_SYSREG_BASE + MPFS_SYSREG_MSSIO_BANK4_CFG_CR)
#define MPFS_SYSREG_B4_0_1 (MPFS_SYSREG_BASE + MPFS_SYSREG_MSSIO_BANK4_IO_CFG_0_1_CR_OFFSET)
#define MPFS_SYSREG_B4_2_3 (MPFS_SYSREG_BASE + MPFS_SYSREG_MSSIO_BANK4_IO_CFG_2_3_CR_OFFSET)
#define MPFS_SYSREG_B4_4_5 (MPFS_SYSREG_BASE + MPFS_SYSREG_MSSIO_BANK4_IO_CFG_4_5_CR_OFFSET)
#define MPFS_SYSREG_B4_6_7 (MPFS_SYSREG_BASE + MPFS_SYSREG_MSSIO_BANK4_IO_CFG_6_7_CR_OFFSET)
#define MPFS_SYSREG_B4_8_9 (MPFS_SYSREG_BASE + MPFS_SYSREG_MSSIO_BANK4_IO_CFG_8_9_CR_OFFSET)
#define MPFS_SYSREG_B4_10_11 (MPFS_SYSREG_BASE + MPFS_SYSREG_MSSIO_BANK4_IO_CFG_10_11_CR_OFFSET)
#define MPFS_SYSREG_4_12_13 (MPFS_SYSREG_BASE + MPFS_SYSREG_MSSIO_BANK4_IO_CFG_12_13_CR_OFFSET)
...
static void mpfs_blocksetup(struct sdio_dev_s *dev, unsigned int blocksize, unsigned int nblocks);
#endif
static int mpfs_recvsetup(struct sdio_dev_s *dev, uint8_t *buffer, size_t nbytes);
static int mpfs_sendsetup(struct sdio_dev_s *dev, const uint8_t *buffer, size_t nbytes);
static int mpfs_cancel(struct sdio_dev_s *dev);

static int mpfs_waitresponse(struct sdio_dev_s *dev, uint32_t cmd);
static int mpfs_recvshortcrc(struct sdio_dev_s *dev, uint32_t cmd, uint32_t *rshort);
static int mpfs_recvlong(struct sdio_dev_s *dev, uint32_t cmd, uint32_t rlong[4]);
static int mpfs_recvshort(struct sdio_dev_s *dev, uint32_t cmd, uint32_t *rshort);

/* Event handler */

static void mpfs_waitenable(struct sdio_dev_s *dev, sdio_eventset_t eventset, uint32_t timeout);
static sdio_eventset_t mpfs_eventwait(struct sdio_dev_s *dev);
static void mpfs_callbackenable(struct sdio_dev_s *dev, sdio_eventset_t eventset);
static int mpfs_registercallback(struct sdio_dev_s *dev, worker_t callback, void *arg);

/* DMA */

#if defined(CONFIG_SDIO_DMA)
static int mpfs_dmarecvsetup(struct sdio_dev_s *dev, uint8_t *buffer, size_t buflen);
static int mpfs_dmasendsetup(struct sdio_dev_s *dev, const uint8_t *buffer, size_t buflen);
#endif
...
static void mpfs_reset_lines(struct mpfs_dev_s *priv)
{
	...
	modifyreg32(MPFS_EMMCSD_SRS11, 0, MPFS_EMMCSD_SRS11_SRDAT | MPFS_EMMCSD_SRS11_SRCMD);

	do {
		status = getreg32(MPFS_EMMCSD_SRS11);
	} while ((status & (MPFS_EMMCSD_SRS11_SRDAT | MPFS_EMMCSD_SRS11_SRCMD)) && --retries);
...
static bool mpfs_check_lines_busy(struct mpfs_dev_s *priv)
{
	...
	} while (srs9 & (MPFS_EMMCSD_SRS09_CICMD | MPFS_EMMCSD_SRS09_CIDAT) && --retries);
...
static void mpfs_setclkrate(struct mpfs_dev_s *priv, uint32_t clkrate)
{
	...
	for (i = 1; i < 2046; i++) {
		if (((baseclk / i) < clkrate) || (((baseclk / i) == clkrate) && ((baseclk % i) == 0u))) {
			break;
		}
	}
	...
	settings = (divider & 0xff00u) | ((divider & 0x30000u) >> 10) | MPFS_EMMCSD_SRS11_ICE;
	...
	modifyreg32(MPFS_EMMCSD_SRS11,
				MPFS_EMMCSD_SRS11_SDCFSL | MPFS_EMMCSD_SRS11_SDCFSH | MPFS_EMMCSD_SRS11_ICE,
				settings);
...
static void mpfs_configwaitints(struct mpfs_dev_s *priv, uint32_t waitmask,
								sdio_eventset_t waitevents, sdio_eventset_t wkupevent)
{
	irqstate_t flags;
...
static void mpfs_endwait(struct mpfs_dev_s *priv, sdio_eventset_t wkupevent)
{
	mcinfo("wkupevent: %u\n", wkupevent);
...
static void mpfs_endtransfer(struct mpfs_dev_s *priv, sdio_eventset_t wkupevent)
{
	...
	putreg32(MPFS_EMMCSD_SRS12_BRR | MPFS_EMMCSD_SRS12_BWR | MPFS_EMMCSD_SRS12_DMAINT,
			 MPFS_EMMCSD_SRS12);
...
static int mpfs_emmcsd_interrupt(int irq, void *context, void *arg)
{
	...
	if (status & MPFS_EMMCSD_SRS12_EINT) {
		if (status & MPFS_EMMCSD_SRS12_EDCRC) {
			...
			mpfs_endtransfer(priv, SDIOWAIT_TRANSFERDONE | SDIOWAIT_TIMEOUT);
		} else if (status & MPFS_EMMCSD_SRS12_EADMA) {
			/* Handle DMA error */

			mcerr("ERROR: DMA error: %08" PRIx32 " SRS21: %08" PRIx32 "\n", status,
				  getreg32(MPFS_EMMCSD_SRS21));
...
static void mpfs_set_data_timeout(struct mpfs_dev_s *priv, uint32_t timeout_us)
{
...
static void mpfs_set_sdhost_power(struct mpfs_dev_s *priv, uint32_t voltage)
{
	...
	case MPFS_EMMCSD_SRS10_3_3V_BUS_VOLTAGE:
		...
		modifyreg32(MPFS_EMMCSD_SRS10, MPFS_EMMCSD_SRS10_BVS,
					MPFS_EMMCSD_SRS10_3_3V_BUS_VOLTAGE | MPFS_EMMCSD_SRS10_BP);
		break;
	case MPFS_EMMCSD_SRS10_3_0V_BUS_VOLTAGE:
		DEBUGASSERT(srs16 & MPFS_EMMCSD_SRS16_VS30);
		modifyreg32(MPFS_EMMCSD_SRS10, MPFS_EMMCSD_SRS10_BVS,
					MPFS_EMMCSD_SRS10_3_0V_BUS_VOLTAGE | MPFS_EMMCSD_SRS10_BP);
		break;
	case MPFS_EMMCSD_SRS10_1_8V_BUS_VOLTAGE:
		DEBUGASSERT(srs16 & MPFS_EMMCSD_SRS16_VS18);
		modifyreg32(MPFS_EMMCSD_SRS10, MPFS_EMMCSD_SRS10_BVS,
					MPFS_EMMCSD_SRS10_1_8V_BUS_VOLTAGE | MPFS_EMMCSD_SRS10_BP);
		break;
	default:
		DEBUGPANIC();
	}
...
static void mpfs_sdcard_init(struct mpfs_dev_s *priv)
{
	...
	putreg32(LIBERO_SETTING_MSSIO_BANK4_IO_CFG_10_11_CR_SD, MPFS_SYSREG_B4_10_11);
	putreg32(LIBERO_SETTING_MSSIO_BANK4_IO_CFG_12_13_CR_SD, MPFS_SYSREG_4_12_13);
...
static void mpfs_emmc_card_init(struct mpfs_dev_s *priv)
{
	...
	putreg32(LIBERO_SETTING_MSSIO_BANK4_IO_CFG_0_1_CR_EMMC, MPFS_SYSREG_B4_0_1);
	putreg32(LIBERO_SETTING_MSSIO_BANK4_IO_CFG_2_3_CR_EMMC, MPFS_SYSREG_B4_2_3);
	putreg32(LIBERO_SETTING_MSSIO_BANK4_IO_CFG_4_5_CR_EMMC, MPFS_SYSREG_B4_4_5);
	putreg32(LIBERO_SETTING_MSSIO_BANK4_IO_CFG_6_7_CR_EMMC, MPFS_SYSREG_B4_6_7);
	putreg32(LIBERO_SETTING_MSSIO_BANK4_IO_CFG_8_9_CR_EMMC, MPFS_SYSREG_B4_8_9);
	putreg32(LIBERO_SETTING_MSSIO_BANK4_IO_CFG_10_11_CR_EMMC, MPFS_SYSREG_B4_10_11);
	putreg32(LIBERO_SETTING_MSSIO_BANK4_IO_CFG_12_13_CR_EMMC, MPFS_SYSREG_4_12_13);
...
static bool mpfs_device_reset(struct sdio_dev_s *dev)
{
	...
	modifyreg32(MPFS_SYSREG_SOFT_RESET_CR, SYSREG_SOFT_RESET_CR_FPGA | SYSREG_SOFT_RESET_CR_FIC3,
				0);
	...
	if (!priv->emmc) {
		 ...
		 * if this ROUX works as the system bootloader. Otherwise, it's
	...
	modifyreg32(MPFS_SYSREG_SUBBLK_CLOCK_CR, 0, SYSREG_SUBBLK_CLOCK_CR_MMC);
	...
	if (cap & MPFS_EMMCSD_SRS16_A64S) {
		modifyreg32(MPFS_EMMCSD_SRS15, 0, MPFS_EMMCSD_SRS15_A64B | MPFS_EMMCSD_SRS15_HV4E);
	}
	...
	modifyreg32(MPFS_EMMCSD_SRS10, MPFS_EMMCSD_SRS10_DTW | MPFS_EMMCSD_SRS10_EDTW, 0);
...
static int mpfs_attach(struct sdio_dev_s *dev)
{
	...
	if (ret == OK) {
		...
		modifyreg32(MPFS_EMMCSD_SRS12,
					MPFS_EMMCSD_SRS12_ECL | MPFS_EMMCSD_SRS12_CINT | MPFS_EMMCSD_SRS12_CR |
...
static int mpfs_sendcmd(struct sdio_dev_s *dev, uint32_t cmd, uint32_t arg)
{
	...
	case MMCSD_R2_RESPONSE:
		command_information = MPFS_EMMCSD_SRS03_RESP_L136 | MPFS_EMMCSD_SRS03_CRCCE;
		break;
	...
	case MMCSD_R7_RESPONSE:
		command_information =
			MPFS_EMMCSD_SRS03_RESP_L48 | MPFS_EMMCSD_SRS03_CRCCE | MPFS_EMMCSD_SRS03_CICE;
		break;
	case MMCSD_R1B_RESPONSE:
		command_information =
			MPFS_EMMCSD_SRS03_RESP_L48B | MPFS_EMMCSD_SRS03_CRCCE | MPFS_EMMCSD_SRS03_CICE;
		break;
	...
	if (cmd & MMCSD_DATAXFR_MASK) {
		command_information |=
			MPFS_EMMCSD_SRS03_DPS | MPFS_EMMCSD_SRS03_BCE | MPFS_EMMCSD_SRS03_RECE;
	...
	putreg32((((cmdidx << 24) & MPFS_EMMCSD_SRS03_CIDX) | command_information), MPFS_EMMCSD_SRS03);

	mcinfo("sendcmd: %08" PRIx32 " cmd: %08" PRIx32 " arg: %08" PRIx32 " cmdidx: %08" PRIx32 "\n",
...
static void mpfs_blocksetup(struct sdio_dev_s *dev, unsigned int blocksize, unsigned int nblocks)
{
	...
	putreg32(priv->blocksize | (nblocks << 16) | MPFS_EMMCSD_SRS01_DMA_SZ_512KB, MPFS_EMMCSD_SRS01);
}
#endif
...
static int mpfs_dmarecvsetup(struct sdio_dev_s *dev, uint8_t *buffer, size_t buflen)
{
	...
	putreg32((priv->blocksize | (blockcount << 16) | MPFS_EMMCSD_SRS01_DMA_SZ_512KB),
			 MPFS_EMMCSD_SRS01);
#endif
...
static int mpfs_waitresponse(struct sdio_dev_s *dev, uint32_t cmd)
{
	...
	do {
		status = getreg32(MPFS_EMMCSD_SRS12);
	} while (!(status & (MPFS_EMMCSD_SRS12_CC | MPFS_EMMCSD_SRS12_EINT)) && --timeout);
...
static int mpfs_recvlong(struct sdio_dev_s *dev, uint32_t cmd, uint32_t rlong[4])
{
	...
	if (rlong) {
		...
		mcinfo("recv: %08" PRIx32 " %08" PRIx32 " %08" PRIx32 " %08" PRIx32 "\n", rlong[0],
			   rlong[1], rlong[2], rlong[3]);
	}
...
static void mpfs_waitenable(struct sdio_dev_s *dev, sdio_eventset_t eventset, uint32_t timeout)
{
	...
	if ((priv->waitevents & SDIOWAIT_TIMEOUT) != 0) {
		...
		ret = wd_start(&priv->waitwdog, delay, mpfs_eventtimeout, (wdparm_t)priv);
		if (ret < OK) {
