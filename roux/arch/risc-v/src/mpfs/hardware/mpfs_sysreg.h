...
#define MPFS_SYSREG_GPIO_INTERRUPT_FAB_CR_OFFSET                                                   \
	0x0054									/* Switches GPIO interrupt from PAD to Fabric GPIO */
...
#define MPFS_SYSREG_MPU_VIOLATION_SR_OFFSET                                                        \
	0x00F0 /* Indicates that a master caused a MPU violation */
#define MPFS_SYSREG_MPU_VIOLATION_INTEN_CR_OFFSET                                                  \
	0x00F4											   /* Enables interrupts on MPU violations     \
														*/
...
#define MPFS_SYSREG_MAINTENANCE_INT_SR_OFFSET                                                      \
	0x0148										/* Maintenance interrupt fault and status events*/
...
#define MPFS_SYSREG_RAM_LIGHTSLEEP_CR_OFFSET                                                       \
	0x0168 /* Puts all the RAMS in that block into low leakage mode */
#define MPFS_SYSREG_RAM_DEEPSLEEP_CR_OFFSET                                                        \
	0x016C /* Puts all the RAMS in that block into deep sleep mode */
#define MPFS_SYSREG_RAM_SHUTDOWN_CR_OFFSET                                                         \
	0x0170 /* Puts all the RAMS in that block into shut down mode */
#define MPFS_SYSREG_L2_SHUTDOWN_CR_OFFSET                                                          \
	0x0174 /* Allows each bank of the L2 Cache to be powered down */
#define MPFS_SYSREG_IOMUX0_CR_OFFSET                                                               \
	0x0200 /* Is peripheral connected to the Fabric or IOMUX structure */
...
#define MPFS_SYSREG_IOMUX6_CR_OFFSET                                                               \
	0x0218 /* Inverter MMC/SD Voltage select lines to the IOMUX structure */
#define MPFS_SYSREG_MSSIO_BANK4_CFG_CR 0x0230 /* Configures the MSSIO block */
#define MPFS_SYSREG_MSSIO_BANK4_IO_CFG_0_1_CR_OFFSET                                               \
	0x0234 /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK4_IO_CFG_2_3_CR_OFFSET                                               \
	0x0238 /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK4_IO_CFG_4_5_CR_OFFSET                                               \
	0x023C /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK4_IO_CFG_6_7_CR_OFFSET                                               \
	0x0240 /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK4_IO_CFG_8_9_CR_OFFSET                                               \
	0x0244 /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK4_IO_CFG_10_11_CR_OFFSET                                             \
	0x0248 /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK4_IO_CFG_12_13_CR_OFFSET                                             \
	0x024C									  /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK2_CFG_CR 0x0250 /* Configures the MSSIO block */
#define MPFS_SYSREG_MSSIO_BANK2_IO_CFG_0_1_CR_OFFSET                                               \
	0x0254 /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK2_IO_CFG_2_3_CR_OFFSET                                               \
	0x0258 /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK2_IO_CFG_4_5_CR_OFFSET                                               \
	0x025C /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK2_IO_CFG_6_7_CR_OFFSET                                               \
	0x0260 /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK2_IO_CFG_8_9_CR_OFFSET                                               \
	0x0264 /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK2_IO_CFG_10_11_CR_OFFSET                                             \
	0x0268 /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK2_IO_CFG_12_13_CR_OFFSET                                             \
	0x026C /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK2_IO_CFG_14_15_CR_OFFSET                                             \
	0x0270 /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK2_IO_CFG_16_17_CR_OFFSET                                             \
	0x0274 /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK2_IO_CFG_18_19_CR_OFFSET                                             \
	0x0278 /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK2_IO_CFG_20_21_CR_OFFSET                                             \
	0x027C /* IO electrical configuration for MSSIO pad */
#define MPFS_SYSREG_MSSIO_BANK2_IO_CFG_22_23_CR_OFFSET                                             \
	0x0280											 /* IO electrical configuration for MSSIO pad */
...
#define SYSREG_CLOCK_CONFIG_CR_DIVIDER_CPU_SHIFT                                                   \
	(0) /* Bits 0-1: CPU clock divider (Reset=/1 =0)                                               \
		 */
#define SYSREG_CLOCK_CONFIG_CR_DIVIDER_CPU_MASK (3)
#define SYSREG_CLOCK_CONFIG_CR_DIVIDER_CPU(x)                                                      \
	((x & SYSREG_CLOCK_CONFIG_CR_DIVIDER_CPU_MASK) << SYSREG_CLOCK_CONFIG_CR_DIVIDER_CPU_SHIFT)
#define SYSREG_CLOCK_CONFIG_CR_DIVIDER_AXI_SHIFT                                                   \
	(2) /* Bits 2-3: AXI clock divider (Reset=/1 =0)                                               \
		 */
#define SYSREG_CLOCK_CONFIG_CR_DIVIDER_AXI_MASK (3 << SYSREG_CLOCK_CONFIG_CR_DIVIDER_AXI_SHIFT)
#define SYSREG_CLOCK_CONFIG_CR_DIVIDER_AXI(x)                                                      \
	((x & SYSREG_CLOCK_CONFIG_CR_DIVIDER_AXI_MASK) << SYSREG_CLOCK_CONFIG_CR_DIVIDER_AXI_SHIFT)
#define SYSREG_CLOCK_CONFIG_CR_DIVIDER_AHB_SHIFT                                                   \
	(2) /* Bits 4-5: AHB/APB clock divider (Reset=/2 =1) */
#define SYSREG_CLOCK_CONFIG_CR_DIVIDER_AHB_MASK (3 << SYSREG_CLOCK_CONFIG_CR_DIVIDER_AHB_SHIFT)
#define SYSREG_CLOCK_CONFIG_CR_DIVIDER_AHB(x)                                                      \
	((x & SYSREG_CLOCK_CONFIG_CR_DIVIDER_AHB_MASK) << SYSREG_CLOCK_CONFIG_CR_DIVIDER_AHB_SHIFT)
#define SYSREG_CLOCK_CONFIG_CR_ENABLE_1MHZ_SHIFT                                                   \
	(8) /* Bit: 8: enable the 1mHz (2MHz) on-chip oscillator */
...
#define SYSREG_DEVICE_STATUS_FF_IN_PROGRESS_SHIFT                                                  \
	(2) /* Bit: 2: ff_in_progress input from G5 Control */
...
#define SYSREG_DEVICE_STATUS_IO_EN_SHIFT                                                           \
	(12) /* Bit: 12: status of the io_en input from G5 Control. */
