...
#define COREMMC_IMR_ERROR                                                                          \
	(COREMMC_IMR_UER | COREMMC_IMR_SBI | COREMMC_IMR_TBI | COREMMC_IMR_TXI | COREMMC_IMR_TXI |     \
	 COREMMC_IMR_BOI | COREMMC_IMR_BUI)
...
#define COREMMC_SBIMR_ERROR                                                                        \
	(COREMMC_SBIMR_WDATAINFIFOTO | COREMMC_SBIMR_WBUSYTO | COREMMC_SBIMR_WCRCSTAERR |              \
	 COREMMC_SBIMR_RSTPERR | COREMMC_SBIMR_RSTTO | COREMMC_SBIMR_CRCERR)
...
#define COREMMC_MBIMR_ERROR                                                                        \
	(COREMMC_MBIMR_WDATAINFIFOTO | COREMMC_MBIMR_WBUSYTO | COREMMC_MBIMR_WCRCSTAERR |              \
	 COREMMC_MBIMR_RSTPERR | COREMMC_MBIMR_RSTTO | COREMMC_MBIMR_CRCERR)

/* Interrupt Status Register */

#define COREMMC_ISR_UER                                                                            \
	(1 << 7) /* User error is detected. Write FIFO overrun or Read FIFO underrun error. */
#define COREMMC_ISR_SBI                                                                            \
	(1 << 6) /* Response start bit error detected or time-out error while waiting for a response.  \
			  */
...
#define COREMMC_ISR_ERROR                                                                          \
	(COREMMC_ISR_UER | COREMMC_ISR_SBI | COREMMC_ISR_TBI | COREMMC_ISR_TXI | COREMMC_ISR_BOI |     \
	 COREMMC_ISR_BUI)
...
#define COREMMC_XBISR_ERROR                                                                        \
	(COREMMC_XBISR_WDATAINFIFOTO | COREMMC_XBISR_WBUSYTO | COREMMC_XBISR_WCRCSTAERR |              \
	 COREMMC_XBISR_RSTPERR | COREMMC_XBISR_RSTTO | COREMMC_XBISR_CRCERR)
...
#define COREMMC_ICR_ERROR                                                                          \
	(COREMMC_ICR_CLRUER | COREMMC_ICR_CLRSBI | COREMMC_ICR_CLRTBI | COREMMC_ICR_CLRTXI |           \
	 COREMMC_ICR_CLRBOI | COREMMC_ICR_CLRBUI)
...
#define COREMMC_SBICR_ERROR                                                                        \
	(COREMMC_SBICR_WDATAINFIFOTO | COREMMC_SBICR_WBUSYTO | COREMMC_SBICR_WCRCSTAERR |              \
	 COREMMC_SBICR_RSTPERR | COREMMC_SBICR_RSTTO | COREMMC_SBICR_CRCERR)
...
#define COREMMC_MBICR_ERROR                                                                        \
	(COREMMC_MBICR_WDATAINFIFOTO | COREMMC_MBICR_WBUSYTO | COREMMC_MBICR_WCRCSTAERR |              \
	 COREMMC_MBICR_RSTPERR | COREMMC_MBICR_RSTTO | COREMMC_MBICR_CRCERR)

/* Control Register */

#define COREMMC_CTRL_BUSY                                                                          \
	(1 << 7) /* Slave device is indicating that it is busy by asserting DAT[0] low. */
#define COREMMC_CTRL_RESERVED (1 << 6)	/* Reserved. */
#define COREMMC_CTRL_FIFORESET (1 << 5) /* FIFO reset. */
#define COREMMC_CTRL_CMDFORCELOW                                                                   \
	(1 << 4) /* Force CMD line to 0 (low). Used for boot operation.                                \
			  */
#define COREMMC_CTRL_MIDLE                                                                         \
	(1 << 3) /* MMC Idle. When set to 1, it indicates that the core is in Idle state. */
...
#define COREMMC_SBCSR_WST                                                                          \
	(0x7 << 4) /* Single Block Write Status - CRC Status bits. Good CRC Status = 010. */
...
#define COREMMC_MBCSR_WST                                                                          \
	(0x7 << 4) /* Multiple Block Write Status - CRC Status bits. Good CRC Status = 010. */
