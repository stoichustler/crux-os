...
#define MPFS_DDR_CSR_APB_CFG_MANUAL_ADDRESS_MAP                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MANUAL_ADDRESS_MAP_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_CHIPADDR_MAP                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CHIPADDR_MAP_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_CIDADDR_MAP                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CIDADDR_MAP_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_MB_AUTOPCH_COL_BIT_POS_LOW                                            \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MB_AUTOPCH_COL_BIT_POS_LOW_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_MB_AUTOPCH_COL_BIT_POS_HIGH                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MB_AUTOPCH_COL_BIT_POS_HIGH_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BANKADDR_MAP_0                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BANKADDR_MAP_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BANKADDR_MAP_1                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BANKADDR_MAP_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ROWADDR_MAP_0                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ROWADDR_MAP_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ROWADDR_MAP_1                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ROWADDR_MAP_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ROWADDR_MAP_2                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ROWADDR_MAP_2_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ROWADDR_MAP_3                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ROWADDR_MAP_3_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_COLADDR_MAP_0                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_COLADDR_MAP_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_COLADDR_MAP_1                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_COLADDR_MAP_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_COLADDR_MAP_2                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_COLADDR_MAP_2_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_COLADDR_MAP_3                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_COLADDR_MAP_3_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_VRCG_ENABLE                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_VRCG_ENABLE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_VRCG_DISABLE                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_VRCG_DISABLE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_WRITE_LATENCY_SET                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_WRITE_LATENCY_SET_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_THERMAL_OFFSET                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_THERMAL_OFFSET_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_LPDDR4_FSP_OP                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_LPDDR4_FSP_OP_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_GENERATE_REFRESH_ON_SRX                                               \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_GENERATE_REFRESH_ON_SRX_OFFSET)
...
#define MPFS_DDR_CSR_APB_INIT_FORCE_WRITE_DATA_0                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_FORCE_WRITE_DATA_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_WRITE_CRC (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_WRITE_CRC_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_MPR_READ_FORMAT                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MPR_READ_FORMAT_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_WR_CMD_LAT_CRC_DM                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_WR_CMD_LAT_CRC_DM_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_FINE_GRAN_REF_MODE                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_FINE_GRAN_REF_MODE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_TEMP_SENSOR_READOUT                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_TEMP_SENSOR_READOUT_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_PER_DRAM_ADDR_EN                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_PER_DRAM_ADDR_EN_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_GEARDOWN_MODE                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_GEARDOWN_MODE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_WR_PREAMBLE                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_WR_PREAMBLE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_RD_PREAMBLE                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_RD_PREAMBLE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_RD_PREAMB_TRN_MODE                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_RD_PREAMB_TRN_MODE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_SR_ABORT (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_SR_ABORT_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_CS_TO_CMDADDR_LATENCY                                                 \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CS_TO_CMDADDR_LATENCY_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_INT_VREF_MON                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_INT_VREF_MON_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_TEMP_CTRL_REF_MODE                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_TEMP_CTRL_REF_MODE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_TEMP_CTRL_REF_RANGE                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_TEMP_CTRL_REF_RANGE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_MAX_PWR_DOWN_MODE                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MAX_PWR_DOWN_MODE_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_CA_PARITY_PERSIST_ERR                                                 \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CA_PARITY_PERSIST_ERR_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_RTT_PARK (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_RTT_PARK_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_INBUF_4_PD                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_INBUF_4_PD_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_CA_PARITY_ERR_STATUS                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CA_PARITY_ERR_STATUS_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_CRC_ERROR_CLEAR                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CRC_ERROR_CLEAR_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_CA_PARITY_LATENCY                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CA_PARITY_LATENCY_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_VREFDQ_TRN_ENABLE                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_VREFDQ_TRN_ENABLE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_VREFDQ_TRN_RANGE                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_VREFDQ_TRN_RANGE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_VREFDQ_TRN_VALUE                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_VREFDQ_TRN_VALUE_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_WTR_S_CRC_DM                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_WTR_S_CRC_DM_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_WTR_L_CRC_DM                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_WTR_L_CRC_DM_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_NIBBLE_DEVICES                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_NIBBLE_DEVICES_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS0_0                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS0_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS0_1                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS0_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS1_0                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS1_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS1_1                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS1_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS2_0                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS2_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS2_1                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS2_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS3_0                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS3_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS3_1                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS3_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS4_0                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS4_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS4_1                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS4_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS5_0                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS5_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS5_1                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS5_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS6_0                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS6_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS6_1                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS6_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS7_0                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS7_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS7_1                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS7_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS8_0                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS8_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS8_1                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS8_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS9_0                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS9_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS9_1                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS9_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS10_0                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS10_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS10_1                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS10_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS11_0                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS11_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS11_1                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS11_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS12_0                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS12_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS12_1                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS12_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS13_0                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS13_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS13_1                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS13_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS14_0                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS14_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS14_1                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS14_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS15_0                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS15_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS15_1                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BIT_MAP_INDEX_CS15_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_NUM_LOGICAL_RANKS_PER_3DS                                             \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_NUM_LOGICAL_RANKS_PER_3DS_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_ADVANCE_ACTIVATE_READY                                                \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ADVANCE_ACTIVATE_READY_OFFSET)
#define MPFS_DDR_CSR_APB_CTRLR_SOFT_RESET_N                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CTRLR_SOFT_RESET_N_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_LOOKAHEAD_PCH                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_LOOKAHEAD_PCH_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_LOOKAHEAD_ACT                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_LOOKAHEAD_ACT_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_AUTOINIT_DISABLE                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_AUTOINIT_DISABLE_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_FORCE_RESET                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_FORCE_RESET_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_GEARDOWN_EN                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_GEARDOWN_EN_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_DISABLE_CKE                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_DISABLE_CKE_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_CS (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_CS_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_PRECHARGE_ALL                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_PRECHARGE_ALL_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_REFRESH (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_REFRESH_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_ZQ_CAL_REQ                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_ZQ_CAL_REQ_OFFSET)
...
#define MPFS_DDR_CSR_APB_CTRLR_INIT (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CTRLR_INIT_OFFSET)
#define MPFS_DDR_CSR_APB_CTRLR_INIT_DONE                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CTRLR_INIT_DONE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_AUTO_REF_EN                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_AUTO_REF_EN_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_READ_TO_WRITE                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_READ_TO_WRITE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_WRITE_TO_WRITE                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_WRITE_TO_WRITE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_READ_TO_READ                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_READ_TO_READ_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_WRITE_TO_READ                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_WRITE_TO_READ_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_READ_TO_WRITE_ODT                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_READ_TO_WRITE_ODT_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_WRITE_TO_WRITE_ODT                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_WRITE_TO_WRITE_ODT_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_READ_TO_READ_ODT                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_READ_TO_READ_ODT_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_WRITE_TO_READ_ODT                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_WRITE_TO_READ_ODT_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_MIN_READ_IDLE                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MIN_READ_IDLE_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_DLL_DISABLE                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_DLL_DISABLE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_REF_PER (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_REF_PER_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_STARTUP_DELAY                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_STARTUP_DELAY_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_MEM_COLBITS                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MEM_COLBITS_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_MEM_ROWBITS                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MEM_ROWBITS_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_MEM_BANKBITS                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MEM_BANKBITS_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_RD_MAP_CS0                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_RD_MAP_CS0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_RD_MAP_CS1                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_RD_MAP_CS1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_RD_MAP_CS2                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_RD_MAP_CS2_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_RD_MAP_CS3                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_RD_MAP_CS3_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_RD_MAP_CS4                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_RD_MAP_CS4_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_RD_MAP_CS5                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_RD_MAP_CS5_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_RD_MAP_CS6                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_RD_MAP_CS6_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_RD_MAP_CS7                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_RD_MAP_CS7_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_WR_MAP_CS0                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_WR_MAP_CS0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_WR_MAP_CS1                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_WR_MAP_CS1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_WR_MAP_CS2                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_WR_MAP_CS2_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_WR_MAP_CS3                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_WR_MAP_CS3_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_WR_MAP_CS4                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_WR_MAP_CS4_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_WR_MAP_CS5                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_WR_MAP_CS5_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_WR_MAP_CS6                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_WR_MAP_CS6_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_WR_MAP_CS7                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_WR_MAP_CS7_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_RD_TURN_ON                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_RD_TURN_ON_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_WR_TURN_ON                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_WR_TURN_ON_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_RD_TURN_OFF                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_RD_TURN_OFF_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ODT_WR_TURN_OFF                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_WR_TURN_OFF_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_TWO_T_SEL_CYCLE                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_TWO_T_SEL_CYCLE_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_ADDR_MIRROR                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ADDR_MIRROR_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ZQ_CAL_TYPE                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ZQ_CAL_TYPE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ZQ_CAL_PER (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ZQ_CAL_PER_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_AUTO_ZQ_CAL_EN                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_AUTO_ZQ_CAL_EN_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_MEMORY_TYPE                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MEMORY_TYPE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ONLY_SRANK_CMDS                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ONLY_SRANK_CMDS_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_EARLY_RANK_TO_WR_START                                                \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_EARLY_RANK_TO_WR_START_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_EARLY_RANK_TO_RD_START                                                \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_EARLY_RANK_TO_RD_START_OFFSET)
...
#define MPFS_DDR_CSR_APB_INIT_MR_WR_DATA                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_MR_WR_DATA_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_MR_WR_MASK                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_MR_WR_MASK_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_NOP (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_NOP_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_INIT_DURATION                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_INIT_DURATION_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ZQINIT_CAL_DURATION                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ZQINIT_CAL_DURATION_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ZQ_CAL_L_DURATION                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ZQ_CAL_L_DURATION_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ZQ_CAL_S_DURATION                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ZQ_CAL_S_DURATION_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ZQ_CAL_R_DURATION                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ZQ_CAL_R_DURATION_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_ODT_POWERDOWN                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ODT_POWERDOWN_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_CAL_READ_PERIOD                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CAL_READ_PERIOD_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_NUM_CAL_READS                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_NUM_CAL_READS_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_SELF_REFRESH                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_SELF_REFRESH_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_SELF_REFRESH_STATUS                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_SELF_REFRESH_STATUS_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_POWER_DOWN                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_POWER_DOWN_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_POWER_DOWN_STATUS                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_POWER_DOWN_STATUS_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_FORCE_WRITE                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_FORCE_WRITE_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_FORCE_WRITE_CS                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_FORCE_WRITE_CS_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_CTRLR_INIT_DISABLE                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CTRLR_INIT_DISABLE_OFFSET)
#define MPFS_DDR_CSR_APB_CTRLR_READY (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CTRLR_READY_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_RDIMM_READY                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_RDIMM_READY_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_RDIMM_COMPLETE                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_RDIMM_COMPLETE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_RDIMM_LAT (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_RDIMM_LAT_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_RDIMM_BSIDE_INVERT                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_RDIMM_BSIDE_INVERT_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_LRDIMM (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_LRDIMM_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_MEMORY_RESET_MASK                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_MEMORY_RESET_MASK_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_RD_PREAMB_TOGGLE                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_RD_PREAMB_TOGGLE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_RD_POSTAMBLE                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_RD_POSTAMBLE_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_ZQLATCH_DURATION                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ZQLATCH_DURATION_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_CAL_SELECT                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_CAL_SELECT_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_CAL_L_R_REQ                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_CAL_L_R_REQ_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_CAL_L_B_SIZE                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_CAL_L_B_SIZE_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_CAL_L_R_ACK                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_CAL_L_R_ACK_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_CAL_L_READ_COMPLETE                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_CAL_L_READ_COMPLETE_OFFSET)
...
#define MPFS_DDR_CSR_APB_INIT_START_DQSOSC                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_START_DQSOSC_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_STOP_DQSOSC                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_STOP_DQSOSC_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_ZQ_CAL_START                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_ZQ_CAL_START_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_WR_POSTAMBLE                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_WR_POSTAMBLE_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_CAL_L_ADDR_0                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_CAL_L_ADDR_0_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_CAL_L_ADDR_1                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_CAL_L_ADDR_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_CTRLUPD_TRIG                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CTRLUPD_TRIG_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_CTRLUPD_START_DELAY                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CTRLUPD_START_DELAY_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_DFI_T_CTRLUPD_MAX                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_DFI_T_CTRLUPD_MAX_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_CTRLR_BUSY_SEL                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CTRLR_BUSY_SEL_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_CTRLR_BUSY_VALUE                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CTRLR_BUSY_VALUE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_CTRLR_BUSY_TURN_OFF_DELAY                                             \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CTRLR_BUSY_TURN_OFF_DELAY_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_CTRLR_BUSY_SLOW_RESTART_WINDOW                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CTRLR_BUSY_SLOW_RESTART_WINDOW_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_CTRLR_BUSY_RESTART_HOLDOFF                                            \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CTRLR_BUSY_RESTART_HOLDOFF_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_PARITY_RDIMM_DELAY                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_PARITY_RDIMM_DELAY_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_CTRLR_BUSY_ENABLE                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_CTRLR_BUSY_ENABLE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ASYNC_ODT (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ASYNC_ODT_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ZQ_CAL_DURATION                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ZQ_CAL_DURATION_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_MRRI (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MRRI_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_ODT_FORCE_EN                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_ODT_FORCE_EN_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_ODT_FORCE_RANK                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_ODT_FORCE_RANK_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_PHYUPD_ACK_DELAY                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_PHYUPD_ACK_DELAY_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_MIRROR_X16_BG0_BG1                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MIRROR_X16_BG0_BG1_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_PDA_MR_W_REQ                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_PDA_MR_W_REQ_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_PDA_NIBBLE_SELECT                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_PDA_NIBBLE_SELECT_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_DRAM_CLK_DISABLE_IN_SELF_REFRESH                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_DRAM_CLK_DISABLE_IN_SELF_REFRESH_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_DFI_T_CTRL_DELAY                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_DFI_T_CTRL_DELAY_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_DFI_T_DRAM_CLK_ENABLE                                                 \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_DFI_T_DRAM_CLK_ENABLE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_IDLE_TIME_TO_SELF_REFRESH                                             \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_IDLE_TIME_TO_SELF_REFRESH_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_IDLE_TIME_TO_POWER_DOWN                                               \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_IDLE_TIME_TO_POWER_DOWN_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BURST_RW_REFRESH_HOLDOFF                                              \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BURST_RW_REFRESH_HOLDOFF_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_REFRESH_COUNT                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_REFRESH_COUNT_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_BG_INTERLEAVE                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_BG_INTERLEAVE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_REFRESH_DURING_PHY_TRAINING                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_REFRESH_DURING_PHY_TRAINING_OFFSET)
...
#define MPFS_DDR_CSR_APB_MT_STOP_ON_ERROR                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MT_STOP_ON_ERROR_OFFSET)
...
#define MPFS_DDR_CSR_APB_MT_DATA_PATTERN                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MT_DATA_PATTERN_OFFSET)
#define MPFS_DDR_CSR_APB_MT_ADDR_PATTERN                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MT_ADDR_PATTERN_OFFSET)
...
#define MPFS_DDR_CSR_APB_MT_START_ADDR_0                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MT_START_ADDR_0_OFFSET)
#define MPFS_DDR_CSR_APB_MT_START_ADDR_1                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MT_START_ADDR_1_OFFSET)
#define MPFS_DDR_CSR_APB_MT_ERROR_MASK_0                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MT_ERROR_MASK_0_OFFSET)
#define MPFS_DDR_CSR_APB_MT_ERROR_MASK_1                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MT_ERROR_MASK_1_OFFSET)
#define MPFS_DDR_CSR_APB_MT_ERROR_MASK_2                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MT_ERROR_MASK_2_OFFSET)
#define MPFS_DDR_CSR_APB_MT_ERROR_MASK_3                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MT_ERROR_MASK_3_OFFSET)
#define MPFS_DDR_CSR_APB_MT_ERROR_MASK_4                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MT_ERROR_MASK_4_OFFSET)
#define MPFS_DDR_CSR_APB_MT_USER_DATA_PATTERN                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MT_USER_DATA_PATTERN_OFFSET)
#define MPFS_DDR_CSR_APB_MT_ALG_AUTO_PCH                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MT_ALG_AUTO_PCH_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_STARVE_TIMEOUT_P0                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_STARVE_TIMEOUT_P0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_STARVE_TIMEOUT_P1                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_STARVE_TIMEOUT_P1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_STARVE_TIMEOUT_P2                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_STARVE_TIMEOUT_P2_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_STARVE_TIMEOUT_P3                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_STARVE_TIMEOUT_P3_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_STARVE_TIMEOUT_P4                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_STARVE_TIMEOUT_P4_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_STARVE_TIMEOUT_P5                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_STARVE_TIMEOUT_P5_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_STARVE_TIMEOUT_P6                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_STARVE_TIMEOUT_P6_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_STARVE_TIMEOUT_P7                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_STARVE_TIMEOUT_P7_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_REORDER_EN (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_REORDER_EN_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_REORDER_QUEUE_EN                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_REORDER_QUEUE_EN_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_INTRAPORT_REORDER_EN                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_INTRAPORT_REORDER_EN_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_MAINTAIN_COHERENCY                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MAINTAIN_COHERENCY_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_Q_AGE_LIMIT                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_Q_AGE_LIMIT_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_RO_CLOSED_PAGE_POLICY                                                 \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_RO_CLOSED_PAGE_POLICY_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_REORDER_RW_ONLY                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_REORDER_RW_ONLY_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_RO_PRIORITY_EN                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_RO_PRIORITY_EN_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_ECC_CORRECTION_EN                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ECC_CORRECTION_EN_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ECC_BYPASS (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ECC_BYPASS_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_WRITE_DATA_1B_ECC_ERROR_GEN                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_WRITE_DATA_1B_ECC_ERROR_GEN_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_WRITE_DATA_2B_ECC_ERROR_GEN                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_WRITE_DATA_2B_ECC_ERROR_GEN_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ECC_1BIT_INT_THRESH                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ECC_1BIT_INT_THRESH_OFFSET)
#define MPFS_DDR_CSR_APB_STAT_INT_ECC_1BIT_THRESH                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_STAT_INT_ECC_1BIT_THRESH_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_READ_CAPTURE_ADDR                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_READ_CAPTURE_ADDR_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_READ_CAPTURE_DATA_0                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_READ_CAPTURE_DATA_0_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_READ_CAPTURE_DATA_1                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_READ_CAPTURE_DATA_1_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_READ_CAPTURE_DATA_2                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_READ_CAPTURE_DATA_2_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_READ_CAPTURE_DATA_3                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_READ_CAPTURE_DATA_3_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_READ_CAPTURE_DATA_4                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_READ_CAPTURE_DATA_4_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ERROR_GROUP_SEL                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ERROR_GROUP_SEL_OFFSET)
...
#define MPFS_DDR_CSR_APB_CFG_POST_TRIG_CYCS                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_POST_TRIG_CYCS_OFFSET)
...
#define MPFS_DDR_CSR_APB_MTC_ACQ_CYCS_STORED                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MTC_ACQ_CYCS_STORED_OFFSET)
#define MPFS_DDR_CSR_APB_MTC_ACQ_TRIG_DETECT                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MTC_ACQ_TRIG_DETECT_OFFSET)
#define MPFS_DDR_CSR_APB_MTC_ACQ_MEM_TRIG_ADDR                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MTC_ACQ_MEM_TRIG_ADDR_OFFSET)
#define MPFS_DDR_CSR_APB_MTC_ACQ_MEM_LAST_ADDR                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MTC_ACQ_MEM_LAST_ADDR_OFFSET)
#define MPFS_DDR_CSR_APB_MTC_ACK (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MTC_ACK_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_TRIG_MT_ADDR_0                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_TRIG_MT_ADDR_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_TRIG_MT_ADDR_1                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_TRIG_MT_ADDR_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_TRIG_ERR_MASK_0                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_TRIG_ERR_MASK_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_TRIG_ERR_MASK_1                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_TRIG_ERR_MASK_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_TRIG_ERR_MASK_2                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_TRIG_ERR_MASK_2_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_TRIG_ERR_MASK_3                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_TRIG_ERR_MASK_3_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_TRIG_ERR_MASK_4                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_TRIG_ERR_MASK_4_OFFSET)
#define MPFS_DDR_CSR_APB_MTC_ACQ_WR_DATA_0                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MTC_ACQ_WR_DATA_0_OFFSET)
#define MPFS_DDR_CSR_APB_MTC_ACQ_WR_DATA_1                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MTC_ACQ_WR_DATA_1_OFFSET)
#define MPFS_DDR_CSR_APB_MTC_ACQ_WR_DATA_2                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MTC_ACQ_WR_DATA_2_OFFSET)
#define MPFS_DDR_CSR_APB_MTC_ACQ_RD_DATA_0                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MTC_ACQ_RD_DATA_0_OFFSET)
#define MPFS_DDR_CSR_APB_MTC_ACQ_RD_DATA_1                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MTC_ACQ_RD_DATA_1_OFFSET)
#define MPFS_DDR_CSR_APB_MTC_ACQ_RD_DATA_2                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MTC_ACQ_RD_DATA_2_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_PRE_TRIG_CYCS                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_PRE_TRIG_CYCS_OFFSET)
#define MPFS_DDR_CSR_APB_MTC_ACQ_ERROR_CNT                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MTC_ACQ_ERROR_CNT_OFFSET)
#define MPFS_DDR_CSR_APB_MTC_ACQ_ERROR_CNT_OVFL                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_MTC_ACQ_ERROR_CNT_OVFL_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_DATA_SEL_FIRST_ERROR                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_DATA_SEL_FIRST_ERROR_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_DQ_WIDTH (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_DQ_WIDTH_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ACTIVE_DQ_SEL                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ACTIVE_DQ_SEL_OFFSET)
#define MPFS_DDR_CSR_APB_STAT_CA_PARITY_ERROR                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_STAT_CA_PARITY_ERROR_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_CA_PARITY_ERROR_GEN_REQ                                              \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_CA_PARITY_ERROR_GEN_REQ_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_CA_PARITY_ERROR_GEN_CMD                                              \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_CA_PARITY_ERROR_GEN_CMD_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_CA_PARITY_ERROR_GEN_ACK                                              \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_CA_PARITY_ERROR_GEN_ACK_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_DFI_T_RDDATA_EN                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_DFI_T_RDDATA_EN_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_DFI_T_PHY_RDLAT                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_DFI_T_PHY_RDLAT_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_DFI_T_PHY_WRLAT                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_DFI_T_PHY_WRLAT_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_DFI_PHYUPD_EN                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_DFI_PHYUPD_EN_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_DFI_LP_DATA_REQ                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_DFI_LP_DATA_REQ_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_DFI_LP_CTRL_REQ                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_DFI_LP_CTRL_REQ_OFFSET)
#define MPFS_DDR_CSR_APB_STAT_DFI_LP_ACK                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_STAT_DFI_LP_ACK_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_DFI_LP_WAKEUP                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_DFI_LP_WAKEUP_OFFSET)
#define MPFS_DDR_CSR_APB_INIT_DFI_DRAM_CLK_DISABLE                                                 \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_INIT_DFI_DRAM_CLK_DISABLE_OFFSET)
#define MPFS_DDR_CSR_APB_STAT_DFI_TRAINING_ERROR                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_STAT_DFI_TRAINING_ERROR_OFFSET)
#define MPFS_DDR_CSR_APB_STAT_DFI_ERROR (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_STAT_DFI_ERROR_OFFSET)
#define MPFS_DDR_CSR_APB_STAT_DFI_ERROR_INFO                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_STAT_DFI_ERROR_INFO_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_DFI_DATA_BYTE_DISABLE                                                 \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_DFI_DATA_BYTE_DISABLE_OFFSET)
#define MPFS_DDR_CSR_APB_STAT_DFI_INIT_COMPLETE                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_STAT_DFI_INIT_COMPLETE_OFFSET)
#define MPFS_DDR_CSR_APB_STAT_DFI_TRAINING_COMPLETE                                                \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_STAT_DFI_TRAINING_COMPLETE_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_DFI_LVL_SEL                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_DFI_LVL_SEL_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_DFI_LVL_PERIODIC                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_DFI_LVL_PERIODIC_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_DFI_LVL_PATTERN                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_DFI_LVL_PATTERN_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_DFI_INIT_START                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_DFI_INIT_START_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_AXI_START_ADDRESS_AXI1_0                                              \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_AXI_START_ADDRESS_AXI1_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_AXI_START_ADDRESS_AXI1_1                                              \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_AXI_START_ADDRESS_AXI1_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_AXI_START_ADDRESS_AXI2_0                                              \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_AXI_START_ADDRESS_AXI2_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_AXI_START_ADDRESS_AXI2_1                                              \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_AXI_START_ADDRESS_AXI2_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_AXI_END_ADDRESS_AXI1_0                                                \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_AXI_END_ADDRESS_AXI1_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_AXI_END_ADDRESS_AXI1_1                                                \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_AXI_END_ADDRESS_AXI1_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_AXI_END_ADDRESS_AXI2_0                                                \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_AXI_END_ADDRESS_AXI2_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_AXI_END_ADDRESS_AXI2_1                                                \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_AXI_END_ADDRESS_AXI2_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_MEM_START_ADDRESS_AXI1_0                                              \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MEM_START_ADDRESS_AXI1_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_MEM_START_ADDRESS_AXI1_1                                              \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MEM_START_ADDRESS_AXI1_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_MEM_START_ADDRESS_AXI2_0                                              \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MEM_START_ADDRESS_AXI2_0_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_MEM_START_ADDRESS_AXI2_1                                              \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_MEM_START_ADDRESS_AXI2_1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ENABLE_BUS_HOLD_AXI1                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ENABLE_BUS_HOLD_AXI1_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_ENABLE_BUS_HOLD_AXI2                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_ENABLE_BUS_HOLD_AXI2_OFFSET)
#define MPFS_DDR_CSR_APB_CFG_AXI_AUTO_PCH                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_CFG_AXI_AUTO_PCH_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_RESET_CONTROL                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_RESET_CONTROL_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_PC_RANK (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_PC_RANK_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_RANKS_TO_TRAIN                                                        \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_RANKS_TO_TRAIN_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_WRITE_REQUEST                                                         \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_WRITE_REQUEST_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_WRITE_REQUEST_DONE                                                    \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_WRITE_REQUEST_DONE_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_READ_REQUEST                                                          \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_READ_REQUEST_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_READ_REQUEST_DONE                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_READ_REQUEST_DONE_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_WRITE_LEVEL_DELAY                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_WRITE_LEVEL_DELAY_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_GATE_TRAIN_DELAY                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_GATE_TRAIN_DELAY_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_EYE_TRAIN_DELAY                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_EYE_TRAIN_DELAY_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_EYE_PAT (MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_EYE_PAT_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_START_RECAL                                                           \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_START_RECAL_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_CLR_DFI_LVL_PERIODIC                                                  \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_CLR_DFI_LVL_PERIODIC_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_TRAIN_STEP_ENABLE                                                     \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_TRAIN_STEP_ENABLE_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_LPDDR_DQ_CAL_PAT                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_LPDDR_DQ_CAL_PAT_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_INDPNDT_TRAINING                                                      \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_INDPNDT_TRAINING_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_ENCODED_QUAD_CS                                                       \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_ENCODED_QUAD_CS_OFFSET)
#define MPFS_DDR_CSR_APB_PHY_HALF_CLK_DLY_ENABLE                                                   \
	(MPFS_DDRCFG_BASE + MPFS_DDR_CSR_APB_PHY_HALF_CLK_DLY_ENABLE_OFFSET)
