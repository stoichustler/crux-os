...
#define MPFS_USB_DMA_CHANNEL(n)                                                                    \
	(MPFS_USB_BASE + MPFS_USB_DMA_CHANNEL_OFFSET + MPFS_USB_DMA_CHANNEL_SIZE * n)
...
struct mpfs_usbdev_s {
	...
	aligned_data(4) struct usb_ctrlreq_s ctrl; /* Last EP0 request */
	...
	aligned_data(4) struct usbdev_epdesc_s ep_descriptors[MPFS_USB_NENDPOINTS * 2];
