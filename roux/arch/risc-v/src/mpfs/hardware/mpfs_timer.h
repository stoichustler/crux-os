...
#define MPFS_MSTIMER_TIM64VALUEU_OFFSET                                                            \
	0x030 /* Current value of the upper 32 bit word of the 64 bit timer */
#define MPFS_MSTIMER_TIM64VALUEL_OFFSET                                                            \
	0x034 /* Current value of the lower 32 bit word of the 64 bit timer */
...
#define MPFS_MSTIMER_TIM64BGLOADVALU_OFFSET                                                        \
	0x040 /* Background load value for upper 32bits of 64 bit mode timer */
#define MPFS_MSTIMER_TIM64BGLOADVALL_OFFSET                                                        \
	0x044 /* Background load value for lower 32bits of 64 bit mode timer */
