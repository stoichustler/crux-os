...
#define PHY_MANAGEMENT_PHY_DATA(n)                                                                 \
	((n & PHY_MANAGEMENT_PHY_DATA_MASK) << PHY_MANAGEMENT_PHY_DATA_SHIFT)
...
#define PHY_MANAGEMENT_REG_ADDRESS(n)                                                              \
	((n & PHY_MANAGEMENT_REG_ADDRESS_MASK) << PHY_MANAGEMENT_REG_ADDRESS_SHIFT)
#define PHY_MANAGEMENT_PHY_ADDRESS_SHIFT (23)
#define PHY_MANAGEMENT_PHY_ADDRESS_MASK (0x1f)
#define PHY_MANAGEMENT_PHY_ADDRESS(n)                                                              \
	((n & PHY_MANAGEMENT_PHY_ADDRESS_MASK) << PHY_MANAGEMENT_PHY_ADDRESS_SHIFT)
...
#define GEM_TX_DMA_NO_CRC (1 << 16) /* Bit 16: don't calc and append crc */
									/* Bits: 17 - 19: reserved */
#define GEM_TX_DMA_OFFLOAD_ERRORS_SHIFT                                                            \
	(20) /* Bits: 20 - 22 Transmit checksum generation offload errors */
...
#define GEM_TX_DMA_TS_PRESENT                                                                      \
	(1 << 23) /* Bit: 23 This descriptor holds a valid time stamp which indicates the transmit     \
		 time. */
			  /* Bits: 24 - 25 reserved */
#define GEM_TX_DMA_LATE_COL_ERROR (1 << 26) /* Bit 26: Late collision transmit error detected. */
#define GEM_TX_DMA_BUS_ERROR                                                                       \
	(1 << 27)						  /* Bit 27: Transmit frame corruption due to AHB/AXI error.   \
									   */
...
#define GEM_TX_DMA_WRAP                                                                            \
	(1 << 30) /* Bit 30: This is the last descriptor in the chain and the DMA controller will next \
		 access the first descriptor in the chain. */
#define GEM_TX_DMA_USED                                                                            \
	(1 << 31) /* Bit 31: Set to 0 by the driver to indicate buffer contains data to be             \
			   * transmitted. Set to 1 by the GEM once packet or packet fragment has been sent     \
			   * from the buffer. */
