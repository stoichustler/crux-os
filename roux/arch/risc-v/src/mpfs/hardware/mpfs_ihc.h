...
#define LIBERO_SETTING_CONTEXT_A_HART_EN                                                           \
	((CONFIG_MPFS_IHC_LINUX_ON_HART4 << 4) | (CONFIG_MPFS_IHC_LINUX_ON_HART3 << 3) |               \
	 (CONFIG_MPFS_IHC_LINUX_ON_HART2 << 2) | (CONFIG_MPFS_IHC_LINUX_ON_HART1 << 1))

#define LIBERO_SETTING_CONTEXT_B_HART_EN                                                           \
	((CONFIG_MPFS_IHC_ROUX_ON_HART4 << 4) | (CONFIG_MPFS_IHC_ROUX_ON_HART3 << 3) |               \
	 (CONFIG_MPFS_IHC_ROUX_ON_HART2 << 2) | (CONFIG_MPFS_IHC_ROUX_ON_HART1 << 1))
...
#if CONFIG_MPFS_IHC_ROUX_ON_HART1 == 1
#define CONTEXTB_HARTID 0x01
#elif CONFIG_MPFS_IHC_ROUX_ON_HART2 == 1
#define CONTEXTB_HARTID 0x02
#elif CONFIG_MPFS_IHC_ROUX_ON_HART3 == 1
#define CONTEXTB_HARTID 0x03
#elif CONFIG_MPFS_IHC_ROUX_ON_HART4 == 1
#define CONTEXTB_HARTID 0x04
#else
#error Context B is required
#endif

/* We currently support only C = B + 1, eg.  ROUX or other RPMSG slaves on
...
#define MPFS_IHC_VERSION(l, r)                                                                     \
	(IHC_LOCAL_H0_REMOTE_H1 + MPFS_IHC_VERSION_OFFSET + MPFS_LOCAL_REMOTE_OFFSET(l, r) +           \
	 MPFS_L_R_FIXUP(l, r))
#define MPFS_IHC_CTRL(l, r)                                                                        \
	(IHC_LOCAL_H0_REMOTE_H1 + MPFS_IHC_CTRL_OFFSET + MPFS_LOCAL_REMOTE_OFFSET(l, r) +              \
	 MPFS_L_R_FIXUP(l, r))
#define MPFS_IHC_LOCAL_HARTID(l, r)                                                                \
	(IHC_LOCAL_H0_REMOTE_H1 + MPFS_IHC_LOCAL_HARTID_OFFSET + MPFS_LOCAL_REMOTE_OFFSET(l, r) +      \
	 MPFS_L_R_FIXUP(l, r))
#define MPFS_IHC_MSG_SIZE(l, r)                                                                    \
	(IHC_LOCAL_H0_REMOTE_H1 + MPFS_IHC_MSG_SIZE_OFFSET + MPFS_LOCAL_REMOTE_OFFSET(l, r) +          \
	 MPFS_L_R_FIXUP(l, r))
#define MPFS_IHC_MSG_IN(l, r)                                                                      \
	(IHC_LOCAL_H0_REMOTE_H1 + MPFS_IHC_MSG_IN_OFFSET + MPFS_LOCAL_REMOTE_OFFSET(l, r) +            \
	 MPFS_L_R_FIXUP(l, r))
#define MPFS_IHC_MSG_OUT(l, r)                                                                     \
	(IHC_LOCAL_H0_REMOTE_H1 + MPFS_IHC_MSG_OUT_OFFSET + MPFS_LOCAL_REMOTE_OFFSET(l, r) +           \
	 MPFS_L_R_FIXUP(l, r))
...
#define IHCIA_CONTEXTA_INTS                                                                        \
	(HSS_HART_MP_INT_EN | HSS_HART_ACK_INT_EN | (1 << (CONTEXTB_HARTID * 2)) |                     \
	 (1 << (CONTEXTB_HARTID * 2 + 1)))

#define IHCIA_CONTEXTA2_INTS                                                                       \
	(HSS_HART_MP_INT_EN | HSS_HART_ACK_INT_EN | (1 << (CONTEXTC_HARTID * 2)) |                     \
	 (1 << (CONTEXTC_HARTID * 2 + 1)))

#define IHCIA_CONTEXTB_INTS                                                                        \
	(HSS_HART_MP_INT_EN | HSS_HART_ACK_INT_EN | (1 << (CONTEXTA_HARTID * 2)) |                     \
