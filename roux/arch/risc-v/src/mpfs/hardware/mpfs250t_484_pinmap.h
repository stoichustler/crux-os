...
#define MSSIO_IO_CFG_CR(bank, pin)                                                                 \
	(MPFS_SYSREG_BASE +                                                                            \
	 (bank == 0 ? MSSIO_IO_CFG_BANK0_CR_OFFSET(pin) : MSSIO_IO_CFG_BANK1_CR_OFFSET(pin)))
...
#define MSSIO_MUX_BANK0_REG_OFFSET(pin) (MPFS_SYSREG_IOMUX1_CR_OFFSET + (pin >> 3) * 4)
#define MSSIO_MUX_BANK1_REG_OFFSET(pin) (MPFS_SYSREG_IOMUX3_CR_OFFSET + (pin >> 3) * 4)

#define MSSIO_MUX_BANK_REG_OFFSET(bank, pin)                                                       \
	(bank == 0 ? MSSIO_MUX_BANK0_REG_OFFSET(pin) : MSSIO_MUX_BANK1_REG_OFFSET(pin))
#define MSSIO_MUX_BANK_REG(bank, pin) (MPFS_SYSREG_BASE + MSSIO_MUX_BANK_REG_OFFSET(bank, pin))
