...
static uint64_t g_app_entrypoints[] = {CONFIG_MPFS_HART0_ENTRYPOINT, CONFIG_MPFS_HART1_ENTRYPOINT,
									   CONFIG_MPFS_HART2_ENTRYPOINT, CONFIG_MPFS_HART3_ENTRYPOINT,
...
uint8_t g_mpfs_boot_stacks[ENTRY_STACK * ENTRYPT_CNT] aligned_data(STACK_ALIGNMENT);
#endif
