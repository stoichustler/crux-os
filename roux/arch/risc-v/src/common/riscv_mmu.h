...
#define RV_MMU_VADDR_SHIFT(_n) (RV_MMU_PAGE_SHIFT + RV_MMU_VPN_WIDTH * (RV_MMU_PT_LEVELS - (_n)))
/* Sv39 has:
 * - 4K page size
 * - 3 page table levels
 * - 9-bit VPN width
...
void mmu_ln_map_region(uint32_t ptlevel, uintptr_t lnvaddr, uintptr_t paddr, uintptr_t vaddr,
