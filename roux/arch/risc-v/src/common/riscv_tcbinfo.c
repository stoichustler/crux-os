...
static const uint16_t g_reg_offs[] = {
	...
	TCB_REG_OFF(REG_X1_NDX),  TCB_REG_OFF(REG_X2_NDX),	TCB_REG_OFF(REG_X3_NDX),
	TCB_REG_OFF(REG_X4_NDX),  TCB_REG_OFF(REG_X5_NDX),	TCB_REG_OFF(REG_X6_NDX),
	TCB_REG_OFF(REG_X7_NDX),  TCB_REG_OFF(REG_X8_NDX),	TCB_REG_OFF(REG_X9_NDX),
	TCB_REG_OFF(REG_X10_NDX), TCB_REG_OFF(REG_X11_NDX), TCB_REG_OFF(REG_X12_NDX),
	TCB_REG_OFF(REG_X13_NDX), TCB_REG_OFF(REG_X14_NDX), TCB_REG_OFF(REG_X15_NDX),
	TCB_REG_OFF(REG_X16_NDX), TCB_REG_OFF(REG_X17_NDX), TCB_REG_OFF(REG_X18_NDX),
	TCB_REG_OFF(REG_X19_NDX), TCB_REG_OFF(REG_X20_NDX), TCB_REG_OFF(REG_X21_NDX),
	TCB_REG_OFF(REG_X22_NDX), TCB_REG_OFF(REG_X23_NDX), TCB_REG_OFF(REG_X24_NDX),
	TCB_REG_OFF(REG_X25_NDX), TCB_REG_OFF(REG_X26_NDX), TCB_REG_OFF(REG_X27_NDX),
	TCB_REG_OFF(REG_X28_NDX), TCB_REG_OFF(REG_X29_NDX), TCB_REG_OFF(REG_X30_NDX),
	TCB_REG_OFF(REG_X31_NDX), TCB_REG_OFF(REG_EPC_NDX),
