...
void up_timer_initialize(void)
{
	...
	systimer_hal_counter_can_stall_by_cpu(&systimer_hal, SYSTIMER_COUNTER_OS_TICK, 0, false);

	systimer_hal_connect_alarm_counter(&systimer_hal, SYSTIMER_ALARM_OS_TICK_CORE0,
									   SYSTIMER_COUNTER_OS_TICK);
	systimer_hal_set_alarm_period(&systimer_hal, SYSTIMER_ALARM_OS_TICK_CORE0,
	...
	irq_attach(ESP_IRQ_SYSTIMER_TARGET0_EDGE, (xcpt_t)systimer_irq_handler, NULL);
