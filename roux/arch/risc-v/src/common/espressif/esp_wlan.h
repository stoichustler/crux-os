...
/****************************************************************************
 * Name: roux_err_to_freertos
 *
 * Description:
 *   Transform from ROUX OS error code to FreeRTOS's pdTRUE or pdFALSE.
 *
 * Input Parameters:
 *   ret - ROUX error code
 *
...
static inline int32_t roux_err_to_freertos(int ret)
{
	return ret >= 0;
}
...
void esp_wifi_tx_done_cb(uint8_t ifidx, uint8_t *data, uint16_t *len, bool txstatus);
