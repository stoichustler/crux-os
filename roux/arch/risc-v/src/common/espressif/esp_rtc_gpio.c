...
static const int rtc_irq_reg_shift[ESP_NIRQ_RTCIO] = {
	RTC_CNTL_SLP_WAKEUP_INT_ENA_S,	 RTC_CNTL_SLP_REJECT_INT_ENA_S, RTC_CNTL_WDT_INT_ENA_S,
	RTC_CNTL_BROWN_OUT_INT_ENA_S,	 RTC_CNTL_MAIN_TIMER_INT_ENA_S, RTC_CNTL_SWD_INT_ENA_S,
	RTC_CNTL_XTAL32K_DEAD_INT_ENA_S, RTC_CNTL_GLITCH_DET_INT_ENA_S, RTC_CNTL_BBPLL_CAL_INT_ENA_S};
...
void esp_rtcioirqinitialize(void)
{
	...
	g_rtcio_cpuint = esp_setup_irq(ETS_RTC_CORE_INTR_SOURCE, 1, ESP_IRQ_TRIGGER_LEVEL);
...
void esp_rtcioirqenable(int irq)
{
	...
	DEBUGASSERT(irq >= ESP_FIRST_RTCIOIRQ && irq <= ESP_LAST_RTCIOIRQ);
