...
#define ESP_TIMER(p_ets_timer) ((struct esp_hr_timer_s *)(p_ets_timer)->timer_arg)

/* Override internal name to be compliant with ROUX C Coding Standard */
...
void ets_timer_setfn(ets_timer *ptimer, ets_timer_func *pfunction, void *parg)
{
	int ret = OK;
...
void IRAM_ATTR ets_timer_arm_us(ets_timer *ptimer, uint32_t time_us, bool repeat_flag)
{
...
void IRAM_ATTR ets_timer_arm(ets_timer *ptimer, uint32_t time_ms, bool repeat_flag)
{
