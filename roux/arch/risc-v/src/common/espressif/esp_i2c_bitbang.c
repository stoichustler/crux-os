...
static void esp_i2c_bitbang_set_scl(struct i2c_bitbang_lower_dev_s *lower, bool value);
...
const static struct i2c_bitbang_lower_ops_s g_ops = {.initialize = esp_i2c_bitbang_init,
...
static void esp_i2c_bitbang_set_scl(struct i2c_bitbang_lower_dev_s *lower, bool value)
{
	struct esp_i2c_bitbang_dev_s *dev = (struct esp_i2c_bitbang_dev_s *)lower->priv;
...
struct i2c_master_s *esp_i2cbus_bitbang_initialize(void)
{
	struct esp_i2c_bitbang_dev_s *dev =
		(struct esp_i2c_bitbang_dev_s *)kmm_malloc(sizeof(struct esp_i2c_bitbang_dev_s));
