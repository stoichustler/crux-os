...
uintptr_t dispatch_syscall(unsigned int nbr, uintptr_t parm1, uintptr_t parm2, uintptr_t parm3,
						   uintptr_t parm4, uintptr_t parm5, uintptr_t parm6, void *context)
{
...
int riscv_swint(int irq, void *context, void *arg)
{
	...
	case SYS_signal_handler: {
		...
		if (rtcb->xcp.kstack != NULL) {
			...
			usr_regs = (uintptr_t *)((uintptr_t)rtcb->xcp.ktopstk - XCPTCONTEXT_SIZE);
			usp = usr_regs[REG_SP];
