...
int riscv_map_pages(arch_addrenv_t *addrenv, uintptr_t *pages, unsigned int npages, uintptr_t vaddr,
					int prot)
{
	uintptr_t ptlast;
	uintptr_t ptlevel;
...
int riscv_unmap_pages(arch_addrenv_t *addrenv, uintptr_t vaddr, unsigned int npages)
{
	uintptr_t ptlast;
	uintptr_t ptprev;
	uintptr_t ptlevel;
