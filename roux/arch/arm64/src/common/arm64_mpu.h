...
#define REGION_RAM_ATTR                                                                            \
	{                                                                                              \
		/* AP, XN, SH */                                                                           \
		.rbar = (NOT_EXEC | P_RW_U_NA_MSK | INNER_SHAREABLE_MSK), /* Cache-ability */              \
...
#define REGION_RAM_TEXT_ATTR                                                                       \
	{                                                                                              \
		/* AP, XN, SH */                                                                           \
		.rbar = P_RO_U_RO_MSK | NON_SHAREABLE_MSK, /* Cache-ability */                             \
			.mair_idx = MPU_MAIR_INDEX_SRAM,                                                       \
	}
...
#define REGION_RAM_RO_ATTR                                                                         \
	{                                                                                              \
		/* AP, XN, SH */                                                                           \
		.rbar = NOT_EXEC | P_RO_U_RO_MSK | NON_SHAREABLE_MSK, /* Cache-ability */                  \
			.mair_idx = MPU_MAIR_INDEX_SRAM,                                                       \
	}
...
#define MPU_REGION_ENTRY(_name, _base, _limit, _attr)                                              \
	{                                                                                              \
		.name = _name, .base = _base, .limit = _limit, .attr = _attr,                              \
	}
