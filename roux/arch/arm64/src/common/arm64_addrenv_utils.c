...
int arm64_map_pages(arch_addrenv_t *addrenv, uintptr_t *pages, unsigned int npages, uintptr_t vaddr,
					uint64_t prot)
{
	uintptr_t ptlast;
	uintptr_t ptlevel;
...
int arm64_unmap_pages(arch_addrenv_t *addrenv, uintptr_t vaddr, unsigned int npages)
{
	uintptr_t ptlast;
	uintptr_t ptprev;
	uintptr_t ptlevel;
