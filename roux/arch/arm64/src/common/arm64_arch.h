...
#define SCTLR_EL3_RES1                                                                             \
	(BIT(29) | BIT(28) | BIT(23) | BIT(22) | BIT(18) | BIT(16) | BIT(11) | BIT(5) | BIT(4))

#define SCTLR_EL2_RES1                                                                             \
	(BIT(29) | BIT(28) | BIT(23) | BIT(22) | BIT(18) | BIT(16) | BIT(11) | BIT(5) | BIT(4))

#define SCTLR_EL1_RES1 (BIT(29) | BIT(28) | BIT(23) | BIT(22) | BIT(20) | BIT(11))
...
#define arm64_current_el()                                                                         \
	({                                                                                             \
		uint64_t __el;                                                                             \
		int __ret;                                                                                 \
		__asm__ volatile("mrs %0, CurrentEL" : "=r"(__el));                                        \
		__ret = GET_EL(__el);                                                                      \
		__ret;                                                                                     \
	})
