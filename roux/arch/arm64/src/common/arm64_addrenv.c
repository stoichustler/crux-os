...
static int create_region(arch_addrenv_t *addrenv, uintptr_t vaddr, size_t size, uint64_t mmuflags)
{
	uintptr_t ptlast;
	uintptr_t ptprev;
	uintptr_t paddr;
...
int up_addrenv_create(size_t textsize, size_t datasize, size_t heapsize, arch_addrenv_t *addrenv)
{
	int ret;
	uintptr_t resvbase;
	uintptr_t resvsize;
...
int up_addrenv_vdata(arch_addrenv_t *addrenv, uintptr_t textsize, void **vdata)
{
