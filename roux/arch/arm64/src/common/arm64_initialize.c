...
#ifdef CONFIG_SMP
INIT_STACK_ARRAY_DEFINE(g_cpu_idlestackalloc, CONFIG_SMP_NCPUS, SMP_STACK_SIZE);
INIT_STACK_ARRAY_DEFINE(g_interrupt_stacks, CONFIG_SMP_NCPUS, INTSTACK_SIZE);

#ifdef CONFIG_ARM64_DECODEFIQ
INIT_STACK_ARRAY_DEFINE(g_interrupt_fiq_stacks, CONFIG_SMP_NCPUS, INTSTACK_SIZE);
#endif
...
#ifdef CONFIG_ARCH_FPU
int arm64_panic_disable_fpu(struct notifier_block *block, unsigned long action, void *data)
{
	arm64_fpu_disable();
	return 0;
}
