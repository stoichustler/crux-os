...
#define PMCR_EL0_E                                                                                 \
	(1ul                                                                                           \
	 << 0) /* All counters that are accessible at Non-secure EL1 are enabled by PMCNTENSET_EL0 */
...
#define PMSELR_EL0_SEL_C                                                                           \
	(0x1ful << 0) /* When PMSELR_EL0.SEL is 0b11111, it selects the cycle counter */
...
#define CLUSTERPMSELR_EL1_SEL_C                                                                    \
	(0x1ful << 0) /* When CLUSTERPMSELR_EL0.SEL is 0b11111, it selects the cycle counter */

/* CLUSTERPMINTENCLR_EL1 */

#define CLUSTERPMINTENCLR_EL1_C                                                                    \
	(1ul << 31) /* CLUSTERPMCCNTR_EL0 overflow interrupt request disable bit */
