...
uintptr_t up_addrenv_find_page(arch_addrenv_t *addrenv, uintptr_t vaddr)
{
	...
	for (ptlevel = mmu_get_base_pgt_level(), lnvaddr = pgdir; ptlevel < MMU_PGT_LEVEL_MAX;
		 ptlevel++) {
...
int up_addrenv_kmap_pages(void **pages, unsigned int npages, uintptr_t vaddr, int prot)
{
