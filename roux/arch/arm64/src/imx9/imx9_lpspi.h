 ...
 *   struct spi_ops_s (see include/roux/spi/spi.h). All other methods
 ...
 *      board is configured.
 *   3. If CONFIG_SPI_CMDDATA is defined in your ROUX configuration file,
 ...
 *   method of the SPI interface (see include/roux/spi/spi.h for details)
 *
 * Input Parameters:
 *   dev -      Device-specific state data
...
int imx9_lpspi_register(struct spi_dev_s *dev, spi_mediachange_t callback, void *arg);
#endif
