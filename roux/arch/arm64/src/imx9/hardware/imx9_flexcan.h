...
#define CAN_ESR1_ERRINTFAST                                                                        \
	(1 << 20) /* Bit 20: Error Interrupt for Errors Detected in Data Phase of CAN FD frames */
...
#define CAN_ESR1_PTA (1 << 23)	  /* Bit 23: Passive to Active State */
								  /* Bits 24-25: Reserved */
#define CAN_ESR1_STFERRFAST                                                                        \
	(1 << 26) /* Bit 26: Stuffing Error in the Data Phase of CAN FD frames */
#define CAN_ESR1_FRMERRFAST (1 << 27) /* Bit 27: Form Error in the Data Phase of CAN FD frames */
#define CAN_ESR1_CRCERRFAST                                                                        \
	(1 << 28) /* Bit 28: Cyclic Redundancy Check Error in the CRC field of CAN FD frames */
			  /* Bit 29: Reserved */
...
#define CAN_CTRL2_TSTAMPCAP_CSOF                                                                   \
	(3 << CAN_CTRL2_TSTAMPCAP_SHIFT) /* Start of classical CAN frame or res for CAN FD */
...
#define CAN_CTRL2_MBTSBASE_LOWER                                                                   \
	(1 << CAN_CTRL2_MBTSBASE_SHIFT) /* Lower 16 bits of high-resolution timer */
#define CAN_CTRL2_MBTSBASE_UPPER                                                                   \
	(2 << CAN_CTRL2_MBTSBASE_SHIFT) /* Upper 16 bits of high-resolution timer */
...
#define CAN_CTRL2_EACEN                                                                            \
	(1 << 16)					/* Bit 16: Entire Frame Arbitration Field Comparison Enable (Rx) */
...
#define CAN_CTRL2_ECRWRE                                                                           \
	(1 << 29) /* Bit 28: Error Correction Configuration Register Write Enable */
#define CAN_CTRL2_BOFFDONEMSK (1 << 30) /* Bit 30: Bus Off Done Interrupt Mask */
#define CAN_CTRL2_ERRMSKFAST                                                                       \
	(1 << 31) /* Bit 31: Error Interrupt for Errors Detected in the Data Phase of CAN FD frames */
#define CAN_CTRL2_WRMFRZ                                                                           \
	(1 << 28) /* Bit 28: Enable unrestricted write access to FlexCAN memory in Freeze mode */
			  /* Bits 29-31: Reserved */
...
#define CAN_FDCTRL_MBDSR1(x)                                                                       \
	(((uint32_t)(((uint32_t)(x)) << CAN_FDCTRL_MBDSR1_SHIFT)) & CAN_FDCTRL_MBDSR1_MASK)
...
#define CAN_FDCTRL_MBDSR2(x)                                                                       \
	(((uint32_t)(((uint32_t)(x)) << CAN_FDCTRL_MBDSR2_SHIFT)) & CAN_FDCTRL_MBDSR2_MASK)
/* Bits 24-30: Reserved */
