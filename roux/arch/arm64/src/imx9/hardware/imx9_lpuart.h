...
#define LPUART_PINCFG_TRGSEL_RXD                                                                   \
	(1 << LPUART_PINCFG_TRGSEL_SHIFT) /* Trigger used instead of RXD pin */
#define LPUART_PINCFG_TRGSEL_CTSB                                                                  \
	(2 << LPUART_PINCFG_TRGSEL_SHIFT) /* Trigger used instead of CTS_B pin */
#define LPUART_PINCFG_TRGSEL_TXDMOD                                                                \
	(3 << LPUART_PINCFG_TRGSEL_SHIFT) /* Trigger used to modulate the TXD output */
...
#define LPUART_BAUD_RXEDGIE                                                                        \
	(1 << 14)							/* Bit 14: RX Input Active Edge Interrupt Enable (RXEDGIE) \
										 */
...
#define LPUART_BAUD_MATCFG_RWUENAB                                                                 \
	(3 << LPUART_BAUD_MATCFG_SHIFT) /* Enables RWU on Data Match and Match On/Off for transmitter  \
					   CTS input */
...
#define LPUART_ALL_INTS                                                                            \
	(LPUART_CTRL_ORIE | LPUART_CTRL_NEIE | LPUART_CTRL_FEIE | LPUART_CTRL_PEIE | LPUART_CTRL_TIE | \
	 LPUART_CTRL_TCIE | LPUART_CTRL_RIE | LPUART_CTRL_ILIE | LPUART_CTRL_MA1IE |                   \
	 LPUART_CTRL_MA2IE)
...
#define LPUART_DATA_FRETSC                                                                         \
	(1 << 13)						  /* Bit 13: Frame Error / Transmit Special Character (FRETSC) \
									   */
...
#define LPUART_MODIR_TXRTSPOL                                                                      \
	(1 << 2)						 /* Bit 2: Transmitter request-to-send polarity (TXRTSPOL)     \
									  */
...
#define LPUART_MODIR_TXCTSSRC_RXMAT                                                                \
	(1 << 5)							/*        CTS input is receiver address match result       \
										 */
										/* Bits 6-7: Reserved */
...
#define LPUART_FIFO_RXIDEN_DISABLE                                                                 \
	(0 << LPUART_FIFO_RXIDEN_SHIFT) /* Disable RDRF assertion when receiver is idle */
#define LPUART_FIFO_RXIDEN_1                                                                       \
	(1 << LPUART_FIFO_RXIDEN_SHIFT) /* Enable RDRF assertion when receiver idle for 1 character */
#define LPUART_FIFO_RXIDEN_2                                                                       \
	(2 << LPUART_FIFO_RXIDEN_SHIFT) /* Enable RDRF assertion when receiver idle for 2 characters   \
									 */
#define LPUART_FIFO_RXIDEN_4                                                                       \
	(3 << LPUART_FIFO_RXIDEN_SHIFT) /* Enable RDRF assertion when receiver idle for 4 characters   \
									 */
#define LPUART_FIFO_RXIDEN_8                                                                       \
	(4 << LPUART_FIFO_RXIDEN_SHIFT) /* Enable RDRF assertion when receiver idle for 8 characters   \
									 */
#define LPUART_FIFO_RXIDEN_16                                                                      \
	(5 << LPUART_FIFO_RXIDEN_SHIFT) /* Enable RDRF assertion when receiver idle for 16 characters  \
									 */
#define LPUART_FIFO_RXIDEN_32                                                                      \
	(6 << LPUART_FIFO_RXIDEN_SHIFT) /* Enable RDRF assertion when receiver idle for 32 characters  \
									 */
#define LPUART_FIFO_RXIDEN_64                                                                      \
	(7 << LPUART_FIFO_RXIDEN_SHIFT) /* Enable RDRF assertion when receiver idle for 64 characters  \
									 */
