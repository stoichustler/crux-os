...
#define ENET_MSCR_HOLDTIME_1CYCLE                                                                  \
	(0 << ENET_MSCR_HOLDTIME_SHIFT) /* 1 internal module clock cycle */
#define ENET_MSCR_HOLDTIME_2CYCLES                                                                 \
	(1 << ENET_MSCR_HOLDTIME_SHIFT) /* 2 internal module clock cycles */
#define ENET_MSCR_HOLDTIME_3CYCLES                                                                 \
	(2 << ENET_MSCR_HOLDTIME_SHIFT) /* 3 internal module clock cycles */
#define ENET_MSCR_HOLDTIME_8CYCLES                                                                 \
	(7 << ENET_MSCR_HOLDTIME_SHIFT) /* 8 internal module clock cycles */
...
#define ENET_RSEM_RX_EMPTY_SHIFT                                                                   \
	(0) /* Bits 0-9: Value of the receive FIFO section empty threshold */
...
#define ENET_RACC_IPDIS                                                                            \
	(1 << 1) /* Bit 1: Enable discard of frames with wrong IPv4 header checksum */
#define ENET_RACC_PRODIS                                                                           \
	(1 << 2)					   /* Bit 2: Enable discard of frames with wrong protocol checksum \
									*/
								   /* Bits 3-5: Reserved */
...
#define ENET_ATCR_PINPER                                                                           \
	(1 << 7) /* Bit 7:  Enables event signal output assertion on period event */
			 /* Bit 8:  Reserved */
...
#define ENET_ATINC_INC_SHIFT                                                                       \
	(0) /* Bits 0-6: Clock period of the timestamping clock (ts_clk) in nanoseconds */
...
#define ENET_TCSR_TMODE_ICFALLLING                                                                 \
	(2 << ENET_TCSR_TMODE_SHIFT)							/* Input Capture on falling edge       \
															 */
...
#define ENET_TCSR_TMODE_OCTOGGLE                                                                   \
	(5 << ENET_TCSR_TMODE_SHIFT)						   /* Output Compare, toggle on compare */
...
#define ENET_TCSR_TMODE_OCSETCLR                                                                   \
	(9 << ENET_TCSR_TMODE_SHIFT) /* Output Compare, set on compare, clear on overflow */
#define ENET_TCSR_TMODE_OCCLRSET                                                                   \
	(10 << ENET_TCSR_TMODE_SHIFT) /*  Output Compare, clear on compare, set on overflow */
#define ENET_TCSR_TMODE_PCPULSEL                                                                   \
	(14 << ENET_TCSR_TMODE_SHIFT) /* Output Compare, pulse low on compare */
#define ENET_TCSR_TMODE_PCPULSEH                                                                   \
	(15 << ENET_TCSR_TMODE_SHIFT) /* Output Compare, pulse high on compare */
...
#define TXDESC_STATUS2_ERRORS                                                                      \
	(TXDESC_TSE | TXDESC_OE | TXDESC_LCE | TXDESC_FE | TXDESC_EE | TXDESC_UE | TXDESC_TXE)
