...
#define IMX9_EDMA_CH_GRPRI_OFFSET(n)                                                               \
	(0x000100 + ((n) << 2)) /* Channel n Arbitration Group Register (CHn_GRPRI) */

/* eDMA3 only */

#define IMX9_EDMA_INT_OFFSET                                                                       \
	(0x000008) /* Management Page Interrupt Request Status Register (INT) */
#define IMX9_EDMA_HRS_OFFSET                                                                       \
	(0x00000c) /* Management Page Hardware Request Status Register (HRS)                           \
				*/

/* eDMA4 only */

#define IMX9_EDMA_INT_LOW_OFFSET                                                                   \
	(0x000008) /* Management Page Interrupt Request Status Register (INT_LOW) */
#define IMX9_EDMA_INT_HIGH_OFFSET                                                                  \
	(0x00000c) /* Management Page Interrupt Request Status Register (INT_HIGH) */
#define IMX9_EDMA_HRS_LOW_OFFSET                                                                   \
	(0x000010) /* Management Page Hardware Request Status Register (HRS_LOW) */
#define IMX9_EDMA_HRS_HIGH_OFFSET                                                                  \
	(0x000014) /* Management Page Hardware Request Status Register (HRS_HIGH) */
...
#define IMX9_EDMA_CH_MUX_OFFSET                                                                    \
	(0x000014) /* Channel Multiplexor Configuration (CH0_MUX) (eDMA4 only) */
#define IMX9_EDMA_CH_MATTR_OFFSET                                                                  \
	(0x000018) /* Memory Attributes Register (CH0_MATTR) (eDMA4 only) */
#define IMX9_EDMA_TCD_SADDR_OFFSET (0x000020) /* TCD Source Address Register (TCD0_SADDR) */
#define IMX9_EDMA_TCD_SOFF_OFFSET                                                                  \
	(0x000024) /* TCD Signed Source Address Offset Register (TCD0_SOFF) */
...
#define IMX9_EDMA_TCD_SLAST_SDA_OFFSET                                                             \
	(0x00002c) /* TCD Last Source Address Adjustment / Store DADDR Address Register                \
		  (TCD0_SLAST_SDA) */
#define IMX9_EDMA_TCD_DADDR_OFFSET (0x000030) /* TCD Destination Address Register (TCD0_DADDR) */
#define IMX9_EDMA_TCD_DOFF_OFFSET                                                                  \
	(0x000034) /* TCD Signed Destination Address Offset Register (TCD0_DOFF) */
#define IMX9_EDMA_TCD_CITER_OFFSET                                                                 \
	(0x000036) /* TCD Current Major Loop Count Register (TCD0_CITER) */
#define IMX9_EDMA_TCD_DLAST_SGA_OFFSET                                                             \
	(0x000038) /* TCD Last Destination Address Adjustment / Scatter Gather Address Register        \
		  (TCD0_DLAST_SGA)*/
#define IMX9_EDMA_TCD_CSR_OFFSET (0x00003c) /* TCD Control and Status Register (TCD0_CSR) */
#define IMX9_EDMA_TCD_BITER_OFFSET                                                                 \
	(0x00003e) /* TCD Beginning Major Loop Count Register (TCD0_BITER) */
...
#define IMX9_EDMA_TCD_INST_OFFSET(n)                                                               \
	((n) == IMX9_DMA3_BASE ? IMX9_EDMA3_TCD_INST_OFFSET : IMX9_EDMA4_TCD_INST_OFFSET)
...
#define EDMA_ES_ECX (1 << 8) /* Bit 8: Transfer Canceled (ECX) */
							 /* Bits 9-23: Reserved */
#define EDMA_ES_ERRCHN_SHIFT                                                                       \
	(24) /* Bits 24-28: Error Channel Number or Canceled Channel Number (ERRCHN) */
...
#define EDMA_CH_CSR_EARQ                                                                           \
	(1 << 1) /* Bit 1: Enable Asynchronous DMA Request in Stop Mode for Channel (EARQ) */
...
#define EDMA_TCD_NBYTES_SHIFT                                                                      \
	(0) /* Bits 0-29: Number of Bytes to Transfer per Service Request (NBYTES) */
...
#define EDMA_TCD_SLAST_SDA_SHIFT                                                                   \
	(0) /* Bits 0-31: Last Source Address Adjustment / Store DADDR Address (SLAST_SDA) */
...
#define EDMA_TCD_CITER_LINKCH(n)                                                                   \
	(((n) << EDMA_TCD_CITER_LINKCH_SHIFT) & EDMA_TCD_CITER_LINKCH_SHIFT)
...
#define EDMA_TCD_DLAST_SGA_SHIFT                                                                   \
	(0) /* Bits 0-31: Last Destination Address Adjustment / Scatter Gather Address (DLAST_SGA) */
...
#define EDMA_TCD_CSR_INTMAJOR                                                                      \
	(1 << 1) /* Bit 1: Enable Interrupt if Major count complete (INTMAJOR) */
#define EDMA_TCD_CSR_INTHALF                                                                       \
	(1 << 2) /* Bit 2: Enable Interrupt if Major Count Half-complete (INTHALF) */
...
#define EDMA_TCD_CSR_MAJORELINK                                                                    \
	(1 << 5)					   /* Bit 5: Enable Link When Major Loop Complete (MAJORELINK) */
...
#define EDMA_TCD_CSR_MAJORLINKCH_SHIFT                                                             \
	(8) /* Bits 8-12: Major Loop Link Channel Number (MAJORLINKCH) */
#define EDMA_TCD_CSR_MAJORLINKCH_MASK (0x1f << EDMA_TCD_CSR_MAJORLINKCH_SHIFT)
#define EDMA_TCD_CSR_MAJORLINKCH(n)                                                                \
	(((n) << EDMA_TCD_CSR_MAJORLINKCH_SHIFT) & EDMA_TCD_CSR_MAJORLINKCH_MASK)
/* Bit 13: Reserved */
...
#define EDMA_TCD_CSR_BWC_HPE                                                                       \
	(0x01 << EDMA_TCD_CSR_BWC_SHIFT) /* Enable eDMA master high-priority elevation (HPE) mode */
#define EDMA_TCD_CSR_BWC_4CYCLES                                                                   \
	(0x02 << EDMA_TCD_CSR_BWC_SHIFT) /* eDMA engine stalls for 4 cycles after each R/W */
#define EDMA_TCD_CSR_BWC_8CYCLES                                                                   \
	(0x03 << EDMA_TCD_CSR_BWC_SHIFT) /* eDMA engine stalls for 8 cycles after each R/W */
...
struct imx9_edmatcd_s {
	...
	uint32_t dlastsga; /* Offset: 0x0018  TCD Last Destination Address Adjustment/Scatter Gather
			  Address */
