...
#define IMX9_CCM_CR_CTRL_OFFSET(n)                                                                 \
	(0x0000 + ((n) << 7)) /* Clock root control (CLOCK_ROOTn_CONTROL, n=0..94) */
#define IMX9_CCM_CR_CTRL_SET_OFFSET(n)                                                             \
	(0x0004 + ((n) << 7)) /* Clock root control (CLOCK_ROOTn_CONTROL_SET, n=0..94) */
#define IMX9_CCM_CR_CTRL_CLR_OFFSET(n)                                                             \
	(0x0008 + ((n) << 7)) /* Clock root control (CLOCK_ROOTn_CONTROL_CLR, n=0..94) */
#define IMX9_CCM_CR_CTRL_TOG_OFFSET(n)                                                             \
	(0x000c + ((n) << 7)) /* Clock root control (CLOCK_ROOTn_CONTROL_TOG, n=0..94) */
#define IMX9_CCM_CR_STAT0_OFFSET(n)                                                                \
	(0x0020 + ((n) << 7)) /* Clock root working status (CLOCK_ROOTn_STATUS0, n=0..94) */
#define IMX9_CCM_CR_AUTH_OFFSET(n)                                                                 \
	(0x0030 + ((n) << 7)) /* Clock root access control (CLOCK_ROOTn_AUTHEN, n=0..94) */
#define IMX9_CCM_CR_AUTH_SET_OFFSET(n)                                                             \
	(0x0034 + ((n) << 7)) /* Clock root access control (CLOCK_ROOTn_AUTHEN_SET, n=0..94) */
#define IMX9_CCM_CR_AUTH_CLR_OFFSET(n)                                                             \
	(0x0038 + ((n) << 7)) /* Clock root access control (CLOCK_ROOTn_AUTHEN_CLR, n=0..94) */
#define IMX9_CCM_CR_AUTH_TOG_OFFSET(n)                                                             \
	(0x003c + ((n) << 7)) /* Clock root access control (CLOCK_ROOTn_AUTHEN_TOG, n=0..94) */

#define IMX9_CCM_GPR_SH_OFFSET(n)                                                                  \
	(0x4800 + ((n) << 5)) /* General Purpose Register (GPR_SHAREDn, n=0..7) */
#define IMX9_CCM_GPR_SH_SET_OFFSET(n)                                                              \
	(0x4804 + ((n) << 5)) /* General Purpose Register (GPR_SHAREDn_SET, n=0..7) */
#define IMX9_CCM_GPR_SH_CLR_OFFSET(n)                                                              \
	(0x4808 + ((n) << 5)) /* General Purpose Register (GPR_SHAREDn_CLR, n=0..7) */
#define IMX9_CCM_GPR_SH_TOG_OFFSET(n)                                                              \
	(0x480c + ((n) << 5)) /* General Purpose Register (GPR_SHAREDn_TOG, n=0..7) */
#define IMX9_CCM_GPR_SH_AUTH_OFFSET(n)                                                             \
	(0x4810 + ((n) << 5)) /* General Purpose Register (GPR_SHAREDn_AUTHEN, n=0..7) */
#define IMX9_CCM_GPR_SH_AUTH_SET_OFFSET(n)                                                         \
	(0x4814 + ((n) << 5)) /* General Purpose Register (GPR_SHAREDn_AUTHEN_SET, n=0..7) */
#define IMX9_CCM_GPR_SH_AUTH_CLR_OFFSET(n)                                                         \
	(0x4818 + ((n) << 5)) /* General Purpose Register (GPR_SHAREDn_AUTHEN_CLR, n=0..7) */
#define IMX9_CCM_GPR_SH_AUTH_TOG_OFFSET(n)                                                         \
	(0x481c + ((n) << 5)) /* General Purpose Register (GPR_SHAREDn_AUTHEN_TOG, n=0..7) */

#define IMX9_CCM_GPR_PR_OFFSET(n)                                                                  \
	(0x4c00 + (((n)-1) << 5)) /* General Purpose Register (GPR_PRIVATEn, n=1..7) */
#define IMX9_CCM_GPR_PR_SET_OFFSET(n)                                                              \
	(0x4c04 + (((n)-1) << 5)) /* General Purpose Register (GPR_PRIVATEn_SET, n=1..7) */
#define IMX9_CCM_GPR_PR_CLR_OFFSET(n)                                                              \
	(0x4c08 + (((n)-1) << 5)) /* General Purpose Register (GPR_PRIVATEn_CLR, n=1..7) */
#define IMX9_CCM_GPR_PR_TOG_OFFSET(n)                                                              \
	(0x4c0c + (((n)-1) << 5)) /* General Purpose Register (GPR_PRIVATEn_TOG, n=1..7) */
#define IMX9_CCM_GPR_PR_AUTH_OFFSET(n)                                                             \
	(0x4c10 + (((n)-1) << 5)) /* General Purpose Register (GPR_PRIVATEn_AUTHEN, n=1..7) */
#define IMX9_CCM_GPR_PR_AUTH_SET_OFFSET(n)                                                         \
	(0x4c14 + (((n)-1) << 5)) /* General Purpose Register (GPR_PRIVATEn_AUTHEN_SET, n=1..7) */
#define IMX9_CCM_GPR_PR_AUTH_CLR_OFFSET(n)                                                         \
	(0x4c18 + (((n)-1) << 5)) /* General Purpose Register (GPR_PRIVATEn_AUTHEN_CLR, n=1..7) */
#define IMX9_CCM_GPR_PR_AUTH_TOG_OFFSET(n)                                                         \
	(0x4c1c + (((n)-1) << 5)) /* General Purpose Register (GPR_PRIVATEn_AUTHEN_TOG, n=1..7) */

#define IMX9_CCM_OSCPLL_DIR_OFFSET(n)                                                              \
	(0x5000 + ((n) << 6)) /* Clock source direct control (OSCPLLn_DIRECT, n=0..18) */
#define IMX9_CCM_OSCPLL_LPM_STAT0_OFFSET(n)                                                        \
	(0x5004 + ((n) << 6)) /* Clock source direct control (OSCPLLn_DIRECT, n=0..18) */
#define IMX9_CCM_OSCPLL_LPM_STAT1_OFFSET(n)                                                        \
	(0x5008 + ((n) << 6)) /* Clock source direct control (OSCPLLn_DIRECT, n=0..18) */
#define IMX9_CCM_OSCPLL_LPM0_OFFSET(n)                                                             \
	(0x5010 + ((n) << 6)) /* Clock source direct control (OSCPLLn_DIRECT, n=0..18) */
#define IMX9_CCM_OSCPLL_LPM1_OFFSET(n)                                                             \
	(0x5014 + ((n) << 6)) /* Clock source direct control (OSCPLLn_DIRECT, n=0..18) */
#define IMX9_CCM_OSCPLL_LPM_CUR_OFFSET(n)                                                          \
	(0x501C + ((n) << 6)) /* Clock source direct control (OSCPLLn_DIRECT, n=0..18) */
#define IMX9_CCM_OSCPLL_STAT0_OFFSET(n)                                                            \
	(0x5020 + ((n) << 6)) /* Clock source working status (OSCPLLn_STATUS0, n=0..18) */
#define IMX9_CCM_OSCPLL_STAT1_OFFSET(n)                                                            \
	(0x5024 + ((n) << 6)) /* Clock source low power status (OSCPLLn_STATUS1, n=0..18) */
#define IMX9_CCM_OSCPLL_AUTH_OFFSET(n)                                                             \
	(0x5030 + ((n) << 6)) /* Clock source access control (OSCPLLn_AUTHEN, n=0..18) */

#define IMX9_CCM_LPCG_DIR_OFFSET(n)                                                                \
	(0x8000 + ((n) << 6)) /* LPCG direct control (LPCGn_DIRECT, n=0..126) */
#define IMX9_CCM_LPCG_LPM_STAT0_OFFSET(n)                                                          \
	(0x8004 + ((n) << 6)) /* Clock source direct control (OSCPLLn_DIRECT, n=0..126) */
#define IMX9_CCM_LPCG_LPM_STAT1_OFFSET(n)                                                          \
	(0x8008 + ((n) << 6)) /* Clock source direct control (OSCPLLn_DIRECT, n=0..126) */
#define IMX9_CCM_LPCG_LPM0_OFFSET(n)                                                               \
	(0x8010 + ((n) << 6)) /* Clock source direct control (OSCPLLn_DIRECT, n=0..126) */
#define IMX9_CCM_LPCG_LPM1_OFFSET(n)                                                               \
	(0x8014 + ((n) << 6)) /* Clock source direct control (OSCPLLn_DIRECT, n=0..126) */
#define IMX9_CCM_LPCG_LPM_CUR_OFFSET(n)                                                            \
	(0x801C + ((n) << 6)) /* Clock source direct control (OSCPLLn_DIRECT, n=0..126) */
#define IMX9_CCM_LPCG_STAT0_OFFSET(n)                                                              \
	(0x8020 + ((n) << 6)) /* LPCG working status (LPCGn_STATUS0, n=0..126) */
#define IMX9_CCM_LPCG_STAT1_OFFSET(n)                                                              \
	(0x8024 + ((n) << 6)) /* LPCG low power status (LPCGn_STATUS1, n=0..126) */
#define IMX9_CCM_LPCG_AUTH_OFFSET(n)                                                               \
	(0x8030 + ((n) << 6)) /* LPCG access control (LPCGn_AUTHEN, n=0..126) */
...
#define CCM_CR_STAT0_OFF (1 << 24) /* Bit 24:     Current clock root OFF setting (OFF) */
								   /* Bits 25-27: Reserved */
#define CCM_CR_STAT0_SLICE_BUSY                                                                    \
	(1 << 28) /* Bit 28:     Clock generation logic is applying the new setting (SLICE_BUSY) */
#define CCM_CR_STAT0_CHANGING                                                                      \
	(1 << 31) /* Bit 31:     Clock generation logic is updating currently (CHANGING) */

/* Clock root access control (CLOCK_ROOTn_AUTHEN, n=0..94) */

#define CCM_CR_AUTH_TZ_USER                                                                        \
	(1 << 8) /* Bit 8:      Clock root can be changed in user mode (TZ_USER) */
#define CCM_CR_AUTH_TZ_NS                                                                          \
	(1 << 9) /* Bit 9:      Clock root can be changed in non-secure mode (TZ_NS) */
			 /* Bit 10:     Reserved */
...
#define CCM_CR_AUTH_WHITE_LIST_SHIFT                                                               \
	(16) /* Bits 16-31:  Allow domains to change clock (WHITE_LIST) */
#define CCM_CR_AUTH_WHITE_LIST_MASK (0xffff << CCM_CR_AUTH_WHITE_LIST_SHIFT)

/* General Purpose Register (GPR_SHAREDn, n=0..7) */

#define CCM_GPR_SH_GPR_SHIFT                                                                       \
	(0) /* Bits 0-31:  General purpose register, shared for all CPU domains (GPR) */
...
#define CCM_GPR_SH_AUTH_TZ_USER                                                                    \
	(1 << 8) /* Bit 8:      Clock root can be changed in user mode (TZ_USER) */
#define CCM_GPR_SH_AUTH_TZ_NS                                                                      \
	(1 << 9) /* Bit 9:      Clock root can be changed in non-secure mode (TZ_NS) */
			 /* Bit 10:     Reserved */
...
#define CCM_GPR_SH_AUTH_WHITE_LIST_SHIFT                                                           \
	(16) /* Bits 16-31:  Allow domains to change clock (WHITE_LIST) */
...
#define CCM_GPR_PR_GPR_SHIFT                                                                       \
	(0) /* Bits 0-31:  General purpose register, with dedicated bits for each domain (GPR) */
#define CCM_GPR_PR_GPR_MASK (0xffffffff << CCM_GPR_PR_GPR_SHIFT)

/* General Purpose Register (GPR_PRIVATEn_AUTHEN, n=1..7) */

#define CCM_GPR_PR_AUTH_TZ_USER                                                                    \
	(1 << 8) /* Bit 8:      Clock root can be changed in user mode (TZ_USER) */
#define CCM_GPR_PR_AUTH_TZ_NS                                                                      \
	(1 << 9) /* Bit 9:      Clock root can be changed in non-secure mode (TZ_NS) */
			 /* Bit 10:     Reserved */
...
#define CCM_GPR_PR_AUTH_WHITE_LIST_SHIFT                                                           \
	(16) /* Bits 16-31: Allow domains to change clock (WHITE_LIST) */
...
#define CCM_OSCPLL_LPM_STAT_CPU_MODE_GET(n, v)                                                     \
	(((v) >> CCM_OSCPLL_LPM_STAT_CPU_DOMAIN(n)) & CCM_OSCPLL_LPM_STAT_CPU_MODE_MASK)
...
#define CCM_OSCPLL_LPM_MODE_RUNWAIT                                                                \
	(2) /* Clock is on in run and wait modes, but off in STOP modes */
#define CCM_OSCPLL_LPM_MODE_RUNWAITSTOP                                                            \
	(3)								/* Clock is on during all modes, except SUSPEND mode           \
									 */
...
#define CCM_OSCPLL_LPM_MODE_CPU_MODE_SET(n, v)                                                     \
	((v)&CCM_OSCPLL_LPM_MODE_MASK << CCM_LPCG_LPM_MODE_CPU_DOMAIN(n))
#define CCM_OSCPLL_LPM_MODE_CPU_MODE_GET(n, v)                                                     \
	(((v) >> CCM_LPCG_LPM_STAT_CPU_DOMAIN(n)) & CCM_OSCPLL_LPM_MODE_MASK)

/* Clock source working status (OSCPLLn_STATUS0, n=0..18) */

#define CCM_OSCPLL_STAT0_ON (1 << 0) /* Bit 0:      Clock source is turned on (ON) */
									 /* Bits 1-3:   Reserved */
#define CCM_OSCPLL_STAT0_STATUS_EARLY                                                              \
	(1 << 4) /* Bit 4:      Clock source is active (STATUS_EARLY) */
#define CCM_OSCPLL_STAT0_STATUS_LATE                                                               \
	(1 << 5) /* Bit 5:      Clock source is ready to use (STATUS_LATE) */
			 /* Bits 6-11:  Reserved */
#define CCM_OSCPLL_STAT0_IN_USE                                                                    \
	(1 << 12) /* Bit 28:     Indicates whether the clock source is being used by active clock      \
		 roots (IN_USE) */
			  /* Bits 16-31: Reserved */
...
#define CCM_OSCPLL_AUTH_LOCK_MODE                                                                  \
	(1 << 7) /* Bit 7:      Lock low power and access mode (LOCK_MODE) */
#define CCM_OSCPLL_AUTH_TZ_USER                                                                    \
	(1 << 8) /* Bit 8:      Clock source can be changed in user mode (TZ_USER) */
#define CCM_OSCPLL_AUTH_TZ_NS                                                                      \
	(1 << 9) /* Bit 9:      Clock source can be changed in non-secure mode (TZ_NS) */
			 /* Bit 10:     Reserved */
...
#define CCM_OSCPLL_AUTH_WHITE_LIST_SHIFT                                                           \
	(16) /* Bits 16-31: Allow domains to change clock (WHITE_LIST) */
...
#define CCM_LPCG_LPM_STAT_CPU_MODE_GET(n, v)                                                       \
	(((v) >> CCM_LPCG_LPM_STAT_CPU_DOMAIN(n)) & CCM_LPCG_LPM_STAT_CPU_MODE_MASK)
...
#define CCM_LPCG_LPM_MODE_RUNWAIT                                                                  \
	(2) /* Clock is on in run and wait modes, but off in STOP modes                                \
		 */
...
#define CCM_LPCG_LPM_MODE_CPU_MODE_SET(n, v)                                                       \
	((v)&CCM_LPCG_LPM_MODE_MASK << CCM_LPCG_LPM_MODE_CPU_DOMAIN(n))
#define CCM_LPCG_LPM_MODE_CPU_MODE_GET(n, v)                                                       \
	(((v) >> CCM_LPCG_LPM_MODE_CPU_DOMAIN(n)) & CCM_LPCG_LPM_MODE_MASK)
...
#define CCM_LPCG_STAT0_ACTIVE_DOMAIN_SHIFT                                                         \
	(8) /* Bits 8-11:  Domains that own this clock source according to whitelist (ACTIVE_DOMAIN)   \
		 */
#define CCM_LPCG_STAT0_ACTIVE_DOMAIN_MASK (0x0f << CCM_LPCG_STAT0_ACTIVE_DOMAIN_SHIFT)
#define CCM_LPCG_STAT0_DOMAIN_ENABLE_SHIFT                                                         \
	(8) /* Bits 12-15: Enable status from each domain (DOMAIN_ENABLE) */
...
#define CCM_LPCG_AUTH_LOCK_MODE                                                                    \
	(1 << 7) /* Bit 7:      Lock low power and access mode (LOCK_MODE) */
#define CCM_LPCG_AUTH_TZ_USER                                                                      \
	(1 << 8) /* Bit 8:      Clock source can be changed in user mode (TZ_USER) */
#define CCM_LPCG_AUTH_TZ_NS                                                                        \
	(1 << 9) /* Bit 9:      Clock source can be changed in non-secure mode (TZ_NS) */
			 /* Bit 10:     Reserved */
...
#define CCM_LPCG_AUTH_WHITE_LIST_SHIFT                                                             \
	(16) /* Bits 16-31: Allow domains to change clock (WHITE_LIST) */
