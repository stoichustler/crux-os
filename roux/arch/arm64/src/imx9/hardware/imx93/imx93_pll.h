...
#define PLL_SPREAD_SPECTRUM_STEP(n)                                                                \
	(((n) << PLL_SPREAD_SPECTRUM_STEP_SHIFT) & PLL_SPREAD_SPECTRUM_STEP_MASK)
...
#define PLL_SPREAD_SPECTRUM_STOP(n)                                                                \
	(((n) << PLL_SPREAD_SPECTRUM_STOP_SHIFT) & PLL_SPREAD_SPECTRUM_STOP_MASK)
...
#define PLL_PLL_STATUS_ANA_MFN(n)                                                                  \
	(((n) << PLL_PLL_STATUS_ANA_MFN_SHIFT) & PLL_PLL_STATUS_ANA_MFN_MASK)
