...
#define USBHOST_HCSPARAMS_NPTT_SHIFT                                                               \
	(20) /* Bits 20-23: Number of Ports per Transaction Translator */
...
#define USBHOST_PRTSC1_LS_JSTATE                                                                   \
	(2 << USBHOST_PRTSC1_LS_SHIFT) /* J-state (USB_DP HIGH and USB_DM LOW) */
#define USBHOST_PRTSC1_LS_KSTATE                                                                   \
	(1 << USBHOST_PRTSC1_LS_SHIFT) /* K-state (USB_DP LOW and USB_DM HIGH) */
...
#define USBDEV_ENDPTCOMPLETE_ETCE7                                                                 \
	(1 << 23) /* Bit 23: EP xmt complete event for physical IN EP 7 */
#define USBDEV_ENDPTCOMPLETE_ETCE6                                                                 \
	(1 << 22) /* Bit 22: EP xmt complete event for physical IN EP 6 */
#define USBDEV_ENDPTCOMPLETE_ETCE5                                                                 \
	(1 << 21) /* Bit 21: EP xmt complete event for physical IN EP 5 */
#define USBDEV_ENDPTCOMPLETE_ETCE4                                                                 \
	(1 << 20) /* Bit 20: EP xmt complete event for physical IN EP 4 */
#define USBDEV_ENDPTCOMPLETE_ETCE3                                                                 \
	(1 << 19) /* Bit 19: EP xmt complete event for physical IN EP 3 */
#define USBDEV_ENDPTCOMPLETE_ETCE2                                                                 \
	(1 << 18) /* Bit 18: EP xmt complete event for physical IN EP 2 */
#define USBDEV_ENDPTCOMPLETE_ETCE1                                                                 \
	(1 << 17) /* Bit 17: EP xmt complete event for physical IN EP 1 */
#define USBDEV_ENDPTCOMPLETE_ETCE0                                                                 \
	(1 << 16) /* Bit 16: EP xmt complete event for physical IN EP 0 */
#define USBDEV_ENDPTCOMPLETE_ERCE7                                                                 \
	(1 << 7) /* Bit 7:  EP recv complete event for physical OUT EP 7 */
#define USBDEV_ENDPTCOMPLETE_ERCE6                                                                 \
	(1 << 6) /* Bit 6:  EP recv complete event for physical OUT EP 6 */
#define USBDEV_ENDPTCOMPLETE_ERCE5                                                                 \
	(1 << 5) /* Bit 5:  EP recv complete event for physical OUT EP 5 */
#define USBDEV_ENDPTCOMPLETE_ERCE4                                                                 \
	(1 << 4) /* Bit 4:  EP recv complete event for physical OUT EP 4 */
#define USBDEV_ENDPTCOMPLETE_ERCE3                                                                 \
	(1 << 3) /* Bit 3:  EP recv complete event for physical OUT EP 3 */
#define USBDEV_ENDPTCOMPLETE_ERCE2                                                                 \
	(1 << 2) /* Bit 2:  EP recv complete event for physical OUT EP 2 */
#define USBDEV_ENDPTCOMPLETE_ERCE1                                                                 \
	(1 << 1) /* Bit 1:  EP recv complete event for physical OUT EP 1 */
#define USBDEV_ENDPTCOMPLETE_ERCE0                                                                 \
	(1 << 0) /* Bit 0:  EP recv complete event for physical OUT EP 0 */
...
#define USBNC_CTRL2_VBUS_SOURCE_SEL_MASK                                                           \
	(0x3) /* Bits 0-1: VBUS source select at VBUS wakeup event */

/* PHY Configure 1 -- internal control register bits of the PHY clock */

#define USBNC_UTMIPHY_CFG1_TXPREEMPPULSETUNE0                                                      \
	(1 << 30) /* Bit 30: HS Transmitter Pre-Emphasis Duration Control */
#define USBNC_UTMIPHY_CFG1_TXPREEMPAMPTUNE0_SHIFT                                                  \
	(28) /* Bits 28-29: HS Transmitter Pre-Emphasis Current Control */
...
#define USBNC_UTMIPHY_CFG1_TXRISETUNE0_SHIFT                                                       \
	(24) /* Bits 24-25: HS Transmitter Rise/Fall Time Adjustment */
...
#define USBNC_UTMIPHY_CFG1_TXFSLSTUNE0_SHIFT                                                       \
	(16) /* Bits 16-19: FS/LS Source Impedance Adjustment */
#define USBNC_UTMIPHY_CFG1_TXFSLSTUNE0_MASK (0xf << 16)
#define USBNC_UTMIPHY_CFG1_PHY_POR_SW (1 << 15) /* Bit 15 : PHY software POR */
#define USBNC_UTMIPHY_CFG1_TXHSXVTUNE_SHIFT                                                        \
	(13) /* Bits 13-14: Transmitter High-Speed Crossover Adjustment */
