...
#define IMX9_GPIO_ICRN_IRQS                                                                        \
	(1 << 20)					  /* Bit 20: Configures the selected interrupt, or DMA request. */
#define IMX9_GPIO_ICRN_SHIFT (16) /* Bits 16-19:  Interrupt Configuration */
#define IMX9_GPIO_ICRN_MASK (0xf << IMX9_GPIO_ICRN_SHIFT)
#define IMX9_GPIO_ICRN_DISABLED                                                                    \
	(0 << IMX9_GPIO_ICRN_SHIFT) /* Interrupt Status Flag (ISF) is disabled */
#define IMX9_GPIO_ICRN_DMARISING                                                                   \
	(1 << IMX9_GPIO_ICRN_SHIFT) /* ISF flag and DMA request on rising edge */
#define IMX9_GPIO_ICRN_DMAFALLING                                                                  \
	(2 << IMX9_GPIO_ICRN_SHIFT) /* ISF flag and DMA request on falling edge */
#define IMX9_GPIO_ICRN_DMABOTH                                                                     \
	(3 << IMX9_GPIO_ICRN_SHIFT) /* ISF flag and DMA request on either edge */
...
#define IMX9_GPIO_ICRN_RISING                                                                      \
	(9 << IMX9_GPIO_ICRN_SHIFT) /* ISF flag and Interrupt on rising-edge */
#define IMX9_GPIO_ICRN_FALLING                                                                     \
	(10 << IMX9_GPIO_ICRN_SHIFT) /* ISF flag and Interrupt on falling-edge */
#define IMX9_GPIO_ICRN_BOTH                                                                        \
	(11 << IMX9_GPIO_ICRN_SHIFT)						/* ISF flag and Interrupt on either edge   \
														 */
...
#define IMX9_GPIO_GICLR_GIWD_PIN(n)                                                                \
	((uint32_t)(n) << IMX9_GPIO_GICLR_GIWD_SHIFT) /* Pin n=0..15                                   \
												   */
...
#define IMX9_GPIO_GICLR_GIWE_PIN(n)                                                                \
	((uint32_t)(n) << IMX9_GPIO_GICLR_GIWE_SHIFT) /* Pin n=0..15                                   \
												   */
...
#define IMX9_GPIO_GICHR_GIWD_PIN(n)                                                                \
	((uint32_t)((n)-16) << IMX9_GPIO_GICHR_GIWD_SHIFT) /* Pin n=16..31 */
...
#define IMX9_GPIO_GICHR_GIWE_PIN(n)                                                                \
	((uint32_t)((n)-16) << IMX9_GPIO_GICHR_GIWE_SHIFT) /* Pin n=16..31 */
