...
#define IMX9_USDHC_CQTDLBAU_OFFSET                                                                 \
	0x0124 /* Command Queuing Task Descriptor List Base Address Upper 32 Bits */
...
#define IMX9_USDHC_CQCRDCT_OFFSET                                                                  \
	0x0148 /* Command Queuing Command Response for Direct-Command Task */
...
#define USDHC_XFERTYP_RSPTYP_LEN48BSY                                                              \
	(3 << USDHC_XFERTYP_RSPTYP_SHIFT) /* Response length 48, check busy */
...
#define USDHC_XFERTYP_CMDTYP_SUSPEND                                                               \
	(1 << USDHC_XFERTYP_CMDTYP_SHIFT) /* Suspend CMD52 for writing bus suspend in CCCR */
#define USDHC_XFERTYP_CMDTYP_RESUME                                                                \
	(2 << USDHC_XFERTYP_CMDTYP_SHIFT) /* Resume CMD52 for writing function select in CCCR */
#define USDHC_XFERTYP_CMDTYP_ABORT                                                                 \
	(3 << USDHC_XFERTYP_CMDTYP_SHIFT) /* Abort CMD12, CMD52 for writing I/O abort in CCCR */
...
#define USDHC_PROCTL_DMAS_NODMA                                                                    \
	(0 << USDHC_PROCTL_DMAS_SHIFT) /* No DMA or simple DMA is selected */
...
#define USDHC_SYSCTL_SDCLKFS_BYPASS                                                                \
	(0x00 << USDHC_SYSCTL_SDCLKFS_SHIFT)								 /* Bypass the prescaler   \
																		  */
...
#define USDHC_FEVT_AC12IE (1 << 4)	/* Bit 4:  Force Event Auto Command 12 Index Error */
									/* Bits 5-6: Reserved */
#define USDHC_FEVT_CNIBAC12E                                                                       \
	(1 << 7) /* Bit 7:  Force Event Command Not Executed By Auto Command 12 Error */
			 /* Bits 8-15: Reserved */
...
#define USDHC_DL_CTRL_REF_UPDINT_SHIFT                                                             \
	(28) /* Bits 28-31: DLL Control Reference Update Interval                                      \
		  */
...
#define USDHC_CLKTUNE_CS_DCS_POST_SHIFT                                                            \
	(0) /* Bits 0-3: Set delay cells between CLK_OUT and CLK_POST*/
...
#define USDHC_CLKTUNE_CS_DCS_OUT_SHIFT                                                             \
	(4) /* Bits 4-7: Set delay cells between CLK_PRE and CLK_OUT */
...
#define USDHC_CLKTUNE_CS_DCS_PRE_SHIFT                                                             \
	(8) /* Bits 8-14: Set celay cells between the feedback clock and CLK_PRE */
...
#define USDHC_CLKTUNE_CS_TS_POST_SHIFT                                                             \
	(16) /* Bits 16-19: Delay cells between CLK_OUT and CLK_POST */
...
#define USDHC_CLKTUNE_CS_TS_OUT_SHIFT                                                              \
	(20) /* Bits 20-23: Delay cells between CLK_PRE and CLK_OUT                                    \
		  */
...
#define USDHC_CLKTUNE_CS_TS_PRE_SHIFT                                                              \
	(24) /* Bits 24-30: Delay cells between the feedback clock and CLK_PRE */
...
#define USDHC_MMCBOOT_DISABLETO (1 << 8)  /* Bit 8:  Timeout enable */
										  /* Bits 9-15: Reserved */
#define USDHC_MMCBOOT_BOOTBLKCNT_SHIFT                                                             \
	(16) /* Bits 16-31: Stop at block gap value of automatic mode */
...
#define USDHC_VS2_TUNINGBITEN_30                                                                   \
	(0 << USDHC_VS2_TUNINGBITEN_SHIFT) /* Enable Tuning circuit for DATA[3:0] */
#define USDHC_VS2_TUNINGBITEN_70                                                                   \
	(1 << USDHC_VS2_TUNINGBITEN_SHIFT) /* Enable Tuning circuit for DATA[7:0] */
#define USDHC_VS2_TUNINGBITEN_0                                                                    \
	(2 << USDHC_VS2_TUNINGBITEN_SHIFT) /* Enable Tuning circuit for DATA[0] */
...
#define USDHC_VS2_FBCLK_TAP_SEL_SHIFT                                                              \
	(16) /* Bits 16-31: Enable extra delay on internal feedback clock */
