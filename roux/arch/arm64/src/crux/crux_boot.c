/****************************************************************************
 * arch/arm64/src/crux/crux_boot.c
 *
...
static const struct arm_mmu_region g_mmu_regions[] = {
	MMU_REGION_FLAT_ENTRY("AMBA_PL011", CONFIG_AMBA_PL011_BASEADDR,
						  CONFIG_AMBA_PL011_SIZE,
						  MT_DEVICE_NGNRNE | MT_RW | MT_SECURE),

#if CONFIG_ARM64_GIC_VERSION == 3 || CONFIG_ARM64_GIC_VERSION == 4
	MMU_REGION_FLAT_ENTRY("GICD_REGION", CONFIG_GICD_BASE,
						  CONFIG_GICD_SIZE,
						  MT_DEVICE_NGNRNE | MT_RW | MT_SECURE),
	MMU_REGION_FLAT_ENTRY("GICR_REGION", CONFIG_GICR_BASE,
						  CONFIG_GICR_SIZE,
						  MT_DEVICE_NGNRNE | MT_RW | MT_SECURE),
#endif
...
void arm64_chip_boot(void)
{
...
#if defined(CONFIG_ARCH_CHIP_CRUX_WITH_HV) && defined(CONFIG_ARM64_PSCI)
	arm64_psci_init("hvc");
	...
	arm64_lowputs("roux preps for crux\n");
}
