/****************************************************************************
 * arch/arm64/src/rk356x/rk356x_boot.c
 *
...
#include "arm64_mmu.h"
#include "rk356x_boot.h"
#include "rk356x_serial.h"
...
static const struct arm_mmu_region g_mmu_regions[] = {
	MMU_REGION_FLAT_ENTRY("DEVICE_REGION", CONFIG_DEVICEIO_BASEADDR, CONFIG_DEVICEIO_SIZE,
...
void arm64_chip_boot(void)
{
	...
	arm64_lowputs("Initializing MTE\n");
	arm64_mte_init();
#endif
	...
	arm64_lowputs("Initializing PSCI\n");
#if defined(CONFIG_ARCH_CHIP_RK356X_WITH_HV) && defined(CONFIG_ARM64_PSCI)
	arm64_psci_init("hvc");
	...
	arm64_lowputs("Initializing board\n");
	rk356x_board_initialize();
