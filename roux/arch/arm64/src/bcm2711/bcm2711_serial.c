...
static int bcm2711_miniuart_receive(struct uart_dev_s *dev, unsigned int *status);
...
static int bcm2711_miniuart_setup(struct uart_dev_s *dev)
{
	struct bcm2711_miniuart_port_s *port = (struct bcm2711_miniuart_port_s *)dev->priv;
	...
	modreg32(BCM_AUX_MU_IIR_RXCLEAR, BCM_AUX_MU_IIR_RXCLEAR, BCM_AUX_MU_IIR_REG);
	modreg32(BCM_AUX_MU_IIR_TXCLEAR, BCM_AUX_MU_IIR_TXCLEAR, BCM_AUX_MU_IIR_REG);
	...
	modreg32(BCM_AUX_MU_CNTL_TXENABLE, BCM_AUX_MU_CNTL_TXENABLE, BCM_AUX_MU_CNTL_REG);
	modreg32(BCM_AUX_MU_CNTL_RXENABLE, BCM_AUX_MU_CNTL_RXENABLE, BCM_AUX_MU_CNTL_REG);
...
{
	int ret = -ENOSYS;
	const struct bcm2711_miniuart_port_s *port = (struct bcm2711_miniuart_port_s *)dev->priv;
