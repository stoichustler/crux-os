...
#define BCM_BSC0 (BCM_PERIPHERAL_BASEADDR + 0x000205000) /* BSC/I2C interface 0 */
#define BCM_BSC1 (BCM_PERIPHERAL_BASEADDR + 0x000804000) /* BSC/I2C interface 1 */
#define BCM_BSC3 (BCM_PERIPHERAL_BASEADDR + 0x000205600) /* BSC/I2C interface 2 */
#define BCM_BSC4 (BCM_PERIPHERAL_BASEADDR + 0x000205800) /* BSC/I2C interface 3 */
#define BCM_BSC5 (BCM_PERIPHERAL_BASEADDR + 0x000205a80) /* BSC/I2C interface 4 */
#define BCM_BSC6 (BCM_PERIPHERAL_BASEADDR + 0x000205c00) /* BSC/I2C interface 5 */
...
#define BCM_BSC_CLKT(reg) (reg + BCM_BSC_CLKT_OFFSET) /* Clock Stretch Timeout */
