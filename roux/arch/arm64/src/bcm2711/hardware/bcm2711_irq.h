...
#define BCM_IRQ_ARMLOCAL_ARM_CONTROL _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_ARM_CONTROL_OFFSET)
#define BCM_IRQ_ARMLOCAL_CORE_IRQ_CONTROL _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_CORE_IRQ_CONTROL_OFFSET)
#define BCM_IRQ_ARMLOCAL_PMU_CONTROL_SET _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_PMU_CONTROL_SET_OFFSET)
#define BCM_IRQ_ARMLOCAL_PMU_CONTROL_CLR _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_PMU_CONTROL_CLR_OFFSET)
#define BCM_IRQ_ARMLOCAL_PERI_IRQ_ROUTE0 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_PERI_IRQ_ROUTE0_OFFSET)
#define BCM_IRQ_ARMLOCAL_AXI_QUIET_TIME _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_AXI_QUIET_TIME_OFFSET)
#define BCM_IRQ_ARMLOCAL_LOCAL_TIMER_CONTROL                                                       \
	_BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_LOCAL_TIMER_CONTROL_OFFSET)
#define BCM_IRQ_ARMLOCAL_LOCAL_TIMER_IRQ _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_LOCAL_TIMER_IRQ_OFFSET)
#define BCM_IRQ_ARMLOCAL_TIMER_CNTRL0 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_TIMER_CNTRL0_OFFSET)
#define BCM_IRQ_ARMLOCAL_TIMER_CNTRL1 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_TIMER_CNTRL1_OFFSET)
#define BCM_IRQ_ARMLOCAL_TIMER_CNTRL2 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_TIMER_CNTRL2_OFFSET)
#define BCM_IRQ_ARMLOCAL_TIMER_CNTRL3 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_TIMER_CNTRL3_OFFSET)
#define BCM_IRQ_ARMLOCAL_MAILBOX_CNTRL0 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_MAILBOX_CNTRL0_OFFSET)
#define BCM_IRQ_ARMLOCAL_MAILBOX_CNTRL1 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_MAILBOX_CNTRL1_OFFSET)
#define BCM_IRQ_ARMLOCAL_MAILBOX_CNTRL2 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_MAILBOX_CNTRL2_OFFSET)
#define BCM_IRQ_ARMLOCAL_MAILBOX_CNTRL3 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_MAILBOX_CNTRL3_OFFSET)
#define BCM_IRQ_ARMLOCAL_IRQ_SOURCE0 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_IRQ_SOURCE0_OFFSET)
#define BCM_IRQ_ARMLOCAL_IRQ_SOURCE1 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_IRQ_SOURCE1_OFFSET)
#define BCM_IRQ_ARMLOCAL_IRQ_SOURCE2 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_IRQ_SOURCE2_OFFSET)
#define BCM_IRQ_ARMLOCAL_IRQ_SOURCE3 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_IRQ_SOURCE3_OFFSET)
#define BCM_IRQ_ARMLOCAL_FIQ_SOURCE0 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_FIQ_SOURCE0_OFFSET)
#define BCM_IRQ_ARMLOCAL_FIQ_SOURCE1 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_FIQ_SOURCE1_OFFSET)
#define BCM_IRQ_ARMLOCAL_FIQ_SOURCE2 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_FIQ_SOURCE2_OFFSET)
#define BCM_IRQ_ARMLOCAL_FIQ_SOURCE3 _BCM_ARMLOCAL(BCM_IRQ_ARMLOCAL_FIQ_SOURCE3_OFFSET)
...
#define BCM_IRQ_ARMC_IRQ0_PENDING0 _BCM_ARMC(BCM_IRQ_ARMC_IRQ0_PENDING0_OFFSET)
#define BCM_IRQ_ARMC_IRQ0_PENDING1 _BCM_ARMC(BCM_IRQ_ARMC_IRQ0_PENDING1_OFFSET)
#define BCM_IRQ_ARMC_IRQ0_PENDING2 _BCM_ARMC(BCM_IRQ_ARMC_IRQ0_PENDING2_OFFSET)
#define BCM_IRQ_ARMC_IRQ0_SET_EN_0 _BCM_ARMC(BCM_IRQ_ARMC_IRQ0_SET_EN_0_OFFSET)
#define BCM_IRQ_ARMC_IRQ0_SET_EN_1 _BCM_ARMC(BCM_IRQ_ARMC_IRQ0_SET_EN_1_OFFSET)
#define BCM_IRQ_ARMC_IRQ0_SET_EN_2 _BCM_ARMC(BCM_IRQ_ARMC_IRQ0_SET_EN_2_OFFSET)
#define BCM_IRQ_ARMC_IRQ0_CLR_EN_0 _BCM_ARMC(BCM_IRQ_ARMC_IRQ0_CLR_EN_0_OFFSET)
#define BCM_IRQ_ARMC_IRQ0_CLR_EN_1 _BCM_ARMC(BCM_IRQ_ARMC_IRQ0_CLR_EN_1_OFFSET)
#define BCM_IRQ_ARMC_IRQ0_CLR_EN_2 _BCM_ARMC(BCM_IRQ_ARMC_IRQ0_CLR_EN_2_OFFSET)
...
#define BCM_IRQ_ARMC_IRQ1_PENDING0 _BCM_ARMC(BCM_IRQ_ARMC_IRQ1_PENDING0_OFFSET)
#define BCM_IRQ_ARMC_IRQ1_PENDING1 _BCM_ARMC(BCM_IRQ_ARMC_IRQ1_PENDING1_OFFSET)
#define BCM_IRQ_ARMC_IRQ1_PENDING2 _BCM_ARMC(BCM_IRQ_ARMC_IRQ1_PENDING2_OFFSET)
#define BCM_IRQ_ARMC_IRQ1_SET_EN_0 _BCM_ARMC(BCM_IRQ_ARMC_IRQ1_SET_EN_0_OFFSET)
#define BCM_IRQ_ARMC_IRQ1_SET_EN_1 _BCM_ARMC(BCM_IRQ_ARMC_IRQ1_SET_EN_1_OFFSET)
#define BCM_IRQ_ARMC_IRQ1_SET_EN_2 _BCM_ARMC(BCM_IRQ_ARMC_IRQ1_SET_EN_2_OFFSET)
#define BCM_IRQ_ARMC_IRQ1_CLR_EN_0 _BCM_ARMC(BCM_IRQ_ARMC_IRQ1_CLR_EN_0_OFFSET)
#define BCM_IRQ_ARMC_IRQ1_CLR_EN_1 _BCM_ARMC(BCM_IRQ_ARMC_IRQ1_CLR_EN_1_OFFSET)
#define BCM_IRQ_ARMC_IRQ1_CLR_EN_2 _BCM_ARMC(BCM_IRQ_ARMC_IRQ1_CLR_EN_2_OFFSET)
#define BCM_IRQ_ARMC_IRQ2_PENDING0 _BCM_ARMC(BCM_IRQ_ARMC_IRQ2_PENDING0_OFFSET)
#define BCM_IRQ_ARMC_IRQ2_PENDING1 _BCM_ARMC(BCM_IRQ_ARMC_IRQ2_PENDING1_OFFSET)
#define BCM_IRQ_ARMC_IRQ2_PENDING2 _BCM_ARMC(BCM_IRQ_ARMC_IRQ2_PENDING2_OFFSET)
#define BCM_IRQ_ARMC_IRQ2_SET_EN_0 _BCM_ARMC(BCM_IRQ_ARMC_IRQ2_SET_EN_0_OFFSET)
#define BCM_IRQ_ARMC_IRQ2_SET_EN_1 _BCM_ARMC(BCM_IRQ_ARMC_IRQ2_SET_EN_1_OFFSET)
#define BCM_IRQ_ARMC_IRQ2_SET_EN_2 _BCM_ARMC(BCM_IRQ_ARMC_IRQ2_SET_EN_2_OFFSET)
#define BCM_IRQ_ARMC_IRQ2_CLR_EN_0 _BCM_ARMC(BCM_IRQ_ARMC_IRQ2_CLR_EN_0_OFFSET)
#define BCM_IRQ_ARMC_IRQ2_CLR_EN_1 _BCM_ARMC(BCM_IRQ_ARMC_IRQ2_CLR_EN_1_OFFSET)
#define BCM_IRQ_ARMC_IRQ2_CLR_EN_2 _BCM_ARMC(BCM_IRQ_ARMC_IRQ2_CLR_EN_2_OFFSET)
#define BCM_IRQ_ARMC_IRQ3_PENDING0 _BCM_ARMC(BCM_IRQ_ARMC_IRQ3_PENDING0_OFFSET)
#define BCM_IRQ_ARMC_IRQ3_PENDING1 _BCM_ARMC(BCM_IRQ_ARMC_IRQ3_PENDING1_OFFSET)
#define BCM_IRQ_ARMC_IRQ3_PENDING2 _BCM_ARMC(BCM_IRQ_ARMC_IRQ3_PENDING2_OFFSET)
#define BCM_IRQ_ARMC_IRQ3_SET_EN_0 _BCM_ARMC(BCM_IRQ_ARMC_IRQ3_SET_EN_0_OFFSET)
#define BCM_IRQ_ARMC_IRQ3_SET_EN_1 _BCM_ARMC(BCM_IRQ_ARMC_IRQ3_SET_EN_1_OFFSET)
#define BCM_IRQ_ARMC_IRQ3_SET_EN_2 _BCM_ARMC(BCM_IRQ_ARMC_IRQ3_SET_EN_2_OFFSET)
#define BCM_IRQ_ARMC_IRQ3_CLR_EN_0 _BCM_ARMC(BCM_IRQ_ARMC_IRQ3_CLR_EN_0_OFFSET)
#define BCM_IRQ_ARMC_IRQ3_CLR_EN_1 _BCM_ARMC(BCM_IRQ_ARMC_IRQ3_CLR_EN_1_OFFSET)
#define BCM_IRQ_ARMC_IRQ3_CLR_EN_2 _BCM_ARMC(BCM_IRQ_ARMC_IRQ3_CLR_EN_2_OFFSET)
#define BCM_IRQ_ARMC_FIQ0_PENDING0 _BCM_ARMC(BCM_IRQ_ARMC_FIQ0_PENDING0_OFFSET)
#define BCM_IRQ_ARMC_FIQ0_PENDING1 _BCM_ARMC(BCM_IRQ_ARMC_FIQ0_PENDING1_OFFSET)
#define BCM_IRQ_ARMC_FIQ0_PENDING2 _BCM_ARMC(BCM_IRQ_ARMC_FIQ0_PENDING2_OFFSET)
#define BCM_IRQ_ARMC_FIQ0_SET_EN_0 _BCM_ARMC(BCM_IRQ_ARMC_FIQ0_SET_EN_0_OFFSET)
#define BCM_IRQ_ARMC_FIQ0_SET_EN_1 _BCM_ARMC(BCM_IRQ_ARMC_FIQ0_SET_EN_1_OFFSET)
#define BCM_IRQ_ARMC_FIQ0_SET_EN_2 _BCM_ARMC(BCM_IRQ_ARMC_FIQ0_SET_EN_2_OFFSET)
#define BCM_IRQ_ARMC_FIQ0_CLR_EN_0 _BCM_ARMC(BCM_IRQ_ARMC_FIQ0_CLR_EN_0_OFFSET)
#define BCM_IRQ_ARMC_FIQ0_CLR_EN_1 _BCM_ARMC(BCM_IRQ_ARMC_FIQ0_CLR_EN_1_OFFSET)
#define BCM_IRQ_ARMC_FIQ0_CLR_EN_2 _BCM_ARMC(BCM_IRQ_ARMC_FIQ0_CLR_EN_2_OFFSET)
#define BCM_IRQ_ARMC_FIQ1_PENDING0 _BCM_ARMC(BCM_IRQ_ARMC_FIQ1_PENDING0_OFFSET)
#define BCM_IRQ_ARMC_FIQ1_PENDING1 _BCM_ARMC(BCM_IRQ_ARMC_FIQ1_PENDING1_OFFSET)
#define BCM_IRQ_ARMC_FIQ1_PENDING2 _BCM_ARMC(BCM_IRQ_ARMC_FIQ1_PENDING2_OFFSET)
#define BCM_IRQ_ARMC_FIQ1_SET_EN_0 _BCM_ARMC(BCM_IRQ_ARMC_FIQ1_SET_EN_0_OFFSET)
#define BCM_IRQ_ARMC_FIQ1_SET_EN_1 _BCM_ARMC(BCM_IRQ_ARMC_FIQ1_SET_EN_1_OFFSET)
#define BCM_IRQ_ARMC_FIQ1_SET_EN_2 _BCM_ARMC(BCM_IRQ_ARMC_FIQ1_SET_EN_2_OFFSET)
#define BCM_IRQ_ARMC_FIQ1_CLR_EN_0 _BCM_ARMC(BCM_IRQ_ARMC_FIQ1_CLR_EN_0_OFFSET)
#define BCM_IRQ_ARMC_FIQ1_CLR_EN_1 _BCM_ARMC(BCM_IRQ_ARMC_FIQ1_CLR_EN_1_OFFSET)
#define BCM_IRQ_ARMC_FIQ1_CLR_EN_2 _BCM_ARMC(BCM_IRQ_ARMC_FIQ1_CLR_EN_2_OFFSET)
#define BCM_IRQ_ARMC_FIQ2_PENDING0 _BCM_ARMC(BCM_IRQ_ARMC_FIQ2_PENDING0_OFFSET)
#define BCM_IRQ_ARMC_FIQ2_PENDING1 _BCM_ARMC(BCM_IRQ_ARMC_FIQ2_PENDING1_OFFSET)
#define BCM_IRQ_ARMC_FIQ2_PENDING2 _BCM_ARMC(BCM_IRQ_ARMC_FIQ2_PENDING2_OFFSET)
#define BCM_IRQ_ARMC_FIQ2_SET_EN_0 _BCM_ARMC(BCM_IRQ_ARMC_FIQ2_SET_EN_0_OFFSET)
#define BCM_IRQ_ARMC_FIQ2_SET_EN_1 _BCM_ARMC(BCM_IRQ_ARMC_FIQ2_SET_EN_1_OFFSET)
#define BCM_IRQ_ARMC_FIQ2_SET_EN_2 _BCM_ARMC(BCM_IRQ_ARMC_FIQ2_SET_EN_2_OFFSET)
#define BCM_IRQ_ARMC_FIQ2_CLR_EN_0 _BCM_ARMC(BCM_IRQ_ARMC_FIQ2_CLR_EN_0_OFFSET)
#define BCM_IRQ_ARMC_FIQ2_CLR_EN_1 _BCM_ARMC(BCM_IRQ_ARMC_FIQ2_CLR_EN_1_OFFSET)
#define BCM_IRQ_ARMC_FIQ2_CLR_EN_2 _BCM_ARMC(BCM_IRQ_ARMC_FIQ2_CLR_EN_2_OFFSET)
#define BCM_IRQ_ARMC_FIQ3_PENDING0 _BCM_ARMC(BCM_IRQ_ARMC_FIQ3_PENDING0_OFFSET)
#define BCM_IRQ_ARMC_FIQ3_PENDING1 _BCM_ARMC(BCM_IRQ_ARMC_FIQ3_PENDING1_OFFSET)
#define BCM_IRQ_ARMC_FIQ3_PENDING2 _BCM_ARMC(BCM_IRQ_ARMC_FIQ3_PENDING2_OFFSET)
#define BCM_IRQ_ARMC_FIQ3_SET_EN_0 _BCM_ARMC(BCM_IRQ_ARMC_FIQ3_SET_EN_0_OFFSET)
#define BCM_IRQ_ARMC_FIQ3_SET_EN_1 _BCM_ARMC(BCM_IRQ_ARMC_FIQ3_SET_EN_1_OFFSET)
#define BCM_IRQ_ARMC_FIQ3_SET_EN_2 _BCM_ARMC(BCM_IRQ_ARMC_FIQ3_SET_EN_2_OFFSET)
#define BCM_IRQ_ARMC_FIQ3_CLR_EN_0 _BCM_ARMC(BCM_IRQ_ARMC_FIQ3_CLR_EN_0_OFFSET)
#define BCM_IRQ_ARMC_FIQ3_CLR_EN_1 _BCM_ARMC(BCM_IRQ_ARMC_FIQ3_CLR_EN_1_OFFSET)
#define BCM_IRQ_ARMC_FIQ3_CLR_EN_2 _BCM_ARMC(BCM_IRQ_ARMC_FIQ3_CLR_EN_2_OFFSET)
