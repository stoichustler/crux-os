...
static inline uintptr_t sys_call0(unsigned int nbr)
{
	...
	__asm__ __volatile__("svc %1" : "=r"(reg0) : "i"(SYS_syscall), "r"(reg0) : "memory", "x30");
...
static inline uintptr_t sys_call3(unsigned int nbr, uintptr_t parm1, uintptr_t parm2,
								  uintptr_t parm3)
{
	register uint64_t reg0 __asm__("x0") = (uint64_t)(nbr);
...
static inline uintptr_t sys_call4(unsigned int nbr, uintptr_t parm1, uintptr_t parm2,
...
static inline uintptr_t sys_call5(unsigned int nbr, uintptr_t parm1, uintptr_t parm2,
...
void arm64_smccc_hvc(unsigned long a0, unsigned long a1, unsigned long a2, unsigned long a3,
...
void arm64_smccc_smc(unsigned long a0, unsigned long a1, unsigned long a2, unsigned long a3,
					 unsigned long a4, unsigned long a5, unsigned long a6, unsigned long a7,
					 struct arm64_smccc_res *res);
