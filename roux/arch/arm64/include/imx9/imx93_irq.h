...
#define IMX9_IRQ_RESERVED37                                                                        \
	(IMX9_IRQ_EXT + 5)						   /* Performance Unit Interrupts from CA55 platform   \
												*/
#define IMX9_IRQ_RESERVED38 (IMX9_IRQ_EXT + 6) /* ECC error from CA55 platform cache */
#define IMX9_IRQ_RESERVED39                                                                        \
	(IMX9_IRQ_EXT + 7) /* 1-bit or 2-bit ECC or Parity error from CA55 platform cache */
...
#define IMX9_IRQ_MU1_A                                                                             \
	(IMX9_IRQ_EXT + 21) /* Messaging Unit 1 - Side A (to communicate with M7 core) */
#define IMX9_IRQ_MU1_B                                                                             \
	(IMX9_IRQ_EXT + 22) /* Messaging Unit 1 - Side B (to communicate with M33 core) */
#define IMX9_IRQ_MU2_A                                                                             \
	(IMX9_IRQ_EXT + 23) /* Messaging Unit 2 - Side A (to communicate with M7 core) */
#define IMX9_IRQ_MU2_B                                                                             \
	(IMX9_IRQ_EXT + 24) /* Messaging Unit 2 - Side B (to communicate with A55 core) */
...
#define IMX9_IRQ_RESERVED65                                                                        \
	(IMX9_IRQ_EXT + 33)							 /* Edgelock Realtime Core MUA TX empty interrupt  \
												  */
...
#define IMX9_IRQ_RESERVED122                                                                       \
	(IMX9_IRQ_EXT + 90)							  /* DRAM controller Performance Monitor Interrupt \
												   */
...
#define IMX9_IRQ_ENET_MAC0_RX_TX_D                                                                 \
	ONE1(IMX9_IRQ_EXT + 179) /* MAC 0 Receive/ Transmit Frame/ Buffer Done */
#define IMX9_IRQ_ENET_MAC0_RX_TX_D                                                                 \
	ONE2(IMX9_IRQ_EXT + 180)					   /* MAC 0 Receive/ Transmit Frame/ Buffer Done */
...
#define IMX9_IRQ_USDHC3                                                                            \
	(IMX9_IRQ_EXT + 205) /* ultra Secure Digital Host Controller interrupt 3                       \
						  */
