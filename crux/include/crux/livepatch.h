...
#ifndef __CRUX_LIVEPATCH_H__
#define __CRUX_LIVEPATCH_H__
...
#include <crux/errno.h> /* For -ENOSYS or -EOVERFLOW */
...
#define ELF_LIVEPATCH_CRUX_DEPENDS ".livepatch.crux_depends"
...
int livepatch_op(struct crux_sysctl_livepatch_op *);
...
static inline int livepatch_op(struct crux_sysctl_livepatch_op *op)
{
    return -ENOSYS;
}
