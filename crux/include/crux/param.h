#ifndef _CRUX_PARAM_H
#define _CRUX_PARAM_H
...
#define custom_runtime_only_param(nam, variable, initfunc) \
    __paramfs __parfs_##variable = \
        { .hypfs.e.type = CRUX_HYPFS_TYPE_STRING, \
          .hypfs.e.encoding = CRUX_HYPFS_ENC_PLAIN, \
          .hypfs.e.name = (nam), \
...
#define boolean_runtime_only_param(nam, variable) \
    __paramfs __parfs_##variable = \
        { .hypfs.e.type = CRUX_HYPFS_TYPE_BOOL, \
          .hypfs.e.encoding = CRUX_HYPFS_ENC_PLAIN, \
          .hypfs.e.name = (nam), \
...
#define integer_runtime_only_param(nam, variable) \
    __paramfs __parfs_##variable = \
        { .hypfs.e.type = CRUX_HYPFS_TYPE_UINT, \
          .hypfs.e.encoding = CRUX_HYPFS_ENC_PLAIN, \
          .hypfs.e.name = (nam), \
          .hypfs.e.size = sizeof(variable), \
          .hypfs.e.max_size = sizeof(variable), \
                                   ...
                                   const char *s, const char *e)
{
    ...
    printk(CRUXLOG_INFO "CONFIG_%s disabled - ignoring '%s=%.*s' setting\n",
           cfg, param, len, s);
}
