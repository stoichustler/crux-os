#ifndef __CRUX_PMSTAT_H_
#define __CRUX_PMSTAT_H_

#include <crux/types.h>
#include <public/platform.h> /* for struct crux_processor_power */
#include <public/sysctl.h>   /* for struct pm_cx_stat */

int set_px_pminfo(uint32_t acpi_id, struct crux_processor_performance *perf);
long set_cx_pminfo(uint32_t acpi_id, struct crux_processor_power *power);
