#ifndef __CRUX_HYPFS_H__
#define __CRUX_HYPFS_H__
...
struct hypfs_funcs {
    ...
    int (*write)(struct hypfs_entry_leaf *leaf,
                 CRUX_GUEST_HANDLE_PARAM(const_void) uaddr, unsigned int ulen);
...
#define HYPFS_STRING_INIT(var, nam)               \
    HYPFS_VARSIZE_INIT(var, CRUX_HYPFS_TYPE_STRING, nam, 0, &hypfs_leaf_ro_funcs)

/*
 * Set content and size of a CRUX_HYPFS_TYPE_STRING node. The node will point
...
#define HYPFS_UINT_INIT(var, nam, contvar)                       \
    HYPFS_FIXEDSIZE_INIT(var, CRUX_HYPFS_TYPE_UINT, nam, contvar, \
...
#define HYPFS_INT_INIT(var, nam, contvar)                        \
    HYPFS_FIXEDSIZE_INIT(var, CRUX_HYPFS_TYPE_INT, nam, contvar,  \
                         &hypfs_leaf_ro_funcs, 0)
...
#define HYPFS_BOOL_INIT(var, nam, contvar)                       \
    HYPFS_FIXEDSIZE_INIT(var, CRUX_HYPFS_TYPE_BOOL, nam, contvar, \
                         &hypfs_leaf_ro_funcs, 0)
