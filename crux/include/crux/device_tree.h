 ...
 */
#ifndef __CRUX_DEVICE_TREE_H__
#define __CRUX_DEVICE_TREE_H__
 ...
 * @used_by: who owns the node? (ie: crux, dom0...)
 ...
 *
 * Return true if the property "crux,passthrough" is present in the node,
 * false otherwise.
 */
