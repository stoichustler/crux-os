...
#ifndef _CRUX_MEM_ACCESS_H
#define _CRUX_MEM_ACCESS_H
...
struct p2m_domain;
bool cruxmem_access_to_p2m_access(const struct p2m_domain *p2m,
                                 cruxmem_access_t xaccess,
 ...
 */
int p2m_get_mem_access(struct domain *d, gfn_t gfn, cruxmem_access_t *access,
                       unsigned int altp2m_idx);
