...
#ifndef __CRUX_LIVEPATCH_PAYLOAD_H__
#define __CRUX_LIVEPATCH_PAYLOAD_H__
...
struct payload {
    ...
    char name[CRUX_LIVEPATCH_NAME_SIZE];  /* Name of it. */
...
#endif /* __CRUX_LIVEPATCH_PAYLOAD_H__ */
