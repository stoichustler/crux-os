...
#ifndef CRUX_LIB_X86_POLICIES_H
#define CRUX_LIB_X86_POLICIES_H

#include <crux/lib/x86/cpuid-autogen.h>
...
typedef CRUX_GUEST_HANDLE_64(crux_cpuid_leaf_t) cpuid_leaf_buffer_t;
typedef CRUX_GUEST_HANDLE_64(crux_msr_entry_t) msr_entry_buffer_t;
#else
#include <crux/arch-x86/crux.h>
typedef crux_cpuid_leaf_t cpuid_leaf_buffer_t[];
typedef crux_msr_entry_t msr_entry_buffer_t[];
#endif
