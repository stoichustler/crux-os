 ...
 * sndif.h
 *
 * Unified sound-device I/O interface for crux guest OSes.
 *
...
#ifndef __CRUX_PUBLIC_IO_SNDIF_H__
#define __CRUX_PUBLIC_IO_SNDIF_H__
 ...
 ******************************************************************************
 */
#define CRUXSND_PROTOCOL_VERSION         2
 ...
 * notification can be made conditional on cruxsnd_req (i.e., the generic
 * hold-off mechanism provided by the ring macros). Backends must set
 * cruxsnd_req appropriately (e.g., using RING_FINAL_CHECK_FOR_REQUESTS()).
 *
 * Back->front notifications: when enqueuing a new response, sending a
 * notification can be made conditional on cruxsnd_resp (i.e., the generic
 * hold-off mechanism provided by the ring macros). Frontends must set
 * cruxsnd_resp appropriately (e.g., using RING_FINAL_CHECK_FOR_RESPONSES()).
 *
 ...
 *      Values:         <string>
 *
 *      List of CRUXSND_LIST_SEPARATOR separated protocol versions supported
 ...
 *
 *      List of supported sample rates separated by CRUXSND_LIST_SEPARATOR.
 *      Sample rates are expressed as a list of decimal values w/o any
 *      ordering requirement.
 *
 * sample-formats
 *      Values:         <list of CRUXSND_PCM_FORMAT_XXX_STR>
 *
 *      List of supported sample formats separated by CRUXSND_LIST_SEPARATOR.
 *      Items must not exceed CRUXSND_SAMPLE_FORMAT_MAX_LEN length.
 *
 * buffer-size
 *      Values:         <uint32_t>
 *
 ...
 ******************************************************************************
 *
 * CRUXSND_PCM_FORMAT_<format>[_<endian>]
 *
 ...
 */
#define CRUXSND_PCM_FORMAT_S8            0
#define CRUXSND_PCM_FORMAT_U8            1
#define CRUXSND_PCM_FORMAT_S16_LE        2
#define CRUXSND_PCM_FORMAT_S16_BE        3
#define CRUXSND_PCM_FORMAT_U16_LE        4
#define CRUXSND_PCM_FORMAT_U16_BE        5
#define CRUXSND_PCM_FORMAT_S24_LE        6
#define CRUXSND_PCM_FORMAT_S24_BE        7
#define CRUXSND_PCM_FORMAT_U24_LE        8
#define CRUXSND_PCM_FORMAT_U24_BE        9
#define CRUXSND_PCM_FORMAT_S32_LE        10
#define CRUXSND_PCM_FORMAT_S32_BE        11
#define CRUXSND_PCM_FORMAT_U32_LE        12
#define CRUXSND_PCM_FORMAT_U32_BE        13
#define CRUXSND_PCM_FORMAT_F32_LE        14 /* 4-byte float, IEEE-754 32-bit, */
#define CRUXSND_PCM_FORMAT_F32_BE        15 /* range -1.0 to 1.0              */
#define CRUXSND_PCM_FORMAT_F64_LE        16 /* 8-byte float, IEEE-754 64-bit, */
#define CRUXSND_PCM_FORMAT_F64_BE        17 /* range -1.0 to 1.0              */
#define CRUXSND_PCM_FORMAT_IEC958_SUBFRAME_LE 18
#define CRUXSND_PCM_FORMAT_IEC958_SUBFRAME_BE 19
#define CRUXSND_PCM_FORMAT_MU_LAW        20
#define CRUXSND_PCM_FORMAT_A_LAW         21
#define CRUXSND_PCM_FORMAT_IMA_ADPCM     22
#define CRUXSND_PCM_FORMAT_MPEG          23
#define CRUXSND_PCM_FORMAT_GSM           24
 ...
 ******************************************************************************
 */
#define CRUXSND_OP_OPEN                  0
#define CRUXSND_OP_CLOSE                 1
#define CRUXSND_OP_READ                  2
#define CRUXSND_OP_WRITE                 3
#define CRUXSND_OP_SET_VOLUME            4
#define CRUXSND_OP_GET_VOLUME            5
#define CRUXSND_OP_MUTE                  6
#define CRUXSND_OP_UNMUTE                7
#define CRUXSND_OP_TRIGGER               8
#define CRUXSND_OP_HW_PARAM_QUERY        9

#define CRUXSND_OP_TRIGGER_START         0
#define CRUXSND_OP_TRIGGER_PAUSE         1
#define CRUXSND_OP_TRIGGER_STOP          2
#define CRUXSND_OP_TRIGGER_RESUME        3
 ...
 ******************************************************************************
 */
#define CRUXSND_DRIVER_NAME              "vsnd"

#define CRUXSND_LIST_SEPARATOR           ","
/* Field names */
#define CRUXSND_FIELD_BE_VERSIONS        "versions"
#define CRUXSND_FIELD_FE_VERSION         "version"
#define CRUXSND_FIELD_VCARD_SHORT_NAME   "short-name"
#define CRUXSND_FIELD_VCARD_LONG_NAME    "long-name"
#define CRUXSND_FIELD_RING_REF           "ring-ref"
#define CRUXSND_FIELD_EVT_CHNL           "event-channel"
#define CRUXSND_FIELD_EVT_RING_REF       "evt-ring-ref"
#define CRUXSND_FIELD_EVT_EVT_CHNL       "evt-event-channel"
#define CRUXSND_FIELD_DEVICE_NAME        "name"
#define CRUXSND_FIELD_TYPE               "type"
#define CRUXSND_FIELD_STREAM_UNIQUE_ID   "unique-id"
#define CRUXSND_FIELD_CHANNELS_MIN       "channels-min"
#define CRUXSND_FIELD_CHANNELS_MAX       "channels-max"
#define CRUXSND_FIELD_SAMPLE_RATES       "sample-rates"
#define CRUXSND_FIELD_SAMPLE_FORMATS     "sample-formats"
#define CRUXSND_FIELD_BUFFER_SIZE        "buffer-size"

/* Stream type field values. */
#define CRUXSND_STREAM_TYPE_PLAYBACK     "p"
#define CRUXSND_STREAM_TYPE_CAPTURE      "c"
/* Sample rate max string length */
#define CRUXSND_SAMPLE_RATE_MAX_LEN      11
/* Sample format field values */
#define CRUXSND_SAMPLE_FORMAT_MAX_LEN    24

#define CRUXSND_PCM_FORMAT_S8_STR        "s8"
#define CRUXSND_PCM_FORMAT_U8_STR        "u8"
#define CRUXSND_PCM_FORMAT_S16_LE_STR    "s16_le"
#define CRUXSND_PCM_FORMAT_S16_BE_STR    "s16_be"
#define CRUXSND_PCM_FORMAT_U16_LE_STR    "u16_le"
#define CRUXSND_PCM_FORMAT_U16_BE_STR    "u16_be"
#define CRUXSND_PCM_FORMAT_S24_LE_STR    "s24_le"
#define CRUXSND_PCM_FORMAT_S24_BE_STR    "s24_be"
#define CRUXSND_PCM_FORMAT_U24_LE_STR    "u24_le"
#define CRUXSND_PCM_FORMAT_U24_BE_STR    "u24_be"
#define CRUXSND_PCM_FORMAT_S32_LE_STR    "s32_le"
#define CRUXSND_PCM_FORMAT_S32_BE_STR    "s32_be"
#define CRUXSND_PCM_FORMAT_U32_LE_STR    "u32_le"
#define CRUXSND_PCM_FORMAT_U32_BE_STR    "u32_be"
#define CRUXSND_PCM_FORMAT_F32_LE_STR    "float_le"
#define CRUXSND_PCM_FORMAT_F32_BE_STR    "float_be"
#define CRUXSND_PCM_FORMAT_F64_LE_STR    "float64_le"
#define CRUXSND_PCM_FORMAT_F64_BE_STR    "float64_be"
#define CRUXSND_PCM_FORMAT_IEC958_SUBFRAME_LE_STR "iec958_subframe_le"
#define CRUXSND_PCM_FORMAT_IEC958_SUBFRAME_BE_STR "iec958_subframe_be"
#define CRUXSND_PCM_FORMAT_MU_LAW_STR    "mu_law"
#define CRUXSND_PCM_FORMAT_A_LAW_STR     "a_law"
#define CRUXSND_PCM_FORMAT_IMA_ADPCM_STR "ima_adpcm"
#define CRUXSND_PCM_FORMAT_MPEG_STR      "mpeg"
#define CRUXSND_PCM_FORMAT_GSM_STR       "gsm"
 ...
 * CRUXSND_OP_OPEN can be used for audio samples and part, for example,
 * for volume control.
 *
 ...
 *   operation - uint8_t, operation code, CRUXSND_OP_???
 *
 * For all packets which use offset and length:
 *   offset - uint32_t, read or write data offset within the shared buffer,
 *     passed with CRUXSND_OP_OPEN request, octets,
 *     [0; CRUXSND_OP_OPEN.buffer_sz - 1].
 ...
 * pcm_format - uint8_t, CRUXSND_PCM_FORMAT_XXX value
 ...
 *   like to receive CRUXSND_EVT_CUR_POS notifications from the backend when
 ...
 *   If set to 0 no CRUXSND_EVT_CUR_POS events are sent by the backend.
 *
...
/*
 * Shared page for CRUXSND_OP_OPEN buffer descriptor (gref_directory in the
 ...
 *   allocated at CRUXSND_OP_OPEN
 *
 * Number of grant_ref_t entries in the whole page directory is not
 * passed, but instead can be calculated as:
 *   num_grefs_total = (CRUXSND_OP_OPEN.buffer_sz + CRUX_PAGE_SIZE - 1) /
 *       CRUX_PAGE_SIZE
 */

struct cruxsnd_page_directory {
 ...
 *         0                1                 2               3        octet
 * +----------------+----------------+----------------+----------------+
 * |               id                | CRUXSND_OP_CLOSE|    reserved    | 4
 * +----------------+----------------+----------------+----------------+
 * |                             reserved                              | 8
 * +----------------+----------------+----------------+----------------+
 * |/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/|
 ...
 * +----------------+----------------+----------------+----------------+
 *
 * operation - CRUXSND_OP_READ for read or CRUXSND_OP_WRITE for write
 */

struct cruxsnd_rw_req {
    uint32_t offset;
    uint32_t length;
};
 ...
 * +----------------+----------------+----------------+----------------+
 *
 * operation - CRUXSND_OP_SET_VOLUME for volume set
 *   or CRUXSND_OP_GET_VOLUME for volume get
 * Buffer passed with CRUXSND_OP_OPEN is used to exchange volume
 * values:
 *
 *         0                1                 2               3        octet
 * +----------------+----------------+----------------+----------------+
 ...
 * +----------------+----------------+----------------+----------------+
 *
 * N = CRUXSND_OP_OPEN.pcm_channels
 ...
 * +----------------+----------------+----------------+----------------+
 *
 * operation - CRUXSND_OP_MUTE for mute or CRUXSND_OP_UNMUTE for unmute
 * Buffer passed with CRUXSND_OP_OPEN is used to exchange mute/unmute
 * values:
 *
 *                                   0                                 octet
 * +----------------+----------------+----------------+----------------+
 ...
 *------------------------------------ N.B. -----------------------------------
 *
 * The 'struct cruxsnd_rw_req' is also used for CRUXSND_OP_SET_VOLUME,
 * CRUXSND_OP_GET_VOLUME, CRUXSND_OP_MUTE, CRUXSND_OP_UNMUTE.
 *
 ...
 * +----------------+----------------+----------------+----------------+
 *
 * type - uint8_t, CRUXSND_OP_TRIGGER_XXX value
 */

struct cruxsnd_trigger_req {
    uint8_t type;
};
 ...
 *   of the multidimensional configuration available on cruxStore, e.g.
 ...
 *   on cruxStore or less). For example, selecting 96kHz sample rate may limit
 *   number of channels available for such configuration from 4 to 2, etc.
 *   Thus, each call to CRUXSND_OP_HW_PARAM_QUERY may reduce configuration
 *   space making it possible to iteratively get the final stream configuration,
 *   used in CRUXSND_OP_OPEN request.
 *
 ...
 *   made as bitwise OR of (1 << CRUXSND_PCM_FORMAT_XXX) values
 *
 ...
 * operation - uint8_t, CRUXSND_OP_* - copied from request
 * status - int32_t, response status, zero on success and -CRUX_EXX on failure
 *
 *
 * HW parameter query response - response for CRUXSND_OP_HW_PARAM_QUERY:
 *         0                1                 2               3        octet
 * +----------------+----------------+----------------+----------------+
 * |               id                |    operation   |    reserved    | 4
 * +----------------+----------------+----------------+----------------+
 ...
 * CRUXSND_OP_HW_PARAM_QUERY request.
 */
...
struct cruxsnd_req {
    ...
    uint8_t reserved[5];
    union {
        struct cruxsnd_open_req open;
        struct cruxsnd_rw_req rw;
        struct cruxsnd_trigger_req trigger;
        struct cruxsnd_query_hw_param hw_param;
        uint8_t reserved[56];
    } op;
};
...
struct cruxsnd_evt {
    ...
    uint8_t reserved[5];
    union {
        struct cruxsnd_cur_pos_evt cur_pos;
        uint8_t reserved[56];
    } op;
};

DEFINE_RING_TYPES(crux_sndif, struct cruxsnd_req, struct cruxsnd_resp);
...
struct cruxsnd_event_page {
    uint32_t in_cons;
    uint32_t in_prod;
    uint8_t reserved[56];
};

#define CRUXSND_EVENT_PAGE_SIZE 4096
#define CRUXSND_IN_RING_OFFS (sizeof(struct cruxsnd_event_page))
#define CRUXSND_IN_RING_SIZE (CRUXSND_EVENT_PAGE_SIZE - CRUXSND_IN_RING_OFFS)
#define CRUXSND_IN_RING_LEN (CRUXSND_IN_RING_SIZE / sizeof(struct cruxsnd_evt))
#define CRUXSND_IN_RING(page) \
    ((struct cruxsnd_evt *)((char *)(page) + CRUXSND_IN_RING_OFFS))
#define CRUXSND_IN_RING_REF(page, idx) \
    (CRUXSND_IN_RING((page))[(idx) % CRUXSND_IN_RING_LEN])

#endif /* __CRUX_PUBLIC_IO_SNDIF_H__ */
