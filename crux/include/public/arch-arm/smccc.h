...
#ifndef __CRUX_PUBLIC_ARCH_ARM_SMCCC_H__
#define __CRUX_PUBLIC_ARCH_ARM_SMCCC_H__
 ...
 *
 * We can't use CRUX version here, because of SMCCC requirements:
 ...
 * So, it is SMCCC protocol revision code, not CRUX version.
 *
 * Those values are subjected to change, when interface will be extended.
 */
#define CRUX_SMCCC_MAJOR_REVISION 0
#define CRUX_SMCCC_MINOR_REVISION 1

/* Hypervisor Service UID. Randomly generated with uuidgen. */
#define CRUX_SMCCC_UID CRUX_DEFINE_UUID(0xa71812dcU, 0xc698, 0x4369, 0x9acf, \
...
#define SSSC_SMCCC_UID CRUX_DEFINE_UUID(0xf863386fU, 0x4b39, 0x4cbd, 0x9220,\
                                       0xce, 0x16, 0x41, 0xe5, 0x9f, 0x6f)

#endif /* __CRUX_PUBLIC_ARCH_ARM_SMCCC_H__ */
