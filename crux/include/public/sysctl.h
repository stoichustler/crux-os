...
#ifndef __CRUX_PUBLIC_SYSCTL_H__
#define __CRUX_PUBLIC_SYSCTL_H__
...
struct crux_sysctl_readconsole {
    ...
    CRUX_GUEST_HANDLE_64(char) buffer;
...
/* CRUX_SYSCTL_tbuf_op */
struct crux_sysctl_tbuf_op {
    /* IN variables */
#define CRUX_SYSCTL_TBUFOP_get_info     0
#define CRUX_SYSCTL_TBUFOP_set_cpu_mask 1
#define CRUX_SYSCTL_TBUFOP_set_evt_mask 2
#define CRUX_SYSCTL_TBUFOP_set_size     3
#define CRUX_SYSCTL_TBUFOP_enable       4
#define CRUX_SYSCTL_TBUFOP_disable      5
    uint32_t cmd;
    /* IN/OUT variables */
    struct cruxctl_bitmap cpu_mask;
    uint32_t             evt_mask;
    /* OUT variables */
 ...
 */
/* CRUX_SYSCTL_physinfo */
 /* The platform supports HVM guests. */
#define _CRUX_SYSCTL_PHYSCAP_hvm          0
#define CRUX_SYSCTL_PHYSCAP_hvm           (1u<<_CRUX_SYSCTL_PHYSCAP_hvm)
 /* The platform supports PV guests. */
#define _CRUX_SYSCTL_PHYSCAP_pv           1
#define CRUX_SYSCTL_PHYSCAP_pv            (1u<<_CRUX_SYSCTL_PHYSCAP_pv)
 /* The platform supports direct access to I/O devices with IOMMU. */
#define _CRUX_SYSCTL_PHYSCAP_directio     2
#define CRUX_SYSCTL_PHYSCAP_directio  (1u<<_CRUX_SYSCTL_PHYSCAP_directio)
/* The platform supports Hardware Assisted Paging. */
#define _CRUX_SYSCTL_PHYSCAP_hap          3
#define CRUX_SYSCTL_PHYSCAP_hap           (1u<<_CRUX_SYSCTL_PHYSCAP_hap)
/* The platform supports software paging. */
#define _CRUX_SYSCTL_PHYSCAP_shadow       4
#define CRUX_SYSCTL_PHYSCAP_shadow        (1u<<_CRUX_SYSCTL_PHYSCAP_shadow)
/* The platform supports sharing of HAP page tables with the IOMMU. */
#define _CRUX_SYSCTL_PHYSCAP_iommu_hap_pt_share 5
#define CRUX_SYSCTL_PHYSCAP_iommu_hap_pt_share  \
    (1u << _CRUX_SYSCTL_PHYSCAP_iommu_hap_pt_share)
#define CRUX_SYSCTL_PHYSCAP_vmtrace       (1u << 6)
...
/* Max CRUX_SYSCTL_PHYSCAP_* constant.  Used for ABI checking. */
#define CRUX_SYSCTL_PHYSCAP_MAX CRUX_SYSCTL_PHYSCAP_gnttab_v2

#if defined(__arm__) || defined(__aarch64__)
#define CRUX_SYSCTL_PHYSCAP_ARM_SVE_MASK  (0x1FU)
#endif

struct crux_sysctl_physinfo {
    ...
    uint32_t cpu_khz;
    uint32_t capabilities;/* CRUX_SYSCTL_PHYSCAP_??? */
    uint32_t arch_capabilities;/* CRUX_SYSCTL_PHYSCAP_{X86,ARM,...}_??? */
    uint32_t pad;
 ...
 */
/* CRUX_SYSCTL_sched_id */
struct crux_sysctl_sched_id {
    /* OUT variable */
    uint32_t sched_id;
};
...
#define CRUX_SYSCTL_PERFCOP_query 2   /* Get perfctr information. */
struct crux_sysctl_perfc_desc {
    char         name[80];             /* name of perf counter */
    uint32_t     nr_vals;              /* number of values for this counter */
};
typedef struct crux_sysctl_perfc_desc crux_sysctl_perfc_desc_t;
DEFINE_CRUX_GUEST_HANDLE(crux_sysctl_perfc_desc_t);
typedef uint32_t crux_sysctl_perfc_val_t;
DEFINE_CRUX_GUEST_HANDLE(crux_sysctl_perfc_val_t);

struct crux_sysctl_perfc_op {
    /* IN variables. */
    uint32_t       cmd;                /*  CRUX_SYSCTL_PERFCOP_??? */
    /* OUT variables. */
    uint32_t       nr_counters;       /*  number of counters description  */
    uint32_t       nr_vals;           /*  number of values  */
    /* counter information (or NULL) */
    CRUX_GUEST_HANDLE_64(crux_sysctl_perfc_desc_t) desc;
    /* counter values (or NULL) */
    CRUX_GUEST_HANDLE_64(crux_sysctl_perfc_val_t) val;
};

/* CRUX_SYSCTL_getdomaininfolist */
struct crux_sysctl_getdomaininfolist {
    /* IN variables. */
    domid_t               first_domain;
    uint32_t              max_domains;
    CRUX_GUEST_HANDLE_64(crux_domctl_getdomaininfo_t) buffer;
    /* OUT variables. */
...
struct crux_sysctl_debug_keys {
    /* IN variables. */
    CRUX_GUEST_HANDLE_64(const_char) keys;
    uint32_t nr_keys;
};

/* Get physical CPU information. */
/* CRUX_SYSCTL_getcpuinfo */
struct crux_sysctl_cpuinfo {
    uint64_aligned_t idletime;
};
typedef struct crux_sysctl_cpuinfo crux_sysctl_cpuinfo_t;
DEFINE_CRUX_GUEST_HANDLE(crux_sysctl_cpuinfo_t);
struct crux_sysctl_getcpuinfo {
    /* IN variables. */
    uint32_t max_cpus;
    CRUX_GUEST_HANDLE_64(crux_sysctl_cpuinfo_t) info;
    /* OUT variables. */
    uint32_t nr_cpus;
};

/* CRUX_SYSCTL_availheap */
struct crux_sysctl_availheap {
    /* IN variables. */
...
DEFINE_CRUX_GUEST_HANDLE(pm_px_val_t);
...
struct pm_px_stat {
     ...
     */
    CRUX_GUEST_HANDLE_64(uint64) trans_pt;
    /* OUT: This should have total elements (PMSTAT_get_pxstat) */
    CRUX_GUEST_HANDLE_64(pm_px_val_t) pt;
};
...
struct pm_cx_stat {
    ...
    CRUX_GUEST_HANDLE_64(uint64) triggers;
     ...
     */
    CRUX_GUEST_HANDLE_64(uint64) pc;
    CRUX_GUEST_HANDLE_64(uint64) cc;
};

struct crux_sysctl_get_pmstat {
...
/* CRUX_SYSCTL_cpu_hotplug */
struct crux_sysctl_cpu_hotplug {
    /* IN variables */
    uint32_t cpu;   /* Physical cpu. */

    /* Single CPU enable/disable. */
#define CRUX_SYSCTL_CPU_HOTPLUG_ONLINE  0
#define CRUX_SYSCTL_CPU_HOTPLUG_OFFLINE 1
     ...
     * is in use.
     */
#define CRUX_SYSCTL_CPU_HOTPLUG_SMT_ENABLE  2
#define CRUX_SYSCTL_CPU_HOTPLUG_SMT_DISABLE 3
    uint32_t op;    /* hotplug opcode */
};

/*
 * Get/set crux power management, include
 * 1. cpufreq governors and related parameters
 */
/* CRUX_SYSCTL_pm_op */
struct crux_userspace {
    uint32_t scaling_setspeed;
};

struct crux_ondemand {
...
struct crux_cppc_para {
    /* OUT */
    /* activity_window supported if set */
#define CRUX_SYSCTL_CPPC_FEAT_ACT_WINDOW  (1 << 0)
     ...
     */
#define CRUX_CPPC_ACT_WINDOW_MANTISSA_MASK  0x07f
#define CRUX_CPPC_ACT_WINDOW_EXPONENT_MASK  0x380
 ...
 * CRUX_SYSCTL_CPPC_ACT_WINDOW_MASK for activity window.  Set bits outside the
 * range will be returned as -EINVAL.
 *
 * Activity Window may not be supported by the hardware.  In that case, the
 * returned set_params will clear CRUX_SYSCTL_CPPC_SET_ACT_WINDOW to indicate
 ...
 */
struct crux_set_cppc_para {
#define CRUX_SYSCTL_CPPC_SET_MINIMUM              (1U << 0)
#define CRUX_SYSCTL_CPPC_SET_MAXIMUM              (1U << 1)
#define CRUX_SYSCTL_CPPC_SET_DESIRED              (1U << 2)
#define CRUX_SYSCTL_CPPC_SET_ENERGY_PERF          (1U << 3)
#define CRUX_SYSCTL_CPPC_SET_ACT_WINDOW           (1U << 4)
#define CRUX_SYSCTL_CPPC_SET_PRESET_MASK          0xf0000000U
#define CRUX_SYSCTL_CPPC_SET_PRESET_NONE          0x00000000U
#define CRUX_SYSCTL_CPPC_SET_PRESET_ONDEMAND      0x10000000U
#define CRUX_SYSCTL_CPPC_SET_PRESET_POWERSAVE     0x20000000U
#define CRUX_SYSCTL_CPPC_SET_PRESET_PERFORMANCE   0x30000000U
#define CRUX_SYSCTL_CPPC_SET_PARAM_MASK \
        (CRUX_SYSCTL_CPPC_SET_PRESET_MASK | \
         CRUX_SYSCTL_CPPC_SET_MINIMUM     | \
         CRUX_SYSCTL_CPPC_SET_MAXIMUM     | \
         CRUX_SYSCTL_CPPC_SET_DESIRED     | \
         CRUX_SYSCTL_CPPC_SET_ENERGY_PERF | \
         CRUX_SYSCTL_CPPC_SET_ACT_WINDOW  )
    /* IN/OUT */
    uint32_t set_params; /* bitflags for valid values */
    /* See comments in struct crux_cppc_para. */
    /* IN */
    uint32_t minimum;
    uint32_t maximum;
    uint32_t desired;
    uint32_t energy_perf;
#define CRUX_SYSCTL_CPPC_ACT_WINDOW_MASK (CRUX_CPPC_ACT_WINDOW_MANTISSA_MASK | \
                                         CRUX_CPPC_ACT_WINDOW_EXPONENT_MASK)
    uint32_t activity_window;
};

#define CRUX_HWP_DRIVER_NAME "hwp"
...
struct crux_get_cpufreq_para {
    ...
    /* for all governors */
    /* OUT variable */
    CRUX_GUEST_HANDLE_64(uint32) affected_cpus;
    CRUX_GUEST_HANDLE_64(uint32) scaling_available_frequencies;
    CRUX_GUEST_HANDLE_64(char)   scaling_available_governors;
    ...
    union {
        struct {
            ...
            union {
                struct  crux_userspace userspace;
                struct  crux_ondemand ondemand;
            } u;
        } s;
...
struct crux_set_cpufreq_gov {
    char scaling_governor[CPUFREQ_NAME_LEN];
};

struct crux_set_cpufreq_para {
...
struct crux_sysctl_pm_op {
    ...
    #define CRUX_SYSCTL_pm_op_set_sched_opt_smt    0x21
     ...
     */
    #define CRUX_SYSCTL_pm_op_get_max_cstate       0x22
    #define CRUX_SYSCTL_pm_op_set_max_cstate       0x23

    /* set scheduler migration cost value */
    #define CRUX_SYSCTL_pm_op_set_vcpu_migration_delay   0x24
    #define CRUX_SYSCTL_pm_op_get_vcpu_migration_delay   0x25

    /* enable/disable turbo mode when in dbs governor */
    #define CRUX_SYSCTL_pm_op_enable_turbo               0x26
    #define CRUX_SYSCTL_pm_op_disable_turbo              0x27

    uint32_t cmd;
    uint32_t cpuid;
    union {
        struct crux_get_cpufreq_para get_para;
        struct crux_set_cpufreq_gov  set_gov;
        struct crux_set_cpufreq_para set_para;
        struct crux_set_cppc_para    set_cppc;
        uint64_aligned_t get_avgfreq;
        uint32_t                    set_sched_opt_smt;
#define CRUX_SYSCTL_CX_UNLIMITED 0xffffffffU
...
struct crux_sysctl_page_offline_op {
...
#define sysctl_query_page_offline  3
     ...
     * bit 16~31: owner
     */
    CRUX_GUEST_HANDLE(uint32) status;
};
...
#define PG_OFFLINE_CRUXPAGE   (0x1UL << 8)
...
/* Sub-operations: */
#define CRUX_SYSCTL_LOCKPROF_reset 1   /* Reset all profile data to zero. */
#define CRUX_SYSCTL_LOCKPROF_query 2   /* Get lock profile information. */
/* Record-type: */
...
struct crux_sysctl_lockprof_data {
...
typedef struct crux_sysctl_lockprof_data crux_sysctl_lockprof_data_t;
DEFINE_CRUX_GUEST_HANDLE(crux_sysctl_lockprof_data_t);
struct crux_sysctl_lockprof_op {
    /* IN variables. */
    uint32_t       cmd;               /* CRUX_SYSCTL_LOCKPROF_??? */
    ...
    CRUX_GUEST_HANDLE_64(crux_sysctl_lockprof_data_t) data;
};

/* CRUX_SYSCTL_cputopoinfo */
#define CRUX_INVALID_CORE_ID     (~0U)
#define CRUX_INVALID_SOCKET_ID   (~0U)
#define CRUX_INVALID_NODE_ID     (~0U)

struct crux_sysctl_cputopo {
    uint32_t core;
    uint32_t socket;
    uint32_t node;
};
typedef struct crux_sysctl_cputopo crux_sysctl_cputopo_t;
DEFINE_CRUX_GUEST_HANDLE(crux_sysctl_cputopo_t);
 ...
 */
struct crux_sysctl_cputopoinfo {
    uint32_t num_cpus;
    CRUX_GUEST_HANDLE_64(crux_sysctl_cputopo_t) cputopo;
};

/* CRUX_SYSCTL_numainfo */
#define CRUX_INVALID_MEM_SZ     (~0U)
#define CRUX_INVALID_NODE_DIST  (~0U)

struct crux_sysctl_meminfo {
    uint64_t memsize;
    uint64_t memfree;
};
typedef struct crux_sysctl_meminfo crux_sysctl_meminfo_t;
DEFINE_CRUX_GUEST_HANDLE(crux_sysctl_meminfo_t);
...
struct crux_sysctl_numainfo {
    uint32_t num_nodes;

    CRUX_GUEST_HANDLE_64(crux_sysctl_meminfo_t) meminfo;
     ...
     */
    CRUX_GUEST_HANDLE_64(uint32) distance;
};

/* CRUX_SYSCTL_cpupool_op */
#define CRUX_SYSCTL_CPUPOOL_OP_CREATE                1  /* C */
#define CRUX_SYSCTL_CPUPOOL_OP_DESTROY               2  /* D */
#define CRUX_SYSCTL_CPUPOOL_OP_INFO                  3  /* I */
#define CRUX_SYSCTL_CPUPOOL_OP_ADDCPU                4  /* A */
#define CRUX_SYSCTL_CPUPOOL_OP_RMCPU                 5  /* R */
#define CRUX_SYSCTL_CPUPOOL_OP_MOVEDOMAIN            6  /* M */
#define CRUX_SYSCTL_CPUPOOL_OP_FREEINFO              7  /* F */
#define CRUX_SYSCTL_CPUPOOL_PAR_ANY     0xFFFFFFFFU
struct crux_sysctl_cpupool_op {
    uint32_t op;          /* IN */
    ...
    struct cruxctl_bitmap cpumap; /*     OUT: IF */
};
 ...
 *
 * -EADDRINUSE:
 *  CRUX_SYSCTL_CPUPOOL_OP_RMCPU: A vcpu is temporarily pinned to the cpu
 *    which is to be removed from a cpupool.
 * -EADDRNOTAVAIL:
 *  CRUX_SYSCTL_CPUPOOL_OP_ADDCPU, CRUX_SYSCTL_CPUPOOL_OP_RMCPU: A previous
 *    request to remove a cpu from a cpupool was terminated with -EAGAIN
 *    and has not been retried using the same parameters.
 * -EAGAIN:
 *  CRUX_SYSCTL_CPUPOOL_OP_RMCPU: The cpu can't be removed from the cpupool
 *    as it is active in the hypervisor. A retry will succeed soon.
 * -EBUSY:
 *  CRUX_SYSCTL_CPUPOOL_OP_DESTROY, CRUX_SYSCTL_CPUPOOL_OP_RMCPU: A cpupool
 *    can't be destroyed or the last cpu can't be removed as there is still
 *    a running domain in that cpupool.
 * -EEXIST:
 *  CRUX_SYSCTL_CPUPOOL_OP_CREATE: A cpupool_id was specified and is already
 *    existing.
 * -EINVAL:
 *  CRUX_SYSCTL_CPUPOOL_OP_ADDCPU, CRUX_SYSCTL_CPUPOOL_OP_RMCPU: An illegal
 *    cpu was specified (cpu does not exist).
 *  CRUX_SYSCTL_CPUPOOL_OP_MOVEDOMAIN: An illegal domain was specified
 *    (domain id illegal or not suitable for operation).
 * -ENODEV:
 *  CRUX_SYSCTL_CPUPOOL_OP_ADDCPU, CRUX_SYSCTL_CPUPOOL_OP_RMCPU: The specified
...
typedef struct crux_sysctl_arinc653_schedule crux_sysctl_arinc653_schedule_t;
DEFINE_CRUX_GUEST_HANDLE(crux_sysctl_arinc653_schedule_t);

/*
 * Valid range for context switch rate limit (in microseconds).
 * Applicable to Credit and Credit2 schedulers.
 */
#define CRUX_SYSCTL_SCHED_RATELIMIT_MAX 500000
#define CRUX_SYSCTL_SCHED_RATELIMIT_MIN 100

struct crux_sysctl_credit_schedule {
    /* Length of timeslice in milliseconds */
#define CRUX_SYSCTL_CSCHED_TSLICE_MAX 1000
#define CRUX_SYSCTL_CSCHED_TSLICE_MIN 1
    uint32_t tslice_ms;
    ...
    */
#define CRUX_SYSCTL_CSCHED_MGR_DLY_MAX_US (100 * 1000)
    uint32_t vcpu_migr_delay_us;
};

struct crux_sysctl_credit2_schedule {
    uint32_t ratelimit_us;
};

/* CRUX_SYSCTL_scheduler_op */
/* Set or get info? */
#define CRUX_SYSCTL_SCHEDOP_putinfo 0
#define CRUX_SYSCTL_SCHEDOP_getinfo 1
struct crux_sysctl_scheduler_op {
    uint32_t cpupool_id; /* Cpupool whose scheduler is to be targetted. */
    uint32_t sched_id;   /* CRUX_SCHEDULER_* (domctl.h) */
    uint32_t cmd;        /* CRUX_SYSCTL_SCHEDOP_* */
    union {
        struct crux_sysctl_sched_arinc653 {
            CRUX_GUEST_HANDLE_64(crux_sysctl_arinc653_schedule_t) schedule;
        } sched_arinc653;
        struct crux_sysctl_credit_schedule sched_credit;
        struct crux_sysctl_credit2_schedule sched_credit2;
    } u;
};
 ...
 *
 * CRUX_GCOV_FORMAT_MAGIC CRUX_GCOV_RECORD ... CRUX_GCOV_RECORD
 *
...
#define CRUX_GCOV_FORMAT_MAGIC    0x58434f56 /* XCOV */
...
#define CRUX_SYSCTL_COVERAGE_read     1 /* Read output data */
#define CRUX_SYSCTL_COVERAGE_reset    2 /* Reset all counters */

struct crux_sysctl_coverage_op {
    uint32_t cmd;
    uint32_t size; /* IN/OUT: size of the buffer  */
    CRUX_GUEST_HANDLE_64(char) buffer; /* OUT */
};

#define CRUX_SYSCTL_PSR_CMT_get_total_rmid            0
#define CRUX_SYSCTL_PSR_CMT_get_l3_upscaling_factor   1
/* The L3 cache size is returned in KB unit */
#define CRUX_SYSCTL_PSR_CMT_get_l3_cache_size         2
#define CRUX_SYSCTL_PSR_CMT_enabled                   3
#define CRUX_SYSCTL_PSR_CMT_get_l3_event_mask         4
struct crux_sysctl_psr_cmt_op {
    uint32_t cmd;       /* IN: CRUX_SYSCTL_PSR_CMT_* */
...
/* CRUX_SYSCTL_pcitopoinfo */
#define CRUX_INVALID_DEV (CRUX_INVALID_NODE_ID - 1)
struct crux_sysctl_pcitopoinfo {
    /*
    ...
    CRUX_GUEST_HANDLE_64(physdev_pci_device_t) devs;

    /*
     * OUT: node identifier for each device.
     * If information for a particular device is not available then
     * corresponding entry will be set to CRUX_INVALID_NODE_ID. If
     * device is not known to the hypervisor then CRUX_INVALID_DEV
     * will be provided.
     */
    CRUX_GUEST_HANDLE_64(uint32) nodes;
};

#define CRUX_SYSCTL_PSR_get_l3_info               0
#define CRUX_SYSCTL_PSR_get_l2_info               1
#define CRUX_SYSCTL_PSR_get_mba_info              2
struct crux_sysctl_psr_alloc {
    uint32_t cmd;       /* IN: CRUX_SYSCTL_PSR_* */
    uint32_t target;    /* IN */
    union {
        struct {
            uint32_t cbm_len;   /* OUT: CBM length */
            uint32_t cos_max;   /* OUT: Maximum COS */
#define CRUX_SYSCTL_PSR_CAT_L3_CDP       (1u << 0)
        ...
        struct {
            ...
            uint32_t cos_max;   /* OUT: Maximum COS */
#define CRUX_SYSCTL_PSR_MBA_LINEAR      (1u << 0)
...
/*
 * CRUX_SYSCTL_get_cpu_levelling_caps (x86 specific)
 *
 * Return hardware capabilities concerning masking or faulting of the cpuid
 * instruction for PV guests.
 */
struct crux_sysctl_cpu_levelling_caps {
#define CRUX_SYSCTL_CPU_LEVELCAP_faulting    (1UL <<  0) /* CPUID faulting    */
#define CRUX_SYSCTL_CPU_LEVELCAP_ecx         (1UL <<  1) /* 0x00000001.ecx    */
#define CRUX_SYSCTL_CPU_LEVELCAP_edx         (1UL <<  2) /* 0x00000001.edx    */
#define CRUX_SYSCTL_CPU_LEVELCAP_extd_ecx    (1UL <<  3) /* 0x80000001.ecx    */
#define CRUX_SYSCTL_CPU_LEVELCAP_extd_edx    (1UL <<  4) /* 0x80000001.edx    */
#define CRUX_SYSCTL_CPU_LEVELCAP_xsave_eax   (1UL <<  5) /* 0x0000000D:1.eax  */
#define CRUX_SYSCTL_CPU_LEVELCAP_thermal_ecx (1UL <<  6) /* 0x00000006.ecx    */
#define CRUX_SYSCTL_CPU_LEVELCAP_l7s0_eax    (1UL <<  7) /* 0x00000007:0.eax  */
#define CRUX_SYSCTL_CPU_LEVELCAP_l7s0_ebx    (1UL <<  8) /* 0x00000007:0.ebx  */
    uint32_t caps;
};

/*
 * CRUX_SYSCTL_get_cpu_featureset (x86 specific)
 *
...
#define CRUX_SYSCTL_cpu_featureset_host     1
#define CRUX_SYSCTL_cpu_featureset_pv       2
#define CRUX_SYSCTL_cpu_featureset_hvm      3
#define CRUX_SYSCTL_cpu_featureset_pv_max   4
#define CRUX_SYSCTL_cpu_featureset_hvm_max  5
    ...
    uint32_t nr_features; /* IN/OUT: Number of entries in/written to
                           ...
                           * maximum length. */
    CRUX_GUEST_HANDLE_64(uint32) features; /* OUT: */
};
 ...
 *  CRUX_SYSCTL_LIVEPATCH_UPLOAD (0)
 *  CRUX_SYSCTL_LIVEPATCH_GET (1)
 *  CRUX_SYSCTL_LIVEPATCH_LIST (2)
 *  CRUX_SYSCTL_LIVEPATCH_ACTION (3)
 *
 * The normal sequence of sub-ops is to:
 *  1) CRUX_SYSCTL_LIVEPATCH_UPLOAD to upload the payload. If errors STOP.
 *  2) CRUX_SYSCTL_LIVEPATCH_GET to check the `->rc`. If -CRUX_EAGAIN spin.
 *     If zero go to next step.
 *  3) CRUX_SYSCTL_LIVEPATCH_ACTION with LIVEPATCH_ACTION_APPLY to apply the patch.
 *  4) CRUX_SYSCTL_LIVEPATCH_GET to check the `->rc`. If in -CRUX_EAGAIN spin.
 ...
 *
 * We guard this with __CRUX__ as toolstacks SHOULD not use it.
 */
#ifdef __CRUX__
 ...
 * Recommended length is upto CRUX_LIVEPATCH_NAME_SIZE.
 * Includes the NUL terminator.
 */
#define CRUX_LIVEPATCH_NAME_SIZE 128
struct crux_livepatch_name {
    CRUX_GUEST_HANDLE_64(char) name;         /* IN: pointer to name. */
    uint16_t size;                          /* IN: size of name. May be upto
                                               CRUX_LIVEPATCH_NAME_SIZE. */
 ...
 * controlled by CRUX_SYSCTL_LIVEPATCH_ACTION.
 *
 ...
 * section in the Live Patch design document.
 */
#define CRUX_SYSCTL_LIVEPATCH_UPLOAD 0
struct crux_sysctl_livepatch_upload {
    struct crux_livepatch_name name;         /* IN, name of the patch. */
    uint64_t size;                          /* IN, size of the ELF file. */
    CRUX_GUEST_HANDLE_64(uint8) payload;     /* IN, the ELF file. */
};

/*
 * Retrieve an status of an specific payload.
 *
 * Upon completion the `struct crux_livepatch_status` is updated.
 *
 * The return value is zero on success and CRUX_EXX on failure. This operation
 * is synchronous and does not require preemption.
 */
#define CRUX_SYSCTL_LIVEPATCH_GET 1

struct crux_livepatch_status {
#define LIVEPATCH_STATE_CHECKED      1
#define LIVEPATCH_STATE_APPLIED      2
    uint32_t state;                /* OUT: LIVEPATCH_STATE_*. */
    int32_t rc;                    /* OUT: 0 if no error, otherwise -CRUX_EXX. */
};
typedef struct crux_livepatch_status crux_livepatch_status_t;
DEFINE_CRUX_GUEST_HANDLE(crux_livepatch_status_t);

struct crux_sysctl_livepatch_get {
    struct crux_livepatch_name name;         /* IN, name of the payload. */
    struct crux_livepatch_status status;     /* IN/OUT, state of it. */
};
 ...
 * `version` field.
 */
#define CRUX_SYSCTL_LIVEPATCH_LIST 2
struct crux_sysctl_livepatch_list {
    ...
    uint32_t metadata_total_size;           /* IN: Size of metadata buffer
                                               OUT: Total size of transferred
                                               metadata */
    CRUX_GUEST_HANDLE_64(crux_livepatch_status_t) status;  /* OUT. Must have enough
                                               space allocate for nr of them. */
    CRUX_GUEST_HANDLE_64(char) name;         /* OUT: Array of names. Each member
                                               may have an arbitrary length up to
                                               CRUX_LIVEPATCH_NAME_SIZE bytes. Must have
                                               nr of them. */
    CRUX_GUEST_HANDLE_64(uint32) len;        /* OUT: Array of lengths of name's.
                                               Must have nr of them. */
    CRUX_GUEST_HANDLE_64(char) metadata;     /* OUT: Array of metadata strings. Each
                                               member may have an arbitrary length.
                                               Must have nr of them. */
    CRUX_GUEST_HANDLE_64(uint32) metadata_len;  /* OUT: Array of lengths of metadata's.
                                                  Must have nr of them. */
};
 ...
 * by using either CRUX_SYSCTL_LIVEPATCH_GET or CRUX_SYSCTL_LIVEPATCH_LIST hypercall.
 */
#define CRUX_SYSCTL_LIVEPATCH_ACTION 3
struct crux_sysctl_livepatch_action {
    struct crux_livepatch_name name;         /* IN, name of the patch. */
...
struct crux_sysctl_livepatch_op {
    uint32_t cmd;                           /* IN: CRUX_SYSCTL_LIVEPATCH_*. */
    uint32_t flags;                         /* IN, flags. */
#define LIVEPATCH_FLAG_FORCE      (1u << 0) /* Skip some checks. */
#define LIVEPATCH_FLAGS_MASK      LIVEPATCH_FLAG_FORCE
    union {
        struct crux_sysctl_livepatch_upload upload;
        struct crux_sysctl_livepatch_list list;
        struct crux_sysctl_livepatch_get get;
        struct crux_sysctl_livepatch_action action;
    } u;
};

#if defined(__i386__) || defined(__x86_64__)
/*
 * CRUX_SYSCTL_get_cpu_policy (x86 specific)
 *
...
#define CRUX_SYSCTL_cpu_policy_host         1
#define CRUX_SYSCTL_cpu_policy_pv_max       2
#define CRUX_SYSCTL_cpu_policy_hvm_max      3
#define CRUX_SYSCTL_cpu_policy_pv_default   4
#define CRUX_SYSCTL_cpu_policy_hvm_default  5
    ...
    CRUX_GUEST_HANDLE_64(crux_cpuid_leaf_t) leaves; /* OUT */
    CRUX_GUEST_HANDLE_64(crux_msr_entry_t)  msrs;   /* OUT */
};
typedef struct crux_sysctl_cpu_policy crux_sysctl_cpu_policy_t;
DEFINE_CRUX_GUEST_HANDLE(crux_sysctl_cpu_policy_t);
#endif

#if defined(__arm__) || defined(__aarch64__)
/*
 * CRUX_SYSCTL_dt_overlay
...
#define CRUX_SYSCTL_DT_OVERLAY_ADD                   1
#define CRUX_SYSCTL_DT_OVERLAY_REMOVE                2
...
struct crux_sysctl {
    uint32_t cmd;
#define CRUX_SYSCTL_readconsole                    1
#define CRUX_SYSCTL_tbuf_op                        2
#define CRUX_SYSCTL_physinfo                       3
#define CRUX_SYSCTL_sched_id                       4
#define CRUX_SYSCTL_perfc_op                       5
#define CRUX_SYSCTL_getdomaininfolist              6
#define CRUX_SYSCTL_debug_keys                     7
#define CRUX_SYSCTL_getcpuinfo                     8
#define CRUX_SYSCTL_availheap                      9
#define CRUX_SYSCTL_get_pmstat                    10
#define CRUX_SYSCTL_cpu_hotplug                   11
#define CRUX_SYSCTL_pm_op                         12
#define CRUX_SYSCTL_page_offline_op               14
#define CRUX_SYSCTL_lockprof_op                   15
#define CRUX_SYSCTL_cputopoinfo                   16
#define CRUX_SYSCTL_numainfo                      17
#define CRUX_SYSCTL_cpupool_op                    18
#define CRUX_SYSCTL_scheduler_op                  19
#define CRUX_SYSCTL_coverage_op                   20
#define CRUX_SYSCTL_psr_cmt_op                    21
#define CRUX_SYSCTL_pcitopoinfo                   22
#define CRUX_SYSCTL_psr_alloc                     23
/* #define CRUX_SYSCTL_tmem_op                       24 */
#define CRUX_SYSCTL_get_cpu_levelling_caps        25
#define CRUX_SYSCTL_get_cpu_featureset            26
#define CRUX_SYSCTL_livepatch_op                  27
/* #define CRUX_SYSCTL_set_parameter              28 */
#define CRUX_SYSCTL_get_cpu_policy                29
#define CRUX_SYSCTL_dt_overlay                    30
    uint32_t interface_version; /* CRUX_SYSCTL_INTERFACE_VERSION */
    union {
        struct crux_sysctl_readconsole       readconsole;
        struct crux_sysctl_tbuf_op           tbuf_op;
        struct crux_sysctl_physinfo          physinfo;
        struct crux_sysctl_cputopoinfo       cputopoinfo;
        struct crux_sysctl_pcitopoinfo       pcitopoinfo;
        struct crux_sysctl_numainfo          numainfo;
        struct crux_sysctl_sched_id          sched_id;
        struct crux_sysctl_perfc_op          perfc_op;
        struct crux_sysctl_getdomaininfolist getdomaininfolist;
        struct crux_sysctl_debug_keys        debug_keys;
        struct crux_sysctl_getcpuinfo        getcpuinfo;
        struct crux_sysctl_availheap         availheap;
        struct crux_sysctl_get_pmstat        get_pmstat;
        struct crux_sysctl_cpu_hotplug       cpu_hotplug;
        struct crux_sysctl_pm_op             pm_op;
        struct crux_sysctl_page_offline_op   page_offline;
        struct crux_sysctl_lockprof_op       lockprof_op;
        struct crux_sysctl_cpupool_op        cpupool_op;
        struct crux_sysctl_scheduler_op      scheduler_op;
        struct crux_sysctl_coverage_op       coverage_op;
        struct crux_sysctl_psr_cmt_op        psr_cmt_op;
        struct crux_sysctl_psr_alloc         psr_alloc;
        struct crux_sysctl_cpu_levelling_caps cpu_levelling_caps;
        struct crux_sysctl_cpu_featureset    cpu_featureset;
        struct crux_sysctl_livepatch_op      livepatch;
#if defined(__i386__) || defined(__x86_64__)
        struct crux_sysctl_cpu_policy        cpu_policy;
#endif

#if defined(__arm__) || defined(__aarch64__)
        struct crux_sysctl_dt_overlay        dt_overlay;
#endif
        uint8_t                             pad[128];
    } u;
};
typedef struct crux_sysctl crux_sysctl_t;
DEFINE_CRUX_GUEST_HANDLE(crux_sysctl_t);

#endif /* __CRUX_PUBLIC_SYSCTL_H__ */
