...
#ifndef __CRUX_ARM_LIVEPATCH_H__
#define __CRUX_ARM_LIVEPATCH_H__

#include <crux/sizes.h> /* For SZ_* macros. */
#include <asm/insn.h>
...
#endif /* __CRUX_ARM_LIVEPATCH_H__ */
